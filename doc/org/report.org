...
#+begin_SRC R :results graphics output :session *R* :file "img/histograms.pdf" :width 10 :height 10 :eval no-export :exports both
library(ggplot2)
library(dplyr)
library(GGally)
...
#+begin_SRC R :results graphics output :session *R* :file "img/scatter.pdf" :width 10 :height 10 :eval no-export :exports both
library(ggplot2)
library(dplyr)
library(tidyr)
