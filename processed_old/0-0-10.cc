...
# 3 "cc1plus-checksum.c" 2
extern const unsigned char executable_checksum[16] = { 0x2b, 0xc1, 0x1e, 0x8d, 0xaa, 0xee, 0x23, 0x37, 0xff, 0xae, 0xb2, 0xa5, 0x9c, 0x6a, 0xf0, 0x99 };
