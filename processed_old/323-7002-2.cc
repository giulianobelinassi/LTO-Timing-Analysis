# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
extern Mem mem;
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
# 1 "d/id.h" 1
...
# 30 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
# 32 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
# 33 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
void initPrecedence();
# 34 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
# 35 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 2
...
# 96 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c"
...
bool isTypeFinalClass(Type *t) { return t->toBasetype()->ty == Tclass && (((TypeClass *)t->toBasetype())->sym->storage_class & 8LL) != 0; }
...
bool isDeclLazy(Declaration *d) { return (d->storage_class & 0x2000LL) != 0; }
...
TraitsInitializer::TraitsInitializer()
{
    ...
    for (size_t idx = 0;; idx++)
    {
        ...
        ((void)(!(sv) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c", 278, __FUNCTION__), 0 : 0));
    }
}
...
# 333 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c"
Expression *pointerBitmap(TraitsExp *e)
{
    ...
    if (sz > 
# 355 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c" 3 4
            (18446744073709551615UL) 
# 355 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c"
                       - sz_size_t)
    {
    ...
    public:
        ...
        virtual void visit(TypeError *t) { visit((Type *)t); }
        virtual void visit(TypeNext *) { ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c", 387, __FUNCTION__), 0 : 0)); }
        ...
        virtual void visit(TypeArray *) { ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c", 394, __FUNCTION__), 0 : 0)); }
        virtual void visit(TypeSArray *t)
        {
            d_uns64 arrayoff = offset;
            d_uns64 nextsize = t->next->size();
            if (nextsize == (~(d_uns64)0))
                error = true;
        ...
        virtual void visit(TypeDArray *) { setpointer(offset + sz_size_t); }
        ...
        virtual void visit(TypeDelegate *) { setpointer(offset); }
        virtual void visit(TypeQualified *) { ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c", 420, __FUNCTION__), 0 : 0)); }
        virtual void visit(TypeIdentifier *) { ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c", 421, __FUNCTION__), 0 : 0)); }
        virtual void visit(TypeInstance *) { ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c", 422, __FUNCTION__), 0 : 0)); }
        virtual void visit(TypeTypeof *) { ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c", 423, __FUNCTION__), 0 : 0)); }
        virtual void visit(TypeReturn *) { ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c", 424, __FUNCTION__), 0 : 0)); }
        virtual void visit(TypeEnum *t) { visit((Type *)t); }
        virtual void visit(TypeTuple *t) { visit((Type *)t); }
        virtual void visit(TypeSlice *) { ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c", 427, __FUNCTION__), 0 : 0)); }
...
Expression *semanticTraits(TraitsExp *e, Scope *sc)
{
    ...
    else if (e->ident == Id::identifier)
    {
        ...
        {
            id = po->ident;
            ((void)(!(id) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c", 638, __FUNCTION__), 0 : 0));
        }
        else
        {
            Dsymbol *s = getDsymbol(o);
    ...
    else if (e->ident == Id::getProtection)
    {
        ...
        const char *protName = protectionToChars(s->prot().kind);
        ((void)(!(protName) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c", 678, __FUNCTION__), 0 : 0));
             ...
             e->ident == Id::getVirtualFunctions)
    {
                 ...
                 e->ident == Id::getOverloads)
        {
            ...
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c", 847, __FUNCTION__), 0 : 0));
    }
    ...
    else if (e->ident == Id::getFunctionVariadicStyle)
    {
        ...
        else
        {
            ...
            if (!s || (fd = s->isFuncDeclaration()) == nullptr)
            {
        ...
        switch (varargs)
        {
            ...
            default:
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c", 1010, __FUNCTION__), 0 : 0));
        }
    ...
    else if (e->ident == Id::getParameterStorageClasses)
    {
        ...
        if (stc & 0x80000LL && !(stc & 0x2000000000000LL))
            ...
            else
            {
                switch (ad->classKind)
                {
                    ...
                    case ClassKind::objc:
                        ...
                        break;
                    default:
                        ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c", 1161, __FUNCTION__), 0 : 0));
                }
            }
        }
             ...
             e->ident == Id::derivedMembers)
    {
        ...
        struct PushIdentsDg
        {
            ...
            static int dg(void *ctx, size_t, Dsymbol *sm)
            {
                ...
                {
                    if (decl->storage_class & 0x8000000000000LL)
                    {
                        return 0;
                    }
                }
                ...
                if (sm->ident)
                {
                    ...
                    if (!pid->sds->isModule() && sm->isImport())
                        return 0;
            ...
            struct PushBaseMembers
            {
                static void dg(ClassDeclaration *cd, PushIdentsDg *ctx)
                {
                    for (size_t i = 0; i < cd->baseclasses->length; i++)
                    {
                        ...
                        ((void)(!(cb) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c", 1284, __FUNCTION__), 0 : 0));
        ...
        ((void)(!(sizeof(Expressions) == sizeof(Identifiers)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/traits.c", 1295, __FUNCTION__), 0 : 0));
    ...
    else if (e->ident == Id::compiles)
    {
        ...
        for (size_t i = 0; i < dim; i++)
        {
            ...
            sc2->tinst = nullptr;
            sc2->minst = nullptr;
            sc2->flags = (sc->flags & ~(0x0080 | 0x0004)) | 0x0100 | 0x10000;
            bool err = false;
