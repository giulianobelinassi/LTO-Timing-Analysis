# 1 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
# 19 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
# 1 "./config.h" 1
# 20 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 2
# 33 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
struct block
{
  ...
  if (n > (size_t) (pfile->out.limit - pfile->out.cur))
    {
      ...
      pfile->out.base = ((unsigned char *) xrealloc ((void *) (pfile->out.base), sizeof (unsigned char) * (new_size)));
...
# 159 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
static const uchar *
...
# 223 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
static const uchar *
...
lex_identifier (cpp_reader *pfile, const uchar *cur)
{
  ...
  result = ((cpp_hashnode *) (ht_lookup (pfile->hash_table, pfile->out.cur, len, HT_ALLOC)))
                       ;
  pfile->out.cur = out;
  return result;
}
...
# 304 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
                          __null
# 304 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
                              ;
}
...
_cpp_read_logical_line_trad (cpp_reader *pfile)
{
      ...
      if (pfile->buffer->need_line && !_cpp_get_fresh_line (pfile))
 {
  ...
  while (!_cpp_scan_out_logical_line (pfile, 
# 321 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
                                            __null
# 321 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
                                                , false)
  || pfile->state.skipping);

  return pfile->buffer != 
# 324 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
                         __null
# 324 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
                             ;
}
...
# 380 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
bool
       ...
       bool builtin_macro_arg)
{
  ...
  fmacro.buff = 
# 394 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
               __null
# 394 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
                   ;
  fmacro.args = 
# 395 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
               __null
# 395 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
                   ;
  fmacro.node = 
# 396 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
               __null
# 396 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
                   ;
  fmacro.offset = 0;
  fmacro.line = 0;
  fmacro.paramc = 0;
 ...
 case '\n':
   ...
   do { const class line_maps *line_table = pfile->line_table; const struct line_map_ordinary *map = LINEMAPS_LAST_ORDINARY_MAP (line_table); linenum_type line = SOURCE_LINE (map, line_table->highest_line); linemap_line_start (pfile->line_table, line + 1, 0); } while (0);
 ...
 case ')':
       ...
       if (lex_state == ls_fun_close && paren_depth == 0)
  {
    if (cpp_builtin_macro_p (fmacro.node))
      {
# 629 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
        lex_state = ls_none;
        save_argument (&fmacro, out - pfile->out.base);
        cpp_macro m;
        memset (&m, '\0', sizeof (m));
          ...
          fmacro.argc))
   {
     ...
     const unsigned char *ctx_rlimit = ((context)->u.trad.rlimit);
     ...
     context->prev = 
# 667 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
                    __null
# 667 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
                        ;

     _cpp_scan_out_logical_line (pfile, 
# 669 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
                                       __null
# 669 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
                                           , true);
     ...
     *pfile->out.cur = '\n';
     ...
     pfile->out.cur = pfile->out.base + fmacro.offset;
     ((context)->u.trad.cur) = cur;
     ((context)->u.trad.rlimit) = ctx_rlimit;
     len = ustrlen (text);
...
{
  bool recursing = !!(node->flags & (1 << 4));
# 872 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
      ...
      do
 {
   ...
   context = context->prev;
      ...
      while (context);
      recursing = context != 
# 885 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
                            __null
# 885 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
                                ;
    }
...
_cpp_replacement_text_len (const cpp_macro *macro)
{
      ...
      for (exp = macro->exp.text;;)
 {
   ...
   if (b->arg_index == 0)
     break;
   len += (((&(macro->parm.params[b->arg_index - 1])->ident))->len);
   exp += (((
# 916 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
         __builtin_offsetof (
# 916 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
         struct block
# 916 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
         , 
# 916 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
...
_cpp_copy_replacement_text (const cpp_macro *macro, uchar *dest)
{
      ...
      for (exp = macro->exp.text;;)
 {
   ...
   exp += (((
# 947 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
         __builtin_offsetof (
# 947 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
         struct block
# 947 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
         , 
# 947 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
...
replace_args_and_push (cpp_reader *pfile, struct fun_macro *fmacro)
{
      ...
      for (exp = macro->exp.text;;)
 {
   ...
   exp += (((
# 989 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
         __builtin_offsetof (
# 989 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
         struct block
# 989 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
         , 
# 989 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
...
# 989 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
      ...
      for (exp = macro->exp.text;;)
 {
  ...
  cxtquote = ! cxtquote;
   ...
   in = base;
# 1037 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
       ...
       else if (cxtquote && argquote && *in == '\\')
  {
   ...
   exp += (((
# 1059 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
         __builtin_offsetof (
# 1059 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
         struct block
# 1059 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
         , 
# 1059 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
         ...
         unsigned int arg_index)
{
  ...
  if (macro->paramc == 0)
  ...
  else
    {
      ...
      size_t blen = (((
# 1145 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
                   __builtin_offsetof (
# 1145 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
                   struct block
# 1145 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
                   , 
# 1145 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
...
_cpp_create_trad_definition (cpp_reader *pfile)
{
  ...
  int fun_like = 0;
  cpp_hashnode **params = 
# 1181 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
                         __null
# 1181 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
                             ;
 ...
 fun_like = -1;
  ...
  cpp_macro *macro = 
# 1201 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
                    __null
# 1201 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
                        ;
...
{
  uchar *p1 = ((uchar *) xmalloc (sizeof (uchar) * (macro1->count + macro2->count)));
      ...
      for (;;)
 {
   ...
   exp1 += (((
# 1307 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
          __builtin_offsetof (
# 1307 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
          struct block
# 1307 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
          , 
# 1307 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
...
# 1307 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
   ...
   exp2 += (((
# 1308 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
          __builtin_offsetof (
# 1308 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
          struct block
# 1308 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c" 3 4
          , 
# 1308 "/home/giulianob/gcc_git_gnu/gcc/libcpp/traditional.c"
