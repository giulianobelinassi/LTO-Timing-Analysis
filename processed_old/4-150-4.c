# 1 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c"
# 21 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c"
# 1 "./config.h" 1
# 22 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c" 2
...
# 29 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c" 2
...
# 32 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c" 2
...
# 35 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c" 2
...
# 38 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c" 2
# 49 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c"
...
# 50 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c" 2
extern int mkstemps (char *, int);
# 70 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c"
...
try_dir (const char *dir, const char *base)
{
  ...
  if (dir != 0
      && access (dir, 
# 78 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c" 3 4
                     4 
# 78 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c"
                          | 
# 78 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c" 3 4
                            2 
# 78 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c"
...
# 104 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c"
const char *
choose_tmpdir (void)
{
  if (!memoized_tmpdir)
    {
      ...
      if (strcmp (
# 126 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c" 3 4
                 "/tmp"
# 126 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c"
                         , "\\") == 0)
 base = try_dir ("\\.", base);
      else
 base = try_dir (
# 129 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c" 3 4
                "/tmp"
# 129 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c"
                        , base);
...
# 166 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c"
    }

  return memoized_tmpdir;
}
# 183 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c"
char *
make_temp_file_with_prefix (const char *prefix, const char *suffix)
{
  ...
  temp_filename = ((char *) xmalloc (sizeof (char) * (base_len + (sizeof("XXXXXX") - 1) + suffix_len + prefix_len + 1)))


                       ;
  strcpy (temp_filename, base);
  strcpy (temp_filename + base_len, prefix);
  strcpy (temp_filename + base_len + prefix_len, "XXXXXX");
  strcpy (temp_filename + base_len + prefix_len + (sizeof("XXXXXX") - 1), suffix);
  ...
  if (fd == -1)
    {
      fprintf (
# 214 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c" 3 4
              stderr
# 214 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c"
                    , "Cannot create temporary file in %s: %s\n",
        base, strerror (
# 215 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c" 3 4
                       (*__errno_location ())
# 215 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c"
                            ));
      abort ();
    }
...
{
  return make_temp_file_with_prefix (
# 227 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c" 3 4
                                    ((void *)0)
# 227 "/home/giulianob/gcc_git_gnu/gcc/libiberty/make-temp-file.c"
                                        , suffix);
}
