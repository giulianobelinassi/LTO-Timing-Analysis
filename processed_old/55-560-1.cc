# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/aliasthis.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/aliasthis.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/aliasthis.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/aliasthis.c" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/aliasthis.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/aliasthis.c" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/aliasthis.h" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/aliasthis.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/aliasthis.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/aliasthis.c" 2
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/aliasthis.c", 88, __FUNCTION__), 0 : 0));
...
void AliasThis::semantic(Scope *sc)
{
    ...
    ((void)(!(ad->members) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/aliasthis.c", 117, __FUNCTION__), 0 : 0));
    Dsymbol *s = ad->search(loc, ident);
    if (!s)
    {
        s = sc->search(loc, ident, nullptr);
        if (s)
    ...
    if (ad->type->ty == Tstruct && ((TypeStruct *)ad->type)->sym != ad)
    {
        ...
        ((void)(!(ad2->type == Type::terror) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/aliasthis.c", 137, __FUNCTION__), 0 : 0));
    ...
    {
        Type *t = d->type;
        ((void)(!(t) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/aliasthis.c", 154, __FUNCTION__), 0 : 0));
