# 1 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
# 21 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
# 1 "./config.h" 1
# 22 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 2
...
# 79 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
...
# 168 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
static void do_define (cpp_reader *); static void do_include (cpp_reader *); static void do_endif (cpp_reader *); static void do_ifdef (cpp_reader *); static void do_if (cpp_reader *); static void do_else (cpp_reader *); static void do_ifndef (cpp_reader *); static void do_undef (cpp_reader *); static void do_line (cpp_reader *); static void do_elif (cpp_reader *); static void do_error (cpp_reader *); static void do_pragma (cpp_reader *); static void do_warning (cpp_reader *); static void do_include_next (cpp_reader *); static void do_ident (cpp_reader *); static void do_import (cpp_reader *); static void do_assert (cpp_reader *); static void do_unassert (cpp_reader *); static void do_ident (cpp_reader *);
...
"define", "include", "endif", "ifdef", "if", "else", "ifndef", "undef", "line", "elif", "error", "pragma", "warning", "include_next", "ident", "import", "assert", "unassert", "sccs",
  
# 193 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
 __null

# 194 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
};
...
{
  if (! (pfile->cur_token[-1].type == CPP_EOF) && (expand
   ? cpp_get_token (pfile)
...
check_eol_return_comments (cpp_reader *pfile)
{
  ...
  buf = ((const cpp_token * *) xmalloc (sizeof (const cpp_token *) * (capacity)));
  c = 0;
  if (! (pfile->cur_token[-1].type == CPP_EOF))
    {
      while (1)
 {
  ...
  {
    capacity *= 2;
    buf = ((const cpp_token * *) xrealloc ((void *) (buf), sizeof (const cpp_token *) * (capacity)));
  }
       buf[c] = tok;
       ++c;
     }
  ...
  buf[c] = 
# 286 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
          __null
# 286 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
              ;
  return buf;
}
...
prepare_directive_trad (cpp_reader *pfile)
{
 ...
 pfile->state.skipping = false;
      ...
      if (no_expand)
 pfile->state.prevent_expansion++;
      _cpp_scan_out_logical_line (pfile, 
# 354 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                                        __null
# 354 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                                            , false);
      if (no_expand)
 pfile->state.prevent_expansion--;
...
directive_diagnostics (cpp_reader *pfile, const directive *dir, int indented)
{
  ...
  if (! pfile->state.skipping)
    {
      if (dir->origin == 2
   && !(dir == &dtable[T_IMPORT] && ((pfile)->opts.objc))
   && ((pfile)->opts.cpp_pedantic))
 cpp_error (pfile, CPP_DL_PEDWARN, "#%s is a GCC extension", dir->name);
      else if (((dir->flags & (1 << 5)) != 0
  || (dir == &dtable[T_IMPORT] && !((pfile)->opts.objc)))
        && ((pfile)->opts.cpp_warn_deprecated))
 cpp_warning (pfile, CPP_W_DEPRECATED,
  ...
  if (((pfile)->opts.cpp_warn_traditional))
    {
...
_cpp_handle_directive (cpp_reader *pfile, bool indented)
{
 ...
 dir = &dtable[dname->val.node.node->directive_index];
    ...
    {
      dir = &linemarker_dir;
      if (((pfile)->opts.cpp_pedantic) && ! ((pfile)->opts.preprocessed)
...
# 473 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
      ...
      else if (!pfile->state.skipping)
 {
   ...
   const char *hint = 
# 508 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                     __null
# 508 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                         ;
...
# 594 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
 ...
 return node;
  ...
  return 
# 616 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
        __null
# 616 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
            ;
}
...
do_undef (cpp_reader *pfile)
{
      ...
      if (cpp_macro_p (node))
 {
   if (node->flags & (1 << 3))
     ...
     && ((pfile)->opts.warn_builtin_macro_redefined))
...
# 671 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                                            __null
# 671 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                                                );
...
static int
undefine_macros (cpp_reader *pfile __attribute__ ((__unused__)), cpp_hashnode *h,
   void *data_p __attribute__ ((__unused__)))
{


  h->type = NT_VOID;
  h->value.answers = 
# 689 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                    __null
# 689 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                        ;
  h->flags &= ~((1 << 1)|(1 << 4)|(1 << 5));
  return 1;
}
...
{
  cpp_forall_identifiers (pfile, undefine_macros, 
# 699 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                                                 __null
# 699 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                                                     );
}
...
glue_header_name (cpp_reader *pfile)
{
  ...
  buffer = ((char *) xmalloc (sizeof (char) * (capacity)));
  for (;;)
    {
      ...
      if (total_len + len > capacity)
 {
   ...
   buffer = ((char *) xrealloc ((void *) (buffer), sizeof (char) * (capacity)));
 }
        ...
        const cpp_token ***buf, location_t *location)
{
  ...
  *location = header->src_loc;
  if ((header->type == CPP_STRING && header->val.str.text[0] != 'R')
    ...
    {
      fname = ((char *) xmalloc (sizeof (char) * (header->val.str.len - 1)));
 ...
 dir = pfile->directive->name;
   ...
   dir);
      ...
      return 
# 786 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
            __null
# 786 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                ;
    }
...
# 793 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                 __null 
# 793 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                      || ((pfile)->opts.discard_comments))
...
do_include_common (cpp_reader *pfile, enum include_type type)
{
  ...
  int angle_brackets;
  const cpp_token **buf = 
# 811 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                         __null
# 811 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                             ;
  location_t location;
...
do_line (cpp_reader *pfile)
{
  ...
  linenum_type cap = ((pfile)->opts.c99) ? 2147483647 : 32767;
  bool wrapped;
 ...
 cpp_error (pfile, CPP_DL_ERROR,
  ...
  if (((pfile)->opts.cpp_pedantic) && (new_lineno == 0 || new_lineno > cap || wrapped))
...
do_linemarker (cpp_reader *pfile)
{
 ...
 from = 
# 1096 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
       __null
# 1096 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
           ;
...
_cpp_do_file_change (cpp_reader *pfile, enum lc_reason reason,
       ...
       unsigned int sysp)
{
  do { if (! (reason != LC_ENTER_MACRO)) fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c", 1126, __FUNCTION__); } while (0);

  const line_map_ordinary *ord_map = 
# 1128 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                                    __null
# 1128 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                                        ;
        ...
        enum cpp_warning_reason reason, int print_dir)
{
  ...
  if (print_dir)
    ...
    dir_name = 
# 1172 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
              __null
# 1172 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                  ;
  pfile->state.prevent_expansion++;
     ...
     bool allow_name_expansion)
{
      ...
      else if (entry->allow_expansion != allow_name_expansion)
 {
   ...
   return 
# 1271 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
         __null
# 1271 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
             ;
 }
      chain = &entry->u.space;
    }
   ...
   "and no namespace", name);
      return 
# 1280 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
            __null
# 1280 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                ;
    }
  ...
  entry = lookup_pragma_entry (*chain, node);
  if (entry == 
# 1286 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
              __null
# 1286 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                  )
    {
      entry = new_pragma_entry (pfile, chain);
      entry->pragma = node;
  ...
  return 
# 1304 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
        __null
# 1304 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
            ;
}
...
count_registered_pragmas (struct pragma_entry *pe)
{
  int ct = 0;
  for (; pe != 
# 1387 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
              __null
# 1387 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                  ; pe = pe->next)
    {
      if (pe->is_nspace)
...
{
  for (; pe != 
# 1402 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
              __null
# 1402 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                  ; pe = pe->next)
    {
      if (pe->is_nspace)
 sd = save_registered_pragmas (pe->u.space, sd);
      *sd++ = (char *) xmemdup (((&pe->pragma->ident)->str),
                                ((&pe->pragma->ident)->len),
...
{
  for (; pe != 
# 1432 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
              __null
# 1432 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                  ; pe = pe->next)
    {
      if (pe->is_nspace)
...
# 1459 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
static void
do_pragma (cpp_reader *pfile)
{
  const struct pragma_entry *p = 
# 1462 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                                __null
# 1462 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                                    ;
      ...
      if (p && p->is_nspace)
 {
   ...
   if (token->type == CPP_NAME)
     ...
     p = 
# 1486 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
        __null
# 1486 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
            ;
   if (allow_name_expansion)
     pfile->state.prevent_expansion++;
   count = 2;
      ...
      else
 {
   ...
   if (p->allow_expansion)
    ...
    {
      if (count == 1 || pfile->context->prev == 
# 1522 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                                               __null
# 1522 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                                                   )
      ...
      else
 {
   ...
   cpp_token *toks = ((cpp_token *) xmalloc (sizeof (cpp_token) * (2)));
   toks[0] = ns_token;
   toks[0].flags |= (1 << 10);
   toks[1] = *token;
   toks[1].flags |= (1 << 10);
   _cpp_push_token_context (pfile, 
# 1536 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                                  __null
# 1536 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                                      , toks, 2);
 }
...
do_pragma_push_macro (cpp_reader *pfile)
{
  ...
  size_t defnlen;
  const uchar *defn = 
# 1561 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                     __null
# 1561 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                         ;
  char *macroname, *dest;
  ...
  dest = macroname = (char *) __builtin_alloca(txt->val.str.len + 2);
  ...
  *dest = 0;
  check_eol (pfile, false);
  skip_rest_of_line (pfile);
  c = ((struct def_pragma_macro *) xmalloc (sizeof (struct def_pragma_macro)));
  memset (c, 0, sizeof (struct def_pragma_macro));
  c->name = ((char *) xmalloc ((strlen (macroname) + 1)));
  ...
  if (node->type == NT_VOID)
  ...
  else
    {
      ...
      c->definition = ((uchar *) xmalloc (sizeof (uchar) * (defnlen + 2)));
...
do_pragma_pop_macro (cpp_reader *pfile)
{
  ...
  const char *limit, *src;
  const cpp_token *txt;
  struct def_pragma_macro *l = 
# 1623 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                              __null
# 1623 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                                  , *c = pfile->pushed_macros;
  txt = get__Pragma_string (pfile);
  if (!txt)
    {
      location_t src_loc = pfile->cur_token[-1].src_loc;
  ...
  *dest = 0;
  ...
  while (c != 
# 1648 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
             __null
# 1648 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                 )
    {
...
# 1731 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                                                __null
# 1731 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                                                    , &location);
  if (!fname)
    return;
...
get__Pragma_string (cpp_reader *pfile)
{
  ...
  if (paren->type != CPP_OPEN_PAREN)
    return 
# 1812 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
          __null
# 1812 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
              ;
  ...
  if (string->type != CPP_STRING && string->type != CPP_WSTRING
    ...
    return 
# 1820 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
          __null
# 1820 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
              ;
  ...
  if (paren->type != CPP_CLOSE_PAREN)
    return 
# 1826 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
          __null
# 1826 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
              ;
       ...
       location_t expansion_loc)
{
  ...
  dest = result = (char *) __builtin_alloca(in->len - 1);
  ...
  *dest = '\n';
# 1866 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
  saved_context = pfile->context;
  saved_cur_token = pfile->cur_token;
  saved_cur_run = pfile->cur_run;

  pfile->context = ((cpp_context *) xcalloc (1, sizeof (cpp_context)));
...
# 1898 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
  if (pfile->directive_result.type == CPP_PRAGMA)
    {
      ...
      count = 1;
      maxcount = 50;
      toks = ((cpp_token *) xmalloc (sizeof (cpp_token) * (maxcount)));
      ...
      do
 {
   if (count == maxcount)
     {
       ...
       toks = ((cpp_token *) xrealloc ((void *) (toks), sizeof (cpp_token) * (maxcount)));
     }
   ...
   toks[count++].flags |= (1 << 10);
    ...
    {
      count = 1;
      toks = ((cpp_token *) xmalloc (sizeof (cpp_token)));
      toks[0] = pfile->directive_result;
 ...
 pfile->cb.line_change (pfile, pfile->cur_token, false);
  ...
  pfile->buffer->file = 
# 1940 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                       __null
# 1940 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                           ;
  _cpp_pop_buffer (pfile);


  free ((void*) (pfile->context));
  ...
  _cpp_push_token_context (pfile, 
# 1950 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                                 __null
# 1950 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                                     , toks, count);
}
...
do_else (cpp_reader *pfile)
{
  ...
  if (ifs == 
# 2048 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
            __null
# 2048 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                )
...
do_elif (cpp_reader *pfile)
{
  ...
  if (ifs == 
# 2081 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
            __null
# 2081 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                )
...
do_endif (cpp_reader *pfile)
{
  ...
  if (ifs == 
# 2117 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
            __null
# 2117 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                )
      ...
      if (ifs->next == 0 && ifs->mi_cmacro)
 {
   ...
   pfile->mi_cmacro = ifs->mi_cmacro;
      ...
      __extension__ ({ struct obstack *__o = (&pfile->buffer_ob); void *__obj = (void *) (ifs); if (__obj > (void *) __o->chunk && __obj < (void *) __o->chunk_limit) __o->next_free = __o->object_base = (char *) __obj; else _obstack_free (__o, __obj); });
    }
}
       ...
       cpp_macro **answer_ptr)
{
 ...
 return true;
  ...
  cpp_macro *answer = _cpp_new_macro (pfile, cmk_assert,
        ...
        sizeof (cpp_macro)));
  answer->parm.next = 
# 2201 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                     __null
# 2201 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                         ;
  unsigned count = 0;
  for (;;)
    {
...
parse_assertion (cpp_reader *pfile, int type, cpp_macro **answer_ptr)
{
  ...
  *answer_ptr = 
# 2250 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
               __null
# 2250 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                   ;
  ...
  if (predicate->type == CPP_EOF)
    ...
    {
      unsigned int len = (((&(predicate->val.node.node)->ident))->len);
      unsigned char *sym = (unsigned char *) __builtin_alloca(len + 1);


      sym[0] = '#';
      memcpy (sym + 1, (((&(predicate->val.node.node)->ident))->str), len);
...
find_answer (cpp_hashnode *node, const cpp_macro *candidate)
{
  unsigned int i;
  cpp_macro **result = 
# 2280 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                      __null
# 2280 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                          ;
...
# 2429 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
 __builtin_va_start(
# 2429 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
 ap
# 2429 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
 ,
# 2429 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
...
# 2431 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
 __builtin_va_end(
# 2431 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
 ap
# 2431 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
 )
# 2431 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
...
cpp_pop_definition (cpp_reader *pfile, struct def_pragma_macro *c)
{
  ...
  if (node == 
# 2466 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
             __null
# 2466 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                 )
    return;
 ...
 pfile->cb.undef (pfile, pfile->directive_line, node);
      if (((pfile)->opts.warn_unused_macros))
 _cpp_warn_if_unused_macro (pfile, node, 
# 2477 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                                        __null
# 2477 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                                            );
      _cpp_free_definition (node);
    }
...

  {
    ...
    const uchar *dn;
    cpp_hashnode *h = 
# 2492 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
                     __null
# 2492 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                         ;
    cpp_buffer *nbuf;
    ...
    if (nbuf != 
# 2500 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c" 3 4
               __null
# 2500 "/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c"
                   )
      {
 _cpp_clean_line (pfile);
 nbuf->sysp = 1;
 if (!_cpp_create_definition (pfile, h))
   fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c", 2505, __FUNCTION__);
 _cpp_pop_buffer (pfile);
      }
    else
      fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/libcpp/directives.c", 2509, __FUNCTION__);
...
cpp_push_buffer (cpp_reader *pfile, const uchar *buffer, size_t len,
   int from_stage3)
{
  cpp_buffer *new_buffer = ((cpp_buffer *) __extension__ ({ struct obstack *__h = ((&pfile->buffer_ob)); __extension__ ({ struct obstack *__o = (__h); size_t __len = ((sizeof (cpp_buffer))); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < __len) _obstack_newchunk (__o, __len); ((void) ((__o)->next_free += (__len))); }); __extension__ ({ struct obstack *__o1 = (__h); void *__value = (void *) __o1->object_base; if (__o1->next_free == __value) __o1->maybe_empty_object = 1; __o1->next_free = ((sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (((__o1->next_free) - (sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (__o1->alignment_mask)) & ~(__o1->alignment_mask))); if ((size_t) (__o1->next_free - (char *) __o1->chunk) > (size_t) (__o1->chunk_limit - (char *) __o1->chunk)) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; __value; }); }));
...
_cpp_pop_buffer (cpp_reader *pfile)
{
  ...
  __extension__ ({ struct obstack *__o = (&pfile->buffer_ob); void *__obj = (void *) (buffer); if (__obj > (void *) __o->chunk && __obj < (void *) __o->chunk_limit) __o->next_free = __o->object_base = (char *) __obj; else _obstack_free (__o, __obj); });
