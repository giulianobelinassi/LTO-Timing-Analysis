# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c" 2
...
extern Mem mem;
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/module.h" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/module.h" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c" 2
...
void initPrecedence();
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c" 2
...
Dsymbols Module::deferred;
Dsymbols Module::deferred2;
        ...
        : Package(ident)
{
    ...
    rootimports = 0;
    insearch = 0;
    searchCacheIdent = nullptr;
    searchCacheSymbol = nullptr;
    searchCacheFlags = 0;
    decldefs = nullptr;
    sictor = nullptr;
    sctor = nullptr;
        ...
        FileName::exists(filename) == 1)
    {
        ...
        srcfilename = FileName::removeExt(filename);
    }
...
# 147 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c"
                              ...
                              Array<const char *> *ms, size_t msdim, const char *p)
{
    ...
    for (size_t j = msdim; j--;)
    {
        ...
        ((void)(!(q) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c", 204, __FUNCTION__), 0 : 0));
...
Module *Module::load(Loc loc, Identifiers *packages, Identifier *ident)
{
    ...
    if (result)
    {
        ...
        if (path)
            ...
            m->srcfilePath = getcwd(nullptr, 0);
    }
...
bool Module::read(Loc loc)
{
    ...
    if (srcfile->read())
    {
        if (!strcmp(srcfile->toChars(), "object.d"))
        {
            ...
            const char *dmdConfFile = global.inifilename.length ? FileName::canonicalName(global.inifilename.ptr) : nullptr;
        ...
        if (!global.gag)
        {
            ...
            if (global.path)
            {
                for (size_t i = 0; i < global.path->length; i++)
                {
                    ...
                    fprintf(
# 330 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c" 3 4
                           stderr
# 330 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c"
                                 , "import path[%llu] = %s\n", (ulonglong)i, p);
                }
            }
            else
                fprintf(
# 334 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c" 3 4
                       stderr
# 334 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c"
...
Module *Module::parse()
{
    ...
    if (buflen >= 2)
    {
# 366 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c"
        unsigned le;
        unsigned bom = 1;
    ...
    {
        Parser p(this, buf, buflen, docfile != nullptr);
        p.nextToken();
    ...
    if (md)
    {
        ...
        this->ident = md->id;
        Package *ppack = nullptr;
        dst = Package::resolve(md->packages, &this->parent, &ppack);
        ((void)(!(dst) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c", 555, __FUNCTION__), 0 : 0));

        Module *m = ppack ? ppack->isModule() : nullptr;
    ...
    if (isPackageFile)
    {
# 599 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c"
    ...
    if (!dst->insert(s))
    {
        ...
        ((void)(!(prev) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c", 613, __FUNCTION__), 0 : 0));
        ...
        else if (Package *pkg = prev->isPackage())
        {
            ...
            ((void)(!(global.errors) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c", 645, __FUNCTION__), 0 : 0));
    }
    else
    {
...
void Module::importAll(Scope *)
{
    ...
    if (members->length == 0 || ((*members)[0])->ident != Id::object ||
        (*members)[0]->isImport() == nullptr)
    {
        Import *im = new Import(Loc(), nullptr, Id::object, nullptr, 0);
        members->shift(im);
    }
...
void Module::runDeferredSemantic()
{
    ...
    do
    {
        ...
        if (todoalloc)
            free(todoalloc);
    } while (deferred.length < len || dprogress);
    nested--;
...
# 1174 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c"
...
DsymbolTable *Package::resolve(Identifiers *packages, Dsymbol **pparent, Package **ppkg)
{
    ...
    if (packages)
    {
        for (size_t i = 0; i < packages->length; i++)
        {
            ...
            {
                pkg = p->isPackage();
                ((void)(!(pkg) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c", 1225, __FUNCTION__), 0 : 0));
...
Dsymbol *Package::search(const Loc &loc, Identifier *ident, int flags)
{
    ...
    if (!isModule() && mod)
    {
        ...
        Dsymbol *s = symtab ? symtab->lookup(ident) : nullptr;
        if (s)
            return s;
...
# 1285 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmodule.c"
const char *lookForSourceFile(const char **path, const char *filename)
{
