...
# 3 "cc1obj-checksum.c" 2
extern const unsigned char executable_checksum[16] = { 0xb7, 0x72, 0x9e, 0x9c, 0x4f, 0xaa, 0x79, 0xa2, 0xb1, 0x01, 0x32, 0xa2, 0x71, 0xa2, 0x7a, 0xee };
