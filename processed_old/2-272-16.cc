# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 2

# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.h" 1
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.h"
struct prefix_list
{
  const char *prefix;
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 2
...
static const char standard_exec_prefix[] = "/usr/local/lib/gcc/";



static const char standard_libexec_prefix[] = "/usr/local/libexec/gcc/";



static const char standard_bin_prefix[] = "/usr/local/bin/";




static const char *const tooldir_base_prefix = "../../../../";
...
static const char *const target_machine = "x86_64-pc-linux-gnu";



static const char *const target_version = "11.0.0";
...
static const char dir_separator[] = { '/', 0 };
...
setup_prefixes (const char *exec_path)
{
  ...
  if (!self)
    ...
    self = concat (self, "gcc-" "ar", nullptr);


  self_exec_prefix = make_relative_prefix (self,
        standard_bin_prefix,
        standard_exec_prefix);
  if (self_exec_prefix == nullptr)
  ...
  if (self_libexec_prefix == nullptr)
  ...
  prefix_from_string (concat (self_tooldir_prefix, "bin", nullptr), &target_path);
...
main (int ac, char **av)
{
  ...
  const char *err_msg;
  const char **nargv;
  bool is_ar = !strcmp ("ar", "ar");
  int exit_code = 
# 136 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
                 1
# 136 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
                                ;
  int i;
      ...
      if (!strncmp (av[i], "-B", 2))
 {
  ...
  {
    fprintf (
# 156 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
            stderr
# 156 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
                  , "Usage: gcc-ar [-B prefix] ar arguments ...\n");
    exit (
# 157 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
         1
# 157 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
                     );
  }
       memmove (av + i, av + i + 1, sizeof (char *) * ((ac + 1) - i));
       ac--;
  ...
  plugin = find_a_file (&target_path, "liblto_plugin.so", 
# 184 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
                                                      4
# 184 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
                                                          );
  if (!plugin)
    {
      fprintf (
# 187 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
              stderr
# 187 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
                    , "%s: Cannot find plugin '%s'\n", av[0], "liblto_plugin.so");
      exit (1);
    }



  exe_name = find_a_file (&target_path, "ar", 
# 193 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
                                                    1
# 193 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
                                                        );
  if (!exe_name)
    {
      const char *real_exe_name = "ar";



      exe_name = find_a_file (&path, real_exe_name, 
# 200 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
                                                   1
# 200 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
                                                       );
      if (!exe_name)
 {
   fprintf (
# 203 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
           stderr
# 203 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
  ...
  nargv = ((const char * *) xcalloc ((ac + 4), sizeof (const char *)));
  nargv[0] = exe_name;
  ...
  for (k = 1; k < ac; k++)
    nargv[2 + k] = av[k];
  nargv[2 + k] = nullptr;
# 231 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
  err_msg = pex_one (0x1|0x2,
       exe_name,
  ...
  if (err_msg)
    fprintf (
# 237 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
            stderr
# 237 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
                  , "Error running %s: %s\n", exe_name, err_msg);
  else if (status)
    {
      if (
# 240 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
         (((signed char) (((
# 240 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
         status
# 240 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
         ) & 0x7f) + 1) >> 1) > 0)
# 240 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
 ...
 {
   int sig = 
# 242 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
            ((
# 242 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
            status
# 242 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
            ) & 0x7f)
# 242 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
                             ;
   fprintf (
# 243 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
           stderr
# 243 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
                 , "%s terminated with signal %d [%s]%s\n",
     exe_name, sig, strsignal (sig),
     
# 245 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
    ((
# 245 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
    status
# 245 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
    ) & 0x80) 
# 245 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
...
# 247 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
              (((
# 247 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
              status
# 247 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
              ) & 0x7f) == 0)
# 247 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
 ...
 exit_code = 
# 248 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
            (((
# 248 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
            status
# 248 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
            ) & 0xff00) >> 8)
# 248 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
    ...
    exit_code = 
# 251 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c" 3 4
               0
# 251 "/home/giulianob/gcc_git_gnu/gcc/gcc/gcc-ar.c"
                                ;
