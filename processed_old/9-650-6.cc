# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c"
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c"
# 1 "./bconfig.h" 1
...
# 6 "./bconfig.h" 2
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c" 2
# 1 "./tm.h" 1
# 22 "./tm.h"
# 1 "./options.h" 1
...
# 49 "./tm.h" 2
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c" 2
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/gensupport.h" 1
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/gensupport.h"
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/gensupport.h" 2
...
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c" 2
...
walk_insn_part (rtx part, int recog_p, int non_pc_set_src)
{
  ...
  switch (code)
    ...
    case MATCH_OPERAND:
      if ((((part)->u.fld[0]).rt_int) > max_recog_operands)
 max_recog_operands = (((part)->u.fld[0]).rt_int);
      return;
 ...
 max_recog_operands = (((part)->u.fld[0]).rt_int);
    ...
    case LABEL_REF:
      if (((enum rtx_code) ((((part)->u.fld[0]).rt_rtx))->code) == MATCH_OPERAND
   || ((enum rtx_code) ((((part)->u.fld[0]).rt_rtx))->code) == MATCH_DUP)
 break;
      return;
 ...
 have_rotatert_flag = 1;
    ...
    case SET:
      walk_insn_part ((((part)->u.fld[0]).rt_rtx), 0, recog_p);
      walk_insn_part ((((part)->u.fld[1]).rt_rtx), recog_p,
        ((enum rtx_code) ((((part)->u.fld[0]).rt_rtx))->code) != PC);
      return;
   ...
   && ((enum rtx_code) ((((part)->u.fld[1]).rt_rtx))->code) == MATCH_OPERAND
   && ((enum rtx_code) ((((part)->u.fld[2]).rt_rtx))->code) == MATCH_OPERAND)
 have_cmove_flag = 1;
      break;
 ...
 have_cond_exec_flag = 1;
  ...
  for (i = 0; i < (rtx_length[(int) (((enum rtx_code) (part)->code))]); i++)
    switch (*format_ptr++)
      ...
      case 'e':
      case 'u':
 walk_insn_part ((((part)->u.fld[i]).rt_rtx), recog_p, non_pc_set_src);
 break;
      case 'E':
 if ((((part)->u.fld[i]).rt_rtvec) != nullptr)
   for (j = 0; j < (((((part)->u.fld[i]).rt_rtvec))->num_elem); j++)
     walk_insn_part ((((((part)->u.fld[i]).rt_rtvec))->elem[j]), recog_p, non_pc_set_src);
 break;
      }
}
...
gen_insn (md_rtx_info *info)
{
  ...
  if ((((insn)->u.fld[1]).rt_rtvec) != 0)
    for (i = 0; i < (((((insn)->u.fld[1]).rt_rtvec))->num_elem); i++)
      walk_insn_part ((((((insn)->u.fld[1]).rt_rtvec))->elem[i]), 1, 0);
...
gen_expand (md_rtx_info *info)
{
 ...
 walk_insn_part ((((((insn)->u.fld[1]).rt_rtvec))->elem[i]), 0, 0);
...
gen_split (md_rtx_info *info)
{
  ...
  rtx split = info->def;
  for (i = 0; i < (((((split)->u.fld[0]).rt_rtvec))->num_elem); i++)
    walk_insn_part ((((((split)->u.fld[0]).rt_rtvec))->elem[i]), 1, 0);

  if ((((((split)->u.fld[2]).rt_rtvec))->num_elem) > max_insns_per_split)
    max_insns_per_split = (((((split)->u.fld[2]).rt_rtvec))->num_elem);
}
...
gen_peephole (md_rtx_info *info)
{
  ...
  rtx peep = info->def;
  for (i = 0; i < (((((peep)->u.fld[0]).rt_rtvec))->num_elem); i++)
    walk_insn_part ((((((peep)->u.fld[0]).rt_rtvec))->elem[i]), 1, 0);
}
...
gen_peephole2 (md_rtx_info *info)
{
  ...
  rtx peep = info->def;
  for (i = (((((peep)->u.fld[0]).rt_rtvec))->num_elem) - 1; i >= 0; --i)
    walk_insn_part ((((((peep)->u.fld[0]).rt_rtvec))->elem[i]), 1, 0);


  for (i = (((((peep)->u.fld[0]).rt_rtvec))->num_elem) - 1, n = 0; i >= 0; --i)
    if (((enum rtx_code) ((((((peep)->u.fld[0]).rt_rtvec))->elem[i]))->code) != MATCH_DUP
 && ((enum rtx_code) ((((((peep)->u.fld[0]).rt_rtvec))->elem[i]))->code) != MATCH_SCRATCH)
      n++;
...
main (int argc, const char **argv)
{
  ...
  if (!init_rtx_reader_args (argc, argv))
    return (
# 278 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c" 3 4
           1
# 278 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c"
                          );
 ...
 break;
  ...
  if (ferror_unlocked (
# 384 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c" 3 4
     stdout
# 384 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c"
     ) || fflush_unlocked (
# 384 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c" 3 4
                        stdout
# 384 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c"
...
# 384 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c"
    ...
    return 
# 385 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c" 3 4
          1
# 385 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c"
                         ;

  return 
# 387 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c" 3 4
        0
# 387 "/home/giulianob/gcc_git_gnu/gcc/gcc/genconfig.c"
                         ;
}
