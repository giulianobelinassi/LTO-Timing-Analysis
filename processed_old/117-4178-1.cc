# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/enum.h" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c" 2
# 1 "d/id.h" 1
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c" 2
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c" 2
...
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c" 2
...
# 300 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c"
...
void ClassDeclaration::semantic(Scope *sc)
{
    ...
    if (!parent)
    {
        ((void)(!(sc->parent) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c", 355, __FUNCTION__), 0 : 0));
        parent = sc->parent;
    }
    ...
    if (baseok < BASEOKdone)
    {
        ...
        if (baseclasses->length)
        {
            ...
            if (tc->sym->baseok < BASEOKdone)
                resolveBase(this, sc, scx, tc->sym);
            if (tc->sym->baseok < BASEOKdone)
            {
        ...
        if (!baseClass && ident != Id::Object && !isCPPclass())
        {
            ...
            if (t->ty == Terror)
                badObjectDotD(this);
            ((void)(!(t->ty == Tclass) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c", 565, __FUNCTION__), 0 : 0));
            ...
            baseClass = tc->sym;
            ((void)(!(!baseClass->isInterfaceDeclaration()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c", 572, __FUNCTION__), 0 : 0));
            b->sym = baseClass;
        }
        if (baseClass)
        {
            if (baseClass->storage_class & 8LL)
            ...
            storage_class |= baseClass->storage_class & (4LL | 0x100000LL | 0x20000000LL | 0x80000000LL);
        }
...
Lancestorsdone:
    ...
    for (size_t i = 0; i < baseclasses->length; i++)
    {
        BaseClass *b = (*baseclasses)[i];
        Type *tb = b->type->toBasetype();
        ((void)(!(tb->ty == Tclass) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c", 653, __FUNCTION__), 0 : 0));
    ...
    if (baseok == BASEOKdone)
    {
        ...
        if (vthis)
        {
            ...
            if (storage_class & 1LL)
                error("static class cannot inherit from nested class %s", baseClass->toChars());
            if (toParent2() != baseClass->toParent2() &&
                (!toParent2() ||
                 !baseClass->toParent2()->getType() ||
                 !baseClass->toParent2()->getType()->isBaseOf(toParent2()->getType(), nullptr)))
            {
                if (toParent2())
                {
    ...
    if (!determineFields())
    {
        ((void)(!(type == Type::terror) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c", 745, __FUNCTION__), 0 : 0));
        sc2->pop();
        return;
    }
    ...
    if (!ctor && noDefaultCtor)
    {
        ...
        {
            VarDeclaration *v = fields[i];
            if (v->storage_class & 0x8000000000LL)
    ...
    {
        FuncDeclaration *fd = resolveFuncCall(loc, sc2, baseClass->ctor, nullptr, type, nullptr, 1);
        if (!fd)
            fd = resolveFuncCall(loc, sc2, baseClass->ctor, nullptr, type->sharedOf(), nullptr, 1);
        if (fd && !fd->errors)
        {
    ...
    {
        if (!(f->storage_class & 0x2000000000LL))
...
# 1011 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c"
...
# 1038 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c"
static unsigned membersPlace(BaseClasses *vtblInterfaces, size_t &bi, ClassDeclaration *cd, unsigned baseOffset)
{
    ...
    for (size_t i = 0; i < cd->interfaces.length; i++)
    {
        ...
        if (b->sym->sizeok != SIZEOKdone)
            b->sym->finalizeSize();
        ((void)(!(b->sym->sizeok == SIZEOKdone) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c", 1048, __FUNCTION__), 0 : 0));

        if (!b->sym->alignsize)
            b->sym->alignsize = target.ptrsize;
        cd->alignmember(b->sym->alignsize, b->sym->alignsize, &offset);
        ((void)(!(bi < vtblInterfaces->length) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c", 1053, __FUNCTION__), 0 : 0));
...
{
    ((void)(!(sizeok != SIZEOKdone) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c", 1079, __FUNCTION__), 0 : 0));


    if (baseClass)
    {
        ((void)(!(baseClass->sizeok == SIZEOKdone) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c", 1084, __FUNCTION__), 0 : 0));
...
# 1385 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c"
...
void InterfaceDeclaration::semantic(Scope *sc)
{
    ...
    if (!parent)
    {
        ((void)(!(sc->parent && sc->func) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c", 1457, __FUNCTION__), 0 : 0));
        parent = sc->parent;
    }
    ((void)(!(parent && !isAnonymous()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c", 1460, __FUNCTION__), 0 : 0));
...
Lancestorsdone:
    ...
    for (size_t i = 0; i < baseclasses->length; i++)
    {
        BaseClass *b = (*baseclasses)[i];
        Type *tb = b->type->toBasetype();
        ((void)(!(tb->ty == Tclass) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c", 1633, __FUNCTION__), 0 : 0));
        TypeClass *tc = (TypeClass *)tb;
    ...
    ((void)(!(type->ty != Tclass || ((TypeClass *)type)->sym == this) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c", 1732, __FUNCTION__), 0 : 0));
}
# 1746 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c"
bool InterfaceDeclaration::isBaseOf(ClassDeclaration *cd, int *poffset)
{

    ((void)(!(!baseClass) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c", 1749, __FUNCTION__), 0 : 0));
    for (size_t j = 0; j < cd->interfaces.length; j++)
    {
        ...
        if (this == b->sym)
        {
            ...
            if (poffset)
            {
                ...
                *poffset = cd->sizeok == SIZEOKdone ? b->offset : 0x76543211;
            }
...
# 1812 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c"
...
# 1872 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c"
bool BaseClass::fillVtbl(ClassDeclaration *cd, FuncDeclarations *vtbl, int newinstance)
{
    ...
    for (size_t j = sym->vtblOffset(); j < sym->vtbl.length; j++)
    {
        ...
        ((void)(!(ifd) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c", 1889, __FUNCTION__), 0 : 0));
...
void BaseClass::copyBaseInterfaces(BaseClasses *vtblInterfaces)
{
    ...
    for (size_t i = 0; i < baseInterfaces.length; i++)
    {
        ...
        ((void)(!(b2->vtbl.length == 0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dclass.c", 1940, __FUNCTION__), 0 : 0));
