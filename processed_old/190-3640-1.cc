# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c" 2
...
extern Mem mem;
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c" 2
# 1 "d/id.h" 1
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c" 2
...
void initPrecedence();
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c" 2
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c" 2
...
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c" 2
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 352, __FUNCTION__), 0 : 0));
...
bool StorageClassDeclaration::oneMember(Dsymbol **ps, Identifier *ident)
{
    ...
    if (t && *ps)
    {
# 370 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c"
...
void StorageClassDeclaration::addMember(Scope *sc, ScopeDsymbol *sds)
{
    ...
    if (d)
    {
        ...
        for (size_t i = 0; i < d->length; i++)
        {
            ...
            {
                decl->storage_class |= stc & 0x8000000000000LL;
                if (StorageClassDeclaration *sdecl = s->isStorageClassDeclaration())
                {
                    sdecl->stc |= stc & 0x8000000000000LL;
                }
            }
            s->addMember(sc2, sds);
        }
...
Scope *StorageClassDeclaration::newScope(Scope *sc)
{
    ...
    if (stc & (0x100LL | 0x80000LL | 1LL | 2LL | 0x800000LL))
        scstc &= ~(0x100LL | 0x80000LL | 1LL | 2LL | 0x800000LL);
    if (stc & (0x100LL | 0x80000LL | 1LL | 0x8000000LL | 0x800000LL | 0x40000000LL))
        scstc &= ~(0x100LL | 0x80000LL | 1LL | 0x8000000LL | 0x800000LL | 0x40000000LL);
    if (stc & (4LL | 0x100000LL | 0x800000LL))
        scstc &= ~(4LL | 0x100000LL | 0x800000LL);
    if (stc & (0x40000000LL | 0x20000000LL | 0x8000000LL))
        scstc &= ~(0x40000000LL | 0x20000000LL | 0x8000000LL);
    if (stc & (0x200000000LL | 0x400000000LL | 0x800000000LL))
        scstc &= ~(0x200000000LL | 0x400000000LL | 0x800000000LL);
    scstc |= stc;
...
DeprecatedDeclaration::DeprecatedDeclaration(Expression *msg, Dsymbols *decl)
        : StorageClassDeclaration(0x400LL, decl)
{
    this->msg = msg;
    this->msgstr = nullptr;
}
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 446, __FUNCTION__), 0 : 0));
    return new DeprecatedDeclaration(msg->syntaxCopy(), Dsymbol::arraySyntaxCopy(decl));
}
# 459 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c"
...
# 487 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c"
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 529, __FUNCTION__), 0 : 0));
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 556, __FUNCTION__), 0 : 0));
...
# 580 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c"
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 606, __FUNCTION__), 0 : 0));
...
{
    ((void)(!(protection.kind > Prot::undefined) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 651, __FUNCTION__), 0 : 0));
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 672, __FUNCTION__), 0 : 0));
...
structalign_t AlignDeclaration::getAlignment(Scope *sc)
{
    ...
    if (n < 1 || n & (n - 1) || ((structalign_t) ~0) < n || !tb->isintegral())
    {
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 735, __FUNCTION__), 0 : 0));
...
void AnonDeclaration::semantic(Scope *sc)
{
    ...
    ((void)(!(sc->parent) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 751, __FUNCTION__), 0 : 0));
    ...
    {
        sc = sc->push();
        sc->stc &= ~(0x100LL | 0x80000LL | 1LL | 0x8000000LL | 0x40000000LL);
        sc->inunion = isunion;
        sc->flags = 0;
...
void AnonDeclaration::setFieldOffset(AggregateDeclaration *ad, unsigned *poffset, bool isunion)
{
    ...
    if (decl)
    {
        ...
        ((void)(!(_scope) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 834, __FUNCTION__), 0 : 0));
...
Dsymbol *PragmaDeclaration::syntaxCopy(Dsymbol *s)
{
    ...
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 875, __FUNCTION__), 0 : 0));
        ...
        if (args)
        {
            for (size_t i = 0; i < args->length; i++)
            {
                ...
                if (se)
                {
                    se = se->toUTF8(sc);
                    fprintf(
# 972 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c" 3 4
                           stderr
# 972 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c"
                                 , "%.*s", (int)se->len, (char *)se->string);
                }
                else
                    fprintf(
# 975 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c" 3 4
                           stderr
# 975 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c"
                                 , "%s", e->toChars());
            }
            fprintf(
# 977 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c" 3 4
                   stderr
# 977 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c"
                         , "\n");
        }
        goto Lnodecl;
    }
...
Ldecl:
    if (decl)
    {
        ...
        for (size_t i = 0; i < decl->length; i++)
        {
            ...
            if (ident == Id::mangle)
            {
                ((void)(!(args && args->length == 1) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 1155, __FUNCTION__), 0 : 0));
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 1199, __FUNCTION__), 0 : 0));
...
Dsymbols *ConditionalDeclaration::include(Scope *sc)
{
    ...
    ((void)(!(condition) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 1231, __FUNCTION__), 0 : 0));
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 1292, __FUNCTION__), 0 : 0));
...
Dsymbols *StaticIfDeclaration::include(Scope *sc)
{
    ...
    if (condition->inc == 0)
    {
        ((void)(!(scopesym) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 1313, __FUNCTION__), 0 : 0));
        ((void)(!(_scope) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 1314, __FUNCTION__), 0 : 0));
...
{
# 1361 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c"
    this->scopesym = sds;
}
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 1405, __FUNCTION__), 0 : 0));
...
Dsymbols *StaticForeachDeclaration::include(Scope *)
{
    ...
    if (cached)
    {
        ((void)(!(!onStack) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 1432, __FUNCTION__), 0 : 0));
        return cache;
    }
    onStack = true;
    ...
    if (_scope)
    {
        staticForeachPrepare(sfe, _scope);
    }
...
# 1530 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c"
...
void CompileDeclaration::compileIt(Scope *sc)
{
    ...
    if (p.errors)
    {
        ((void)(!(global.errors != errors) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 1602, __FUNCTION__), 0 : 0));
        decl = nullptr;
    }
}
...
Dsymbol *UserAttributeDeclaration::syntaxCopy(Dsymbol *s)
{
    ...
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.c", 1646, __FUNCTION__), 0 : 0));
