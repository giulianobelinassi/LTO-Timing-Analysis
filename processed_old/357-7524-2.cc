# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c" 2
...
extern Mem mem;
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c" 2
# 1 "d/id.h" 1
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c" 2
...
# 42 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c"
...
static Identifier *opId(Expression *e)
{
    ...
    public:
        Identifier *id;
        void visit(Expression *) { ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c", 79, __FUNCTION__), 0 : 0)); }
...
# 211 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c"
Expression *op_overload(Expression *e, Scope *sc)
{
    ...
    public:
        ...
        {
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c", 227, __FUNCTION__), 0 : 0));
        }
        ...
        void visit(UnaExp *e)
        {
            ...
            if (e->e1->op == TOKarray)
            {
                ...
                {
                    ((void)(!((*ae->arguments)[0]->op == TOKinterval) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c", 247, __FUNCTION__), 0 : 0));
            ...
            if (ad)
            {
                ...
                if (e->op != TOKpreplusplus && e->op != TOKpreminusminus)
                {
                    ...
                    if (fd)
                    {
                        ...
                        result = build_overload(e->loc, sc, e->e1, nullptr, fd);
                        return;
                    }
                }
        ...
        void visit(ArrayExp *ae)
        {
            ...
            if (maybeSlice && ae->arguments->length)
            {
                ((void)(!((*ae->arguments)[0]->op == TOKinterval) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c", 405, __FUNCTION__), 0 : 0));
                ie = (IntervalExp *)(*ae->arguments)[0];
            }
        ...
        void visit(EqualExp *e)
        {
            ...
            {
# 1016 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c"
...
# 1049 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c"
                if (e->att1 && t1 == e->att1)
                    return;
                if (e->att2 && t2 == e->att2)
                    return;
            ...
            if (e->e1->op == TOKtuple && e->e2->op == TOKtuple)
            {
                ...
                else
                {
                    ...
                    ((void)(!(result) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c", 1113, __FUNCTION__), 0 : 0));
                }
        ...
        void visit(BinAssignExp *e)
        {
            ...
            if (e->e1->op == TOKarray)
            {
                ...
                if (maybeSlice && ae->arguments->length)
                {
                    ((void)(!((*ae->arguments)[0]->op == TOKinterval) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c", 1148, __FUNCTION__), 0 : 0));
                    ie = (IntervalExp *)(*ae->arguments)[0];
                }
...
Expression *compare_overload(BinExp *e, Scope *sc, Identifier *id)
{
    ...
    if (s || s_r)
    {
        ...
        if (m.count > 1)
        {
# 1473 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c"
...
Expression *build_overload(Loc loc, Scope *sc, Expression *ethis, Expression *earg,
        Dsymbol *d)
{
    ((void)(!(d) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c", 1560, __FUNCTION__), 0 : 0));
    Expression *e;
...
bool inferApplyArgTypes(ForeachStatement *fes, Scope *sc, Dsymbol *&sapply)
{
    ...
    if (sapply)
    {
        ...
        { ((void)(!(tab->ty == Tdelegate && fes->aggr->op == TOKdelegate) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c", 1727, __FUNCTION__), 0 : 0));
    ...
    ((void)(!(taggr) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c", 1756, __FUNCTION__), 0 : 0));
...
# 1922 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c"
...
{ size_t nparams;
    ...
    ((void)(!(tf->ty == Tfunction) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/opover.c", 1932, __FUNCTION__), 0 : 0));
