# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 2
...
# 33 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 2
...
# 34 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 2
...
# 35 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 2
...
# 36 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 2
...
# 37 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 2
...
type_lineloc (const_type_p ty)
{
  ...
  switch (ty->kind)
    {
    case TYPE_NONE:
      (fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c", 49, __FUNCTION__));
    case TYPE_STRUCT:
    case TYPE_UNION:
    ...
    case TYPE_ARRAY:
      return nullptr;
    default:
      (fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c", 62, __FUNCTION__));
    }
}
...
# 100 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
...
# 129 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
struct state_token_st *state_token = (struct state_token_st*)0;


static FILE *state_file;
static const char *state_path = nullptr;
...
# 230 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
void
...
# 281 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
static void
...
# 311 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
static struct state_ident_st *
state_ident_by_name (const char *name, enum insert_option optins)
{
  void * *slot = nullptr;
  int namlen = 0;
  struct state_ident_st *stid = nullptr;
...
read_a_state_token (void)
{
  int c = 0;
  long curoff = 0;
  struct state_token_st *tk = nullptr;

 again:
  c = getc_unlocked (state_file);
  if (c == 
# 350 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
          (-1)
# 350 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
             )
    return nullptr;
      ...
      if (c == '\n')
 {
  ...
  if ((_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isdigit)) || c == '-' || c == '+')
    {
      int n = 0;
      ungetc (c, state_file);
      curoff = ftell (state_file);
      if (fscanf (state_file, "%d", &n) <= 0)
 fatal_reading_state ((struct state_token_st*)0, "Lexical error in number");
      tk = ((struct state_token_st *) xcalloc (1, sizeof (struct state_token_st)));
      tk->stok_kind = STOK_INTEGER;
      tk->stok_line = state_line;
      tk->stok_col = curoff - state_bol;
      tk->stok_file = state_path;
      tk->stok_next = nullptr;
  ...
  else if ((_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isalpha)) || c == '_' || c == '$' || c == '!' || c == '#')
    {
      struct obstack id_obstack;
      struct state_ident_st *sid = nullptr;
      char *ids = nullptr;
      _obstack_begin ((&id_obstack), 0, 0, (xmalloc), (free));
      curoff = ftell (state_file);
      while ((_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isalnum)) || c == '_' || c == '$' || c == '!' || c == '#')
 {
   __extension__ ({ struct obstack *__o = (&id_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < 1) _obstack_newchunk (__o, 1); ((void) (*((__o)->next_free)++ = (c))); });
   c = getc_unlocked (state_file);
   if (c < 0)
     break;
 };
 ...
 ungetc (c, state_file);
  ...
  else if (c == '"')
    {
      ...
      _obstack_begin ((&bstring_obstack), 0, 0, (xmalloc), (free));
      curoff = ftell (state_file);
      while ((c = getc_unlocked (state_file)) != '"' && c >= 0)
 {
   if ((_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isprint)) && c != '\\')
     __extension__ ({ struct obstack *__o = (&bstring_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < 1) _obstack_newchunk (__o, 1); ((void) (*((__o)->next_free)++ = ((char) c))); });
   else if ((_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isspace)) && c != '\n')
     __extension__ ({ struct obstack *__o = (&bstring_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < 1) _obstack_newchunk (__o, 1); ((void) (*((__o)->next_free)++ = ((char) c))); });
   else if (c == '\\')
     {
       c = getc_unlocked (state_file);
  ...
  {
  case 'a':
    __extension__ ({ struct obstack *__o = (&bstring_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < 1) _obstack_newchunk (__o, 1); ((void) (*((__o)->next_free)++ = ('\a'))); });
    c = getc_unlocked (state_file);
    break;
  case 'b':
    __extension__ ({ struct obstack *__o = (&bstring_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < 1) _obstack_newchunk (__o, 1); ((void) (*((__o)->next_free)++ = ('\b'))); });
    c = getc_unlocked (state_file);
    break;
  case 't':
  ...
  case 'n':
    ...
    break;
  case 'v':
    __extension__ ({ struct obstack *__o = (&bstring_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < 1) _obstack_newchunk (__o, 1); ((void) (*((__o)->next_free)++ = ('\v'))); });
    c = getc_unlocked (state_file);
    break;
  case 'f':
    __extension__ ({ struct obstack *__o = (&bstring_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < 1) _obstack_newchunk (__o, 1); ((void) (*((__o)->next_free)++ = ('\f'))); });
    c = getc_unlocked (state_file);
    break;
  case 'r':
    __extension__ ({ struct obstack *__o = (&bstring_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < 1) _obstack_newchunk (__o, 1); ((void) (*((__o)->next_free)++ = ('\r'))); });
    c = getc_unlocked (state_file);
    break;
  case '"':
    __extension__ ({ struct obstack *__o = (&bstring_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < 1) _obstack_newchunk (__o, 1); ((void) (*((__o)->next_free)++ = ('\"'))); });
  ...
  case 'x':
    {
      ...
      if (fscanf (state_file, "%02x", &cx) > 0 && cx > 0)
        __extension__ ({ struct obstack *__o = (&bstring_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < 1) _obstack_newchunk (__o, 1); ((void) (*((__o)->next_free)++ = (cx))); });
      else
        fatal_reading_state
   ((struct state_token_st*)0,
  ...
  default:
    fatal_reading_state
     ...
     fatal_reading_state ((struct state_token_st*)0, "Lexical error...");
 };
      if (c != '"')
 fatal_reading_state ((struct state_token_st*)0, "Unterminated string");
      __extension__ ({ struct obstack *__o = (&bstring_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < 1) _obstack_newchunk (__o, 1); ((void) (*((__o)->next_free)++ = ('\0'))); });
      cstr = ((char *) __extension__ ({ struct obstack *__o1 = ((&bstring_obstack)); void *__value = (void *) __o1->object_base; if (__o1->next_free == __value) __o1->maybe_empty_object = 1; __o1->next_free = ((sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (((__o1->next_free) - (sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (__o1->alignment_mask)) & ~(__o1->alignment_mask))); if ((size_t) (__o1->next_free - (char *) __o1->chunk) > (size_t) (__o1->chunk_limit - (char *) __o1->chunk)) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; __value; }));
      cslen = strlen (cstr);
 ...
 xcalloc (sizeof (struct state_token_st) + cslen, 1);
      ...
      __extension__ ({ struct obstack *__o = (&bstring_obstack); void *__obj = (void *) (nullptr); if (__obj > (void *) __o->chunk && __obj < (void *) __o->chunk_limit) __o->next_free = __o->object_base = (char *) __obj; else _obstack_free (__o, __obj); });
...
peek_state_token (int depth)
{
  ...
  struct state_token_st *tok = nullptr;
...
next_state_tokens (int depth)
{
 ...
 fatal_reading_state ((struct state_token_st*)0, "Tokens stack empty");
...
# 645 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
...
state_writer::write_state_fileloc (struct fileloc *floc)
{
  ...
  if (floc != nullptr && floc->line > 0)
    {
      const char *srcrelpath = nullptr;
      ((void)(!(floc->file != nullptr) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c", 674, __FUNCTION__), 0 : 0));


      srcrelpath = get_file_srcdir_relative_path (floc->file);
      if (srcrelpath != nullptr)
 {
...
state_writer::write_state_fields (pair_p fields)
{
  ...
  ((void)(!(nbpairs == nbfields) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c", 704, __FUNCTION__), 0 : 0));
  end_s_expr ();
}
...
state_writer::write_state_a_string (const char *s)
{
 ...
 {
 case '\a':
   fputs_unlocked ("\\a", state_file);
   break;
 case '\b':
   fputs_unlocked ("\\b", state_file);
   break;
 case '\t':
   fputs_unlocked ("\\t", state_file);
   break;
 case '\n':
   ...
   break;
 case '\v':
   fputs_unlocked ("\\v", state_file);
   break;
 case '\f':
   fputs_unlocked ("\\f", state_file);
   break;
 case '\r':
   fputs_unlocked ("\\r", state_file);
   break;
 case '\"':
   fputs_unlocked ("\\\"", state_file);
   break;
...
state_writer::write_state_string_option (options_p current)
{
  ...
  if (current->info.string != nullptr)
...
state_writer::write_state_nested_option (options_p current)
{
  ...
  if (current->info.nested->convert_from != nullptr)
  ...
  if (current->info.nested->convert_to != nullptr)
...
state_writer::write_state_options (options_p opt)
{
 ...
 fprintf (state_file, "nil ");
  ...
  for (current = opt; current != nullptr; current = current->next)
...
# 905 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
 stderr
# 905 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
 , "%s:%d: " "undefined type @ %p #%d '%s'" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),905, (void *) current, current->state_number, current->u.s.tag);} while (0)
                                              ;
  write_any_indent (0);
  fprintf (state_file, "undefined ");
  ((void)(!(current->gc_used == GC_UNUSED) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c", 909, __FUNCTION__), 0 : 0));
  write_state_common_type_content (current);
  if (current->u.s.tag != nullptr)
...
{
  do {if (do_debug) fprintf (
# 928 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
 stderr
# 928 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
 , "%s:%d: " "%s type @ %p #%d '%s'" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),928, kindstr, (void *) current, current->state_number, current->u.s.tag);} while (0)
                                              ;
  write_any_indent (0);
...
{
  do {if (do_debug) fprintf (
# 961 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
 stderr
# 961 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
 , "%s:%d: " "user_struct type @ %p #%d '%s'" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),961, (void *) current, current->state_number, current->u.s.tag);} while (0)
                                              ;
  write_any_indent (0);
...
state_writer::write_state_lang_struct_type (type_p current)
{
  ...
  do {if (do_debug) fprintf (
# 1000 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
 stderr
# 1000 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
 , "%s:%d: " "lang_struct @ %p #%d" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),1000, (void *) current, current->state_number);} while (0);
  for (hty = current->u.s.lang_struct; hty != nullptr; hty = hty->next)
    {
      nbhomontype++;
      do {if (do_debug) fprintf (
# 1004 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
     stderr
# 1004 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
     , "%s:%d: " "homonymous #%d hty @ %p #%d '%s'" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),1004, nbhomontype, (void *) hty, hty->state_number, hty->u.s.tag);} while (0)
                                                 ;

      ((void)(!(union_or_struct_p (hty)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c", 1007, __FUNCTION__), 0 : 0));
      ((void)(!(hty->u.s.lang_struct == current) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c", 1008, __FUNCTION__), 0 : 0));
      if (!homoname)
 homoname = hty->u.s.tag;
      ((void)(!(strcmp (homoname, hty->u.s.tag) == 0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c", 1011, __FUNCTION__), 0 : 0));
    }
...
state_writer::write_state_gc_used (enum gc_used_enum gus)
{
  ...
  switch (gus)
    ...
    case GC_POINTED_TO:
      ...
      break;
    default:
      (fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c", 1070, __FUNCTION__));
    }
}
...
state_writer::write_state_type (type_p current)
{
  ...
  if (current->state_number > 0)
  ...
  else
    {
      ...
      do {if (do_debug) fprintf (
# 1112 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
     stderr
# 1112 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
     , "%s:%d: " "writing type #%d @%p old number %d" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),1112, m_state_written_type_count, (void *) current, current->state_number);} while (0)
                                           ;
      current->state_number = m_state_written_type_count;
      switch (current->kind)
 {
 case TYPE_NONE:
   (fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c", 1118, __FUNCTION__));
 case TYPE_UNDEFINED:
...
state_writer::write_state_typedefs (void)
{
  ...
  ((void)(!(nbpairs == nbtypedefs) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c", 1209, __FUNCTION__), 0 : 0));
  end_s_expr ();
...
state_writer::write_state_structures (void)
{
  ...
  for (current = structures; current != nullptr; current = current->next)
    nbstruct++;
...
state_writer::write_state_variables (void)
{
  ...
  ((void)(!(nbpairs == nbvars) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c", 1249, __FUNCTION__), 0 : 0));
  end_s_expr ();
  if (verbosity_level >= 2)
...
state_writer::write_state_files_list (void)
{
  ...
  for (i = 0; i < (int) num_gt_files; i++)
    {
      const char *cursrcrelpath = nullptr;
...
write_state_trailer (void)
{
  ...
  if (fputs_unlocked ("\n(!endfile)\n", state_file) == 
# 1321 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
                                             (-1)
# 1321 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
                                                )
    fatal ("failed to write state trailer [%s]", xstrerror (
# 1322 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
                                                           (*__errno_location ())
# 1322 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
                                                                ));
}
...
write_state (const char *state_path)
{
  ...
  state_file = fopen_unlocked (temp_state_path, "w");
  if (state_file == nullptr)
    fatal ("Failed to open file %s for writing state: %s",
    temp_state_path, xstrerror (
# 1349 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
                               (*__errno_location ())
# 1349 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
                                    ));
  ...
  if (ferror_unlocked (state_file))
    fatal ("output error when writing state file %s [%s]",
    temp_state_path, xstrerror (
# 1381 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
                               (*__errno_location ())
# 1381 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
                                    ));
  if (fclose (state_file))
    fatal ("failed to close state file %s [%s]",
    temp_state_path, xstrerror (
# 1384 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
                               (*__errno_location ())
# 1384 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
                                    ));
  if (rename (temp_state_path, state_path))
    fatal ("failed to rename %s to state file %s [%s]", temp_state_path,
    state_path, xstrerror (
# 1387 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
                          (*__errno_location ())
# 1387 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
                               ));
...
record_type (type_p type)
{
  ...
  ((void)(!(slot) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c", 1422, __FUNCTION__), 0 : 0));
...
read_state_undefined_type (type_p type)
{
 ...
 {
   type->u.s.tag = nullptr;
   do {if (do_debug) fprintf (
# 1514 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
  stderr
# 1514 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
  , "%s:%d: " "read anonymous undefined type @%p #%d" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),1514, (void *) type, type->state_number);} while (0)
                                         ;
 }
      else
 {
   ...
   do {if (do_debug) fprintf (
# 1520 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
  stderr
# 1520 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
  , "%s:%d: " "read undefined type @%p #%d '%s'" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),1520, (void *) type, type->state_number, type->u.s.tag);} while (0)
                                                        ;
 }
...
read_state_struct_type (type_p type)
{
      ...
      if (state_token_is_name (t0, "nil"))
 {
   type->u.s.tag = nullptr;
   do {if (do_debug) fprintf (
# 1548 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
  stderr
# 1548 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
  , "%s:%d: " "read anonymous struct type @%p #%d" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),1548, (void *) type, type->state_number);} while (0)
                                         ;
 }
      else
 {
   type->u.s.tag = xstrdup (t0->stok_un.stok_string);
   do {if (do_debug) fprintf (
# 1554 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
  stderr
# 1554 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
  , "%s:%d: " "read struct type @%p #%d '%s'" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),1554, (void *) type, type->state_number, type->u.s.tag);} while (0)
                                                        ;
 }
...
read_state_user_struct_type (type_p type)
{
      ...
      if (state_token_is_name (t0, "nil"))
 {
   type->u.s.tag = nullptr;
   do {if (do_debug) fprintf (
# 1590 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
  stderr
# 1590 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
  , "%s:%d: " "read anonymous struct type @%p #%d" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),1590, (void *) type, type->state_number);} while (0)
                                         ;
 }
      else
 {
   type->u.s.tag = xstrdup (t0->stok_un.stok_string);
   do {if (do_debug) fprintf (
# 1596 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
  stderr
# 1596 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
  , "%s:%d: " "read struct type @%p #%d '%s'" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),1596, (void *) type, type->state_number, type->u.s.tag);} while (0)
                                                        ;
 }
...
read_state_union_type (type_p type)
{
      ...
      if (state_token_is_name (t0, "nil"))
 {
   type->u.s.tag = nullptr;
   do {if (do_debug) fprintf (
# 1625 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
  stderr
# 1625 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
  , "%s:%d: " "read anonymous union type @%p #%d" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),1625, (void *) type, type->state_number);} while (0)
                                         ;
 }
      else
 {
   type->u.s.tag = xstrdup (t0->stok_un.stok_string);
   do {if (do_debug) fprintf (
# 1631 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
  stderr
# 1631 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
  , "%s:%d: " "read union type @%p #%d '%s'" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),1631, (void *) type, type->state_number, type->u.s.tag);} while (0)
                                                        ;
 }
      next_state_tokens (1);
      read_state_fileloc (&(type->u.s.line));
...
read_state_pointer_type (type_p type)
{
  ...
  read_state_common_type_content (type);
  do {if (do_debug) fprintf (
# 1652 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
 stderr
# 1652 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
 , "%s:%d: " "read pointer type @%p #%d" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),1652, (void *) type, type->state_number);} while (0);
  ...
  if (state_token_kind (t0) == STOK_STRING)
    {
      ...
      do {if (do_debug) fprintf (
# 1669 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
     stderr
# 1669 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
     , "%s:%d: " "read array type @%p #%d length '%s'" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),1669, (void *) type, type->state_number, type->u.a.len);} while (0)
                                                    ;
      next_state_tokens (1);
    }
    ...
    {
      type->u.a.len = nullptr;
      do {if (do_debug) fprintf (
# 1677 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
     stderr
# 1677 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
     , "%s:%d: " "read array type @%p #%d without length" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),1677, (void *) type, type->state_number);} while (0)
                                     ;
      next_state_tokens (1);
    }
...
{
  struct state_token_st *t0 = nullptr;
  struct state_token_st *t1 = nullptr;
  struct state_token_st *t2 = nullptr;
 ...
 {
   do {if (do_debug) fprintf (
# 1707 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
  stderr
# 1707 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
  , "%s:%d: " "read anonymous lang_struct type @%p #%d" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),1707, (void *) type, type->state_number);} while (0)
                                         ;
   type->u.s.tag = nullptr;
 }
      else
 {
   type->u.s.tag = xstrdup (t0->stok_un.stok_string);
   do {if (do_debug) fprintf (
# 1714 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
  stderr
# 1714 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
  , "%s:%d: " "read lang_struct type @%p #%d '%s'" "\n", lbasename ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"),1714, (void *) type, type->state_number, type->u.s.tag);} while (0)
                                                        ;
 }
      next_state_tokens (1);
    }
  ...
  if (state_token_kind (t0) == STOK_INTEGER)
    {
      ...
      do { struct state_token_st* badtok = t0; if (badtok) fatal ("%s:%d:%d: Invalid state file; " "Expected integer for state_number line %d", badtok->stok_file, badtok->stok_line, badtok->stok_col, state_line); else fatal ("%s:%d: Invalid state file; " "Expected integer for state_number line %d", state_path, state_line, state_line); } while (0)
...
read_state_type (type_p *current)
{
      ...
      else
 {
   ...
   if (state_token_is_name (t0, "scalar_nonchar"))
     ...
     {
       *current = ((struct type *) xcalloc (1, sizeof (struct type)));
       next_state_tokens (1);
...
read_state_fileloc (struct fileloc *floc)
{
  ...
  ((void)(!(floc != nullptr) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c", 1906, __FUNCTION__), 0 : 0));
  ((void)(!(srcdir != nullptr) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c", 1907, __FUNCTION__), 0 : 0));
   ...
   state_token_kind (t1) == STOK_INTEGER)
 {
   ...
   if (issrcfile)
     {
       static const char dirsepstr[2] = { '/', (char) 0 };
...
read_state_nested_option (options_p opt)
{
  ...
  opt->info.nested = ((struct nested_ptr_data *) xcalloc (1, sizeof (struct nested_ptr_data)));
  ...
  if (state_token_kind (t0) == STOK_STRING)
    ...
    {
      opt->info.nested->convert_from = nullptr;
      next_state_tokens (1);
    }
  else
  ...
  if (state_token_kind (t0) == STOK_STRING)
    ...
    {
      opt->info.nested->convert_to = nullptr;
      next_state_tokens (1);
    }
  else
    fatal_reading_state (t0, "Bad nested convert_from option");
...
read_state_option (options_p *opt)
{
 ...
 {
   *opt = ((struct options *) xcalloc (1, sizeof (struct options)));
   if (state_token_is_name (t0, "nil"))
     (*opt)->name = nullptr;
   else
...
{
  options_p head = nullptr;
  options_p previous = nullptr;
  options_p current_option = nullptr;
  struct state_token_st *t0 = peek_state_token (0);
  struct state_token_st *t1 = peek_state_token (1);
...
read_state_pair (pair_p *current)
{
  ...
  if (state_token_kind (t0) == STOK_LEFTPAR &&
    ...
    {
      *current = ((struct pair *) xcalloc (1, sizeof (struct pair)));
      next_state_tokens (2);
      t0 = peek_state_token (0);
      if (state_token_kind (t0) == STOK_STRING)
 {
      ...
      else
 {
   fatal_reading_state (t0, "Bad name for pair");
    ...
    do { struct state_token_st* badtok = t0; if (badtok) fatal ("%s:%d:%d: Invalid state file; " "Bad syntax for pair, (!pair %d", badtok->stok_file, badtok->stok_line, badtok->stok_col, state_token->stok_kind); else fatal ("%s:%d: Invalid state file; " "Bad syntax for pair, (!pair %d", state_path, state_line, state_token->stok_kind); } while (0)
                           ;
}
...
read_state_languages (void)
{
  ...
  if (state_token_kind (t0) == STOK_LEFTPAR
      ...
      && state_token_kind (t2) == STOK_INTEGER)
    {
      ...
      lang_dir_names = ((const char * *) xcalloc ((num_lang_dirs), sizeof (const char *)));
      next_state_tokens (3);
      t0 = t1 = t2 = nullptr;
      for (i = 0; i < (int) num_lang_dirs; i++)
 {
...
read_state_files_list (void)
{
  ...
  if (state_token_kind (t0) == STOK_LEFTPAR
      ...
      && state_token_kind (t2) == STOK_INTEGER)
    {
      ...
      next_state_tokens (3);
      t0 = t1 = t2 = nullptr;
      gt_files = ((const input_file * *) xcalloc ((num_gt_files), sizeof (const input_file *)));
      for (i = 0; i < (int) num_gt_files; i++)
 {
   bool issrcfile = false;
   t0 = t1 = t2 = nullptr;
    ...
    && state_token_kind (t1) == STOK_RIGHTPAR)
  {
    ...
    input_file *curgt = nullptr;
    if (issrcfile)
      {
        static const char dirsepstr[2] =
   { '/', (char) 0 };
        char *fullpath = concat (srcdir, dirsepstr, fnam, nullptr);
...
{
  state_file = fopen_unlocked (path, "r");
  if (state_file == nullptr)
    fatal ("Failed to open state file %s for reading [%s]", path,
    xstrerror (
# 2576 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
              (*__errno_location ())
# 2576 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
                   ));
  state_path = path;
  state_line = 1;
 ...
 putchar_unlocked ('\n');
      fflush_unlocked (
# 2585 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
     stdout
# 2585 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
     );
    }

  state_seen_types =
    htab_create (2017, hash_type_number, equals_type_number, nullptr);
  state_ident_tab =
    htab_create (4027, htab_hash_string, string_eq, nullptr);
  ...
  if (ferror_unlocked (state_file))
    do { struct state_token_st* badtok = (struct state_token_st*)0; if (badtok) fatal ("%s:%d:%d: Invalid state file; " "input error while reading state [%s]", badtok->stok_file, badtok->stok_line, badtok->stok_col, xstrerror (
# 2598 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
   (*__errno_location ())
# 2598 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
   )); else fatal ("%s:%d: Invalid state file; " "input error while reading state [%s]", state_path, state_line, xstrerror (
# 2598 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
   (*__errno_location ())
# 2598 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
   )); } while (0)
  ...
  if (verbosity_level >= 1)
    {
      ...
      fflush_unlocked (
# 2608 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
     stdout
# 2608 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
     );
    };
  ...
  if (fclose (state_file))
    ...
    path, xstrerror (
# 2613 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c" 3 4
                    (*__errno_location ())
# 2613 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-state.c"
                         ));
  state_file = nullptr;
  state_path = nullptr;
}
