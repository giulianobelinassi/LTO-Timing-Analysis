# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c"
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c"
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c" 2
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c" 2
...
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c" 2
...
# 30 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c" 2
...
# 31 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c" 2
...
# 33 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c" 2
...
# 34 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c" 2
...
# 35 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c" 2
# 1 "d/id.h" 1
...
# 36 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c" 2
...
# 37 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c" 2
...
# 38 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c" 2
...
# 39 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c" 2
...
# 40 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c" 2
...
# 115 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c"
...
# 130 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c"
    ...
    void template_args(TemplateInstance *ti)
    {
        ...
        for (size_t i = 0; i < ti->tiargs->length; i++)
        {
            ...
            ((void)(!(td) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c", 173, __FUNCTION__), 0 : 0));
            ...
            if (tp->isTemplateTupleParameter())
            {
                ...
                for (size_t j = i; j < ti->tiargs->length; j++)
                {
                    ...
                    ((void)(!(t) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c", 190, __FUNCTION__), 0 : 0));
                    t->accept(this);
                }
            ...
            {
                Type *t = isType(o);
                ((void)(!(t) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c", 200, __FUNCTION__), 0 : 0));
                t->accept(this);
            }
            else if (TemplateValueParameter *tv = tp->isTemplateValueParameter())
            {
                ...
                if (tv->valType->isintegral())
                {
                    ...
                    ((void)(!(e) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c", 209, __FUNCTION__), 0 : 0));
                    buf->writeByte('L');
            ...
            {
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c", 271, __FUNCTION__), 0 : 0));
            }
        }
        buf->writeByte('E');
    }
...
# 306 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c"
...
# 327 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c"
    ...
    void mangle_variable(VarDeclaration *d, bool is_temp_arg_ref)
    {
        ...
        if (!(d->storage_class & (2LL | 0x40LL | 0x40000000LL)))
        {
    ...
    void mangle_function(FuncDeclaration *d)
    {
        ...
        if (getFuncTemplateDecl(d))
        {
            ...
            ((void)(!(ti) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c", 597, __FUNCTION__), 0 : 0));
        ...
        else
        {
            ...
            if (p && !p->isModule() && tf->linkage == LINKcpp)
            {
                ...
                buf->writeByte('N');
                CV_qualifiers(d->type);
# 634 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c"
                prefix_name(p);
        ...
        {
            ((void)(!(tf->ty == Tfunction) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c", 659, __FUNCTION__), 0 : 0));
...
public:
    ...
    void mangleOf(Dsymbol *s)
    {
        ...
        {
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c", 726, __FUNCTION__), 0 : 0));
        }
    }
...
# 777 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c"
...
# 853 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c"
        char c;
        char p = 0;
        switch (t->ty)
        {
    ...
    void visit(TypeVector *t)
    {
        ...
        {
            ((void)(!(t->basetype && t->basetype->ty == Tsarray) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c", 909, __FUNCTION__), 0 : 0));
            ((void)(!(((TypeSArray *)t->basetype)->dim) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c", 910, __FUNCTION__), 0 : 0));
    ...
    {
# 977 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c"
        if (substitute(t))
            return;
        buf->writeByte('F');
        if (t->linkage == LINKc)
...
# 1072 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cppmangle.c"
