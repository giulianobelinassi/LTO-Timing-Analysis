# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 2
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 2
...
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 2





# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.h" 1
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.h"
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.h" 2
...
struct mapping;
# 149 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.h"
class md_reader
{
 public:
...
extern void message_at (file_location, const char *, ...) __attribute__ ((__format__ (__printf__, 2, 3))) __attribute__ ((__nonnull__ (2)));
extern void error_at (file_location, const char *, ...) __attribute__ ((__format__ (__printf__, 2, 3))) __attribute__ ((__nonnull__ (2)));
extern void fatal_at (file_location, const char *, ...) __attribute__ ((__format__ (__printf__, 2, 3))) __attribute__ ((__nonnull__ (2)));
...
extern void fatal_expected_char (int, int) __attribute__ ((__noreturn__));
...
# 35 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 2
...
{
  fprint_md_ptr_loc (
# 137 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
                    stdout
# 137 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
                          , ptr);
}
...
md_reader::join_c_conditions (const char *cond1, const char *cond2)
{
  ...
  __extension__ ({ struct obstack *__o = (&m_joined_conditions_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < sizeof (void *)) _obstack_newchunk (__o, sizeof (void *)); __extension__ ({ struct obstack *__o1 = (__o); void *__p1 = __o1->next_free; *(const void **) __p1 = (result); __o1->next_free += sizeof (const void *); (void) 0; }); });
  __extension__ ({ struct obstack *__o = (&m_joined_conditions_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < sizeof (void *)) _obstack_newchunk (__o, sizeof (void *)); __extension__ ({ struct obstack *__o1 = (__o); void *__p1 = __o1->next_free; *(const void **) __p1 = (cond1); __o1->next_free += sizeof (const void *); (void) 0; }); });
  __extension__ ({ struct obstack *__o = (&m_joined_conditions_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < sizeof (void *)) _obstack_newchunk (__o, sizeof (void *)); __extension__ ({ struct obstack *__o1 = (__o); void *__p1 = __o1->next_free; *(const void **) __p1 = (cond2); __o1->next_free += sizeof (const void *); (void) 0; }); });
  entry = ((const void **) __extension__ ({ struct obstack *__o1 = ((&m_joined_conditions_obstack)); void *__value = (void *) __o1->object_base; if (__o1->next_free == __value) __o1->maybe_empty_object = 1; __o1->next_free = ((sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (((__o1->next_free) - (sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (__o1->alignment_mask)) & ~(__o1->alignment_mask))); if ((size_t) (__o1->next_free - (char *) __o1->chunk) > (size_t) (__o1->chunk_limit - (char *) __o1->chunk)) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; __value; }));
...
{
  fprint_c_condition (
# 197 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
                     stdout
# 197 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
                           , cond);
}
...
static void __attribute__ ((__format__ (__printf__, 2, 0))) __attribute__ ((__nonnull__ (2)))
message_at_1 (file_location loc, const char *msg, va_list ap)
{
  fprintf (
# 206 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
          stderr
# 206 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
                , "%s:%d:%d: ", loc.filename, loc.lineno, loc.colno);
  vfprintf (
# 207 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
           stderr
# 207 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
                 , msg, ap);
  fputc ('\n', 
# 208 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
              stderr
# 208 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
                    );
}
...
# 218 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
 __builtin_va_start(
# 218 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
 ap
# 218 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
 ,
# 218 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
...
# 220 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
 __builtin_va_end(
# 220 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
 ap
# 220 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
 )
# 220 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
...
# 230 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
 __builtin_va_start(
# 230 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
 ap
# 230 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
 ,
# 230 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
...
# 232 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
 __builtin_va_end(
# 232 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
 ap
# 232 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
 )
# 232 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
...
# 243 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
 __builtin_va_start(
# 243 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
 ap
# 243 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
 ,
# 243 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
...
# 245 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
 __builtin_va_end(
# 245 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
 ap
# 245 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
 )
# 245 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
...
# 260 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
 __builtin_va_start(
# 260 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
 ap
# 260 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
 ,
# 260 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
...
# 260 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
  ...
  fprintf (
# 262 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
          stderr
# 262 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
                , "%s:%d:%d: error: ", md_reader_ptr->get_filename (),
    md_reader_ptr->get_lineno (),
    md_reader_ptr->get_colno ());
  vfprintf (
# 265 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
           stderr
# 265 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
                 , msg, ap);
  putc ('\n', 
# 266 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
             stderr
# 266 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
                   );
  ...
  for (i = 0; i < sizeof (context)-1; ++i)
    {
      c = read_char ();
      if (c == 
# 272 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
              (-1)
# 272 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
                 )
 break;
      if (c == '\r' || c == '\n')
 {
  ...
  fprintf (
# 283 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
          stderr
# 283 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
...
# 288 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
 __builtin_va_end(
# 288 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
 ap
# 288 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
 )
# 288 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
...
{
  if (actual == 
# 298 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
               (-1)
# 298 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
                  )
...
read_skip_spaces (void)
{
 ...
 case ';':
   do
     c = read_char ();
   while (c != '\n' && c != 
# 325 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
                           (-1)
# 325 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
                              );
   break;
 ...
 case '/':
  ...
  fatal_with_file_and_line ("stray '/' in file");
     ...
     prevc = 0;
     while ((c = read_char ()) && c != 
# 339 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
                                      (-1)
# 339 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
                                         )
       {
  if (prevc == '*' && c == '/')
    break;
...
md_reader::read_char (void)
{
 ...
 return 
# 412 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
       (-1)
# 412 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
          ;
    }
...
md_reader::read_name_1 (struct md_name *name, file_location *out_loc)
{
 ...
 angle_bracket_depth++;
   ...
   angle_bracket_depth--;
      ...
      if (c == ' ' || c == '\n' || c == '\t' || c == '\f' || c == '\r'
   || c == 
# 468 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
          (-1)
# 468 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
             )
 break;
...
md_reader::read_escape ()
{
  ...
  switch (c)
    ...
    case '\'':
      break;
# 570 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
    case 'a': case 'b': case 'f': case 'n': case 'r': case 't': case 'v':
    case '0': case '1': case '2': case '3': case '4': case '5': case '6':
    case '7': case 'x':
      __extension__ ({ struct obstack *__o = (&m_string_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < 1) _obstack_newchunk (__o, 1); ((void) (*((__o)->next_free)++ = ('\\'))); });
      break;



    case ';':
      __extension__ ({ struct obstack *__o = (&m_string_obstack); size_t __len = (4); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < __len) _obstack_newchunk (__o, __len); memcpy (__o->next_free, "\\n\\t", __len); __o->next_free += __len; (void) 0; });
      return;


    default:
      fprintf (
# 584 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
              stderr
# 584 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
  ...
  __extension__ ({ struct obstack *__o = (&m_string_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < 1) _obstack_newchunk (__o, 1); ((void) (*((__o)->next_free)++ = (c))); });
}
...
# 610 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
                               (-1)
# 610 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
                                  )
 break;
  ...
  __extension__ ({ struct obstack *__o = (&m_string_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < 1) _obstack_newchunk (__o, 1); ((void) (*((__o)->next_free)++ = (0))); });
...
# 645 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
                   (-1)
# 645 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
                      )
  ...
  do
    {
      c = read_skip_spaces ();
      if (c == 
# 714 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
              (-1)
# 714 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
                 )
 {
...
scan_comma_elt (const char **pstr)
{
  ...
  if (*p == ',')
    p++;
  while ((_sch_istable[(*p) & 0xff] & (unsigned short)(_sch_isspace)))
    p++;
...
upcase_string (char *string)
{
  ...
  for (i = 0; string[i]; i++)
    string[i] = _sch_toupper[(string[i]) & 0xff];
}
...
md_reader::handle_enum (file_location loc, bool md_p)
{
 ...
 error_at (loc, "redefining `%s' as a different type of enum",
    ...
    {
      def = ((struct enum_type *) xmalloc (sizeof (struct enum_type)));
      def->name = enum_name;
      def->md_p = md_p;
      def->values = 0;
  ...
  while ((c = read_skip_spaces ()) != ']')
    {
      if (c == 
# 935 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
              (-1)
# 935 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
                 )
 {
   error_at (loc, "unterminated construct");
   exit (1);
      ...
      ev = ((struct enum_value *) xmalloc (sizeof (struct enum_value)));
      ev->next = 0;
      if (md_p)
 {
...
: m_compact (compact),
  m_toplevel_fname (nullptr),
  m_base_dir (nullptr),
  m_read_md_file (nullptr),
  m_read_md_filename (nullptr),
  m_read_md_lineno (0),
  m_read_md_colno (0),
  m_first_dir_md_include (nullptr),
  m_last_dir_md_include_ptr (&m_first_dir_md_include),
  m_first_line (0),
  m_last_line (0),
  m_first_overload (nullptr),
  m_next_overload_ptr (&m_first_overload),
  m_overloads_htab (nullptr)
{

  md_reader_ptr = this;

  _obstack_begin ((&m_string_obstack), 0, 0, (mempool_obstack_chunk_alloc), (mempool_obstack_chunk_free));

  m_ptr_locs = htab_create (161, leading_ptr_hash, leading_ptr_eq_p, 0);
  _obstack_begin ((&m_ptr_loc_obstack), 0, 0, (mempool_obstack_chunk_alloc), (mempool_obstack_chunk_free));

  m_joined_conditions = htab_create (161, leading_ptr_hash, leading_ptr_eq_p, 0);
  _obstack_begin ((&m_joined_conditions_obstack), 0, 0, (mempool_obstack_chunk_alloc), (mempool_obstack_chunk_free));
...
md_reader::~md_reader ()
{
  ...
  __extension__ ({ struct obstack *__o = (&m_joined_conditions_obstack); void *__obj = (void *) (nullptr); if (__obj > (void *) __o->chunk && __obj < (void *) __o->chunk_limit) __o->next_free = __o->object_base = (char *) __obj; else _obstack_free (__o, __obj); });
  htab_delete (m_joined_conditions);

  __extension__ ({ struct obstack *__o = (&m_ptr_loc_obstack); void *__obj = (void *) (nullptr); if (__obj > (void *) __o->chunk && __obj < (void *) __o->chunk_limit) __o->next_free = __o->object_base = (char *) __obj; else _obstack_free (__o, __obj); });
  htab_delete (m_ptr_locs);

  __extension__ ({ struct obstack *__o = (&m_string_obstack); void *__obj = (void *) (nullptr); if (__obj > (void *) __o->chunk && __obj < (void *) __o->chunk_limit) __o->next_free = __o->object_base = (char *) __obj; else _obstack_free (__o, __obj); });


  md_reader_ptr = nullptr;
}
...
md_reader::handle_file ()
{
  ...
  m_read_md_colno = 0;
  while ((c = read_skip_spaces ()) != 
# 1136 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c" 3 4
                                     (-1)
# 1136 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
                                        )
    {
      file_location loc = get_current_location ();
      if (c != '(')
...
# 1309 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.c"
bool
