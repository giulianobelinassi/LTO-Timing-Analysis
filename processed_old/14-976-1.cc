# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c"
# 10 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c"
...
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c" 2
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c" 2
# 1 "d/id.h" 1
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c" 2
...
Prot getAccess(AggregateDeclaration *ad, Dsymbol *smember)
{
    ...
    ((void)(!(ad->isStructDeclaration() || ad->isClassDeclaration()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c", 44, __FUNCTION__), 0 : 0));
    ...
    if (ClassDeclaration *cd = ad->isClassDeclaration())
    {
        for (size_t i = 0; i < cd->baseclasses->length; i++)
        {
            ...
            switch (access.kind)
            {
                ...
                default:
                    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c", 83, __FUNCTION__), 0 : 0));
            }
        }
    }
...
{
    ((void)(!(dthis) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c", 103, __FUNCTION__), 0 : 0));
    ...
    else
    {
        ...
        for (; s; s = s->parent)
        {
            if (Module *m = s->isModule())
            {
                ...
                ((void)(!(dst) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c", 235, __FUNCTION__), 0 : 0));
                Dsymbol *s2 = dst->lookup(m->ident);
                ((void)(!(s2) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c", 237, __FUNCTION__), 0 : 0));
...
{
    if (ClassDeclaration *cd = s->isClassMember())
    {
...
# 389 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c"
bool checkAccess(Loc loc, Scope *sc, Package *p)
{
    if (sc->_module == p)
        return false;
...
# 414 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c"
bool symbolIsVisible(Module *mod, Dsymbol *s)
{
    ...
    switch (s->prot().kind)
    {
        ...
        case Prot::export_:
            return true;
        default:
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c", 435, __FUNCTION__), 0 : 0));
    }
    return false;
}
...
# 457 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c"
bool symbolIsVisible(Scope *sc, Dsymbol *s)
{
    ...
    switch (s->prot().kind)
    {
        ...
        case Prot::export_:
            return true;
        default:
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c", 477, __FUNCTION__), 0 : 0));
    }
    return false;
}
    ...
    for (; s; s = next)
    {
        ...
        else if (AliasDeclaration *ad = s->isAliasDeclaration())
        {
            if (!ad->isOverloadable())
            {
                ...
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c", 521, __FUNCTION__), 0 : 0));
            }
            ...
            {
# 542 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c"
                ...
                else
                {
                    ...
                    if (ad->overnext)
                    {
                        ...
                        ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c", 554, __FUNCTION__), 0 : 0));
                    }
                    break;
                }
            }
            ...
            ((void)(!(next != ad) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c", 561, __FUNCTION__), 0 : 0));
            ((void)(!(next != fstart) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/access.c", 562, __FUNCTION__), 0 : 0));
        }
        else
            break;
