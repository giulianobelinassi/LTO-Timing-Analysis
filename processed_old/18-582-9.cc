# 1 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c"
# 23 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c"
# 1 "./config.h" 1
# 24 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c" 2
...
public:
  ...
  public:
    vec ()
      : ary (
# 46 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c" 3 4
            __null
# 46 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c"
                ), num (0), alloc (0)
      {}
    ~vec ()
      {
      ...
      if (num == alloc)
 {
   ...
   ary = ((T *) xrealloc ((void *) (ary), sizeof (T) * (alloc)));
 }
      ary[num++] = elt;
    }
  };
...
static const char *
munge (const char *str, const char *trail = 
# 114 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c" 3 4
                                           __null
# 114 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c"
                                               , ...)
{
...
# 121 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c" 3 4
   __builtin_va_start(
# 121 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c"
   args
# 121 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c" 3 4
   ,
# 121 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c"
...
# 121 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c"
      ...
      for (const char *probe = str; (c = *probe++);)
 {
   if (alloc < dst + 4 + slashes)
     {
       alloc = alloc * 2 + 32;
       buf = ((char *) xrealloc ((void *) (buf), sizeof (char) * (alloc)));
     }
 ...
 str = 
# 175 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c" 3 4
      __builtin_va_arg(
# 175 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c"
      args
# 175 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c" 3 4
      ,
# 175 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c"
...
# 178 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c" 3 4
   __builtin_va_end(
# 178 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c"
   args
# 178 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c" 3 4
   )
# 178 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c"
...
{
  ((void)(!(*t) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c", 296, __FUNCTION__), 0 : 0));
...
deps_add_vpath (class mkdeps *d, const char *vpath)
{
 ...
 continue;
      mkdeps::velt elt;
      elt.len = p - elem;
      char *str = ((char *) xmalloc (sizeof (char) * (elt.len + 1)));
      elt.str = str;
...
make_write_name (const char *name, FILE *fp, unsigned col, unsigned colmax,
   bool quote = true, const char *trail = 
# 331 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c" 3 4
                                         __null
# 331 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c"
                                             )
{
  if (quote)
    name = munge (name, trail, 
# 334 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c" 3 4
                              __null
# 334 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c"
                                  );
...
make_write_vec (const mkdeps::vec<const char *> &vec, FILE *fp,
  ...
  const char *trail = 
# 359 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c" 3 4
                     __null
# 359 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c"
                         )
{
...
deps_save (class mkdeps *deps, FILE *f)
{
  ...
  size = deps->deps.size ();
  if (fwrite_unlocked (&size, sizeof (size), 1, f) != 1)
    return -1;
  ...
  for (i = 0; i < deps->deps.size (); i++)
    {
      ...
      if (fwrite_unlocked (&size, sizeof (size), 1, f) != 1)
 return -1;
      if (fwrite_unlocked (deps->deps[i], size, 1, f) != 1)
 return -1;
    }
...
deps_restore (class mkdeps *deps, FILE *fd, const char *self)
{
  size_t size;
  char *buf = 
# 438 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c" 3 4
             __null
# 438 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c"
                 ;
  size_t buf_size = 0;


  if (fread_unlocked (&size, sizeof (size), 1, fd) != 1)
    return -1;
 ...
 {
   buf_size = size + 512;
   buf = ((char *) xrealloc ((void *) (buf), sizeof (char) * (buf_size)));
 }
      if (fread_unlocked (buf, 1, size, fd) != size)
 {
   free ((void*) (buf));
   return -1;
 }
      ...
      if (self != 
# 465 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c" 3 4
                 __null 
# 465 "/home/giulianob/gcc_git_gnu/gcc/libcpp/mkdeps.c"
                      && filename_cmp (buf, self) != 0)
