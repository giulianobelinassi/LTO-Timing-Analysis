# 1 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c"
# 33 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c"
# 1 "./config.h" 1
# 34 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c" 2
...
# 36 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c" 2
...
# 37 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c" 2
...
# 38 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c" 2
...
# 39 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c" 2
...
# 40 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c" 2
...
# 41 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c" 2
...
extern int backtrace_syminfo (struct backtrace_state *state, uintptr_t addr,
         ...
         backtrace_error_callback error_callback,
         void *data);
# 47 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c" 2
...
# 48 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c" 2
# 128 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c"
static int
       ...
       backtrace_error_callback error_callback, void *data)
{
  ...
  if (!state->threaded)
    ...
    failed = __atomic_load_n ((&state->fileline_initialization_failed), 2);
  ...
  if (fileline_fn != 
# 155 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c" 3 4
                    ((void *)0)
# 155 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c"
                        )
    return 1;
 ...
 case 1:
   filename = 
# 172 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c" 3 4
             ((void *)0)
# 172 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c"
                           ;
   break;
 case 2:
 ...
 case 5:
   filename = 
# 186 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c" 3 4
             ((void *)0)
# 186 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c"
                                                            ;
   break;
 case 6:
   filename = 
# 189 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c" 3 4
             ((void *)0)
# 189 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c"
                                                            ;
   break;
 default:
   abort ();
      ...
      if (filename == 
# 195 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c" 3 4
                     ((void *)0)
# 195 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c"
                         )
 continue;
 ...
 {
   if (state->filename != 
# 213 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c" 3 4
                         ((void *)0)
# 213 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c"
                             )
     error_callback (data, state->filename, 
# 214 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c" 3 4
                                           2
# 214 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/fileline.c"
                                                 );
   else
     error_callback (data,
 ...
 __atomic_store_n ((&state->fileline_initialization_failed), (1), 3);
      return 0;
    }
  ...
  if (!state->threaded)
    ...
    {
      __atomic_store_n ((&state->fileline_fn), (fileline_fn), 3);
