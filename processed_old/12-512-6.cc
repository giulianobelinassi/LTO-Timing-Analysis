# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengenrtl.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengenrtl.c"
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengenrtl.c"
# 1 "./bconfig.h" 1
...
# 6 "./bconfig.h" 2
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengenrtl.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengenrtl.c" 2

struct rtx_definition
{
  const char *const enumname, *const name, *const format;
};
# 36 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengenrtl.c"
...
{ "JUMP_TABLE_DATA", "jump_table_data", "uuBe0000" },


{ "BARRIER", "barrier", "uu00000" },
...
{ "ASM_INPUT", "asm_input", "si" },
# 219 "/home/giulianob/gcc_git_gnu/gcc/gcc/rtl.def"
{ "ASM_OPERANDS", "asm_operands", "ssiEEEi" },
...
{ "CONST_POLY_INT", "const_poly_int", "" },


{ "CONST_FIXED", "const_fixed", "www" },
...
{ "LABEL_REF", "label_ref", "u" },





{ "SYMBOL_REF", "symbol_ref", "s0" },
...
{ "UNSIGNED_FRACT_CONVERT", "unsigned_fract_convert", "e" },
...
{ "SAT_FRACT", "sat_fract", "e" },





{ "UNSIGNED_SAT_FRACT", "unsigned_sat_fract", "e" },
...
{ "SS_ASHIFT", "ss_ashift", "ee" },


{ "US_ASHIFT", "us_ashift", "ee" },
...
{ "VAR_LOCATION", "var_location", "te" },



{ "DEBUG_IMPLICIT_PTR", "debug_implicit_ptr", "t" },
...
{ "DEBUG_PARAMETER_REF", "debug_parameter_ref", "t" },
...
{ "MATCH_CODE", "match_code", "ss" },



{ "MATCH_TEST", "match_test", "s" },
...
{ "DEFINE_INSN_AND_REWRITE", "define_insn_and_rewrite", "sEsTsSV" },



{ "DEFINE_PEEPHOLE2", "define_peephole2", "EsES" },
# 953 "/home/giulianob/gcc_git_gnu/gcc/gcc/rtl.def"
{ "DEFINE_EXPAND", "define_expand", "sEssV" },
...
{ "DEFINE_COND_EXEC", "define_cond_exec", "EssV" },
# 1002 "/home/giulianob/gcc_git_gnu/gcc/gcc/rtl.def"
{ "DEFINE_PREDICATE", "define_predicate", "ses" },
{ "DEFINE_SPECIAL_PREDICATE", "define_special_predicate", "ses" },
# 1016 "/home/giulianob/gcc_git_gnu/gcc/gcc/rtl.def"
{ "DEFINE_REGISTER_CONSTRAINT", "define_register_constraint", "sss" },
# 1055 "/home/giulianob/gcc_git_gnu/gcc/gcc/rtl.def"
{ "DEFINE_CONSTRAINT", "define_constraint", "sse" },
{ "DEFINE_MEMORY_CONSTRAINT", "define_memory_constraint", "sse" },
{ "DEFINE_SPECIAL_MEMORY_CONSTRAINT", "define_special_memory_constraint", "sse" },
{ "DEFINE_ADDRESS_CONSTRAINT", "define_address_constraint", "sse" },
...
{ "FINAL_PRESENCE_SET", "final_presence_set", "ss" },
...
{ "FINAL_ABSENCE_SET", "final_absence_set", "ss" },
...
{ "DEFINE_ENUM_ATTR", "define_enum_attr", "sse" },
...
{ "DEFINE_SUBST", "define_subst", "sEsE" },
# 1361 "/home/giulianob/gcc_git_gnu/gcc/gcc/rtl.def"
{ "DEFINE_SUBST_ATTR", "define_subst_attr", "ssss" },
# 39 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengenrtl.c" 2
};


static const char *formats[(sizeof (defs) / sizeof ((defs)[0]))];
...
type_from_format (int c)
{
  switch (c)
    ...
    case 'B':
      return "basic_block ";
    default:
      (fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengenrtl.c", 73, __FUNCTION__));
    }
}
...
accessor_from_format (int c)
{
  switch (c)
    ...
    default:
      (fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengenrtl.c", 106, __FUNCTION__));
    }
}
...
main (void)
{
  ...
  if (ferror_unlocked (
# 355 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengenrtl.c" 3 4
     stdout
# 355 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengenrtl.c"
     ) || fflush_unlocked (
# 355 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengenrtl.c" 3 4
                        stdout
# 355 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengenrtl.c"
...
# 355 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengenrtl.c"
    ...
    return 
# 356 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengenrtl.c" 3 4
          1
# 356 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengenrtl.c"
                         ;

  return 
# 358 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengenrtl.c" 3 4
        0
# 358 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengenrtl.c"
                         ;
}
