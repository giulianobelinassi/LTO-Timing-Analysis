# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c"
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c"
# 1 "./bconfig.h" 1
...
# 6 "./bconfig.h" 2
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 2
# 1 "./tm.h" 1
# 22 "./tm.h"
# 1 "./options.h" 1
...
# 49 "./tm.h" 2
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 2
...
load_extend_op (machine_mode mode)
{
  ...
  if (is_a <scalar_int_mode> (mode, &int_mode)
      && GET_MODE_PRECISION (int_mode) < ((8) * (((ix86_isa_flags & (1UL << 1)) != 0) ? 8 : 4)))
    return UNKNOWN;
  return UNKNOWN;
}
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 2
...
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 2
...
# 30 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.h" 1
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/read-md.h"
class file_location {
public:
  file_location () {}
...
# 31 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/gensupport.h" 1
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/gensupport.h"
struct obstack;
...
# 56 "/home/giulianob/gcc_git_gnu/gcc/gcc/gensupport.h"
typedef enum optab_tag {
  unknown_optab,
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/optabs.def" 1
# 45 "/home/giulianob/gcc_git_gnu/gcc/gcc/optabs.def"
sext_optab,
trunc_optab,
zext_optab,
...
len_load_optab,
len_store_optab,
# 59 "/home/giulianob/gcc_git_gnu/gcc/gcc/gensupport.h" 2
  NUM_OPTABS
} optab;
# 75 "/home/giulianob/gcc_git_gnu/gcc/gcc/gensupport.h"
struct optab_def
{
...
struct pred_data
{
  ...
  bool codes[((int) LAST_AND_UNUSED_RTX_CODE)];
};
...
# 32 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 2
...
max_operand_1 (rtx x)
{
  ...
  if (code == MATCH_OPERAND || code == MATCH_OPERATOR
      || code == MATCH_PARALLEL)
    max_opno = ((max_opno) > ((((x)->u.fld[0]).rt_int)) ? (max_opno) : ((((x)->u.fld[0]).rt_int)));
  ...
  for (i = 0; i < len; i++)
    {
      if (fmt[i] == 'e' || fmt[i] == 'u')
 max_operand_1 ((((x)->u.fld[i]).rt_rtx));
      else if (fmt[i] == 'E')
 {
   int j;
   for (j = 0; j < (((((x)->u.fld[i]).rt_rtvec))->num_elem); j++)
     max_operand_1 ((((((x)->u.fld[i]).rt_rtvec))->elem[j]));
 }
    }
}
...
{
  int len = (((((insn)->u.fld[1]).rt_rtvec))->num_elem);
  int i;

  max_opno = -1;

  for (i = 0; i < len; i++)
    max_operand_1 ((((((insn)->u.fld[1]).rt_rtvec))->elem[i]));
...
gen_proto (rtx insn)
{
  ...
  int i;
  const char *name = (((insn)->u.fld[0]).rt_str);
  int truth = maybe_eval_c_test ((((insn)->u.fld[2]).rt_str));
  ...
  if (num == 0)
    fputs_unlocked ("void", 
# 112 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 3 4
   stdout
# 112 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c"
   );
  else
    {
      for (i = 1; i < num; i++)
 fputs_unlocked ("rtx, ", 
# 116 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 3 4
stdout
# 116 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c"
);

      fputs_unlocked ("rtx", 
# 118 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 3 4
     stdout
# 118 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c"
     );
    }
...
gen_insn (md_rtx_info *info)
{
  ...
  if (truth == 0)
  ...
  else
    {
      ...
      for (p = (((insn)->u.fld[2]).rt_str); *p; p++)
 {
   if ((_sch_istable[(*p) & 0xff] & (unsigned short)(_sch_isvsp)))
     fputs_unlocked (" \\\n", 
# 190 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 3 4
    stdout
# 190 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c"
    );
   else
     putchar_unlocked (*p);
 }
      fputs_unlocked (")\n", 
# 194 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 3 4
     stdout
# 194 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c"
     );
    }

  __extension__ ({ struct obstack *__o = (&obstack); size_t __len = (sizeof (rtx)); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < __len) _obstack_newchunk (__o, __len); memcpy (__o->next_free, &insn, __len); __o->next_free += __len; (void) 0; });
}
...
main (int argc, const char **argv)
{
  ...
  if (!init_rtx_reader_args (argc, argv))
    return (
# 215 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 3 4
           1
# 215 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c"
                          );
  ...
  while (read_md_rtx (&info))
    switch (((enum rtx_code) (info.def)->code))
      {
      case DEFINE_INSN:
      case DEFINE_EXPAND:
 gen_insn (&info);
 ...
 break;
  ...
  dummy = (rtx) 0;
  __extension__ ({ struct obstack *__o = (&obstack); size_t __len = (sizeof (rtx)); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < __len) _obstack_newchunk (__o, __len); memcpy (__o->next_free, &dummy, __len); __o->next_free += __len; (void) 0; });
  ...
  if (have_error || ferror_unlocked (
# 247 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 3 4
                   stdout
# 247 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c"
                   ) || fflush_unlocked (
# 247 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 3 4
                                      stdout
# 247 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c"
...
# 247 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c"
    ...
    return 
# 248 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 3 4
          1
# 248 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c"
                         ;

  return 
# 250 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c" 3 4
        0
# 250 "/home/giulianob/gcc_git_gnu/gcc/gcc/genflags.c"
                         ;
}
