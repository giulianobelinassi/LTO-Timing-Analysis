# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/match.h" 1
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/match.h"
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 2

static const char expression_syntax[] = "Syntax error in expression at %C";
...
# 40 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
     __null
  
# 41 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
 };
 ...
 goto error;
  ...
  for (i = 0; name[i]; i++)
    if (!(_sch_istable[(name[i]) & 0xff] & (unsigned short)(_sch_isalpha)))
      {
...
gfc_get_parentheses (gfc_expr *e)
{
  ...
  e2 = gfc_get_operator_expr (&e->where, INTRINSIC_PARENTHESES, e, 
# 133 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
                                                                  __null
# 133 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
                                                                      );
  e2->ts = e->ts;
  e2->rank = e->rank;
...
match_level_1 (gfc_expr **result)
{
  ...
  uop = 
# 206 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
       __null
# 206 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
           ;
  ...
  if (uop == 
# 215 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
            __null
# 215 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
                )
    *result = e;
  else
    {
      f = gfc_get_operator_expr (&where, INTRINSIC_USER, e, 
# 219 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
                                                           __null
# 219 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
                                                               );
      f->value.op.uop = uop;
      *result = f;
    }
...
# 244 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
...
match_mult_operand (gfc_expr **result)
{
  ...
  gfc_expr *e = 
# 263 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
               __null
# 263 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
                   , *exp, *r;
  locus where;
  match m;
  ...
  r = gfc_power (e, exp);
  if (r == 
# 289 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
          __null
# 289 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
              )
    {
      gfc_free_expr (e);
      gfc_free_expr (exp);
...
match_ext_mult_operand (gfc_expr **result)
{
  ...
  if (gfc_notification_std ((1<<5)) == ERROR)
    {
  ...
  if (all == 
# 336 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
            __null
# 336 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
                )
    {
      gfc_free_expr (e);
      return MATCH_ERROR;
...
match_add_operand (gfc_expr **result)
{
 ...
 total = gfc_divide (all, e);
      ...
      if (total == 
# 396 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
                  __null
# 396 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
                      )
 {
   gfc_free_expr (all);
   gfc_free_expr (e);
...
match_ext_add_operand (gfc_expr **result)
{
  ...
  if (all == 
# 445 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
            __null
# 445 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
                )
    {
      gfc_free_expr (e);
      return MATCH_ERROR;
...
match_level_2 (gfc_expr **result)
{
 ...
 all = gfc_uplus (e);
      ...
      if (all == 
# 494 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
                __null
# 494 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
                    )
 {
   gfc_free_expr (e);
   return MATCH_ERROR;
 ...
 total = gfc_add (all, e);
      ...
      if (total == 
# 526 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
                  __null
# 526 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
                      )
 {
   gfc_free_expr (all);
   gfc_free_expr (e);
...
{
  gfc_expr *all, *e, *total = 
# 547 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
                             __null
# 547 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
                                 ;
  locus where;
  match m;
      ...
      if (m != MATCH_YES)
 {
   ...
   return MATCH_ERROR;
      ...
      if (total == 
# 572 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
                  __null
# 572 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
                      )
 {
   gfc_free_expr (all);
   gfc_free_expr (e);
...
match_level_4 (gfc_expr **result)
{
  ...
  if (r == 
# 668 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
          __null
# 668 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
              )
    {
      gfc_free_expr (left);
      gfc_free_expr (right);
  ...
  if (i)
    {
      r = gfc_not (e);
      if (r == 
# 701 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
              __null
# 701 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
                  )
 {
   gfc_free_expr (e);
   return MATCH_ERROR;
...
match_or_operand (gfc_expr **result)
{
      ...
      if (m != MATCH_YES)
 {
   ...
   return MATCH_ERROR;
      ...
      total = gfc_and (all, e);
      if (total == 
# 742 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
                  __null
# 742 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
                      )
 {
   gfc_free_expr (all);
   gfc_free_expr (e);
...
match_equiv_operand (gfc_expr **result)
{
      ...
      if (m != MATCH_YES)
 {
   ...
   return MATCH_ERROR;
      ...
      total = gfc_or (all, e);
      if (total == 
# 785 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
                  __null
# 785 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
                      )
 {
   gfc_free_expr (all);
   gfc_free_expr (e);
...
match_level_5 (gfc_expr **result)
{
 ...
 total = gfc_neqv (all, e);
      ...
      if (total == 
# 843 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
                  __null
# 843 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
                      )
 {
   gfc_free_expr (all);
   gfc_free_expr (e);
...
gfc_match_expr (gfc_expr **result)
{
  ...
  for (;;)
    {
      uop = 
# 876 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c" 3 4
           __null
# 876 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/matchexp.c"
               ;
      m = match_defined_operator (&uop);
      if (m == MATCH_NO)
 break;
