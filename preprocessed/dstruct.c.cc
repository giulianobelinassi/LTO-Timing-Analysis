# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c" 2
# 1 "d/id.h" 1
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c" 2
...
FuncDeclaration *StructDeclaration::xerreq;
FuncDeclaration *StructDeclaration::xerrcmp;
...
Scope *AggregateDeclaration::newScope(Scope *sc)
{
    ...
    sc2->stc &= 0x200000000LL | 0x400000000LL | 0x800000000LL;
    sc2->parent = this;
...
void AggregateDeclaration::semantic3(Scope *sc)
{
    ...
    if (!sc)
    {
        ((void)(!(sd) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c", 283, __FUNCTION__), 0 : 0));
...
# 342 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c"
bool AggregateDeclaration::determineFields()
{
    ...
    struct SV
    {
        ...
        static int func(Dsymbol *s, void *param)
        {
            ...
            if (v->storage_class & (1LL | 2LL | 0x8000000LL | 0x40000000LL | 0x800000LL | 0x1000000000LL | 0x40000LL))
                return 0;
...
d_uns64 AggregateDeclaration::size(Loc loc)
{
    ...
    return ok ? structsize : (~(d_uns64)0);
}
...
# 556 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c"
bool AggregateDeclaration::checkOverlappedFields()
{

    ((void)(!(sizeok == SIZEOKdone) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c", 559, __FUNCTION__), 0 : 0));
...
# 631 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c"
bool AggregateDeclaration::fill(Loc loc, Expressions *elements, bool ctorinit)
{

    ((void)(!(sizeok == SIZEOKdone) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c", 634, __FUNCTION__), 0 : 0));
    ((void)(!(elements) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c", 635, __FUNCTION__), 0 : 0));
        ...
        for (size_t j = 0; j < nfields; j++)
        {
            ...
            else
            {
                ...
                else if (vx->_init && v2->_init)
                {
                    ...
                    ((void)(!(vx->_init || (!vx->_init && !v2->_init)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c", 715, __FUNCTION__), 0 : 0));
            }
        }
        if (vx)
        {
            ...
            {
                ((void)(!(!vx->_init->isVoidInitializer()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c", 727, __FUNCTION__), 0 : 0));
                if (vx->inuse)
                {
            ...
            {
                if ((vx->storage_class & 0x8000000000LL) && !ctorinit)
                {
...
# 789 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c"
        ...
        unsigned *poffset)
{
    ...
    switch (alignment)
    {
        ...
        case (structalign_t) ((structalign_t) ~0):


            ((void)(!(size > 0 && !(size & (size - 1))) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c", 804, __FUNCTION__), 0 : 0));
            *poffset = (*poffset + size - 1) & ~(size - 1);
            break;

        default:

            ((void)(!(alignment > 0 && !(alignment & (alignment - 1))) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c", 810, __FUNCTION__), 0 : 0));
            *poffset = (*poffset + alignment - 1) & ~(alignment - 1);
            break;
    }
}
# 829 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c"
        ...
        )
{
    ...
    const unsigned actualAlignment =
        alignment == ((structalign_t) ~0) ? memalignsize : alignment;
...
void AggregateDeclaration::makeNested()
{
    ...
    if (enclosing)
    {
        ...
        ((void)(!(t) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c", 915, __FUNCTION__), 0 : 0));
        if (t->ty == Tstruct)
            t = Type::tvoidptr;
        ((void)(!(!vthis) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c", 918, __FUNCTION__), 0 : 0));
...
void StructDeclaration::semantic(Scope *sc)
{
    ...
    if (!parent)
    {
        ((void)(!(sc->parent && sc->func) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c", 1042, __FUNCTION__), 0 : 0));
        parent = sc->parent;
    }
    ((void)(!(parent && !isAnonymous()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c", 1045, __FUNCTION__), 0 : 0));
    ...
    if (!determineFields())
    {
        ((void)(!(type->ty == Terror) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c", 1128, __FUNCTION__), 0 : 0));
        sc2->pop();
        semanticRun = PASSsemanticdone;
        return;
    }
    ...
    if (ctor)
    {
        ...
        if (scall)
        {
            ...
            sc->tinst = nullptr;
            sc->minst = nullptr;
            FuncDeclaration *fcall = resolveFuncCall(loc, sc, scall, nullptr, nullptr, nullptr, 1);
            sc = sc->pop();
...
void StructDeclaration::finalizeSize()
{
    ...
    ((void)(!(sizeok != SIZEOKdone) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c", 1251, __FUNCTION__), 0 : 0));
    ...
    if (dim >= 1)
    {
        ((void)(!(dim <= 2) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c", 1319, __FUNCTION__), 0 : 0));
        arg1type = (*tt->arguments)[0]->type;
        if (dim == 2)
            arg2type = (*tt->arguments)[1]->type;
    }
}
# 1336 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c"
...
# 1424 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c"
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dstruct.c", 1475, __FUNCTION__), 0 : 0));
