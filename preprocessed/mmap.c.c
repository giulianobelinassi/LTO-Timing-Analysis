# 1 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
# 33 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
# 1 "./config.h" 1
# 34 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 2
...
# 36 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 2
...
# 37 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 2
...
# 38 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 2
...
# 39 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 2
...
# 41 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 2
...
extern int backtrace_syminfo (struct backtrace_state *state, uintptr_t addr,
         ...
         backtrace_error_callback error_callback,
         void *data);
# 43 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 2
...
# 44 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 2
# 63 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
  ...
  if (size >= sizeof (struct backtrace_freelist_struct))
    {
      ...
      c = 0;
      ppsmall = 
# 89 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 3 4
               ((void *)0)
# 89 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
                   ;
      for (pp = &state->freelist; *pp != 
# 90 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 3 4
                                        ((void *)0)
# 90 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
                                            ; pp = &(*pp)->next)
 {
   if (ppsmall == 
# 92 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 3 4
                 ((void *)0) 
# 92 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
                      || (*pp)->size < (*ppsmall)->size)
     ppsmall = pp;
   ++c;
 }
      if (c >= 16)
   ...
   void *data)
{
  ...
  ret = 
# 125 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 3 4
       ((void *)0)
# 125 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
           ;
  ...
  if (locked)
    {
      for (pp = &state->freelist; *pp != 
# 139 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 3 4
                                        ((void *)0)
# 139 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
                                            ; pp = &(*pp)->next)
 {
   if ((*pp)->size >= size)
     {
 ...
 __sync_lock_release (&state->lock_alloc);
  ...
  if (ret == 
# 165 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 3 4
            ((void *)0)
# 165 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
                )
    {
      ...
      page = mmap (
# 171 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 3 4
                  ((void *)0)
# 171 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
                      , asksize, 
# 171 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 3 4
                                 0x1 
# 171 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
...
# 172 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 3 4
    0x02 
# 172 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
                | 
# 172 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 3 4
                  0x20
# 172 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
                               , -1, 0);
      if (page == 
# 173 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 3 4
                 ((void *) -1)
# 173 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
                           )
 {
   if (error_callback)
     error_callback (data, "mmap", 
# 176 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 3 4
                                  (*__errno_location ())
# 176 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
                                       );
 }
      else
 {
         ...
         void *data, struct backtrace_vector *vec)
{
      ...
      else
 {
   ...
   alc = (alc + pagesize - 1) & ~ (pagesize - 1);
      ...
      if (base == 
# 271 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 3 4
                 ((void *)0)
# 271 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
                     )
 return 
# 272 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 3 4
       ((void *)0)
# 272 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
           ;
      if (vec->base != 
# 273 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 3 4
                      ((void *)0)
# 273 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
                          )
 {
...
backtrace_vector_finish (
  struct backtrace_state *state __attribute__ ((__unused__)),
  struct backtrace_vector *vec,
  backtrace_error_callback error_callback __attribute__ ((__unused__)),
  void *data __attribute__ ((__unused__)))
{
     ...
     void *data)
{
  ...
  if (vec->size == 0)
    vec->base = 
# 329 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c" 3 4
               ((void *)0)
# 329 "/home/giulianob/gcc_git_gnu/gcc/libbacktrace/mmap.c"
                   ;
  return 1;
}
