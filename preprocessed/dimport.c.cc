# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c" 2
# 1 "d/id.h" 1
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c" 2
...
Import::Import(Loc loc, Identifiers *packages, Identifier *id, Identifier *aliasId,
    ...
    : Dsymbol(nullptr)
{
    ((void)(!(id) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c", 32, __FUNCTION__), 0 : 0));
    this->loc = loc;
    this->packages = packages;
    this->id = id;
    this->aliasId = aliasId;
    this->isstatic = isstatic;
    this->protection = Prot(Prot::private_);
    this->pkg = nullptr;
    this->mod = nullptr;
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c", 84, __FUNCTION__), 0 : 0));
            ...
            else if (Package *p = s->isPackage())
            {
                if (p->isPkgMod == PKGunknown)
                {
                    ...
                    else
                    {
                        ...
                        ((void)(!(mod->isPackageFile == (p->isPkgMod == PKGmodule)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c", 123, __FUNCTION__), 0 : 0));
...
void Import::semantic(Scope *sc)
{
    ...
    if (mod)
    {
        ...
        if (!aliasId && !names.length)
        {
            ...
            if (packages)
            {
                ...
                for (size_t i = 1; i < packages->length; i++)
                {
            ...
            scopesym->addAccessiblePackage(mod, protection);
        }

        mod->semantic(nullptr);
    ...
    {
# 322 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c"
...
bool Import::overloadInsert(Dsymbol *s)
{
    ...
    ((void)(!(ident && ident == s->ident) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dimport.c", 481, __FUNCTION__), 0 : 0));
    Import *imp;
