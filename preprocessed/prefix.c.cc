# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/prefix.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/prefix.c"
# 66 "/home/giulianob/gcc_git_gnu/gcc/gcc/prefix.c"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 67 "/home/giulianob/gcc_git_gnu/gcc/gcc/prefix.c" 2
...
# 68 "/home/giulianob/gcc_git_gnu/gcc/gcc/prefix.c" 2
...
# 69 "/home/giulianob/gcc_git_gnu/gcc/gcc/prefix.c" 2



# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/prefix.h" 1
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/prefix.h"
extern "C" {
...
# 73 "/home/giulianob/gcc_git_gnu/gcc/gcc/prefix.c" 2
...
# 74 "/home/giulianob/gcc_git_gnu/gcc/gcc/prefix.c" 2

static const char *std_prefix = "/usr/local";

static const char *get_key_value (char *);
static char *translate_name (char *);
static char *save_string (const char *, int);
static void tr (char *, int, int);
# 89 "/home/giulianob/gcc_git_gnu/gcc/gcc/prefix.c"
static const char *
...
{
  char *result = ((char *) xmalloc (sizeof (char) * (len + 1)));

  memcpy (result, s, len);
  result[len] = 0;
  return result;
}
# 182 "/home/giulianob/gcc_git_gnu/gcc/gcc/prefix.c"
static char *
translate_name (char *name)
{
 ...
 break;
      ...
      for (keylen = 0;
    (name[keylen + 1] != 0 && !(((name[keylen + 1]) == '/') || (((name[keylen + 1]) == '\\') && (0))));
    keylen++)
 ;
   ...
   && (p != result && (((p[-1]) == '/') || (((p[-1]) == '\\') && (0)))))
 {
   *p = 0;
   if (!targetm_common.always_strip_dotdot
       && access (result, 
# 288 "/home/giulianob/gcc_git_gnu/gcc/gcc/prefix.c" 3 4
                         1
# 288 "/home/giulianob/gcc_git_gnu/gcc/gcc/prefix.c"
                             ) == 0)
     {
       *p = '.';
       break;
  ...
  {
    --dest;
    while (dest != result && (((*dest) == '/') || (((*dest) == '\\') && (0))))
      --dest;
    while (dest != result && !(((dest[-1]) == '/') || (((dest[-1]) == '\\') && (0))))
      --dest;
  }
...
# 339 "/home/giulianob/gcc_git_gnu/gcc/gcc/prefix.c"
  if ('/' != '/')
    tr (result, '/', '/');
