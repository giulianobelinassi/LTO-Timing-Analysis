# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
# 1 "./bconfig.h" 1
...
# 6 "./bconfig.h" 2
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c" 2



# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/mode-classes.def" 1
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c" 2
...
{
  "MODE_RANDOM", "MODE_CC", "MODE_INT", "MODE_PARTIAL_INT", "MODE_FRACT", "MODE_UFRACT", "MODE_ACCUM", "MODE_UACCUM", "MODE_FLOAT", "MODE_DECIMAL_FLOAT", "MODE_COMPLEX_INT", "MODE_COMPLEX_FLOAT", "MODE_VECTOR_BOOL", "MODE_VECTOR_INT", "MODE_VECTOR_FRACT", "MODE_VECTOR_UFRACT", "MODE_VECTOR_ACCUM", "MODE_VECTOR_UACCUM", "MODE_VECTOR_FLOAT"
};
# 50 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
struct mode_data
{
...
# 283 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
static void
...
{
  do { switch (r_precision) { case SET: if (m->precision == blank_mode.precision) error ("%s:%d: (%s) field %s must be set", m->file, m->line, m->name, "precision"); break; case UNSET: if (m->precision != blank_mode.precision) error ("%s:%d: (%s) field %s must not be set", m->file, m->line, m->name, "precision"); case OPTIONAL: break; } } while (0);
  do { switch (r_bytesize) { case SET: if (m->bytesize == blank_mode.bytesize) error ("%s:%d: (%s) field %s must be set", m->file, m->line, m->name, "bytesize"); break; case UNSET: if (m->bytesize != blank_mode.bytesize) error ("%s:%d: (%s) field %s must not be set", m->file, m->line, m->name, "bytesize"); case OPTIONAL: break; } } while (0);
  do { switch (r_component) { case SET: if (m->component == blank_mode.component) error ("%s:%d: (%s) field %s must be set", m->file, m->line, m->name, "component"); break; case UNSET: if (m->component != blank_mode.component) error ("%s:%d: (%s) field %s must not be set", m->file, m->line, m->name, "component"); case OPTIONAL: break; } } while (0);
  do { switch (r_ncomponents) { case SET: if (m->ncomponents == blank_mode.ncomponents) error ("%s:%d: (%s) field %s must be set", m->file, m->line, m->name, "ncomponents"); break; case UNSET: if (m->ncomponents != blank_mode.ncomponents) error ("%s:%d: (%s) field %s must not be set", m->file, m->line, m->name, "ncomponents"); case OPTIONAL: break; } } while (0);
  do { switch (r_format) { case SET: if (m->format == blank_mode.format) error ("%s:%d: (%s) field %s must be set", m->file, m->line, m->name, "format"); break; case UNSET: if (m->format != blank_mode.format) error ("%s:%d: (%s) field %s must not be set", m->file, m->line, m->name, "format"); case OPTIONAL: break; } } while (0);
}
...
complete_mode (struct mode_data *m)
{
 ...
 m->precision = m->ncomponents * m->component->precision;
    ...
    default:
      (fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c", 400, __FUNCTION__));
    }
...
complete_all_modes (void)
{
  ...
  for (cl = 0; cl < MAX_MODE_CLASS; cl++) for (m = modes[cl]; m; m = m->next)
    complete_mode (m);
}
...
# 570 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
static void
...
# 606 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
static void
...
# 783 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
...
create_modes (void)
{
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def" 1
# 189 "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def"
make_special_mode (MODE_RANDOM, "VOID", "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 189);



make_special_mode (MODE_RANDOM, "BLK", "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 193);


make_int_mode ("BI", 1, 1, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 196);
...
make_int_mode ("QI", -1U, 1, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 204);
make_int_mode ("HI", -1U, 2, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 205);
make_int_mode ("SI", -1U, 4, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 206);
make_int_mode ("DI", -1U, 8, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 207);
make_int_mode ("TI", -1U, 16, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 208);
# 217 "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def"
make_int_n ("TI", 128, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 217);
# 226 "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def"
make_float_mode ("SF", -1U, 4, "ieee_single_format", "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 226);
make_float_mode ("DF", -1U, 8, "ieee_double_format", "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 227);



make_special_mode (MODE_CC, "CC", "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 231);


make_fixed_point_mode (MODE_FRACT, "QQ", 1, 0, 7, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 234);
make_fixed_point_mode (MODE_FRACT, "HQ", 2, 0, 15, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 235);
make_fixed_point_mode (MODE_FRACT, "SQ", 4, 0, 31, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 236);
make_fixed_point_mode (MODE_FRACT, "DQ", 8, 0, 63, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 237);
make_fixed_point_mode (MODE_FRACT, "TQ", 16, 0, 127, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 238);

make_fixed_point_mode (MODE_UFRACT, "UQQ", 1, 0, 8, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 240);
make_fixed_point_mode (MODE_UFRACT, "UHQ", 2, 0, 16, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 241);
make_fixed_point_mode (MODE_UFRACT, "USQ", 4, 0, 32, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 242);
make_fixed_point_mode (MODE_UFRACT, "UDQ", 8, 0, 64, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 243);
make_fixed_point_mode (MODE_UFRACT, "UTQ", 16, 0, 128, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 244);

make_fixed_point_mode (MODE_ACCUM, "HA", 2, 8, 7, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 246);
make_fixed_point_mode (MODE_ACCUM, "SA", 4, 16, 15, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 247);
make_fixed_point_mode (MODE_ACCUM, "DA", 8, 32, 31, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 248);
make_fixed_point_mode (MODE_ACCUM, "TA", 16, 64, 63, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 249);

make_fixed_point_mode (MODE_UACCUM, "UHA", 2, 8, 8, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 251);
make_fixed_point_mode (MODE_UACCUM, "USA", 4, 16, 16, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 252);
make_fixed_point_mode (MODE_UACCUM, "UDA", 8, 32, 32, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 253);
make_fixed_point_mode (MODE_UACCUM, "UTA", 16, 64, 64, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 254);



# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def" 1
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def"
make_float_mode ("XF", 80, 12, "ieee_extended_intel_96_format", "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 24);
make_float_mode ("TF", -1U, 16, "ieee_quad_format", "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 25);



new_adjust ("XF", &adj_format, "format", "(TARGET_128BIT_LONG_DOUBLE ? &ieee_extended_intel_128_format : TARGET_96_ROUND_53_LONG_DOUBLE ? &ieee_extended_intel_96_round_53_format : &ieee_extended_intel_96_format)", MODE_FLOAT, MODE_FLOAT, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 29)



                                       ;
new_adjust ("XF", &adj_bytesize, "bytesize", "TARGET_128BIT_LONG_DOUBLE ? 16 : 12", MODE_RANDOM, MODE_RANDOM, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 34);
new_adjust ("XF", &adj_alignment, "alignment", "TARGET_128BIT_LONG_DOUBLE ? 16 : 4", MODE_RANDOM, MODE_RANDOM, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 35);
# 65 "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def"
make_special_mode (MODE_CC, "CCGC", "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 65);
make_special_mode (MODE_CC, "CCGOC", "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 66);
make_special_mode (MODE_CC, "CCNO", "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 67);
make_special_mode (MODE_CC, "CCGZ", "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 68);
make_special_mode (MODE_CC, "CCA", "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 69);
make_special_mode (MODE_CC, "CCC", "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 70);
make_special_mode (MODE_CC, "CCO", "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 71);
make_special_mode (MODE_CC, "CCP", "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 72);
make_special_mode (MODE_CC, "CCS", "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 73);
make_special_mode (MODE_CC, "CCZ", "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 74);

make_special_mode (MODE_CC, "CCFP", "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 76);



make_vector_modes (MODE_INT, "V", 4, 0, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 80);
make_vector_modes (MODE_INT, "V", 8, 0, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 81);
make_vector_modes (MODE_INT, "V", 16, 0, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 82);
make_vector_modes (MODE_INT, "V", 32, 0, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 83);
make_vector_modes (MODE_INT, "V", 64, 0, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 84);
make_vector_modes (MODE_INT, "V", 128, 0, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 85);
make_vector_modes (MODE_FLOAT, "V", 8, 0, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 86);
make_vector_modes (MODE_FLOAT, "V", 16, 0, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 87);
make_vector_modes (MODE_FLOAT, "V", 32, 0, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 88);
make_vector_modes (MODE_FLOAT, "V", 64, 0, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 89);
make_vector_modes (MODE_FLOAT, "V", 128, 0, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 90);
make_vector_modes (MODE_FLOAT, "V", 256, 0, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 91);
make_vector_mode (MODE_INT, "TI", 1, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 92);;
make_vector_mode (MODE_INT, "DI", 1, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 93);;
make_vector_mode (MODE_INT, "SI", 1, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 94);;
make_vector_mode (MODE_INT, "QI", 2, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 95);;
make_vector_mode (MODE_INT, "QI", 12, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 96);;
make_vector_mode (MODE_INT, "QI", 14, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 97);;
make_vector_mode (MODE_INT, "HI", 6, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 98);;
make_vector_mode (MODE_INT, "SI", 64, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 99);;

make_int_mode ("OI", -1U, 32, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 101);
make_int_mode ("XI", -1U, 64, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 102);




make_partial_integer_mode ("HI", "P2QI", 16, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 107);
make_partial_integer_mode ("SI", "P2HI", 32, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 108);
...
make_partial_integer_mode ("OI", "POI", 160, "/home/giulianob/gcc_git_gnu/gcc/gcc/config/i386/i386-modes.def", 116);
# 259 "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def" 2



make_complex_modes (MODE_INT, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 262);
make_complex_modes (MODE_PARTIAL_INT, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 263);
make_complex_modes (MODE_FLOAT, "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 264);


make_decimal_float_mode ("SD", -1U, 4, "decimal_single_format", "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 267);
make_decimal_float_mode ("DD", -1U, 8, "decimal_double_format", "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 268);
make_decimal_float_mode ("TD", -1U, 16, "decimal_quad_format", "/home/giulianob/gcc_git_gnu/gcc/gcc/machmode.def", 269);
# 791 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c" 2
...
# 832 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
static int
...
calc_wider_mode (void)
{
  ...
  for (c = 0; c < MAX_MODE_CLASS; c++)
    max_n_modes = ((max_n_modes) > (n_modes[c]) ? (max_n_modes) : (n_modes[c]));



  sortbuf = ((struct mode_data * *) __builtin_alloca(sizeof (struct mode_data *) * (max_n_modes + 1)));
...
# 967 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
static void
emit_max_int (void)
{
...
# 1041 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
          adj_nunits || adj_bytesize ? "" : "const ");

  for (c = 0; c < MAX_MODE_CLASS; c++) for (m = modes[c]; m; m = m->next)
    if (!m->need_bytesize_adj)
      printf ("    case E_%smode: return %u;\n", m->name, m->bytesize);

  puts ("    default: return mode_size[mode];\n    }\n}\n");
...
# 1074 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
          adj_nunits ? "" : "const ");
  ...
  puts ("    default: return mode_nunits[mode];\n    }\n}\n");
...
# 1107 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
  for (c = 0; c < MAX_MODE_CLASS; c++) for (m = modes[c]; m; m = m->next)
    printf ("    case E_%smode: return E_%smode;\n", m->name,
     c != MODE_PARTIAL_INT && m->component
     ? m->component->name : m->name);

  puts ("    default: return mode_inner[mode];\n    }\n}\n");
...
# 1140 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
  for (c = 0; c < MAX_MODE_CLASS; c++) for (m = modes[c]; m; m = m->next)
    {
 ...
 printf ("    case E_%smode: return %u;\n", name, m2->bytesize);
  ...
  puts ("    default: return mode_unit_size[mode];\n    }\n}\n");
...
# 1177 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
  for (c = 0; c < MAX_MODE_CLASS; c++) for (m = modes[c]; m; m = m->next)
    {
      struct mode_data *m2
 ...
 printf ("    case E_%smode: return %u*BITS_PER_UNIT;\n",
  ...
  puts ("    default: return mode_unit_precision[mode];\n    }\n}\n");
...
emit_mode_class (void)
{
  ...
  for (c = 0; c < MAX_MODE_CLASS; c++) for (m = modes[c]; m; m = m->next)
    do { int count_ = printf ("  " "%s" ",", mode_class_names[m->cl]); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0);
...
emit_mode_precision (void)
{
  ...
  printf ("\n" "%spoly_uint16_pod" " " "mode_precision" "[" "NUM_MACHINE_MODES" "] = \n{\n", adj_nunits ? "" : "const ")
                                     ;

  for (c = 0; c < MAX_MODE_CLASS; c++) for (m = modes[c]; m; m = m->next)
    if (m->precision != (unsigned int)-1)
      do { int count_ = printf ("  " "{ %u" "" " }" ",", m->precision); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0);
    else
      do { int count_ = printf ("  " "{ %u * BITS_PER_UNIT" "" " }" ",", m->bytesize); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0)
                            ;
...
emit_mode_size (void)
{
  ...
  printf ("\n" "%spoly_uint16_pod" " " "mode_size" "[" "NUM_MACHINE_MODES" "] = \n{\n", adj_nunits || adj_bytesize ? "" : "const ")
                                                     ;

  for (c = 0; c < MAX_MODE_CLASS; c++) for (m = modes[c]; m; m = m->next)
    do { int count_ = printf ("  " "{ %u" "" " }" ",", m->bytesize); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0);
...
emit_mode_nunits (void)
{
  ...
  printf ("\n" "%spoly_uint16_pod" " " "mode_nunits" "[" "NUM_MACHINE_MODES" "] = \n{\n", adj_nunits ? "" : "const ")
                                     ;

  for (c = 0; c < MAX_MODE_CLASS; c++) for (m = modes[c]; m; m = m->next)
    do { int count_ = printf ("  " "{ %u" "" " }" ",", m->ncomponents); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0);
...
emit_mode_wider (void)
{
  ...
  for (c = 0; c < MAX_MODE_CLASS; c++) for (m = modes[c]; m; m = m->next)
    do { int count_ = printf ("  " "E_%smode" ",", m->wider ? m->wider->name : void_mode->name); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0)
    ...
    m2 = m2->wider)
 {
  ...
  continue;
   ...
   break;
      ...
      if (m2 == void_mode)
 m2 = 0;
      do { int count_ = printf ("  " "E_%smode" ",", m2 ? m2->name : void_mode->name); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0)
...
emit_mode_complex (void)
{
  ...
  for (c = 0; c < MAX_MODE_CLASS; c++) for (m = modes[c]; m; m = m->next)
    do { int count_ = printf ("  " "E_%smode" ",", m->complex ? m->complex->name : void_mode->name); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0)
...
emit_mode_mask (void)
{
  ...
  for (c = 0; c < MAX_MODE_CLASS; c++) for (m = modes[c]; m; m = m->next)
    if (m->precision != (unsigned int)-1)
      do { int count_ = printf ("  " "MODE_MASK (%u)" ",", m->precision); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0);
    else
      do { int count_ = printf ("  " "MODE_MASK (%u*BITS_PER_UNIT)" ",", m->bytesize); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0);
...
emit_mode_inner (void)
{
  ...
  for (c = 0; c < MAX_MODE_CLASS; c++) for (m = modes[c]; m; m = m->next)
    do { int count_ = printf ("  " "E_%smode" ",", c != MODE_PARTIAL_INT && m->component ? m->component->name : m->name); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0)
...
emit_mode_unit_size (void)
{
  ...
  printf ("\n" "%sunsigned char" " " "mode_unit_size" "[" "NUM_MACHINE_MODES" "] = \n{\n", adj_bytesize ? "" : "const ")
                                       ;

  for (c = 0; c < MAX_MODE_CLASS; c++) for (m = modes[c]; m; m = m->next)
    do { int count_ = printf ("  " "%u" ",", c != MODE_PARTIAL_INT && m->component ? m->component->bytesize : m->bytesize); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0)
  ...
  for (c = 0; c < MAX_MODE_CLASS; c++) for (m = modes[c]; m; m = m->next)
    {
      struct mode_data *m2 = (c != MODE_PARTIAL_INT && m->component) ?
        m->component : m;
      if (m2->precision != (unsigned int)-1)
 do { int count_ = printf ("  " "%u" ",", m2->precision); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0);
      else
 do { int count_ = printf ("  " "%u*BITS_PER_UNIT" ",", m2->bytesize); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0);
    }
...
emit_mode_base_align (void)
{
  ...
  printf ("\n" "%sunsigned short" " " "mode_base_align" "[" "NUM_MACHINE_MODES" "] = \n{\n", adj_alignment ? "" : "const ")

                   ;

  for (c = 0; c < MAX_MODE_CLASS; c++) for (m = modes[c]; m; m = m->next)
    do { int count_ = printf ("  " "%u" ",", m->alignment); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0);
...
emit_class_narrowest_mode (void)
{
  ...
  for (c = 0; c < MAX_MODE_CLASS; c++)
    ...
    do { int count_ = printf ("  " "MIN_%s" ",", mode_class_names[c]); printf ("%*s/* %s */\n", 27 - count_, "", modes[c] ? ((c != MODE_INT || modes[c]->precision != 1) ? modes[c]->name : (modes[c]->next ? modes[c]->next->name : void_mode->name)) : void_mode->name); } while (0)
...
{
  struct mode_data *m;
# 1672 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
  ...
  for (m = modes[MODE_FLOAT]; m; m = m->next)
    if (!strcmp (m->format, "0"))
      do { int count_ = printf ("  " "%s" ",", m->format); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0);
    else
      do { int count_ = printf ("  " "&%s" ",", m->format); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0);
...
emit_mode_ibit (void)
{
  ...
  printf ("\n" "%sunsigned char" " " "mode_ibit" "[" "NUM_MACHINE_MODES" "] = \n{\n", adj_ibit ? "" : "const ")

              ;

  for (c = 0; c < MAX_MODE_CLASS; c++) for (m = modes[c]; m; m = m->next)
    do { int count_ = printf ("  " "%u" ",", m->ibit); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0);
...
emit_mode_fbit (void)
{
  ...
  printf ("\n" "%sunsigned char" " " "mode_fbit" "[" "NUM_MACHINE_MODES" "] = \n{\n", adj_fbit ? "" : "const ")

              ;

  for (c = 0; c < MAX_MODE_CLASS; c++) for (m = modes[c]; m; m = m->next)
    do { int count_ = printf ("  " "%u" ",", m->fbit); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0);
...
emit_mode_int_n (void)
{
  ...
  for (c = 0; c < MAX_MODE_CLASS; c++) for (m = modes[c]; m; m = m->next)
    if (m->int_n)
      n_modes ++;
  mode_sort = ((struct mode_data * *) __builtin_alloca(sizeof (struct mode_data *) * (n_modes)));
  ...
  for (i = 0; i < n_modes; i ++)
    {
      m = mode_sort[i];
      printf(" {\n");
      do { int count_ = printf ("  " "%u" ",", m->int_n); printf ("%*s/* %s */\n", 27 - count_, "", m->name); } while (0);
...
main (int argc, char **argv)
{
  ...
  if (argc == 1)
  ...
  else
    {
      ...
      return 
# 1988 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c" 3 4
            1
# 1988 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
                           ;
    }
  ...
  if (have_error)
    return 
# 1997 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c" 3 4
          1
# 1997 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
                         ;
  ...
  if (fflush_unlocked (
# 2010 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c" 3 4
     stdout
# 2010 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
     ) || fclose (
# 2010 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c" 3 4
                                stdout
# 2010 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
    ...
    return 
# 2011 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c" 3 4
          1
# 2011 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
                         ;
  return 
# 2012 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c" 3 4
        0
# 2012 "/home/giulianob/gcc_git_gnu/gcc/gcc/genmodes.c"
                         ;
}
