# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c" 2
...
extern Mem mem;
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/aggregate.h" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c" 2
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c" 2
...
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c" 2
...
int isConst(Expression *e)
{
    ...
    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 60, __FUNCTION__), 0 : 0));
    return 0;
}
# 72 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c"
UnionExp Neg(Type *type, Expression *e1)
{
    UnionExp ue;
    Loc loc = e1->loc;
...
UnionExp Add(Loc loc, Type *type, Expression *e1, Expression *e2)
{
    ...
    else if (type->iscomplex())
    {
        ...
        case 6 + 2:
            ...
            break;
        default:
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 211, __FUNCTION__), 0 : 0));
        }
...
UnionExp Min(Loc loc, Type *type, Expression *e1, Expression *e2)
{
    ...
    else if (type->iscomplex())
    {
        ...
        case 6 + 2:
            ...
            break;
        default:
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 321, __FUNCTION__), 0 : 0));
        }
        new(&ue) ComplexExp(loc, v, type);
    }
    else if (e1->op == TOKsymoff)
...
UnionExp Mul(Loc loc, Type *type, Expression *e1, Expression *e2)
{
    ...
    if (type->isfloating())
    {
        ...
        if (type->isreal())
            ...
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 381, __FUNCTION__), 0 : 0));
    }
    else
    {
        new(&ue) IntegerExp(loc, e1->toInteger() * e2->toInteger(), type);
...
UnionExp Div(Loc loc, Type *type, Expression *e1, Expression *e2)
{
    ...
    if (type->isfloating())
    {
        ...
        if (type->isreal())
            ...
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 430, __FUNCTION__), 0 : 0));
    }
    else
    {
        sinteger_t n1;
        ...
        if (n2 == -1 && !type->isunsigned())
        {
            ...
            else if ((dinteger_t)n1 == 0x8000000000000000LL)
            {
...
UnionExp Mod(Loc loc, Type *type, Expression *e1, Expression *e2)
{
    ...
    if (type->isfloating())
    {
        ...
        else if (e2->type->isimaginary())
        {
            ...
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 500, __FUNCTION__), 0 : 0));
        ...
        if (type->isreal())
            ...
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 509, __FUNCTION__), 0 : 0));
    }
    else
    {
        sinteger_t n1;
...
UnionExp Shr(Loc loc, Type *type, Expression *e1, Expression *e2)
{
    ...
    ((void)(!(dcount <= 0xFFFFFFFF) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 649, __FUNCTION__), 0 : 0));
    ...
    switch (e1->type->toBasetype()->ty)
    {
        ...
        default:
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 693, __FUNCTION__), 0 : 0));
    }
...
UnionExp Ushr(Loc loc, Type *type, Expression *e1, Expression *e2)
{
    ...
    dinteger_t value = e1->toInteger();
    dinteger_t dcount = e2->toInteger();
    ((void)(!(dcount <= 0xFFFFFFFF) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 704, __FUNCTION__), 0 : 0));
    unsigned count = (unsigned)dcount;
    switch (e1->type->toBasetype()->ty)
    {
        case Tint8:
        ...
        default:
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 738, __FUNCTION__), 0 : 0));
    }
    new(&ue) IntegerExp(loc, value, type);
    return ue;
}
...
UnionExp Equal(TOK op, Loc loc, Type *type, Expression *e1, Expression *e2)
{
    ...
    ((void)(!(op == TOKequal || op == TOKnotequal) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 776, __FUNCTION__), 0 : 0));
    ...
    else if (e1->op == TOKstring && e2->op == TOKstring)
    {
        ...
        if (es1->sz != es2->sz)
        {
            ((void)(!(global.errors) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 823, __FUNCTION__), 0 : 0));
            new(&ue) CTFEExp(TOKcantexp);
            return ue;
        }
        if (es1->len == es2->len &&
...
UnionExp Cmp(TOK op, Loc loc, Type *type, Expression *e1, Expression *e2)
{
    ...
    if (e1->op == TOKstring && e2->op == TOKstring)
    {
        ...
        StringExp *es2 = (StringExp *)e2;
        size_t sz = es1->sz;
        ((void)(!(sz == es2->sz) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1042, __FUNCTION__), 0 : 0));
    ...
    {
        ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1073, __FUNCTION__), 0 : 0));
    }
    else
    {
        sinteger_t n1;
...
L1:
        ...
        if (e1->type->isfloating())
        {
            ...
            switch (typeb->ty)
            {
                ...
                case Tuns64:
                    ...
                    break;
                default:
                    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1196, __FUNCTION__), 0 : 0));
            }
    ...
    else if (tb->ty == Tstruct && e1->op == TOKint64)
    {
        ...
        ((void)(!(sd) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1236, __FUNCTION__), 0 : 0));
...
UnionExp Index(Type *type, Expression *e1, Expression *e2)
{
    ...
    ((void)(!(e1->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1308, __FUNCTION__), 0 : 0));
...
UnionExp Slice(Type *type, Expression *e1, Expression *lwr, Expression *upr)
{
            ...
            !hasSideEffect(e1))
    {
        ...
        new(&ue) CTFEExp(TOKcantexp);
    ((void)(!(ue.exp()->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1465, __FUNCTION__), 0 : 0));
    return ue;
}
...
void sliceAssignArrayLiteralFromString(ArrayLiteralExp *existingAE, StringExp *newval, size_t firstIndex)
{
    ...
    for (size_t j = 0; j < newlen; j++)
    {
        ...
        switch (sz)
        {
            ...
            default: ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1486, __FUNCTION__), 0 : 0)); break;
        }
...
void sliceAssignStringFromArrayLiteral(StringExp *existingSE, ArrayLiteralExp *newae, size_t firstIndex)
{
    ...
    for (size_t j = 0; j < newae->elements->length; j++)
    {
        ...
        switch (existingSE->sz)
        {
            ...
            default: ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1507, __FUNCTION__), 0 : 0)); break;
        }
    }
}
...
void sliceAssignStringFromString(StringExp *existingSE, StringExp *newstr, size_t firstIndex)
{
    ...
    ((void)(!(sz == newstr->sz) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1519, __FUNCTION__), 0 : 0));
...
int sliceCmpStringWithString(StringExp *se1, StringExp *se2, size_t lo1, size_t lo2, size_t len)
{
    ...
    void *s2 = se2->string;
    size_t sz = se1->sz;
    ((void)(!(sz == se2->sz) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1531, __FUNCTION__), 0 : 0));
...
int sliceCmpStringWithArray(StringExp *se1, ArrayLiteralExp *ae2, size_t lo1, size_t lo2, size_t len)
{
    ...
    for (size_t j = 0; j < len; j++)
    {
        ...
        switch (sz)
        {
            ...
            default: ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1552, __FUNCTION__), 0 : 0)); break;
        }
        int c = val1 - val2;
        if (c)
            return c;
...
UnionExp Cat(Type *type, Expression *e1, Expression *e2)
{
    ...
    else if ((e1->op == TOKint64 || e1->op == TOKstructliteral) && e2->op == TOKnull)
    {
     ...
     L2:
        ...
        ((void)(!(ue.exp()->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1619, __FUNCTION__), 0 : 0));
        return ue;
    }
    else if (e1->op == TOKnull && e2->op == TOKnull)
    {
        if (type == e1->type)
        {
            ...
            if (t1->ty == Tarray && t2 == t1->nextOf())
            {
                ...
                ((void)(!(ue.exp()->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1630, __FUNCTION__), 0 : 0));
                return ue;
            }
            else
            {
                new(&ue) UnionExp(e1);
                ((void)(!(ue.exp()->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1636, __FUNCTION__), 0 : 0));
                return ue;
            }
        }
        if (type == e2->type)
        {
            new(&ue) UnionExp(e2);
            ((void)(!(ue.exp()->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1643, __FUNCTION__), 0 : 0));
            return ue;
        }
        new(&ue) NullExp(e1->loc, type);
        ((void)(!(ue.exp()->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1647, __FUNCTION__), 0 : 0));
        return ue;
    }
    else if (e1->op == TOKstring && e2->op == TOKstring)
    {
        ...
        if (sz != es2->sz)
        {
            ...
            ((void)(!(global.errors) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1663, __FUNCTION__), 0 : 0));
            new(&ue) CTFEExp(TOKcantexp);
            ((void)(!(ue.exp()->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1665, __FUNCTION__), 0 : 0));
            return ue;
        }
        void *s = mem.xmalloc((len + 1) * sz);
        ...
        es->type = type;
        ((void)(!(ue.exp()->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1680, __FUNCTION__), 0 : 0));
        return ue;
    }
        ...
        t1->nextOf()->isintegral())
    {
        ...
        ((void)(!(ue.exp()->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1699, __FUNCTION__), 0 : 0));
        return ue;
    }
    else if (e1->op == TOKstring && e2->op == TOKarrayliteral &&
        t2->nextOf()->isintegral())
    {
        ...
        ((void)(!(ue.exp()->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1718, __FUNCTION__), 0 : 0));
        return ue;
    }
    else if (e1->op == TOKstring && e2->op == TOKint64)
    {
        ...
        es->committed = es1->committed;
        es->type = type;
        ((void)(!(ue.exp()->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1750, __FUNCTION__), 0 : 0));
        return ue;
    }
    else if (e1->op == TOKint64 && e2->op == TOKstring)
    {
        ...
        es->type = type;
        ((void)(!(ue.exp()->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1775, __FUNCTION__), 0 : 0));
        return ue;
    }
    else if (e1->op == TOKarrayliteral && e2->op == TOKarrayliteral &&
        t1->nextOf()->equals(t2->nextOf()))
    {
        ...
        if (type->toBasetype()->ty == Tsarray)
        {
            ...
            e->type = type;
        ((void)(!(ue.exp()->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1793, __FUNCTION__), 0 : 0));
        return ue;
    }
        ...
        t1->nextOf()->equals(t2->nextOf()))
    {
     ...
     L3:
        ...
        if (type->toBasetype()->ty == Tsarray)
        {
            ...
            e->type = type;
        ((void)(!(ue.exp()->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1819, __FUNCTION__), 0 : 0));
        return ue;
    }
        ...
        e1->type->toBasetype()->nextOf()->equals(e2->type))
    {
        ...
        if (type->toBasetype()->ty == Tsarray)
        {
            ...
            e->type = type;
        ((void)(!(ue.exp()->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1839, __FUNCTION__), 0 : 0));
        return ue;
    }
    else if (e2->op == TOKarrayliteral &&
        e2->type->toBasetype()->nextOf()->equals(e1->type))
    {
        ...
        if (type->toBasetype()->ty == Tsarray)
        {
            ...
            e->type = type;
        ((void)(!(ue.exp()->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1856, __FUNCTION__), 0 : 0));
        return ue;
    }
    ...
    else if (e1->op == TOKstring && e2->op == TOKnull)
    {
      ...
      L1:
        ...
        new(&ue) CTFEExp(TOKcantexp);
    ((void)(!(ue.exp()->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/constfold.c", 1893, __FUNCTION__), 0 : 0));
    return ue;
}
