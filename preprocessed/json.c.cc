# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c"
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c"
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c" 2
...
extern Mem mem;
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.h" 1
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.h"
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c" 2
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c" 2
...
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c" 2
# 1 "d/id.h" 1
...
# 30 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c" 2
...
# 31 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c" 2
...
public:
    ...
    void property(const char *name, TRUST trust)
    {
        switch (trust)
        {
            ...
            case TRUSTsafe:
                ...
                break;
            default:
                ((void)(!(false) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c", 276, __FUNCTION__), 0 : 0));
        }
    }
    ...
    void property(const char *name, PURE purity)
    {
        switch (purity)
        {
            ...
            case PUREfwdref:
                ...
                break;
            default:
                ((void)(!(false) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c", 301, __FUNCTION__), 0 : 0));
        }
    }
    ...
    void property(const char *name, LINK linkage)
    {
        switch (linkage)
        {
            ...
            case LINKpascal:
                ...
                break;
            default:
                ((void)(!(false) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c", 330, __FUNCTION__), 0 : 0));
        }
    }
    ...
    void propertyStorageClass(const char *name, StorageClass stc)
    {
        ...
        if (stc)
        {
            ...
            while (stc)
            {
                ...
                ((void)(!(p) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/json.c", 345, __FUNCTION__), 0 : 0));
                item(p);
            }
    ...
    void jsonProperties(TemplateDeclaration *td)
    {
        ...
        if (td->onemember && td->onemember->isCtorDeclaration())
            ...
            property("name", td->ident->toChars());
    }
    ...
    void visit(VarDeclaration *d)
    {
        ...
        if (d->alignment && d->alignment != ((structalign_t) ~0))
