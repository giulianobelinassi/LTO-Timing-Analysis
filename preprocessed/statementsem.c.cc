# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c"
# 10 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c"
...
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
...
extern Mem mem;
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
# 1 "d/id.h" 1
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
...
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
...
# 30 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 2
            ...
            if (s)
            {
                ...
                if (s)
                {
                    ...
                    if (sexception)
                    {
                        ...
                        {
# 174 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c"
    ...
    void visit(ScopeStatement *ss)
    {
        ...
        if (ss->statement)
        {
            ...
            if (ss->statement)
            {
                ...
                ((void)(!(!sentry) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 336, __FUNCTION__), 0 : 0));
                ((void)(!(!sexception) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 337, __FUNCTION__), 0 : 0));
                if (sfinally)
                {
    ...
    {
        ((void)(!(ss->sym) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 353, __FUNCTION__), 0 : 0));
        for (Scope *csc = sc; !ss->sym->forward; csc = csc->enclosing)
        {
            ((void)(!(csc) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 356, __FUNCTION__), 0 : 0));
    ...
    void visit(DoStatement *ds)
    {
        ...
        ds->condition = ds->condition->optimize(0);
    ...
    void visit(ForStatement *fs)
    {
        ...
        if (fs->_init)
        {
# 429 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c"
        ...
        ((void)(!(fs->_init == nullptr) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 445, __FUNCTION__), 0 : 0));
        ...
        if (fs->condition)
        {
            ...
            fs->condition = fs->condition->optimize(0);
        ...
        if (fs->increment)
        {
            ...
            fs->increment = fs->increment->optimize(0);
...
# 509 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c"
    ...
    {
        Loc loc = fs->loc;
        if (storageClass & (0x1000LL | 0x2000LL) ||
            (storageClass & 0x200000LL && !te))
        {
        ...
        if (e)
        {
            ...
            Dsymbol *ds = nullptr;
            if (!(storageClass & 0x800000LL))
            {
                if ((isStatic || tb->ty == Tfunction || tb->ty == Tsarray || storageClass & 0x10000000LL) && e->op == TOKvar)
                    ds = ((VarExp *)e)->var;
            ...
            else if (storageClass & 0x10000000LL)
            {
            ...
            else
            {
                ...
                if (storageClass & 0x200000LL)
                    v->storage_class |= 0x200000LL | 0x4000LL;
                if (isStatic || storageClass & 0x800000LL || e->isConst() ||
                    e->op == TOKstring ||
        ...
        if (isStatic)
            var->storage_class |= 0x8000000000000LL;
        if (statements)
            statements->push(new ExpStatement(loc, var));
        else if (declarations)
            declarations->push(var);
        else
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 617, __FUNCTION__), 0 : 0));
        return true;
    }
        ...
        Statements *statements, Dsymbols *declarations, Dsymbols *dbody)
    {
        ...
        if (!needExpansion && dim == 2)
        {
            ...
            if (p->storageClass & (0x1000LL | 0x200000LL | 0x2000LL))
            {
        ...
        else
        {
            ...
            ((void)(!(e && !t) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 695, __FUNCTION__), 0 : 0));
            ...
            for (size_t l = 0; l < dim; l++)
            {
                ...
                ((void)(!(init_->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 710, __FUNCTION__), 0 : 0));
                declareVariable(fs, paramtype, te, needExpansion, isStatic, stmts, decls,
        ...
        if (statements)
            ...
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 745, __FUNCTION__), 0 : 0));
        return true;
    }
# 771 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c"
                          ...
                          Statements *statements, Dsymbols *declarations, Dsymbols *dbody)
    {
        ...
        else if (fs->aggr->op == TOKtype)
        {
            n = Parameter::dim(tuple->arguments);
        }
        else
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 805, __FUNCTION__), 0 : 0));
    ...
    {
        ((void)(!(sc) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 819, __FUNCTION__), 0 : 0));
    ...
    {
        Loc loc = fs->loc;
        ((void)(!(sc) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 830, __FUNCTION__), 0 : 0));
    ...
    void visit(ForeachStatement *fs)
    {
            ...
            fs->aggr->op != TOKtype && !fs->aggr->isLvalue())
        {
            ...
            vinit = copyToTemp(0x20000000000LL, "__aggr", fs->aggr);
            vinit->semantic(sc);
            ...
            case Tsarray:
                {
                    ...
                    for (size_t i = 0; i < dim; i++)
                    {
                        ...
                        if (dim == 2 && i == 0)
                        {
                            ...
                            var->storage_class |= 0x10000000000LL | 0x4000LL;
                            if (var->storage_class & (0x200000LL | 0x1000LL))
                                var->storage_class |= 0x1000000LL;
                        ...
                        else
                        {
                            ...
                            var->storage_class |= 0x4000LL;
                            var->storage_class |= p->storageClass & (0x800LL | 0x1000LL | 0x200000LL | (4LL | 0x100000LL | 0x20000000LL | 0x80000000LL));
                            if (var->storage_class & (0x200000LL | 0x1000LL))
                                var->storage_class |= 0x1000000LL;

                            fs->value = var;
                            if (var->storage_class & 0x200000LL)
                            {
                                if (fs->aggr->checkModifiable(sc2, 1) == 2)
                                    var->storage_class |= 0x20000LL;
...
# 1123 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c"
                    ...
                    tmp->storage_class |= 0x10000000000LL;
                    ...
                    if (!fs->key)
                    {
                        ...
                        fs->key->storage_class |= 0x10000000000LL;
                    }
                    ...
                    {
                        Parameter *p = (*fs->parameters)[0];
                        if ((p->storageClass & 0x200000LL) && p->type->equals(fs->key->type))
                        {
                        ...
                        else
                        {
                            ...
                            v->storage_class |= 0x4000LL | (p->storageClass & 0x200000LL);
                            fs->_body = new CompoundStatement(loc, new ExpStatement(loc, v), fs->_body);
            ...
            case Tstruct:
                ...
                {
# 1260 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c"
                    ...
                    if (dim == 1)
                    {
                        ...
                        ve->storage_class |= 0x4000LL;
                        ve->storage_class |= p->storageClass & (0x800LL | 0x1000LL | 0x200000LL | (4LL | 0x100000LL | 0x20000000LL | 0x80000000LL));

                        makeargs = new ExpStatement(loc, ve);
                    }
                    else
                    {
                        VarDeclaration *vd = copyToTemp(0x200000LL, "__front", einit);
                        vd->semantic(sc);
                        ...
                        for (size_t i = 0; i < dim; i++)
                        {
                            ...
                            var->storage_class |= 0x1000000000LL | 0x200000LL | 0x4000LL;
            ...
            Lapply:
                {
                    ...
                    if (sapply)
                    {
                        ...
                        if (fdapply)
                        {
                            ((void)(!(fdapply->type && fdapply->type->ty == Tfunction) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 1426, __FUNCTION__), 0 : 0));
                        ...
                        Lget:
                            ...
                            if (tfld->parameterList.parameters->length == 1)
                            {
                                ...
                                if (p->type && p->type->ty == Tdelegate)
                                {
                                    ...
                                    ((void)(!(t->ty == Tdelegate) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 1441, __FUNCTION__), 0 : 0));
                    ...
                    for (size_t i = 0; i < dim; i++)
                    {
                        ...
                        if (tfld)
                        {
                            ...
                            stc = prm->storageClass & 0x200000LL;
                            id = p->ident;
                            if ((p->storageClass & 0x200000LL) != stc)
                            {
                                if (!stc)
                                {
                        ...
                        else if (p->storageClass & 0x200000LL)
                        {
                        ...
                        params->push(new Parameter(stc, p->type, id, nullptr));
                    }

                    StorageClass stc = mergeFuncAttrs(0x200000000LL | 0x4000000LL | 0x40000000000LL, fs->func);
                    ...
                    if (taa)
                    {
                        ...
                        Parameter *p = (*fs->parameters)[0];
                        bool isRef = (p->storageClass & 0x200000LL) != 0;
                        Type *ta = p->type;
                        if (dim == 2)
                        {
                            ...
                            p = (*fs->parameters)[1];
                            isRef = (p->storageClass & 0x200000LL) != 0;
                            ta = p->type;
                        }
...
# 1563 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c"
                        ...
                        if (!fdapply[i])
                        {
                            ...
                            params->push(new Parameter(0, Type::tvoid->pointerTo(), nullptr, nullptr));
                            params->push(new Parameter(0x800LL, Type::tsize_t, nullptr, nullptr));
                            Parameters* dgparams = new Parameters;
                            dgparams->push(new Parameter(0, Type::tvoidptr, nullptr, nullptr));
                            if (dim == 2)
                                dgparams->push(new Parameter(0, Type::tvoidptr, nullptr, nullptr));
                            fldeTy[i] = new TypeDelegate(new TypeFunction(ParameterList(dgparams),
                                                                          Type::tint32, LINKd));
                            params->push(new Parameter(0, fldeTy[i], nullptr, nullptr));
                        ...
                        if (keysize == (~(d_uns64)0))
                            goto Lerror2;
                        ((void)(!(keysize < 
# 1588 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 3 4
                       (18446744073709551615UL) 
# 1588 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c"
                       - target.ptrsize) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 1588, __FUNCTION__), 0 : 0));
                    ...
                    else if (tab->ty == Tarray || tab->ty == Tsarray)
                    {
                        ...
                        switch (tn->ty)
                        {
                            ...
                            default: ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 1622, __FUNCTION__), 0 : 0));
                        }
                        switch (tnv->ty)
                        {
                            case Tchar: flag += 0; break;
                            ...
                            default: ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 1629, __FUNCTION__), 0 : 0));
                        }
                        const char *r = (fs->op == TOKforeach_reverse) ? "R" : "";
                        int j = sprintf(fdname, "_aApply%s%.*s%llu", r, 2, fntab[flag], (ulonglong)dim);
                        ((void)(!(j < BUFFER_LEN) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 1633, __FUNCTION__), 0 : 0));

                        FuncDeclaration *fdapply;
                        TypeDelegate *dgty;
                        params = new Parameters();
                        params->push(new Parameter(0x800LL, tn->arrayOf(), nullptr, nullptr));
                        Parameters* dgparams = new Parameters;
                        dgparams->push(new Parameter(0, Type::tvoidptr, nullptr, nullptr));
                        if (dim == 2)
                            dgparams->push(new Parameter(0, Type::tvoidptr, nullptr, nullptr));
                        dgty = new TypeDelegate(new TypeFunction(ParameterList(dgparams),
                                                                 Type::tint32, LINKd));
                        params->push(new Parameter(0, dgty, nullptr, nullptr));
                    ...
                    else
                    {
                        ...
                        ((void)(!(tab->ty == Tstruct || tab->ty == Tclass) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 1687, __FUNCTION__), 0 : 0));
                        ((void)(!(sapply) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 1688, __FUNCTION__), 0 : 0));
                    ...
                    if (!fs->cases->length)
                    {
                        ...
                        e = new CastExp(loc, e, Type::tvoid);
    ...
    void visit(ForeachRangeStatement *fs)
    {
        ...
        if (fs->prm->type)
        {
            ...
            if (fs->upr->implicitConvTo(fs->prm->type) || (fs->prm->storageClass & 0x200000LL))
            {
...
# 1837 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c"
        ...
        if ((fs->prm->storageClass & 0x200000LL) && fs->prm->type->equals(fs->key->type))
        {
            fs->key->range = nullptr;
        ...
        else
        {
            ...
            v->storage_class |= 0x10000000000LL | 0x4000LL | (fs->prm->storageClass & 0x200000LL);
            fs->_body = new CompoundStatement(loc, new ExpStatement(loc, v), fs->_body);
        ...
        if (fs->prm->storageClass & 0x200000LL)
        {
    ...
    void visit(IfStatement *ifs)
    {
        ...
        if (ifs->prm)
        {
            ...
            if (ifs->match->edtor)
            {
                ...
                ifs->match->storage_class |= 0x1000000LL;
            }
        }
        else
        {
        ...
        ifs->condition = ifs->condition->optimize(0);
            ...
            if (ps->args)
            {
                for (size_t i = 0; i < ps->args->length; i++)
                {
                    ...
                    if (se)
                    {
                        se = se->toUTF8(sc);
                        fprintf(
# 2077 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 3 4
                               stderr
# 2077 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c"
                                     , "%.*s", (int)se->len, (char *)se->string);
                    }
                    else
                        fprintf(
# 2080 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 3 4
                               stderr
# 2080 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c"
                                     , "%s", e->toChars());
                }
                fprintf(
# 2082 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c" 3 4
                       stderr
# 2082 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c"
                             , "\n");
            }
        }
    ...
    void visit(SwitchStatement *ss)
    {
        ...
        ss->condition = ss->condition->optimize(0);
                ...
                if (v && (t->isintegral() || t->ty == Tclass))
                {
                    ...
                    for (Scope *scx = sc; scx; scx = scx->enclosing)
                    {
                        if (scx->enclosing && scx->enclosing->sw == sw)
                            continue;
                        ((void)(!(scx->sw == sw) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 2438, __FUNCTION__), 0 : 0));
    ...
    void visit(CaseRangeStatement *crs)
    {
        ...
        if (errors)
            return setError();
# 2587 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c"
        Statements *statements = new Statements();
    ...
    void visit(ReturnStatement *rs)
    {
        ...
        ((void)(!(tf->ty == Tfunction) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 2686, __FUNCTION__), 0 : 0));
        ...
        if (rs->exp && rs->exp->op == TOKvar && ((VarExp *)rs->exp)->var == fd->vresult)
        {
            ...
            if (sc->fes)
            {
                ((void)(!(rs->caseDim == 0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 2693, __FUNCTION__), 0 : 0));
        ...
        bool inferRef = (tf->isref && (fd->storage_class & 0x100LL));
        ...
        if (sc->fieldinit)
        {
            ...
            ((void)(!(ad) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 2947, __FUNCTION__), 0 : 0));
        ...
        if (sc->fes)
        {
            ...
            else
            {
                ...
                ((void)(!(!r) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 2990, __FUNCTION__), 0 : 0));
...
# 3129 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c"
    ...
    void visit(SynchronizedStatement *ss)
    {
        if (ss->exp)
        {
            ...
            else if (cd->isInterfaceDeclaration())
            {
                ...
                ((void)(!(t->ty == Tclass) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 3208, __FUNCTION__), 0 : 0));
            ...
            args->push(new Parameter(0, ClassDeclaration::object->type, nullptr, nullptr));
        ...
        else
        {
            ...
            VarDeclaration *tmp = new VarDeclaration(ss->loc, t, id, nullptr);
            tmp->storage_class |= 0x10000000000LL | 0x40000000LL | 1LL;
            ...
            VarDeclaration *v = new VarDeclaration(ss->loc, Type::tvoidptr, Identifier::generateId("__sync"), nullptr);
            v->semantic(sc);
            cs->push(new ExpStatement(ss->loc, v));

            Parameters* args = new Parameters;
            args->push(new Parameter(0, t->pointerTo(), nullptr, nullptr));

            FuncDeclaration *fdenter = FuncDeclaration::genCfunc(args, Type::tvoid, Id::criticalenter, 0x2000000LL);
            ...
            FuncDeclaration *fdexit = FuncDeclaration::genCfunc(args, Type::tvoid, Id::criticalexit, 0x2000000LL);
    ...
    void visit(WithStatement *ws)
    {
        ...
        else
        {
            ...
            ((void)(!(t) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 3342, __FUNCTION__), 0 : 0));
            t = t->toBasetype();
            if (t->isClassHandle())
            {
            ...
            else if (t->ty == Tstruct)
            {
                if (!ws->exp->isLvalue())
                {
# 3367 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c"
    ...
    void visit(TryCatchStatement *tcs)
    {
        ...
        ((void)(!(tcs->_body) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 3428, __FUNCTION__), 0 : 0));
    ...
    void visit(CompoundAsmStatement *cas)
    {
        ...
        for (size_t i = 0; i < cas->statements->length; i++)
        {
            ...
            (*cas->statements)[i] = s ? semantic(s, sc) : nullptr;
        }

        ((void)(!(sc->func) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 3727, __FUNCTION__), 0 : 0));

        PURE purity;
        if (!(cas->stc & 0x4000000LL) && (purity = sc->func->isPureBypassingInference()) != PUREimpure && purity != PUREfwdref)
            cas->deprecation("asm statement is assumed to be impure - mark it with 'pure' if it is not");
        if (!(cas->stc & 0x40000000000LL) && sc->func->isNogcBypassingInference())
            cas->deprecation("asm statement is assumed to use the GC - mark it with '@nogc' if it does not");
        if (!(cas->stc & (0x400000000LL|0x200000000LL)) && sc->func->setUnsafe())
    ...
    void visit(ImportStatement *imps)
    {
        for (size_t i = 0; i < imps->imports->length; i++)
        {
            ...
            ((void)(!(!s->aliasdecls.length) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/statementsem.c", 3746, __FUNCTION__), 0 : 0));
...
Statement *semanticNoScope(Statement *s, Scope *sc)
{
    ...
    {
        s = new CompoundStatement(s->loc, s);
    }
    s = semantic(s, sc);
    return s;
}
