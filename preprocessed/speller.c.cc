# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/speller.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/speller.c"
# 9 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/speller.c"
...
# 10 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/speller.c" 2
...
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/speller.c" 2

const char idchars[] = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_";
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/speller.c"
        ...
        const char *charset, size_t index, int* cost)
{
    if (!seedlen)
        return nullptr;
    ((void)(!(seed[seedlen] == 0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/speller.c", 45, __FUNCTION__), 0 : 0));
    ...
    {
        buf = (char *)__builtin_alloca(seedlen + 2);
        if (!buf)
            return nullptr;
    }
    ...
    *cost = 0x7fffffff;
    ...
    if (index < seedlen)
    {
        ...
        ((void)(!(buf[seedlen - 1] == 0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/speller.c", 67, __FUNCTION__), 0 : 0));
    ...
    if (charset && *charset)
    {
        ...
        if (index < seedlen)
        {
            ...
            ((void)(!(buf[seedlen] == 0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/speller.c", 88, __FUNCTION__), 0 : 0));
        }
        ...
        ((void)(!(buf[seedlen + 1] == 0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/speller.c", 103, __FUNCTION__), 0 : 0));
    }
...
# 219 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/speller.c"
void *speller(const char *seed, fp_speller_t fp, void *fparg, const char *charset)
{
