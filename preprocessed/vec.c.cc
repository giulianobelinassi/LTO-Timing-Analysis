# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c"
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c" 2
...
# 31 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c" 2
...
# 32 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c" 2
...
# 34 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c" 2
...
# 39 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c" 2
# 49 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c"
vnull vNULL;
...
public:
  ...
  dump (mem_location *loc, mem_usage &total) const
  {
    ...
    fprintf (
# 86 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c" 3 4
            stderr
# 86 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c"
                  ,
      "%-48s %10" 
# 87 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c" 3 4
                 "l" "u" 
# 87 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c"
                        "%" "10" 
# 87 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c" 3 4
                        "l" "u" 
# 87 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c"
...
# 88 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c"
     ":%4.1f%%" "%" "10" 
# 88 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c" 3 4
                "l" "u" 
# 88 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c"
                "%c" "%" "10" 
# 88 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c" 3 4
...
# 88 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c"
      ...
      (uint64_t)(((m_peak) < 10 * 1024 ? (m_peak) : ((m_peak) < 10 * (1024 * 1024) ? (m_peak) / 1024 : (m_peak) / (1024 * 1024)))), ((m_peak) < 10 * 1024 ? ' ' : ((m_peak) < 10 * (1024 * 1024) ? 'k' : 'M')), (uint64_t)m_times,
      m_times * 100.0 / total.m_times,
      (uint64_t)(((m_items) < 10 * 1024 ? (m_items) : ((m_items) < 10 * (1024 * 1024) ? (m_items) / 1024 : (m_items) / (1024 * 1024)))), ((m_items) < 10 * 1024 ? ' ' : ((m_items) < 10 * (1024 * 1024) ? 'k' : 'M')), (uint64_t)(((m_items_peak) < 10 * 1024 ? (m_items_peak) : ((m_items_peak) < 10 * (1024 * 1024) ? (m_items_peak) / 1024 : (m_items_peak) / (1024 * 1024)))), ((m_items_peak) < 10 * 1024 ? ' ' : ((m_items_peak) < 10 * (1024 * 1024) ? 'k' : 'M')));
  }
  ...
  {
    fprintf (
# 102 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c" 3 4
            stderr
# 102 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c"
                  , "%s" "%" "64" 
# 102 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c" 3 4
                         "l" "u" 
# 102 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c"
...
# 102 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c"
                                             "%c" "\n",
      "Total", (uint64_t)(((m_allocated) < 10 * 1024 ? (m_allocated) : ((m_allocated) < 10 * (1024 * 1024) ? (m_allocated) / 1024 : (m_allocated) / (1024 * 1024)))), ((m_allocated) < 10 * 1024 ? ' ' : ((m_allocated) < 10 * (1024 * 1024) ? 'k' : 'M')),
      (uint64_t)(((m_times) < 10 * 1024 ? (m_times) : ((m_times) < 10 * (1024 * 1024) ? (m_times) / 1024 : (m_times) / (1024 * 1024)))), ((m_times) < 10 * 1024 ? ' ' : ((m_times) < 10 * (1024 * 1024) ? 'k' : 'M')), (uint64_t)(((m_items) < 10 * 1024 ? (m_items) : ((m_items) < 10 * (1024 * 1024) ? (m_items) / 1024 : (m_items) / (1024 * 1024)))), ((m_items) < 10 * 1024 ? ' ' : ((m_items) < 10 * (1024 * 1024) ? 'k' : 'M')));
  }
  ...
  {
    fprintf (
# 111 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c" 3 4
            stderr
# 111 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c"
...
vec_prefix::calculate_allocation_1 (unsigned alloc, unsigned desired)
{
  ...
  ((void)(!(alloc < desired) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 163, __FUNCTION__), 0 : 0));
...
{
# 232 "/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c"
  size_t i1, i2, i, j;
  ...
  for (i1 = 0; i1 < n; i1 = i2)
    {
      ...
      for (i2 = i1 + 1; i2 < n; i2++)
 if (cmp (((const char *) base + (i1) * size), ((const char *) base + (i2) * size), data))
   break;
 else if (cmp (((const char *) base + (i2) * size), ((const char *) base + (i1) * size), data))
   return qsort_chk_error (((const char *) base + (i1) * size), ((const char *) base + (i2) * size), nullptr, cmp, data);
      size_t lim1 = ((i2 - i1) <= 16 ? (i2 - i1) : 12 + floor_log2 (i2 - i1)), lim2 = ((n - i2) <= 16 ? (n - i2) : 12 + floor_log2 (n - i2));

      for (i = i1 + 1; i + 1 < i2; i++)
 for (j = i + 1; j < i1 + lim1; j++)
   if (cmp (((const char *) base + (i) * size), ((const char *) base + (j) * size), data))
     return qsort_chk_error (((const char *) base + (i) * size), ((const char *) base + (i1) * size), ((const char *) base + (j) * size), cmp, data);
   else if (cmp (((const char *) base + (j) * size), ((const char *) base + (i) * size), data))
     return qsort_chk_error (((const char *) base + (i) * size), ((const char *) base + (j) * size), nullptr, cmp, data);


      for (i = i1; i < i2; i++)
 for (j = i2; j < i2 + lim2; j++)
   if (cmp (((const char *) base + (i) * size), ((const char *) base + (j) * size), data) >= 0)
     return qsort_chk_error (((const char *) base + (i) * size), ((const char *) base + (i1) * size), ((const char *) base + (j) * size), cmp, data);
   else if (cmp (((const char *) base + (j) * size), ((const char *) base + (i) * size), data) <= 0)
     return qsort_chk_error (((const char *) base + (i) * size), ((const char *) base + (j) * size), nullptr, cmp, data);
    }
...
{
  auto_vec <int> v;
  do { const char *desc_ = "ASSERT_EQ (" "(0)" ", " "(v.length ())" ")"; if (((0)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 291, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 291, __FUNCTION__)))), desc_); } while (0);
  v.reserve (3);
  do { const char *desc_ = "ASSERT_EQ (" "(0)" ", " "(v.length ())" ")"; if (((0)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 293, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 293, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_TRUE (" "(v.space (3))" ")"; bool actual_ = ((v.space (3))); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 294, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 294, __FUNCTION__))), desc_); } while (0);
  v.quick_push (5);
  v.quick_push (6);
  v.quick_push (7);
  do { const char *desc_ = "ASSERT_EQ (" "(3)" ", " "(v.length ())" ")"; if (((3)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 298, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 298, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(5)" ", " "(v[0])" ")"; if (((5)) == ((v[0]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 299, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 299, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(6)" ", " "(v[1])" ")"; if (((6)) == ((v[1]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 300, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 300, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(7)" ", " "(v[2])" ")"; if (((7)) == ((v[2]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 301, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 301, __FUNCTION__)))), desc_); } while (0);
}
...
{
  auto_vec <int> v;
  do { const char *desc_ = "ASSERT_EQ (" "(0)" ", " "(v.length ())" ")"; if (((0)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 310, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 310, __FUNCTION__)))), desc_); } while (0);
  v.safe_push (5);
  v.safe_push (6);
  v.safe_push (7);
  do { const char *desc_ = "ASSERT_EQ (" "(3)" ", " "(v.length ())" ")"; if (((3)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 314, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 314, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(5)" ", " "(v[0])" ")"; if (((5)) == ((v[0]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 315, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 315, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(6)" ", " "(v[1])" ")"; if (((6)) == ((v[1]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 316, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 316, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(7)" ", " "(v[2])" ")"; if (((7)) == ((v[2]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 317, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 317, __FUNCTION__)))), desc_); } while (0);
}
...
{
  auto_vec <int> v;
  do { const char *desc_ = "ASSERT_EQ (" "(0)" ", " "(v.length ())" ")"; if (((0)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 326, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 326, __FUNCTION__)))), desc_); } while (0);
  safe_push_range (v, 0, 10);
  do { const char *desc_ = "ASSERT_EQ (" "(10)" ", " "(v.length ())" ")"; if (((10)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 328, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 328, __FUNCTION__)))), desc_); } while (0);

  v.truncate (5);
  do { const char *desc_ = "ASSERT_EQ (" "(5)" ", " "(v.length ())" ")"; if (((5)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 331, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 331, __FUNCTION__)))), desc_); } while (0);
}
...
{
  auto_vec <int> v;
  do { const char *desc_ = "ASSERT_EQ (" "(0)" ", " "(v.length ())" ")"; if (((0)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 340, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 340, __FUNCTION__)))), desc_); } while (0);
  v.safe_grow_cleared (50);
  do { const char *desc_ = "ASSERT_EQ (" "(50)" ", " "(v.length ())" ")"; if (((50)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 342, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 342, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(0)" ", " "(v[0])" ")"; if (((0)) == ((v[0]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 343, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 343, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(0)" ", " "(v[49])" ")"; if (((0)) == ((v[49]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 344, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 344, __FUNCTION__)))), desc_); } while (0);
}
...
test_pop ()
{
  ...
  do { const char *desc_ = "ASSERT_EQ (" "(15)" ", " "(v.length ())" ")"; if (((15)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 354, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 354, __FUNCTION__)))), desc_); } while (0);

  int last = v.pop ();
  do { const char *desc_ = "ASSERT_EQ (" "(19)" ", " "(last)" ")"; if (((19)) == ((last))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 357, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 357, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(14)" ", " "(v.length ())" ")"; if (((14)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 358, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 358, __FUNCTION__)))), desc_); } while (0);
}
...
test_safe_insert ()
{
  ...
  safe_push_range (v, 0, 10);
  v.safe_insert (5, 42);
  do { const char *desc_ = "ASSERT_EQ (" "(4)" ", " "(v[4])" ")"; if (((4)) == ((v[4]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 369, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 369, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(42)" ", " "(v[5])" ")"; if (((42)) == ((v[5]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 370, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 370, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(5)" ", " "(v[6])" ")"; if (((5)) == ((v[6]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 371, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 371, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(11)" ", " "(v.length ())" ")"; if (((11)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 372, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 372, __FUNCTION__)))), desc_); } while (0);
}
...
test_ordered_remove ()
{
  ...
  safe_push_range (v, 0, 10);
  v.ordered_remove (5);
  do { const char *desc_ = "ASSERT_EQ (" "(4)" ", " "(v[4])" ")"; if (((4)) == ((v[4]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 383, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 383, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(6)" ", " "(v[5])" ")"; if (((6)) == ((v[5]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 384, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 384, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(9)" ", " "(v.length ())" ")"; if (((9)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 385, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 385, __FUNCTION__)))), desc_); } while (0);
}
...
test_ordered_remove_if (void)
{
  ...
  unsigned ix, ix2;
  int *elem_ptr;
  { ((void)(!(((v).length ()) <= ((v)).length ()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 397, __FUNCTION__), 0 : 0)); for (ix = ix2 = (0); ix < ((v).length ()); ++ix) { elem_ptr = &((v))[ix]; bool remove_p = ((*elem_ptr == 5 || *elem_ptr == 7)); if (remove_p) continue; if (ix != ix2) ((v))[ix2] = ((v))[ix]; ix2++; } if (ix - ix2 > 0) ((v)).block_remove (ix2, ix - ix2); }
                                     ;
  do { const char *desc_ = "ASSERT_EQ (" "(4)" ", " "(v[4])" ")"; if (((4)) == ((v[4]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 399, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 399, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(6)" ", " "(v[5])" ")"; if (((6)) == ((v[5]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 400, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 400, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(8)" ", " "(v[6])" ")"; if (((8)) == ((v[6]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 401, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 401, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(8)" ", " "(v.length ())" ")"; if (((8)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 402, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 402, __FUNCTION__)))), desc_); } while (0);

  v.truncate (0);
  safe_push_range (v, 0, 10);
  { ((void)(!((6) <= (v).length ()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 406, __FUNCTION__), 0 : 0)); for (ix = ix2 = (0); ix < (6); ++ix) { elem_ptr = &(v)[ix]; bool remove_p = (*elem_ptr == 5 || *elem_ptr == 7); if (remove_p) continue; if (ix != ix2) (v)[ix2] = (v)[ix]; ix2++; } if (ix - ix2 > 0) (v).block_remove (ix2, ix - ix2); }
                                      ;
  do { const char *desc_ = "ASSERT_EQ (" "(4)" ", " "(v[4])" ")"; if (((4)) == ((v[4]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 408, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 408, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(6)" ", " "(v[5])" ")"; if (((6)) == ((v[5]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 409, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 409, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(7)" ", " "(v[6])" ")"; if (((7)) == ((v[6]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 410, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 410, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(9)" ", " "(v.length ())" ")"; if (((9)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 411, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 411, __FUNCTION__)))), desc_); } while (0);

  v.truncate (0);
  safe_push_range (v, 0, 10);
  { ((void)(!((5) <= (v).length ()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 415, __FUNCTION__), 0 : 0)); for (ix = ix2 = (0); ix < (5); ++ix) { elem_ptr = &(v)[ix]; bool remove_p = (*elem_ptr == 5 || *elem_ptr == 7); if (remove_p) continue; if (ix != ix2) (v)[ix2] = (v)[ix]; ix2++; } if (ix - ix2 > 0) (v).block_remove (ix2, ix - ix2); }
                                      ;
  { ((void)(!((10) <= (v).length ()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 417, __FUNCTION__), 0 : 0)); for (ix = ix2 = (8); ix < (10); ++ix) { elem_ptr = &(v)[ix]; bool remove_p = (*elem_ptr == 5 || *elem_ptr == 7); if (remove_p) continue; if (ix != ix2) (v)[ix2] = (v)[ix]; ix2++; } if (ix - ix2 > 0) (v).block_remove (ix2, ix - ix2); }
                                      ;
  do { const char *desc_ = "ASSERT_EQ (" "(4)" ", " "(v[4])" ")"; if (((4)) == ((v[4]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 419, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 419, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(5)" ", " "(v[5])" ")"; if (((5)) == ((v[5]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 420, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 420, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(6)" ", " "(v[6])" ")"; if (((6)) == ((v[6]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 421, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 421, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(10)" ", " "(v.length ())" ")"; if (((10)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 422, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 422, __FUNCTION__)))), desc_); } while (0);

  v.truncate (0);
  safe_push_range (v, 0, 10);
  { ((void)(!(((v).length ()) <= ((v)).length ()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 426, __FUNCTION__), 0 : 0)); for (ix = ix2 = (0); ix < ((v).length ()); ++ix) { elem_ptr = &((v))[ix]; bool remove_p = ((*elem_ptr == 5)); if (remove_p) continue; if (ix != ix2) ((v))[ix2] = ((v))[ix]; ix2++; } if (ix - ix2 > 0) ((v)).block_remove (ix2, ix - ix2); };
  do { const char *desc_ = "ASSERT_EQ (" "(4)" ", " "(v[4])" ")"; if (((4)) == ((v[4]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 427, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 427, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(6)" ", " "(v[5])" ")"; if (((6)) == ((v[5]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 428, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 428, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(7)" ", " "(v[6])" ")"; if (((7)) == ((v[6]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 429, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 429, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(9)" ", " "(v.length ())" ")"; if (((9)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 430, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 430, __FUNCTION__)))), desc_); } while (0);
}
...
test_unordered_remove ()
{
  ...
  do { const char *desc_ = "ASSERT_EQ (" "(9)" ", " "(v.length ())" ")"; if (((9)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 441, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 441, __FUNCTION__)))), desc_); } while (0);
}
...
test_block_remove ()
{
  ...
  safe_push_range (v, 0, 10);
  v.block_remove (5, 3);
  do { const char *desc_ = "ASSERT_EQ (" "(3)" ", " "(v[3])" ")"; if (((3)) == ((v[3]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 452, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 452, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(4)" ", " "(v[4])" ")"; if (((4)) == ((v[4]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 453, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 453, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(8)" ", " "(v[5])" ")"; if (((8)) == ((v[5]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 454, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 454, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(9)" ", " "(v[6])" ")"; if (((9)) == ((v[6]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 455, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 455, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(7)" ", " "(v.length ())" ")"; if (((7)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 456, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 456, __FUNCTION__)))), desc_); } while (0);
}
...
test_qsort ()
{
  ...
  safe_push_range (v, 0, 10);
  v.qsort (reverse_cmp);
  do { const char *desc_ = "ASSERT_EQ (" "(9)" ", " "(v[0])" ")"; if (((9)) == ((v[0]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 475, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 475, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(8)" ", " "(v[1])" ")"; if (((8)) == ((v[1]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 476, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 476, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(1)" ", " "(v[8])" ")"; if (((1)) == ((v[8]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 477, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 477, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(0)" ", " "(v[9])" ")"; if (((0)) == ((v[9]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 478, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 478, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(10)" ", " "(v.length ())" ")"; if (((10)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 479, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 479, __FUNCTION__)))), desc_); } while (0);
}
...
test_reverse ()
{
  ...
  {
    auto_vec <int> v;
    do { const char *desc_ = "ASSERT_EQ (" "(0)" ", " "(v.length ())" ")"; if (((0)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 490, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 490, __FUNCTION__)))), desc_); } while (0);
    v.reverse ();
    do { const char *desc_ = "ASSERT_EQ (" "(0)" ", " "(v.length ())" ")"; if (((0)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 492, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 492, __FUNCTION__)))), desc_); } while (0);
  }
...

  {
    ...
    v.reverse ();
    do { const char *desc_ = "ASSERT_EQ (" "(3)" ", " "(v[0])" ")"; if (((3)) == ((v[0]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 500, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 500, __FUNCTION__)))), desc_); } while (0);
    do { const char *desc_ = "ASSERT_EQ (" "(2)" ", " "(v[1])" ")"; if (((2)) == ((v[1]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 501, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 501, __FUNCTION__)))), desc_); } while (0);
    do { const char *desc_ = "ASSERT_EQ (" "(1)" ", " "(v[2])" ")"; if (((1)) == ((v[2]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 502, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 502, __FUNCTION__)))), desc_); } while (0);
    do { const char *desc_ = "ASSERT_EQ (" "(0)" ", " "(v[3])" ")"; if (((0)) == ((v[3]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 503, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 503, __FUNCTION__)))), desc_); } while (0);
    do { const char *desc_ = "ASSERT_EQ (" "(4)" ", " "(v.length ())" ")"; if (((4)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 504, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 504, __FUNCTION__)))), desc_); } while (0);
  }
...

  {
    ...
    v.reverse ();
    do { const char *desc_ = "ASSERT_EQ (" "(2)" ", " "(v[0])" ")"; if (((2)) == ((v[0]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 512, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 512, __FUNCTION__)))), desc_); } while (0);
    do { const char *desc_ = "ASSERT_EQ (" "(1)" ", " "(v[1])" ")"; if (((1)) == ((v[1]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 513, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 513, __FUNCTION__)))), desc_); } while (0);
    do { const char *desc_ = "ASSERT_EQ (" "(0)" ", " "(v[2])" ")"; if (((0)) == ((v[2]))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 514, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 514, __FUNCTION__)))), desc_); } while (0);
    do { const char *desc_ = "ASSERT_EQ (" "(3)" ", " "(v.length ())" ")"; if (((3)) == ((v.length ()))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 515, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 515, __FUNCTION__)))), desc_); } while (0);
  }
}
...
test_auto_delete_vec ()
{
  ...
  do { const char *desc_ = "ASSERT_EQ (" "(dtor_count)" ", " "(2)" ")"; if (((dtor_count)) == ((2))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 542, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/vec.c", 542, __FUNCTION__)))), desc_); } while (0);
}
