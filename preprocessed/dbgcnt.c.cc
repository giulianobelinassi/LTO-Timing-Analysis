# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c"
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 2
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 2
...
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 2

# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.h" 1
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.h"
enum debug_counter {
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.def" 1
# 145 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.def"
...
vect_loop,
vect_slp,
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.h" 2
...
# 31 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 2
...
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.def" 1
# 145 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.def"
{ "asan_use_after_scope" , asan_use_after_scope },
{ "auto_inc_dec" , auto_inc_dec },
{ "ccp" , ccp },
{ "cfg_cleanup" , cfg_cleanup },
{ "cprop" , cprop },
{ "cse2_move2add" , cse2_move2add },
{ "dce" , dce },
{ "dce_fast" , dce_fast },
{ "dce_ud" , dce_ud },
{ "delete_trivial_dead" , delete_trivial_dead },
{ "devirt" , devirt },
{ "df_byte_scan" , df_byte_scan },
{ "dom_unreachable_edges" , dom_unreachable_edges },
{ "dse" , dse },
{ "dse1" , dse1 },
{ "dse2" , dse2 },
{ "gcse2_delete" , gcse2_delete },
{ "gimple_unroll" , gimple_unroll },
{ "global_alloc_at_func" , global_alloc_at_func },
{ "global_alloc_at_reg" , global_alloc_at_reg },
{ "graphite_scop" , graphite_scop },
{ "hoist" , hoist },
{ "hoist_insn" , hoist_insn },
{ "ia64_sched2" , ia64_sched2 },
{ "if_after_combine" , if_after_combine },
{ "if_after_reload" , if_after_reload },
{ "if_conversion" , if_conversion },
{ "if_conversion_tree" , if_conversion_tree },
{ "ipa_cp_bits" , ipa_cp_bits },
{ "ipa_sra_params" , ipa_sra_params },
{ "ipa_sra_retvalues" , ipa_sra_retvalues },
{ "ira_move" , ira_move },
{ "ivopts_loop" , ivopts_loop },
{ "lim" , lim },
{ "local_alloc_for_sched" , local_alloc_for_sched },
{ "match" , match },
{ "merged_ipa_icf" , merged_ipa_icf },
{ "postreload_cse" , postreload_cse },
{ "pre" , pre },
{ "pre_insn" , pre_insn },
{ "prefetch" , prefetch },
{ "registered_jump_thread" , registered_jump_thread },
{ "sched2_func" , sched2_func },
{ "sched_block" , sched_block },
{ "sched_breakdep" , sched_breakdep },
{ "sched_func" , sched_func },
{ "sched_insn" , sched_insn },
{ "sched_region" , sched_region },
{ "sel_sched_cnt" , sel_sched_cnt },
{ "sel_sched_insn_cnt" , sel_sched_insn_cnt },
{ "sel_sched_region_cnt" , sel_sched_region_cnt },
{ "sms_sched_loop" , sms_sched_loop },
{ "split_for_sched2" , split_for_sched2 },
{ "store_merging" , store_merging },
{ "store_motion" , store_motion },
{ "stv_conversion" , stv_conversion },
{ "tail_call" , tail_call },
{ "tree_sra" , tree_sra },
{ "treepre_insert" , treepre_insert },
{ "vect_loop" , vect_loop },
{ "vect_slp" , vect_slp },
# 42 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 2
};
...
print_limit_reach (const char *counter, int limit, bool upper_p)
{
  ...
  fputs (buffer, 
# 57 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 3 4
                stderr
# 57 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c"
                      );
  if (dump_file)
...
dbg_cnt_process_single_pair (char *name, char *str)
{
  ...
  char *value2 = strtok (
# 171 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 3 4
                        __null
# 171 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c"
                            , "-");

  unsigned int high, low;

  if (value1 == 
# 175 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 3 4
               __null
# 175 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c"
                   )
    return false;

  if (value2 == 
# 178 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 3 4
               __null
# 178 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c"
                   )
    {
      high = strtol (value1, 
# 180 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 3 4
                            __null
# 180 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c"
                                , 10);
    ...
    {
      low = strtol (value1, 
# 186 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 3 4
                           __null
# 186 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c"
                               , 10);
      high = strtol (value2, 
# 187 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 3 4
                            __null
# 187 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c"
                                , 10);
    }
...
dbg_cnt_process_opt (const char *arg)
{
  ...
  for (char *next = strtok (str, ","); next != 
# 200 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 3 4
                                              __null
# 200 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c"
                                                  ; next = strtok (
# 200 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 3 4
                                                                   __null
# 200 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c"
  ...
  for (i = 0; i < tokens.length (); i++)
    {
      ...
      for (char *part = strtok (
# 208 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 3 4
                               __null
# 208 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c"
                                   , ":"); part; part = strtok (
# 208 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c" 3 4
                                                                __null
# 208 "/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c"
...
test_sorted_dbg_counters ()
{
  for (unsigned i = 0; i < debug_counter_number_of_counters - 1; i++)
    do { const char *desc_ = "ASSERT_LT (" "(strcmp (map[i].name, map[i + 1].name))" ", " "(0)" ")"; if (((strcmp (map[i].name, map[i + 1].name))) < ((0))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c", 257, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/dbgcnt.c", 257, __FUNCTION__)))), desc_); } while (0);
}
