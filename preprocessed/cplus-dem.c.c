# 1 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c"
# 36 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c"
# 1 "./config.h" 1
# 37 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c" 2
...
# 40 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c" 2
...
# 42 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c" 2
...
# 45 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c" 2
...
cplus_demangle_print_callback (int options,
                               struct demangle_component *tree,
                               demangle_callbackref callback, void *opaque);
# 51 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c" 2



# 1 "/home/giulianob/gcc_git_gnu/gcc/libiberty/../include/libiberty.h" 1
# 55 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c" 2
...
# 103 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c" 3 4
   ((void *)0)
# 103 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c"
       , unknown_demangling, 
# 103 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c" 3 4
                             ((void *)0)
  
# 104 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c"
 }
};
...
# 151 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c"
char *
cplus_demangle (const char *mangled, int options)
{
  char *ret;
  ...
  if ((options & ((1 << 8)|(1 << 14)|(1 << 2)|(1 << 15)|(1 << 16)|(1 << 17))) == 0)
    options |= (int) current_demangling_style & ((1 << 8)|(1 << 14)|(1 << 2)|(1 << 15)|(1 << 16)|(1 << 17));



  if ((((int) options) & (1 << 17)) || (((int) options) & (1 << 8)))
    {
      ret = rust_demangle (mangled, options);
      if (ret || (((int) options) & (1 << 17)))
        return ret;
    }


  if ((((int) options) & (1 << 14)) || (((int) options) & (1 << 8)))
    {
      ret = cplus_demangle_v3 (mangled, options);
      if (ret || (((int) options) & (1 << 14)))
 return ret;
    }
...
ada_demangle (const char *mangled, int option __attribute__ ((__unused__)))
{
  ...
  char *d;
  char *demangled = 
# 207 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c" 3 4
                   ((void *)0)
# 207 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c"
                       ;
      ...
      else if (p[0] == 'O')
        {
          ...
          static const char * const operators[][2] =
            {{"Oabs", "abs"}, {"Oand", "and"}, {"Omod", "mod"},
             ...
             {"Oexpon", "**"}, {
# 248 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c" 3 4
                               ((void *)0)
# 248 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c"
                                   , 
# 248 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c" 3 4
                                     ((void *)0)
# 248 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c"
...
# 251 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c" 3 4
                                        ((void *)0)
# 251 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c"
                                            ; k++)
            {
          ...
          if (operators[k][0] == 
# 266 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c" 3 4
                                ((void *)0)
# 266 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c"
                                    )
            goto unknown;
        }
      else
              ...
              if ((_sch_istable[(*p) & 0xff] & (unsigned short)(_sch_isdigit)))
              ...
              else if (p[0] == '_' && p[1] != '_')
                {
                  ...
                  static const char * const special[][2] = {
                    ...
                    { "_assign", ".\":=\"" },
                    { 
# 391 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c" 3 4
                     ((void *)0)
# 391 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c"
                         , 
# 391 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c" 3 4
                           ((void *)0) 
# 391 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c"
                  ...
                  for (k = 0; special[k][0] != 
# 395 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c" 3 4
                                              ((void *)0)
# 395 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c"
                                                  ; k++)
                    {
                  ...
                  if (special[k][0] != 
# 407 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c" 3 4
                                      ((void *)0)
# 407 "/home/giulianob/gcc_git_gnu/gcc/libiberty/cplus-dem.c"
                                          )
                    break;
                  else
                    goto unknown;
