# 1 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
...
# 7 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 2
    ...
    gz_statep state;
{
    ...
    if (state->in == 
# 25 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 3 4
                    ((void *)0)
# 25 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
                        ) {
    ...
    if (!state->direct) {
        ...
        if (state->out == 
# 34 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 3 4
                         ((void *)0)
# 34 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
                             ) {
            free(state->in);
            gz_error(state, (-4), "out of memory");
            return -1;
        ...
        strm->next_in = 
# 52 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 3 4
                       ((void *)0)
# 52 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
                           ;
    }
...
# 91 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 3 4
                                        (*__errno_location ())
# 91 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
                                        ));
                return -1;
            }
    ...
    do {
        ...
        if (strm->avail_out == 0 || (flush != 0 &&
            ...
            while (strm->next_out > state->x.next) {
                ...
                if (writ < 0) {
                    gz_error(state, (-1), strerror(
# 112 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 3 4
                                            (*__errno_location ())
# 112 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
                                            ));
                    return -1;
                }
                state->x.next += writ;
    ...
    off_t len;
{
    ...
    first = 1;
    while (len) {
        n = (sizeof(int) == sizeof(off_t) && (state->size) > 0x7fffffff) || (off_t)state->size > len ?
    ...
    unsigned len;
{
    ...
    if (file == 
# 254 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 3 4
               ((void *)0)
# 254 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
                   )
        return 0;
    ...
    gzFile file;
{
    ...
    if (file == 
# 284 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 3 4
               ((void *)0)
# 284 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
                   )
        return 0;
    state = (gz_statep)file;
    ...
    int c;
{
    ...
    if (file == 
# 314 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 3 4
               ((void *)0)
# 314 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
                   )
        return -1;
    state = (gz_statep)file;
    strm = &(state->strm);
    ...
    const char *str;
{
    ...
    if (file == 
# 361 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 3 4
               ((void *)0)
# 361 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
                   )
        return -1;
    state = (gz_statep)file;
...
int gzvprintf(gzFile file, const char *format, va_list va)
{
    ...
    if (file == 
# 388 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 3 4
               ((void *)0)
# 388 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
                   )
        return (-2);
    state = (gz_statep)file;
    strm = &(state->strm);
    ...
    next[state->size - 1] = 0;
# 428 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
...
# 456 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 3 4
   __builtin_va_start(
# 456 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
   va
# 456 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 3 4
   ,
# 456 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
...
# 458 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 3 4
   __builtin_va_end(
# 458 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
   va
# 458 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 3 4
   )
# 458 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
...
# 553 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
    ...
    int flush;
{
    ...
    if (file == 
# 560 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 3 4
               ((void *)0)
# 560 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
                   )
        return (-2);
    state = (gz_statep)file;
    ...
    int strategy;
{
    ...
    if (file == 
# 594 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 3 4
               ((void *)0)
# 594 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
                   )
        return (-2);
    state = (gz_statep)file;
    strm = &(state->strm);
    ...
    gzFile file;
{
    ...
    if (file == 
# 634 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 3 4
               ((void *)0)
# 634 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
                   )
        return (-2);
    state = (gz_statep)file;
    ...
    gz_error(state, 0, 
# 659 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c" 3 4
                         ((void *)0)
# 659 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzwrite.c"
                             );
    free(state->path);
    if (close(state->fd) == -1)
        ret = (-1);
