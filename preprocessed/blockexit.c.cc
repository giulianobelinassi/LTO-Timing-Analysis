# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/blockexit.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/blockexit.c"
# 10 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/blockexit.c"
...
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/blockexit.c" 2
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/blockexit.c" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/blockexit.c" 2
# 1 "d/id.h" 1
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/blockexit.c" 2
...
int blockExit(Statement *s, FuncDeclaration *func, bool mustNotThrow)
{
    ...
    public:
        ...
        void visit(Statement *s)
        {
            ...
            printf("%s\n", s->toChars());
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/blockexit.c", 37, __FUNCTION__), 0 : 0));
            result = BEany;
        }
        ...
        {
            ((void)(!(global.errors) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/blockexit.c", 72, __FUNCTION__), 0 : 0));
            result = BEfallthru;
        }
        ...
        {
            ((void)(!(global.errors) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/blockexit.c", 148, __FUNCTION__), 0 : 0));
            result = BEfallthru;
        }
        ...
        {
            ((void)(!(global.errors) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/blockexit.c", 219, __FUNCTION__), 0 : 0));
            result = BEfallthru;
        }
        ...
        {
            ((void)(!(s->_body) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/blockexit.c", 355, __FUNCTION__), 0 : 0));
...
# 433 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/blockexit.c"
        ...
        void visit(ThrowStatement *s)
        {
            ...
            ((void)(!(cd) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/blockexit.c", 455, __FUNCTION__), 0 : 0));
        ...
        {
            if (mustNotThrow && !(s->stc & 0x2000000LL))
                s->deprecation("asm statement is assumed to throw - mark it with 'nothrow' if it does not");


            result = BEfallthru | BEreturn | BEgoto | BEhalt;
            if (!(s->stc & 0x2000000LL)) result |= BEthrow;
        }
