# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c" 2
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c" 2
# 39 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
struct token
{
  const char *value;
  int code;
...
print_token (int code, const char *value)
{
  if (code < CHAR_TOKEN_OFFSET)
    ...
    return token_names[code - CHAR_TOKEN_OFFSET];
  else
...
static void __attribute__ ((__format__ (__printf__, 1, 2))) __attribute__ ((__nonnull__ (1)))
parse_error (const char *msg, ...)
{
  va_list ap;

  fprintf (
# 141 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c" 3 4
          stderr
# 141 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
                , "%s:%d: parse error: ",
    get_input_file_name (lexer_line.file), lexer_line.line);

  
# 144 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c" 3 4
 __builtin_va_start(
# 144 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
 ap
# 144 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c" 3 4
 ,
# 144 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
...
# 144 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
                   ;
  vfprintf (
# 145 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c" 3 4
           stderr
# 145 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
                 , msg, ap);
  
# 146 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c" 3 4
 __builtin_va_end(
# 146 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
 ap
# 146 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c" 3 4
 )
# 146 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
  ...
  fputc_unlocked ('\n', 
# 148 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c" 3 4
 stderr
# 148 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
 );
  ...
  while (token () == STRING)
    {
      ...
      l1 = strlen (s1);
      l2 = strlen (s2);
      buf = ((char *) xrealloc ((void *) ((const_cast<char *> ((s1)))), sizeof (char) * (l1 + l2 + 1)));
      memcpy (buf + l1, s2, l2 + 1);
      free ((void*) ((const_cast<char *> ((s2)))));
      s1 = buf;
    }
  return s1;
}
# 257 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
static const char *
...
# 486 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
static type_p
absdecl (void)
{
  type_p ty;
...
# 623 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
static type_p
...
# 654 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
static type_p
     ...
     bool in_struct)
{
 ...
 return nullptr;
    ...
    case '(':
# 683 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
      advance ();
      if (in_struct && token () != '*')
 {
...
# 737 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
static type_p
...
# 766 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
static type_p
...
# 791 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
static pair_p
...
# 875 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
static type_p
type (options_p *optsp, bool nested)
{
 ...
 return find_structure (s, kind);
    ...
    case TYPEDEF:
      ...
      ((void)(!(nested) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c", 1013, __FUNCTION__), 0 : 0));
 ...
 s = xasprintf ("anonymous:%s:%d",
      ...
      if (token () == '{')
 consume_balanced ('{', '}');
# 1039 "/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c"
      if (nested && token () == ';')
 {
...
typedef_decl (void)
{
  ...
  ((void)(!(token () == TYPEDEF) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/gengtype-parse.c", 1069, __FUNCTION__), 0 : 0));
  advance ();
