...
# 3 "cc1objplus-checksum.c" 2
extern const unsigned char executable_checksum[16] = { 0x7b, 0xc0, 0x89, 0x46, 0x1e, 0xd4, 0xb1, 0x34, 0xb7, 0xfb, 0x9d, 0x56, 0x2a, 0x5e, 0x2a, 0x41 };
