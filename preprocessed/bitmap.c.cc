# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c"
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c" 2
...
void
bitmap_register (bitmap b )
{
  static unsigned alloc_descriptor_max_uid = 1;
  ((void)(!(b->alloc_descriptor == 0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 40, __FUNCTION__), 0 : 0));
...
# 211 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c"
static inline void
bitmap_list_link_element (bitmap head, bitmap_element *element)
{
  ...
  ((void)(!(!head->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 217, __FUNCTION__), 0 : 0));
       ...
       bool to_freelist = true)
{
  ...
  ((void)(!(!head->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 276, __FUNCTION__), 0 : 0));
...
bitmap_list_insert_element_after (bitmap head,
      ...
      bitmap_element *node = nullptr)
{
  if (!node)
    node = bitmap_element_allocate (head);
  node->indx = indx;

  ((void)(!(!head->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 315, __FUNCTION__), 0 : 0));
 ...
 node->next->prev = node;
    ...
    {
      ((void)(!(head->current) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 332, __FUNCTION__), 0 : 0));
      node->next = elt->next;
      if (node->next)
 node->next->prev = node;
      elt->next = node;
...
bitmap_list_find_element (bitmap head, unsigned int indx)
{
 ...
 if (0 && usage)
  ...
  ((void)(!(element != nullptr) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 406, __FUNCTION__), 0 : 0));
  head->current = element;
...
# 427 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c"
static inline void
...
bitmap_tree_splay (bitmap head, bitmap_element *t, unsigned int indx)
{
 ...
 usage->m_search_iter++;
      ...
      if (indx < t->indx)
 {
   if (t->prev != nullptr && indx < t->prev->indx)
 ...
 {
   if (t->next != nullptr && indx > t->next->indx)
...
bitmap_tree_link_element (bitmap head, bitmap_element *e)
{
 ...
 (fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 529, __FUNCTION__));
    }
  head->first = e;
  head->current = e;
  head->indx = e->indx;
...
bitmap_tree_unlink_element (bitmap head, bitmap_element *e)
{
  ...
  ((void)(!(t == e) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 544, __FUNCTION__), 0 : 0));
...
bitmap_tree_find_element (bitmap head, unsigned int indx)
{
  ...
  ((void)(!(element != nullptr) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 581, __FUNCTION__), 0 : 0));
  head->first = element;
  head->current = element;
  head->indx = element->indx;
  if (element->indx != indx)
...
bitmap_tree_listify_from (bitmap head, bitmap_element *e)
{
  ...
  ((void)(!(t == e) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 606, __FUNCTION__), 0 : 0));
  ...
  e->prev = nullptr;
  e->next = erb;
# 626 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c"
 ...
 break;
  ...
  ((void)(!(sorted_elements[0] == e) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 646, __FUNCTION__), 0 : 0));

  bitmap_element *prev = nullptr;
  unsigned ix;
  for (ix = 0; (sorted_elements).iterate ((ix), &(n)); ++(ix))
    {
      if (prev != nullptr)
        prev->next = n;
      n->prev = prev;
...
bitmap_list_view (bitmap head)
{
  ...
  ((void)(!(head->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 669, __FUNCTION__), 0 : 0));
...
bitmap_tree_view (bitmap head)
{
  ...
  ((void)(!(! head->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 693, __FUNCTION__), 0 : 0));
  ...
  if (head->tree_form)
    {
      ...
      for (e = head->first; e->prev; e = e->prev)
                                                          ;
      t = bitmap_tree_splay (head, head->first, e->indx);
      ((void)(!(t == e) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 718, __FUNCTION__), 0 : 0));
      head->first = t;
    }
...
bitmap_obstack_initialize (bitmap_obstack *bit_obstack)
{
 ...
 return;
  ...
  bit_obstack->elements = nullptr;
  bit_obstack->heads = nullptr;
  _obstack_begin ((&bit_obstack->obstack), (memory_block_pool::block_size), (__alignof__ (bitmap_element)), (mempool_obstack_chunk_alloc), (mempool_obstack_chunk_free))
  ...
  if (!bit_obstack)
    {
      if (--bitmap_default_obstack_depth)
 {
   ((void)(!(bitmap_default_obstack_depth > 0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 759, __FUNCTION__), 0 : 0));
   return;
 }
      bit_obstack = &bitmap_default_obstack;
    }
  ...
  bit_obstack->elements = nullptr;
  bit_obstack->heads = nullptr;
  __extension__ ({ struct obstack *__o = (&bit_obstack->obstack); void *__obj = (void *) (nullptr); if (__obj > (void *) __o->chunk && __obj < (void *) __o->chunk_limit) __o->next_free = __o->object_base = (char *) __obj; else _obstack_free (__o, __obj); });
}
...
bitmap
bitmap_alloc (bitmap_obstack *bit_obstack )
{
  bitmap map;
  ...
  if (map)
    ...
    map = ((bitmap_head *) __extension__ ({ struct obstack *__h = ((&bit_obstack->obstack)); __extension__ ({ struct obstack *__o = (__h); size_t __len = ((sizeof (bitmap_head))); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < __len) _obstack_newchunk (__o, __len); ((void) ((__o)->next_free += (__len))); }); __extension__ ({ struct obstack *__o1 = (__h); void *__value = (void *) __o1->object_base; if (__o1->next_free == __value) __o1->maybe_empty_object = 1; __o1->next_free = ((sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (((__o1->next_free) - (sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (__o1->alignment_mask)) & ~(__o1->alignment_mask))); if ((size_t) (__o1->next_free - (char *) __o1->chunk) > (size_t) (__o1->chunk_limit - (char *) __o1->chunk)) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; __value; }); }));
...
# 843 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c"
}
...
bitmap_copy (bitmap to, const_bitmap from)
{
  ...
  ((void)(!(!to->tree_form && !from->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 853, __FUNCTION__), 0 : 0));
...
{
  ((void)(!(to->obstack == from->obstack) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 890, __FUNCTION__), 0 : 0));
...
{
  unsigned int indx = bit / (((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)) * (8 * 8 * 1u));
  bitmap_element *ptr;
  ...
  if (ptr != 0)
    {
      ...
      unsigned word_num = bit / (8 * 8 * 1u) % ((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u));
...
{
  unsigned indx = bit / (((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)) * (8 * 8 * 1u));
  bitmap_element *ptr;
  if (!head->tree_form)
    ptr = bitmap_list_find_element (head, indx);
  else
 ...
 ptr->bits[word_num] |= bit_val;
  ...
  ptr->indx = bit / (((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)) * (8 * 8 * 1u));
  ptr->bits[word_num] = bit_val;
  if (!head->tree_form)
...
bitmap_bit_p (const_bitmap head, int bit)
{
  ...
  bit_num = bit % (8 * 8 * 1u);
  word_num = bit / (8 * 8 * 1u) % ((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u));

  return (ptr->bits[word_num] >> bit_num) & 1;
}
# 1030 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c"
static unsigned long
bitmap_count_bits_in_word (const BITMAP_WORD *bits)
{
  unsigned long count = 0;

  for (unsigned ix = 0; ix != ((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)); ix++)
    {
...
bitmap_count_bits (const_bitmap a)
{
  ...
  ((void)(!(!a->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1056, __FUNCTION__), 0 : 0));
...
bitmap_first_set_bit (const_bitmap a)
{
  ...
  ((void)(!(elt) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1148, __FUNCTION__), 0 : 0));

  if (a->tree_form)
    while (elt->prev)
      elt = elt->prev;

  bit_no = elt->indx * (((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)) * (8 * 8 * 1u));
  for (ix = 0; ix != ((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)); ix++)
    {
      word = elt->bits[ix];
      if (word)
 goto found_bit;
  ...
  (fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1161, __FUNCTION__));
 found_bit:
  bit_no += ix * (8 * 8 * 1u);


  ((void)(!(sizeof (long) == sizeof (word)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1166, __FUNCTION__), 0 : 0));
  bit_no += __builtin_ctzl (word);
# 1190 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c"
 return bit_no;
}
...
bitmap_last_set_bit (const_bitmap a)
{
  ...
  ((void)(!(elt) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1208, __FUNCTION__), 0 : 0));

  while (elt->next)
    elt = elt->next;

  bit_no = elt->indx * (((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)) * (8 * 8 * 1u));
  for (ix = ((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)) - 1; ix >= 1; ix--)
    {
      word = elt->bits[ix];
      if (word)
 goto found_bit;
    }
  ((void)(!(elt->bits[ix] != 0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1220, __FUNCTION__), 0 : 0));
 found_bit:
  bit_no += ix * (8 * 8 * 1u);

  ((void)(!(sizeof (long) == sizeof (word)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1224, __FUNCTION__), 0 : 0));
  bit_no += (8 * 8 * 1u) - __builtin_clzl (word) - 1;
# 1240 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c"
  return bit_no;
}
...
bitmap_and (bitmap dst, const_bitmap a, const_bitmap b)
{
  ...
  bitmap_element *dst_prev = nullptr;

  ((void)(!(!dst->tree_form && !a->tree_form && !b->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1254, __FUNCTION__), 0 : 0));
  ((void)(!(dst != a && dst != b) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1255, __FUNCTION__), 0 : 0));
      ...
      else
 {
  ...
  ((void)(!(!dst->current == !dst->first) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1299, __FUNCTION__), 0 : 0));
  if (dst->current)
...
bitmap_and_into (bitmap a, const_bitmap b)
{
  ...
  ((void)(!(!a->tree_form && !b->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1314, __FUNCTION__), 0 : 0));
      ...
      else
 {
  ...
  ((void)(!(!a->current == !a->first && (!a->current || a->indx == a->current->indx)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1358, __FUNCTION__), 0 : 0))
                                                         ;
...
bitmap_and_compl (bitmap dst, const_bitmap a, const_bitmap b)
{
  ...
  ((void)(!(!dst->tree_form && !a->tree_form && !b->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1411, __FUNCTION__), 0 : 0));
  ((void)(!(dst != a && dst != b) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1412, __FUNCTION__), 0 : 0));
      ...
      else
 {
  ...
  ((void)(!(!dst->current == !dst->first) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1507, __FUNCTION__), 0 : 0));
  if (dst->current)
    dst->indx = dst->current->indx;
...
bitmap_and_compl_into (bitmap a, const_bitmap b)
{
  ...
  ((void)(!(!a->tree_form && !b->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1524, __FUNCTION__), 0 : 0));
      ...
      else
 {
  ...
  ((void)(!(!a->current == !a->first && (!a->current || a->indx == a->current->indx)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1565, __FUNCTION__), 0 : 0))
                                                         ;
  return changed != 0;
}
...
bitmap_set_range (bitmap head, unsigned int start, unsigned int count)
{
  ...
  ((void)(!(!head->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1578, __FUNCTION__), 0 : 0));
  ...
  first_index = start / (((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)) * (8 * 8 * 1u));
  end_bit_plus1 = start + count;
  last_index = (end_bit_plus1 - 1) / (((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)) * (8 * 8 * 1u));
  ...
  ((void)(!(elt->indx == first_index) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1605, __FUNCTION__), 0 : 0));
  elt_prev = elt->prev;
  for (i = first_index; i <= last_index; i++)
    {
      unsigned elt_start_bit = i * (((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)) * (8 * 8 * 1u));
      unsigned elt_end_bit_plus1 = elt_start_bit + (((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)) * (8 * 8 * 1u));
      ...
      if (elt_start_bit <= start)
 {
   ...
   first_word_to_mod = (start - elt_start_bit) / (8 * 8 * 1u);


   first_mask =
     (((BITMAP_WORD) 1) << ((start % (8 * 8 * 1u)))) - 1;
      ...
      if (elt_end_bit_plus1 <= end_bit_plus1)
 {
   ...
   last_word_to_mod = ((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)) - 1;
      ...
      else
 {
   ...
   last_word_to_mod =
     (end_bit_plus1 - elt_start_bit) / (8 * 8 * 1u);


   last_mask =
     (((BITMAP_WORD) 1) << ((end_bit_plus1 % (8 * 8 * 1u)))) - 1;
 }
...
bitmap_clear_range (bitmap head, unsigned int start, unsigned int count)
{
  ...
  ((void)(!(!head->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1685, __FUNCTION__), 0 : 0));
  ...
  while (elt && (elt->indx <= last_index))
    {
      ...
      unsigned elt_start_bit = (elt->indx) * (((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)) * (8 * 8 * 1u));
      unsigned elt_end_bit_plus1 = elt_start_bit + (((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)) * (8 * 8 * 1u));
      ...
      else
 {
  ...
  (((BITMAP_WORD) 1) << (((end_bit_plus1) % (8 * 8 * 1u)))) - 1;
   ...
   for (i = 0; i < ((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)); i++)
     if (elt->bits[i])
       {
  clear = false;
  break;
...
bitmap_compl_and_into (bitmap a, const_bitmap b)
{
  bitmap_element *a_elt = a->first;
  const bitmap_element *b_elt = b->first;
  bitmap_element *a_prev = nullptr;
  bitmap_element *next;

  ((void)(!(!a->tree_form && !b->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1822, __FUNCTION__), 0 : 0));
  ((void)(!(a != b) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1823, __FUNCTION__), 0 : 0));
      ...
      else
 {
  ...
  ((void)(!(!a->current == !a->first && (!a->current || a->indx == a->current->indx)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1877, __FUNCTION__), 0 : 0))
                                                         ;
  return;
}
...
bitmap_elt_ior (bitmap dst, bitmap_element *dst_elt, bitmap_element *dst_prev,
  ...
  bool changed)
{
  ((void)(!(a_elt || b_elt) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1892, __FUNCTION__), 0 : 0));
 ...
 src = b_elt;
      ...
      ((void)(!(src) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1936, __FUNCTION__), 0 : 0));
...
bitmap_ior (bitmap dst, const_bitmap a, const_bitmap b)
{
  ...
  ((void)(!(!dst->tree_form && !a->tree_form && !b->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1955, __FUNCTION__), 0 : 0));
  ((void)(!(dst != a && dst != b) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1956, __FUNCTION__), 0 : 0));
      ...
      else
 {
  ...
  ((void)(!(!dst->current == !dst->first) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 1987, __FUNCTION__), 0 : 0));
  if (dst->current)
    dst->indx = dst->current->indx;
  return changed;
}
...
bitmap_ior_into (bitmap a, const_bitmap b)
{
  ...
  ((void)(!(!a->tree_form && !b->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2004, __FUNCTION__), 0 : 0));
  if (a == b)
    return false;
 ...
 {
          changed = bitmap_elt_copy (a, nullptr, a_prev, b_elt, changed);
   b_elt = b_elt->next;
 }
  ...
  ((void)(!(!a->current == !a->first) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2027, __FUNCTION__), 0 : 0));
  if (a->current)
...
bitmap_ior_into_and_free (bitmap a, bitmap *b_)
{
  ...
  ((void)(!(!a->tree_form && !b->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2046, __FUNCTION__), 0 : 0));
  ((void)(!(a->obstack == b->obstack) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2047, __FUNCTION__), 0 : 0));
  if (a == b)
    return false;
      ...
      else if (a_elt->indx > b_elt->indx)
 {
  ...
  ((void)(!(!a->current == !a->first) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2072, __FUNCTION__), 0 : 0));
  if (a->current)
    a->indx = a->current->indx;

  if (b->obstack)
    ((void) (bitmap_obstack_free ((bitmap) *b_), (*b_) = (bitmap) nullptr));
  else
    bitmap_clear (b);
  return changed;
}
...
bitmap_xor (bitmap dst, const_bitmap a, const_bitmap b)
{
  ...
  ((void)(!(!dst->tree_form && !a->tree_form && !b->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2093, __FUNCTION__), 0 : 0));
  ((void)(!(dst != a && dst != b) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2094, __FUNCTION__), 0 : 0));
      ...
      else
 {
  ...
  dst->current = dst->first;
  bitmap_elt_clear_from (dst, dst_elt);
  ((void)(!(!dst->current == !dst->first) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2159, __FUNCTION__), 0 : 0));
  if (dst->current)
    dst->indx = dst->current->indx;
}
...
bitmap_xor_into (bitmap a, const_bitmap b)
{
  ...
  ((void)(!(!a->tree_form && !b->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2173, __FUNCTION__), 0 : 0));
      ...
      else
 {
  ...
  ((void)(!(!a->current == !a->first) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2219, __FUNCTION__), 0 : 0));
  if (a->current)
    a->indx = a->current->indx;
}
...
bitmap_equal_p (const_bitmap a, const_bitmap b)
{
  ...
  ((void)(!(!a->tree_form && !b->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2235, __FUNCTION__), 0 : 0));
...
bitmap_intersect_p (const_bitmap a, const_bitmap b)
{
  ...
  ((void)(!(!a->tree_form && !b->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2259, __FUNCTION__), 0 : 0));
...
bitmap_intersect_compl_p (const_bitmap a, const_bitmap b)
{
  ...
  ((void)(!(!a->tree_form && !b->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2289, __FUNCTION__), 0 : 0));
...
bitmap_ior_and_compl (bitmap dst, const_bitmap a, const_bitmap b, const_bitmap kill)
{
  ...
  ((void)(!(!dst->tree_form && !a->tree_form && !b->tree_form && !kill->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2325, __FUNCTION__), 0 : 0))
                             ;
  ((void)(!(dst != a && dst != b && dst != kill) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2327, __FUNCTION__), 0 : 0));
      ...
      if (new_element)
 {
  ...
  ((void)(!(!dst->current == !dst->first) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2412, __FUNCTION__), 0 : 0));
  if (dst->current)
    dst->indx = dst->current->indx;
...
bitmap_ior_and_compl_into (bitmap a, const_bitmap b, const_bitmap c)
{
  ...
  ((void)(!(!a->tree_form && !b->tree_form && !c->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2433, __FUNCTION__), 0 : 0));
      ...
      do
 {
   ix = a_elt ? a_elt->indx : and_elt_ptr->indx;
     ...
     changed = bitmap_elt_copy (a, nullptr, a_prev, and_elt_ptr, changed);
  ...
  ((void)(!(!a->current == !a->first) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2490, __FUNCTION__), 0 : 0));
  if (a->current)
    a->indx = a->current->indx;
  return changed;
}
...
bitmap_ior_and_into (bitmap a, const_bitmap b, const_bitmap c)
{
  ...
  ((void)(!(!a->tree_form && !b->tree_form && !c->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2510, __FUNCTION__), 0 : 0));
      ...
      do
 {
   ix = a_elt ? a_elt->indx : and_elt.indx;
     ...
     changed = bitmap_elt_copy (a, nullptr, a_prev, &and_elt, changed);
  ...
  ((void)(!(!a->current == !a->first) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2571, __FUNCTION__), 0 : 0));
  if (a->current)
    a->indx = a->current->indx;
  return changed;
}
...
bitmap_hash (const_bitmap head)
{
  ...
  ((void)(!(!head->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2586, __FUNCTION__), 0 : 0));
...
{
  ((void)(!(head->tree_form) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2604, __FUNCTION__), 0 : 0));
  auto_vec<bitmap_element *, 32> stack;
...
debug_bitmap_elt_file (FILE *file, const bitmap_element *ptr)
{
      ...
      if ((ptr->bits[i] >> j) & 1)
 {
   ...
   fprintf (file, " %u", (ptr->indx * (((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)) * (8 * 8 * 1u))
     + i * (8 * 8 * 1u) + j));
   col += 4;
 }
...
{
  debug_bitmap_file (
# 2682 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c" 3 4
                    stderr
# 2682 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c"
                          , head);
}
 ...
 for (unsigned ix = 0; ix != ((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)); ++ix)
   {
     ...
     for (unsigned bit = 0; bit != (8 * 8 * 1u); ++bit)
       if (word & ((BITMAP_WORD)1 << bit))
  {
    fprintf (file, "%s%d", comma,
      (bit + (8 * 8 * 1u) * ix
       + elts[i]->indx * (((128 + (8 * 8 * 1u) - 1) / (8 * 8 * 1u)) * (8 * 8 * 1u))));
    comma = ", ";
  }
   }
    }
    ...
    {
      bitmap_iterator bi;
      for (bmp_iter_set_init (&(bi), (head), (0), &(i)); bmp_iter_set (&(bi), &(i)); bmp_iter_next (&(bi), &(i)))
 {
...
{
  dump_bitmap (
# 2739 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c" 3 4
              stderr
# 2739 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c"
                    , &ref);
}
...
debug (const bitmap_head *ptr)
{
  if (ptr)
    ...
    fprintf (
# 2748 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c" 3 4
            stderr
# 2748 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c"
                  , "<nil>\n");
}
...
test_gc_alloc ()
{
  ...
  do { const char *desc_ = "ASSERT_TRUE (" "(bitmap_empty_p (b))" ")"; bool actual_ = ((bitmap_empty_p (b))); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2769, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2769, __FUNCTION__))), desc_); } while (0);
}
...
{
  bitmap b = bitmap_gc_alloc ();
  do { const char *desc_ = "ASSERT_TRUE (" "(bitmap_empty_p (b))" ")"; bool actual_ = ((bitmap_empty_p (b))); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2778, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2778, __FUNCTION__))), desc_); } while (0);

  bitmap_set_range (b, 7, 5);
  do { const char *desc_ = "ASSERT_FALSE (" "(bitmap_empty_p (b))" ")"; bool actual_ = ((bitmap_empty_p (b))); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2781, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2781, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(5)" ", " "(bitmap_count_bits (b))" ")"; if (((5)) == ((bitmap_count_bits (b)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2782, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2782, __FUNCTION__)))), desc_); } while (0);


  do { const char *desc_ = "ASSERT_FALSE (" "(bitmap_bit_p (b, 6))" ")"; bool actual_ = ((bitmap_bit_p (b, 6))); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2785, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2785, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_TRUE (" "(bitmap_bit_p (b, 7))" ")"; bool actual_ = ((bitmap_bit_p (b, 7))); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2786, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2786, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_TRUE (" "(bitmap_bit_p (b, 11))" ")"; bool actual_ = ((bitmap_bit_p (b, 11))); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2787, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2787, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_FALSE (" "(bitmap_bit_p (b, 12))" ")"; bool actual_ = ((bitmap_bit_p (b, 12))); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2788, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2788, __FUNCTION__))), desc_); } while (0);
}
...
test_clear_bit_in_middle ()
{
  ...
  do { const char *desc_ = "ASSERT_EQ (" "(100)" ", " "(bitmap_count_bits (b))" ")"; if (((100)) == ((bitmap_count_bits (b)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2800, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2800, __FUNCTION__)))), desc_); } while (0);


  bool changed = bitmap_clear_bit (b, 150);
  do { const char *desc_ = "ASSERT_TRUE (" "(changed)" ")"; bool actual_ = ((changed)); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2804, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2804, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(99)" ", " "(bitmap_count_bits (b))" ")"; if (((99)) == ((bitmap_count_bits (b)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2805, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2805, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_TRUE (" "(bitmap_bit_p (b, 149))" ")"; bool actual_ = ((bitmap_bit_p (b, 149))); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2806, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2806, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_FALSE (" "(bitmap_bit_p (b, 150))" ")"; bool actual_ = ((bitmap_bit_p (b, 150))); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2807, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2807, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_TRUE (" "(bitmap_bit_p (b, 151))" ")"; bool actual_ = ((bitmap_bit_p (b, 151))); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2808, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2808, __FUNCTION__))), desc_); } while (0);
}
...
test_copying ()
{
  ...
  do { const char *desc_ = "ASSERT_FALSE (" "(bitmap_equal_p (src, dst))" ")"; bool actual_ = ((bitmap_equal_p (src, dst))); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2820, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2820, __FUNCTION__))), desc_); } while (0);
  bitmap_copy (dst, src);
  do { const char *desc_ = "ASSERT_TRUE (" "(bitmap_equal_p (src, dst))" ")"; bool actual_ = ((bitmap_equal_p (src, dst))); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2822, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2822, __FUNCTION__))), desc_); } while (0);


  bitmap_set_range (src, 70, 5);
  do { const char *desc_ = "ASSERT_FALSE (" "(bitmap_equal_p (src, dst))" ")"; bool actual_ = ((bitmap_equal_p (src, dst))); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2826, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2826, __FUNCTION__))), desc_); } while (0);



  do { const char *desc_ = "ASSERT_FALSE (" "(bitmap_bit_p (dst, 70))" ")"; bool actual_ = ((bitmap_bit_p (dst, 70))); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2830, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2830, __FUNCTION__))), desc_); } while (0);
}
...
test_bitmap_single_bit_set_p ()
{
  ...
  do { const char *desc_ = "ASSERT_FALSE (" "(bitmap_single_bit_set_p (b))" ")"; bool actual_ = ((bitmap_single_bit_set_p (b))); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2840, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2840, __FUNCTION__))), desc_); } while (0);

  bitmap_set_range (b, 42, 1);
  do { const char *desc_ = "ASSERT_TRUE (" "(bitmap_single_bit_set_p (b))" ")"; bool actual_ = ((bitmap_single_bit_set_p (b))); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2843, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2843, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(42)" ", " "(bitmap_first_set_bit (b))" ")"; if (((42)) == ((bitmap_first_set_bit (b)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2844, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2844, __FUNCTION__)))), desc_); } while (0);

  bitmap_set_range (b, 1066, 1);
  do { const char *desc_ = "ASSERT_FALSE (" "(bitmap_single_bit_set_p (b))" ")"; bool actual_ = ((bitmap_single_bit_set_p (b))); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2847, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2847, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(42)" ", " "(bitmap_first_set_bit (b))" ")"; if (((42)) == ((bitmap_first_set_bit (b)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2848, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2848, __FUNCTION__)))), desc_); } while (0);

  bitmap_clear_range (b, 0, 100);
  do { const char *desc_ = "ASSERT_TRUE (" "(bitmap_single_bit_set_p (b))" ")"; bool actual_ = ((bitmap_single_bit_set_p (b))); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2851, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2851, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(1066)" ", " "(bitmap_first_set_bit (b))" ")"; if (((1066)) == ((bitmap_first_set_bit (b)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2852, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c", 2852, __FUNCTION__)))), desc_); } while (0);
}
...
extern const struct ggc_root_tab gt_ggc_rd_gt_bitmap_h[] = {
  { &bitmap_ggc_free, 1, sizeof (bitmap_ggc_free), nullptr, nullptr },
  { nullptr, 0, 0, nullptr, nullptr }
};
# 2871 "/home/giulianob/gcc_git_gnu/gcc/gcc/bitmap.c" 2
