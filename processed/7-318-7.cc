# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/d-incpath.cc"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/d-incpath.cc"
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/d-incpath.cc"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/d-incpath.cc" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/d-incpath.cc" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/d-incpath.cc" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/dcompat.h" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/d-incpath.cc" 2

# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/cppdefault.h" 1
# 34 "/home/giulianob/gcc_git_gnu/gcc/gcc/cppdefault.h"
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/d-incpath.cc" 2
...
prefixed_path (const char *path, const char *iprefix)
{
 ...
 if (!relocated_prefix)
   {
     ...
     char *dummy = concat (gcc_exec_prefix, "dummy", nullptr);
     relocated_prefix
 ...
 return concat (relocated_prefix, path + len, nullptr);
      }
  }
 ...
 return concat (iprefix, path + len, nullptr);
    }
...
add_globalpaths (Strings *paths)
{
      ...
      for (size_t i = 0; i < paths->length; i++)
 {
   ...
   if (target == nullptr || !FileName::exists (target))
     {
       if (target)
...
add_import_paths (const char *iprefix, const char *imultilib, bool stdinc)
{
      ...
      for (const default_include *p = cpp_include_defaults; p->fname; p++)
 {
       ...
       if (strcmp (path, (*global.params.imppath)[i]) == 0)
  {
   ...
   if (imultilib)
     {
       char *target_path = concat (path, "/", imultilib, nullptr);
