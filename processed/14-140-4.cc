# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
# 30 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
...
# 31 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c" 2
...
# 32 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c" 2
# 47 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
int adds(int x, int y, bool& overflow)
{
    int64_t r = (int64_t)x + (int64_t)y;
    if (r < 
# 50 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c" 3 4
           (-2147483647-1) 
# 50 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
                     || r > 
# 50 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c" 3 4
                            (2147483647)
# 50 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
...
# 78 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
unsigned addu(unsigned x, unsigned y, bool& overflow)
{
    unsigned r = x + y;
    if (r < x || r < y)
...
# 108 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
int subs(int x, int y, bool& overflow)
{
    int64_t r = (int64_t)x - (int64_t)y;
    if (r < 
# 111 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c" 3 4
           (-2147483647-1) 
# 111 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
                     || r > 
# 111 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c" 3 4
                            (2147483647)
# 111 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
...
int64_t subs(int64_t x, int64_t y, bool& overflow)
{
    ...
    if ((x < 0 && y >= 0 && r >= 0) ||
        (x >= 0 && y < 0 && (r < 0 || y == 
# 121 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c" 3 4
                                            (-9223372036854775807L -1)
# 121 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
                                                     )))
        overflow = true;
    return r;
}
# 139 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
unsigned subu(unsigned x, unsigned y, bool& overflow)
{
    if (x < y)
        overflow = true;
...
# 164 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
int negs(int x, bool& overflow)
{
    if (x == (int)
# 166 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c" 3 4
                 (-2147483647-1)
# 166 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
                          )
        overflow = true;
    return -x;
}
...
{
    if (x == 
# 174 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c" 3 4
            (-9223372036854775807L -1)
# 174 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
                     )
        overflow = true;
    return -x;
}
# 192 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
int muls(int x, int y, bool& overflow)
{
    int64_t r = (int64_t)x * (int64_t)y;
    if (r < 
# 195 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c" 3 4
           (-2147483647-1) 
# 195 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
                     || r > 
# 195 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c" 3 4
                            (2147483647)
# 195 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
...
# 223 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
unsigned mulu(unsigned x, unsigned y, bool& overflow)
{
    uint64_t r = (uint64_t)x * (uint64_t)y;
    if (r > 
# 226 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c" 3 4
           (4294967295U)
# 226 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.c"
                     )
        overflow = true;
    return (unsigned)r;
}
