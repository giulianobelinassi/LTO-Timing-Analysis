# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/typesem.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/typesem.c"
# 10 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/typesem.c"
...
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/typesem.c" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/typesem.c" 2
    ...
    for (; i < t->idents.length; i++)
    {
        ...
        switch (id->dyncast())
        {
            ...
            case DYNCAST_DSYMBOL:
            {
                ...
                ((void)(!(ti) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/typesem.c", 102, __FUNCTION__), 0 : 0));
            ...
            default:
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/typesem.c", 119, __FUNCTION__), 0 : 0));
        }
    }
    return e;
}
