# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/sort.cc"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/sort.cc"
# 35 "/home/giulianob/gcc_git_gnu/gcc/gcc/sort.cc"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 36 "/home/giulianob/gcc_git_gnu/gcc/gcc/sort.cc" 2
...
# 39 "/home/giulianob/gcc_git_gnu/gcc/gcc/sort.cc" 2
# 49 "/home/giulianob/gcc_git_gnu/gcc/gcc/sort.cc"
...
{
# 95 "/home/giulianob/gcc_git_gnu/gcc/gcc/sort.cc"
  if (__builtin_expect ((c->size == sizeof (size_t)), 1))
    do { size_t t0, t1; memcpy (&t0, e0 + 0, sizeof (size_t)); memcpy (&t1, e1 + 0, sizeof (size_t)); char *out = c->out + 0; if (__builtin_expect ((c->n == 3), 1)) memmove (out + 2*sizeof (size_t), e2 + 0, sizeof (size_t)); memcpy (out, &t0, sizeof (size_t)); out += sizeof (size_t); memcpy (out, &t1, sizeof (size_t)); } while (0);
  else if (__builtin_expect ((c->size == sizeof (int)), 1))
    do { int t0, t1; memcpy (&t0, e0 + 0, sizeof (int)); memcpy (&t1, e1 + 0, sizeof (int)); char *out = c->out + 0; if (__builtin_expect ((c->n == 3), 1)) memmove (out + 2*sizeof (int), e2 + 0, sizeof (int)); memcpy (out, &t0, sizeof (int)); out += sizeof (int); memcpy (out, &t1, sizeof (int)); } while (0);
  else
    {
      size_t offset = 0, step = sizeof (size_t);
      for (; offset + step <= c->size; offset += step)
 do { size_t t0, t1; memcpy (&t0, e0 + offset, sizeof (size_t)); memcpy (&t1, e1 + offset, sizeof (size_t)); char *out = c->out + offset; if (__builtin_expect ((c->n == 3), 1)) memmove (out + 2*c->size, e2 + offset, sizeof (size_t)); memcpy (out, &t0, sizeof (size_t)); out += c->size; memcpy (out, &t1, sizeof (size_t)); } while (0);
      for (; offset < c->size; offset++)
 do { char t0, t1; memcpy (&t0, e0 + offset, sizeof (char)); memcpy (&t1, e1 + offset, sizeof (char)); char *out = c->out + offset; if (__builtin_expect ((c->n == 3), 1)) memmove (out + 2*c->size, e2 + offset, sizeof (char)); memcpy (out, &t0, sizeof (char)); out += c->size; memcpy (out, &t1, sizeof (char)); } while (0);
    }
}
...
{
# 130 "/home/giulianob/gcc_git_gnu/gcc/gcc/sort.cc"
  if (__builtin_expect ((c->size == sizeof (size_t)), 1))
    do { size_t t0, t1, t2, t3; memcpy (&t0, e0 + 0, sizeof (size_t)); memcpy (&t1, e1 + 0, sizeof (size_t)); memcpy (&t2, e2 + 0, sizeof (size_t)); memcpy (&t3, e3 + 0, sizeof (size_t)); char *out = c->out + 0; if (__builtin_expect ((c->n == 5), 1)) memmove (out + 4*sizeof (size_t), e4 + 0, sizeof (size_t)); memcpy (out, &t0, sizeof (size_t)); out += sizeof (size_t); memcpy (out, &t1, sizeof (size_t)); out += sizeof (size_t); memcpy (out, &t2, sizeof (size_t)); out += sizeof (size_t); memcpy (out, &t3, sizeof (size_t)); } while (0);
  else if (__builtin_expect ((c->size == sizeof (int)), 1))
    do { int t0, t1, t2, t3; memcpy (&t0, e0 + 0, sizeof (int)); memcpy (&t1, e1 + 0, sizeof (int)); memcpy (&t2, e2 + 0, sizeof (int)); memcpy (&t3, e3 + 0, sizeof (int)); char *out = c->out + 0; if (__builtin_expect ((c->n == 5), 1)) memmove (out + 4*sizeof (int), e4 + 0, sizeof (int)); memcpy (out, &t0, sizeof (int)); out += sizeof (int); memcpy (out, &t1, sizeof (int)); out += sizeof (int); memcpy (out, &t2, sizeof (int)); out += sizeof (int); memcpy (out, &t3, sizeof (int)); } while (0);
  else
    {
      size_t offset = 0, step = sizeof (size_t);
      for (; offset + step <= c->size; offset += step)
 do { size_t t0, t1, t2, t3; memcpy (&t0, e0 + offset, sizeof (size_t)); memcpy (&t1, e1 + offset, sizeof (size_t)); memcpy (&t2, e2 + offset, sizeof (size_t)); memcpy (&t3, e3 + offset, sizeof (size_t)); char *out = c->out + offset; if (__builtin_expect ((c->n == 5), 1)) memmove (out + 4*c->size, e4 + offset, sizeof (size_t)); memcpy (out, &t0, sizeof (size_t)); out += c->size; memcpy (out, &t1, sizeof (size_t)); out += c->size; memcpy (out, &t2, sizeof (size_t)); out += c->size; memcpy (out, &t3, sizeof (size_t)); } while (0);
      for (; offset < c->size; offset++)
 do { char t0, t1, t2, t3; memcpy (&t0, e0 + offset, sizeof (char)); memcpy (&t1, e1 + offset, sizeof (char)); memcpy (&t2, e2 + offset, sizeof (char)); memcpy (&t3, e3 + offset, sizeof (char)); char *out = c->out + offset; if (__builtin_expect ((c->n == 5), 1)) memmove (out + 4*c->size, e4 + offset, sizeof (char)); memcpy (out, &t0, sizeof (char)); out += c->size; memcpy (out, &t1, sizeof (char)); out += c->size; memcpy (out, &t2, sizeof (char)); out += c->size; memcpy (out, &t3, sizeof (char)); } while (0);
    }
}
...
template<typename sort_ctx>
__attribute__ ((__noinline__)) static intptr_t
...
netsort (char *in, sort_ctx *c)
{
  ...
  do { intptr_t x = cmp1 (e1, e0, c); e0 = (char *)((intptr_t)e0 ^ x); e1 = (char *)((intptr_t)e1 ^ x); } while (0);
  if (__builtin_expect ((c->n == 3), 1))
    {
      do { intptr_t x = cmp1 (e2, e1, c); e1 = (char *)((intptr_t)e1 ^ x); e2 = (char *)((intptr_t)e2 ^ x); } while (0);
      do { intptr_t x = cmp1 (e1, e0, c); e0 = (char *)((intptr_t)e0 ^ x); e1 = (char *)((intptr_t)e1 ^ x); } while (0);
    }
  if (c->n <= 3)
    return reorder23 (c, e0, e1, e2);
  char *e3 = e2 + c->size, *e4 = e3 + c->size;
  if (__builtin_expect ((c->n == 5), 1))
    {
      do { intptr_t x = cmp1 (e4, e3, c); e3 = (char *)((intptr_t)e3 ^ x); e4 = (char *)((intptr_t)e4 ^ x); } while (0);
      do { intptr_t x = cmp1 (e4, e2, c); e2 = (char *)((intptr_t)e2 ^ x); e4 = (char *)((intptr_t)e4 ^ x); } while (0);
    }
  do { intptr_t x = cmp1 (e3, e2, c); e2 = (char *)((intptr_t)e2 ^ x); e3 = (char *)((intptr_t)e3 ^ x); } while (0);
  if (__builtin_expect ((c->n == 5), 1))
    {
      do { intptr_t x = cmp1 (e3, e0, c); e0 = (char *)((intptr_t)e0 ^ x); e3 = (char *)((intptr_t)e3 ^ x); } while (0);
      do { intptr_t x = cmp1 (e4, e1, c); e1 = (char *)((intptr_t)e1 ^ x); e4 = (char *)((intptr_t)e4 ^ x); } while (0);
    }
  do { intptr_t x = cmp1 (e2, e0, c); e0 = (char *)((intptr_t)e0 ^ x); e2 = (char *)((intptr_t)e2 ^ x); } while (0);
  do { intptr_t x = cmp1 (e3, e1, c); e1 = (char *)((intptr_t)e1 ^ x); e3 = (char *)((intptr_t)e3 ^ x); } while (0);
  do { intptr_t x = cmp1 (e2, e1, c); e1 = (char *)((intptr_t)e1 ^ x); e2 = (char *)((intptr_t)e2 ^ x); } while (0);
...
{
  if (__builtin_expect ((n <= c->nlim), 1))
    {
      c->out = out;
      c->n = n;
      return netsort (in, c);
...
# 228 "/home/giulianob/gcc_git_gnu/gcc/gcc/sort.cc"
  if (__builtin_expect ((c->cmp(r, l + (r - out) - c->size) < 0), 1))
    {
      char *end = out + n * c->size;
      if (sizeof (size_t) == 8 && __builtin_expect ((c->size == 8), 1))
 do { intptr_t mr = c->cmp (r, l) >> 31; intptr_t lr = (intptr_t)l ^ (intptr_t)r; lr = (intptr_t)l ^ (lr & mr); out = (char *)memcpy (out, (char *)lr, 8); out += 8; r += mr & 8; if (r == out) return; l += ~mr & 8; } while (r != end);
      else if (__builtin_expect ((c->size == 4), 1))
 do { intptr_t mr = c->cmp (r, l) >> 31; intptr_t lr = (intptr_t)l ^ (intptr_t)r; lr = (intptr_t)l ^ (lr & mr); out = (char *)memcpy (out, (char *)lr, 4); out += 4; r += mr & 4; if (r == out) return; l += ~mr & 4; } while (r != end);
      else
 do { intptr_t mr = c->cmp (r, l) >> 31; intptr_t lr = (intptr_t)l ^ (intptr_t)r; lr = (intptr_t)l ^ (lr & mr); out = (char *)memcpy (out, (char *)lr, c->size); out += c->size; r += mr & c->size; if (r == out) return; l += ~mr & c->size; } while (r != end);
    }
  memcpy (out, l, r - out);
}
