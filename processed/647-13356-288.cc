# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c" 2
...
extern Mem mem;
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c" 2
# 1 "d/id.h" 1
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c" 2
...
# 39 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c"
Expression *implicitCastTo(Expression *e, Scope *sc, Type *t)
{
    ...
    public:
        ...
        void visit(ArrayLiteralExp *e)
        {
                ...
                (typeb->ty == Tarray || typeb->ty == Tsarray))
            {
                ...
                ((void)(!(tbase->ty == Tsarray) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 704, __FUNCTION__), 0 : 0));
        ...
        void visit(CallExp *e)
        {
            ...
            if (e->f && e->f->isNested())
                return;
# 813 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c"
        ...
        void visit(AddrExp *e)
        {
                ...
                (t->ty == Tpointer || t->ty == Tdelegate) && t->nextOf()->ty == Tfunction)
            {
                ...
                for (size_t i = 0; i < eo->vars->a.length; i++)
                {
                    ...
                    ((void)(!(f2) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 902, __FUNCTION__), 0 : 0));
                ...
                e->e1->op == TOKvar)
            {
                ...
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 927, __FUNCTION__), 0 : 0));
            }
        ...
        void visit(NewExp *e)
        {
            ...
            if (result != MATCHnomatch)
                return;
# 1075 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c"
            ...
            if (ntb->isZeroInit(e->loc))
            {
                ...
                if (ntb->ty == Tclass)
                {
                    ...
                    ((void)(!(!cd->isInterfaceDeclaration()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 1198, __FUNCTION__), 0 : 0));
...
Type *toStaticArrayType(SliceExp *e)
{
    if (e->lwr && e->upr)
    {
        ...
        Expression *lwr = e->lwr->optimize(0);
        Expression *upr = e->upr->optimize(0);
...
# 1342 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c"
Expression *castTo(Expression *e, Scope *sc, Type *t)
{
...
# 1518 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c"
        ...
        void visit(StructLiteralExp *e)
        {
            ...
            if (result->op == TOKstructliteral)
                ((StructLiteralExp *)result)->stype = t;
        }
        ...
        void visit(StringExp *e)
        {
            ...
            if (e->committed && tb->ty == Tsarray && typeb->ty == Tarray)
            {
                ...
                ((void)(!(szx <= 255) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 1683, __FUNCTION__), 0 : 0));
            ...
            switch (((int)(tfty) * 256 + (int)(ttty)))
            {
                case ((int)(Tchar) * 256 + (int)(Tchar)):
                case ((int)(Twchar) * 256 + (int)(Twchar)):
                case ((int)(Tdchar) * 256 + (int)(Tdchar)):
                    break;

                case ((int)(Tchar) * 256 + (int)(Twchar)):
                ...
                case ((int)(Twchar) * 256 + (int)(Tdchar)):
                    for (size_t u = 0; u < e->len;)
                    {
                        unsigned c;
                        const char *p = utf_decodeWchar((unsigned short *)se->string, e->len, &u, &c);
                ...
                case ((int)(Tdchar) * 256 + (int)(Twchar)):
                    for (size_t u = 0; u < e->len; u++)
                    {
                        unsigned c = ((unsigned *)se->string)[u];
                        if (!utf_isValidDchar(c))
                ...
                L1:
                    ...
                    {
                        d_uns64 szx = tb->nextOf()->size();
                        ((void)(!(szx <= 255) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 1844, __FUNCTION__), 0 : 0));
                        se->sz = (unsigned char)szx;
                    }
                    break;

                default:
                    ((void)(!(typeb->nextOf()->size() != tb->nextOf()->size()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 1850, __FUNCTION__), 0 : 0));
                    goto Lcast;
            }
            }

        L2:
            ((void)(!(copied) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 1856, __FUNCTION__), 0 : 0));
            ...
            if (!tb->equals(e->type))
            {
                    ...
                    (t->ty == Tpointer || t->ty == Tdelegate) && t->nextOf()->ty == Tfunction)
                {
                    ...
                    for (size_t i = 0; i < eo->vars->a.length; i++)
                    {
                        Dsymbol *s = eo->vars->a[i];
                        FuncDeclaration *f2 = s->isFuncDeclaration();
                        ((void)(!(f2) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 1909, __FUNCTION__), 0 : 0));
                        if (f2->overloadExactMatch(t->nextOf()))
                        {
                            if (f)
                            {
                    ...
                    e->e1->op == TOKvar)
                {
                    ...
                    if (f)
                    {
                        ((void)(!(f->isImportedSymbol()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 1942, __FUNCTION__), 0 : 0));
        ...
        void visit(TupleExp *e)
        {
            ...
            result = te;
# 1997 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c"
        }
        ...
        void visit(ArrayLiteralExp *e)
        {
                ...
                (typeb->ty == Tarray || typeb->ty == Tsarray))
            {
                ...
                TypeVector *tv = (TypeVector *)tb;
                TypeSArray *tbase = (TypeSArray *)tv->basetype;
                ((void)(!(tbase->ty == Tsarray) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 2061, __FUNCTION__), 0 : 0));
                const size_t edim = e->elements->length;
                const size_t tbasedim = tbase->dim->toInteger();
                if (edim > tbasedim)
                    goto L1;
        ...
        void visit(AssocArrayLiteralExp *e)
        {
                ...
                tb->nextOf()->toBasetype()->ty != Tvoid)
            {
                ...
                ((void)(!(e->keys->length == e->values->length) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 2109, __FUNCTION__), 0 : 0));
                for (size_t i = 0; i < e->keys->length; i++)
                {
        ...
        void visit(SliceExp *e)
        {
            ...
            if (tsa && tsa->dim->equals(((TypeSArray *)tb)->dim))
            {
                ...
                if (t1b->ty == Tsarray)
                    ...
                    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 2350, __FUNCTION__), 0 : 0));
                if (e->e1->implicitConvTo(t1b) > MATCHnomatch)
                {
                    Expression *e1x = e->e1->implicitCastTo(sc, t1b);
                    ((void)(!(e1x->op != TOKerror) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 2354, __FUNCTION__), 0 : 0));
                    e = (SliceExp *)e->copy();
                    e->e1 = e1x;
                    e->type = t;
                    result = e;
...
# 2382 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c"
...
Expression *scaleFactor(BinExp *be, Scope *sc)
{
    ...
    else if (t2b->ty == Tpointer && t1b->isintegral())
    {
        ...
        ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 2528, __FUNCTION__), 0 : 0));

    if (sc->func && !sc->intypeof)
    {
        eoff = eoff->optimize(0);
...
# 2552 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c"
...
# 2605 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c"
bool typeMerge(Scope *sc, TOK op, Type **pt, Expression **pe1, Expression **pe2)
{
    ...
    Type *t1 = e1->type;
    Type *t2 = e2->type;
    ((void)(!(t1) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 2624, __FUNCTION__), 0 : 0));
    Type *t = t1;
    ...
    ((void)(!(t2) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 2637, __FUNCTION__), 0 : 0));
             ...
             (t1->ty == Tdelegate && t2->ty == Tdelegate))
    {
        ...
        else if (t1n->ty == Tfunction && t2n->ty == Tfunction)
        {
            ...
            if (tf1->purity != tf2->purity)
                d->purity = PUREimpure;
            ((void)(!(d->purity != PUREfwdref) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 2729, __FUNCTION__), 0 : 0));
...
Lcc:
    ...
    else if (t1->isintegral() && t2->isintegral())
    {
        ...
        ((void)(!(t1->ty == t2->ty) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 3146, __FUNCTION__), 0 : 0));
LmodCompare:
        if (!t1->isImmutable() && !t2->isImmutable() && t1->isShared() != t2->isShared())
            goto Lincompatible;
        unsigned char mod = MODmerge(t1->mod, t2->mod);
...
# 3346 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c"
bool arrayTypeCompatible(Loc loc, Type *t1, Type *t2)
{
...
# 3393 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c"
IntRange getIntRange(Expression *e)
{
    ...
    public:
        ...
        void visit(AndExp *e)
        {
            ...
            ((void)(!(hasResult) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 3465, __FUNCTION__), 0 : 0));
        ...
        void visit(OrExp *e)
        {
            ...
            ((void)(!(hasResult) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 3475, __FUNCTION__), 0 : 0));
            range = result.cast(e->type);
        }
        ...
        void visit(XorExp *e)
        {
            ...
            ((void)(!(hasResult) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dcast.c", 3485, __FUNCTION__), 0 : 0));
            range = result.cast(e->type);
        }
