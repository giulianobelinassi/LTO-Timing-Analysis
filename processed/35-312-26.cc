# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/wide-int-print.cc"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/wide-int-print.cc"
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/wide-int-print.cc"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/wide-int-print.cc" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/wide-int-print.cc" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/wide-int-print.cc" 2
# 32 "/home/giulianob/gcc_git_gnu/gcc/gcc/wide-int-print.cc"
void
...
{
  if ((wi.get_precision () <= 64)
      || (wi.get_len () == 1))
    {
      if (wi::neg_p (wi))
       sprintf (buf, "-" "%" 
# 61 "/home/giulianob/gcc_git_gnu/gcc/gcc/wide-int-print.cc" 3 4
                        "l" "u"
# 61 "/home/giulianob/gcc_git_gnu/gcc/gcc/wide-int-print.cc"
                                                    ,
   -(unsigned long) wi.to_shwi ());
      else
 sprintf (buf, "%" 
# 64 "/home/giulianob/gcc_git_gnu/gcc/gcc/wide-int-print.cc" 3 4
              "l" "d"
# 64 "/home/giulianob/gcc_git_gnu/gcc/gcc/wide-int-print.cc"
                                     , wi.to_shwi ());
    }
  else
    print_hex (wi, buf);
...
print_decu (const wide_int_ref &wi, char *buf)
{
  if ((wi.get_precision () <= 64)
    ...
    sprintf (buf, "%" 
# 89 "/home/giulianob/gcc_git_gnu/gcc/gcc/wide-int-print.cc" 3 4
                 "l" "u"
# 89 "/home/giulianob/gcc_git_gnu/gcc/gcc/wide-int-print.cc"
                                             , wi.to_uhwi ());
  else
    print_hex (wi, buf);
}
...
print_hex (const wide_int_ref &val, char *buf)
{
  if (val == 0)
    ...
    {
      buf += sprintf (buf, "0x");
      int start = ((val.get_precision ()) & ~((64) - 1));
      int width = val.get_precision () - start;
      bool first_p = true;
      for (int i = start; i >= 0; i -= 64)
 {
   unsigned long uhwi = wi::extract_uhwi (val, i, width);
   if (!first_p)
     buf += sprintf (buf, "%016" 
# 120 "/home/giulianob/gcc_git_gnu/gcc/gcc/wide-int-print.cc" 3 4
                         "l" "x"
# 120 "/home/giulianob/gcc_git_gnu/gcc/gcc/wide-int-print.cc"
                                                       , uhwi);
   else if (uhwi != 0)
     {
       buf += sprintf (buf, "%" 
# 123 "/home/giulianob/gcc_git_gnu/gcc/gcc/wide-int-print.cc" 3 4
                           "l" "x"
# 123 "/home/giulianob/gcc_git_gnu/gcc/gcc/wide-int-print.cc"
                                                       , uhwi);
       first_p = false;
     }
   width = 64;
