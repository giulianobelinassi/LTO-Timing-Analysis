# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c"
# 10 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c"
...
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
extern Mem mem;
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
# 1 "d/id.h" 1
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 30 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 31 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 32 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
void initPrecedence();
# 33 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 34 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 35 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 36 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c" 2
...
# 87 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c"
...
# 204 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c"
        ...
        if (v)
        {
            ...
            if (sc->func && !sc->intypeof && !v->isDataseg())
            {
                ...
                if (global.params.vsafe)
                {
                    ...
                    if (v->storage_class & 0x80000LL && sc->func->setUnsafe())
                    {
...
public:
    ...
    {
        ((void)(!(e->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 258, __FUNCTION__), 0 : 0));
        if (e->type->ty == Terror)
            return setError();
        ((void)(!(e->type->deco) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 261, __FUNCTION__), 0 : 0));
        e->normalize();
        result = e;
    }
    ...
    void visit(IdentifierExp *exp)
    {
        ...
        if (s)
        {
            ...
            if (withsym && withsym->withstate->wthis)
            {
                ...
                while (scwith->scopesym != scopesym)
                {
                    ...
                    ((void)(!(scwith) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 313, __FUNCTION__), 0 : 0));
                }
                ...
                for (Scope *scx = scwith; scx && scx->func == scwith->func; scx = scx->enclosing)
                {
                    ...
                    if (scx->scopesym && scx->scopesym->symtab &&
                        (s2 = scx->scopesym->symtab->lookup(s->ident)) != nullptr &&
                        s != s2)
                    {
            ...
            else
            {
                if (withsym)
                {
                    ...
                    if (d)
                        checkAccess(exp->loc, sc, nullptr, d);
                }
        ...
        if (exp->ident == Id::ctfe)
        {
            ...
            VarDeclaration *vd = new VarDeclaration(exp->loc, Type::tbool, Id::ctfe, nullptr);
            vd->storage_class |= 0x10000000000LL;
    ...
    void visit(ThisExp *e)
    {
        ...
        ((void)(!(fd->vthis) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 493, __FUNCTION__), 0 : 0));
        e->var = fd->vthis;
        ((void)(!(e->var->parent) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 495, __FUNCTION__), 0 : 0));
        e->type = e->var->type;
    ...
    void visit(SuperExp *e)
    {
        ...
        e->var = fd->vthis;
        ((void)(!(e->var && e->var->parent) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 553, __FUNCTION__), 0 : 0));
        ...
        if (s->isTemplateDeclaration())
            s = s->toParent();
        ((void)(!(s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 560, __FUNCTION__), 0 : 0));
        cd = s->isClassDeclaration();
    ...
    void visit(TypeExp *exp)
    {
        ...
        if (e)
        {
            ...
            if (ve && ve->var && exp->parens && !ve->var->isStatic() && !(sc->stc & 1LL) &&
        ...
        else if (s)
        {
            ...
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 840, __FUNCTION__), 0 : 0));
    ...
    void visit(ScopeExp *exp)
    {
        ...
        while (ti)
        {
            ...
            if (VarDeclaration *v = s->isVarDeclaration())
            {
                ...
                {
# 946 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c"
                    if (ti->inuse)
                    {
    ...
    void visit(NewExp *exp)
    {
        ...
        ClassDeclaration *cdthis = nullptr;
        if (exp->thisexp)
        {
        ...
        if (tb->ty == Tclass)
        {
            ...
            if (cd->isNested())
            {
                ...
                if (ClassDeclaration *cdn = s->isClassDeclaration())
                {
                    if (!cdthis)
                    {
                        ...
                        for (Dsymbol *sp = sc->parent; 1; sp = sp->parent)
                        {
                            ...
                            if (!cdp)
                                continue;
                            if (cdp == cdn || cdn->isBaseOf(cdp, nullptr))
                                break;
                    ...
                    if (cdthis != cdn && !cdn->isBaseOf(cdthis, nullptr))
                    {
                ...
                else if (FuncDeclaration *fdn = s->isFuncDeclaration())
                {
                    ...
                    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 1171, __FUNCTION__), 0 : 0));
            }
            else if (exp->thisexp)
            {
                exp->error("e.new is only for allocating nested classes");
            ...
            if (cd->aggNew)
            {
                ...
                FuncDeclaration *f = resolveFuncCall(exp->loc, sc, cd->aggNew, nullptr, tb, exp->newargs);
                if (!f || f->errors)
                    return setError();
                ...
                Type *rettype;
                if (functionParameters(exp->loc, sc, tf, nullptr, exp->newargs, f, &rettype, &newprefix))
                    return setError();

                exp->allocator = f->isNewDeclaration();
                ((void)(!(exp->allocator) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 1202, __FUNCTION__), 0 : 0));
            }
            else
            {
            ...
            if (cd->ctor)
            {
                FuncDeclaration *f = resolveFuncCall(exp->loc, sc, cd->ctor, nullptr, tb, exp->arguments, 0);
                if (!f || f->errors)
                    return setError();
                exp->checkDeprecated(sc, f);
                exp->checkPurity(sc, f);
                ...
                ((void)(!(exp->member) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 1231, __FUNCTION__), 0 : 0));
            }
            else
            {
                if (nargs)
                ...
                for (ClassDeclaration *c = cd; c; c = c->baseClass)
                {
                    for (size_t i = 0; i < c->fields.length; i++)
                    {
                        ...
                        if (v->inuse || v->_scope == nullptr || v->_init == nullptr ||
        ...
        else if (tb->ty == Tstruct)
        {
            ...
            if (sd->aggNew)
            {
                ...
                FuncDeclaration *f = resolveFuncCall(exp->loc, sc, sd->aggNew, nullptr, tb, exp->newargs);
                if (!f || f->errors)
                    return setError();
                exp->checkDeprecated(sc, f);
                exp->checkPurity(sc, f);
                ...
                exp->allocator = f->isNewDeclaration();
                ((void)(!(exp->allocator) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 1297, __FUNCTION__), 0 : 0));
            }
            else
            {
                if (exp->newargs && exp->newargs->length)
            ...
            if (sd->ctor && nargs)
            {
                FuncDeclaration *f = resolveFuncCall(exp->loc, sc, sd->ctor, nullptr, tb, exp->arguments, 0);
                if (!f || f->errors)
                    return setError();
                exp->checkDeprecated(sc, f);
                exp->checkPurity(sc, f);
                ...
                exp->member = f->isCtorDeclaration();
                ((void)(!(exp->member) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 1326, __FUNCTION__), 0 : 0));
    ...
    void visit(FuncExp *exp)
    {
        ...
        {
# 1562 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c"
            exp->genIdent(sc);


            if (exp->fd->treq && !exp->fd->type->nextOf())
            {
                TypeFunction *tfv = nullptr;
            ...
            if (exp->td)
            {
                ((void)(!(exp->td->parameters && exp->td->parameters->length) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 1581, __FUNCTION__), 0 : 0));
                exp->td->semantic(sc);
                exp->type = Type::tvoid;
            ...
            else
            {
                ...
                exp->type = exp->type->semantic(exp->loc, sc);
# 1635 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c"
                if (exp->fd->treq && exp->fd->treq->ty == Tpointer)
                {

                    exp->fd->tok = TOKfunction;
                    exp->fd->vthis = nullptr;
                }
            }
    ...
    Expression *callExpSemantic(FuncExp *exp, Scope *sc, Expressions *arguments)
    {
        if ((!exp->type || exp->type == Type::tvoid) && exp->td && arguments && arguments->length)
        {
            ...
            ((void)(!(exp->td->parameters && exp->td->parameters->length) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 1662, __FUNCTION__), 0 : 0));
            exp->td->semantic(sc);
    ...
    void visit(DeclarationExp *e)
    {
                ...
                else
                {
                    ...
                    for (Scope *scx = sc->enclosing; scx && (scx->func == sc->func || (scx->func && sc->func->fes)); scx = scx->enclosing)
                    {
                            ...
                            s != s2)
                        {
                            ...
                            if (!decl || !(decl->storage_class & 0x8000000000000LL))
                            {
                                if (sc->func->fes)
                                {
        ...
        {
            Scope *sc2 = sc;
            if (sc2->stc & (0x4000000LL | 0x2000000LL | 0x40000000000LL))
                sc2 = sc->push();
            sc2->stc &= ~(0x4000000LL | 0x2000000LL | 0x40000000000LL);
    ...
    void visit(IsExp *e)
    {
        ...
        if (e->tok2 != TOKreserved)
        {
            switch (e->tok2)
            {
                ...
                case TOKsuper:
                    ...
                    else
                    {
                        ...
                        for (size_t i = 0; i < cd->baseclasses->length; i++)
                        {
                            ...
                            args->push(new Parameter(0x800LL, b->type, nullptr, nullptr));
                        }
                ...
                case TOKparameters:
                    {
                        ...
                        ((void)(!(tded->ty == Tfunction) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 2037, __FUNCTION__), 0 : 0));
                        ...
                        for (size_t i = 0; i < dim; i++)
                        {
                            ...
                            ((void)(!(arg && arg->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 2045, __FUNCTION__), 0 : 0));
                            ...
                            args->push(new Parameter(arg->storageClass, arg->type,
                                                     (e->tok2 == TOKparameters) ? arg->ident : nullptr,
                                                     (e->tok2 == TOKparameters) ? arg->defaultArg : nullptr));
                        }
                        tded = new TypeTuple(args);
                        break;
                    }
                ...
                default:
                    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 2098, __FUNCTION__), 0 : 0));
            }
            goto Lyes;
        }
        ...
        {
# 2138 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c"
            Identifier *tid = e->id ? e->id : Identifier::generateId("__isexp_id");
            e->parameters->insert(0, new TemplateTypeParameter(e->loc, tid, nullptr, nullptr));
    ...
    void visit(BinAssignExp *exp)
    {
        ...
        ((void)(!(e->op == TOKassign || e == exp) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 2324, __FUNCTION__), 0 : 0));
    ...
    void visit(CompileExp *exp)
    {
        ...
        if (p.errors)
        {
            ((void)(!(global.errors != errors) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 2341, __FUNCTION__), 0 : 0));
            return setError();
        }
    ...
    void visit(DotVarExp *exp)
    {
        ...
        if (FuncDeclaration *fd = exp->var->isFuncDeclaration())
        {
            ...
            exp->type = fd->type;
            ((void)(!(exp->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 2594, __FUNCTION__), 0 : 0));
        }
        ...
        else
        {
            ...
            ((void)(!(exp->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 2608, __FUNCTION__), 0 : 0));
            ...
            AggregateDeclaration *ad = vparent ? vparent->isAggregateDeclaration() : nullptr;
            ...
            if (v && (v->isDataseg() || (v->storage_class & 0x800000LL)))
            {
        ...
        if (exp->e1->op == TOKscope)
        {
            ...
            if (ti)
            {
                ...
                if (ti->needsTypeInference(sc, 1))
                {
                    ...
                    tiargs = ti->tiargs;
                    ((void)(!(ti->tempdecl) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 2808, __FUNCTION__), 0 : 0));
                    if (TemplateDeclaration *td = ti->tempdecl->isTemplateDeclaration())
        ...
        if (exp->e1->op == TOKdotti && !exp->e1->type)
        {
            ...
            TemplateInstance *ti = se->ti;
            {
                ...
                if (ti->needsTypeInference(sc, 1))
                {
                    ...
                    tiargs = ti->tiargs;
                    ((void)(!(ti->tempdecl) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 2851, __FUNCTION__), 0 : 0));
                    if (TemplateDeclaration *td = ti->tempdecl->isTemplateDeclaration())
    ...
    Lagain:
        ...
        else
        {
            ...
            if (exp->e1->op == TOKvar)
            {
                ...
                if (ve->var->storage_class & 0x2000LL)
                {
                    ...
                    TypeFunction *tf = new TypeFunction(ParameterList(), tc, LINKd, 0x200000000LL | 0x4000000LL);
                    (tf = (TypeFunction *)tf->semantic(exp->loc, sc))->next = tw;
        ...
        t1 = exp->e1->type ? exp->e1->type->toBasetype() : nullptr;
        ...
        if (t1)
        {
            if (t1->ty == Tstruct)
            {
                ...
                if (exp->e1->op == TOKtype && sd->ctor)
                {
                    ...
                    StructLiteralExp *sle = new StructLiteralExp(exp->loc, sd, nullptr, exp->e1->type);
                    ...
                    else if (OverloadSet *os = sd->ctor->isOverloadSet())
                    {
                        ...
                        ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 3016, __FUNCTION__), 0 : 0));
            ...
            exp->e1->op == TOKdottd)
        {
            ...
            VarDeclaration *v;
            if (ue1->op == TOKvar &&
                (v = ((VarExp *)ue1)->var->isVarDeclaration()) != nullptr &&
                v->needThis())
            {
            ...
            exp->f = resolveFuncCall(exp->loc, sc, s, tiargs, ue1 ? ue1->type : nullptr, exp->arguments);
            ...
            if (exp->f->interfaceVirtual)
            {
                ...
                ((void)(!(vi >= 0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 3132, __FUNCTION__), 0 : 0));
                exp->f = ad2->vtbl[vi]->isFuncDeclaration();
                ((void)(!(exp->f) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 3134, __FUNCTION__), 0 : 0));
            }
            if (exp->f->needThis())
            {
            ...
            else
            {
                ...
                if (ad && cd && ad->isClassDeclaration())
                {
                    if (ue->e1->op == TOKdottype)
                    {
                        ...
                        exp->directcall = true;
                    else if ((cd->storage_class & 8LL) != 0)
                        exp->directcall = true;
        ...
        else if (exp->e1->op == TOKsuper)
        {
            ...
            AggregateDeclaration *ad = sc->func ? sc->func->isThis() : nullptr;
            ...
            if (!sc->intypeof && !(sc->callSuper & 0x80))
            {
                if (sc->noctor || sc->callSuper & 0x10)
                    exp->error("constructor calls not allowed in loops or after labels");
                if (sc->callSuper & (2 | 1))
                    exp->error("multiple constructor calls");
                if ((sc->callSuper & 0x20) && !(sc->callSuper & 0x40))
            ...
            if (OverloadSet *os = cd->baseClass->ctor->isOverloadSet())
                exp->f = resolveOverloadSet(exp->loc, sc, os, nullptr, tthis, exp->arguments);
            else
                exp->f = resolveFuncCall(exp->loc, sc, cd->baseClass->ctor, nullptr, tthis, exp->arguments, 0);
        ...
        else if (exp->e1->op == TOKthis)
        {
            ...
            if (OverloadSet *os = ad->ctor->isOverloadSet())
                ...
                exp->f = resolveFuncCall(exp->loc, sc, ad->ctor, nullptr, tthis, exp->arguments, 0);
            if (!exp->f || exp->f->errors)
                return setError();
            exp->checkDeprecated(sc, exp->f);
            exp->checkPurity(sc, exp->f);
        ...
        else if (t1->ty != Tfunction)
        {
            ...
            if (exp->e1->op == TOKfunction)
            {
                ...
                ((void)(!(((FuncExp *)exp->e1)->fd) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 3345, __FUNCTION__), 0 : 0));
            ...
            else if (t1->ty == Tdelegate)
            {
                ...
                ((void)(!(td->next->ty == Tfunction) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 3353, __FUNCTION__), 0 : 0));
            ...
            L2:
                exp->f = resolveFuncCall(exp->loc, sc, s, tiargs, nullptr, exp->arguments);
                if (!exp->f || exp->f->errors)
                    return setError();
                if (exp->f->needThis())
                {
            ...
            if (!tf->callMatch(nullptr, exp->arguments))
            {
                OutBuffer buf;
            ...
            else if (sc->func && sc->intypeof != 1 && !(sc->flags & 0x0080))
            {
                bool err = false;
                if (!tf->purity && !(sc->flags & 0x0008) && sc->func->setImpure())
                {
        ...
        else if (exp->e1->op == TOKvar)
        {
            ...
            ((void)(!(exp->f) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 3486, __FUNCTION__), 0 : 0));
            tiargs = nullptr;

            if (ve->hasOverloads)
                exp->f = resolveFuncCall(exp->loc, sc, exp->f, tiargs, nullptr, exp->arguments, 2);
            else
            {
        ...
        ((void)(!(t1->ty == Tfunction) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 3557, __FUNCTION__), 0 : 0));
    ...
    void visit(AddrExp *exp)
    {
        ...
        exp->e1 = exp->e1->toLvalue(sc, nullptr);
        if (exp->e1->op == TOKerror)
        {
            result = exp->e1;
            return;
        ...
        if (exp->e1->op == TOKdotvar)
        {
            ...
            else if ((dve->e1->op == TOKthis || dve->e1->op == TOKsuper) && global.params.vsafe)
            {
                ...
                VarDeclaration *v = ve->var->isVarDeclaration();
                if (v && v->storage_class & 0x200000LL)
                {
                    if (!checkAddressVar(sc, exp, v))
                        return setError();
                }
        ...
        else if (wasCond)
        {
            ...
            ((void)(!(exp->e1->op == TOKstar) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 3843, __FUNCTION__), 0 : 0));
            PtrExp *pe = (PtrExp *)exp->e1;
            ((void)(!(pe->e1->op == TOKquestion) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 3845, __FUNCTION__), 0 : 0));
            CondExp *ce = (CondExp *)pe->e1;
            ((void)(!(ce->e1->op == TOKaddress) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 3847, __FUNCTION__), 0 : 0));
            ((void)(!(ce->e2->op == TOKaddress) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 3848, __FUNCTION__), 0 : 0));
    ...
    {
        ((void)(!(!exp->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 3945, __FUNCTION__), 0 : 0));
    ...
    void visit(DeleteExp *exp)
    {
        ...
        exp->e1 = resolveProperties(sc, exp->e1);
        exp->e1 = exp->e1->modifiableLvalue(sc, nullptr);
        if (exp->e1->op == TOKerror)
        {
            result = exp->e1;
            return;
        ...
        { case Tclass:
            ...
            if (tb->ty == Tstruct)
            {
                ...
                Expression *ea = nullptr;
                Expression *eb = nullptr;
                Expression *ec = nullptr;
                ...
                ((void)(!(ea) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 4132, __FUNCTION__), 0 : 0));
                result = ea;
                return;
            }
            break;
    ...
    void visit(VectorExp *exp)
    {
        ...
        Type *tb = exp->type->toBasetype();
        ((void)(!(tb->ty == Tvector) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 4340, __FUNCTION__), 0 : 0));
    ...
    void visit(VectorArrayExp *e)
    {
        if (!e->type)
        {
            ...
            ((void)(!(e->e1->type->ty == Tvector) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 4376, __FUNCTION__), 0 : 0));
    ...
    void visit(SliceExp *exp)
    {
        ...
        if (t1b->ty == Ttuple)
        {
            ...
            else if (exp->e1->op == TOKtype)
            {
                ...
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 4600, __FUNCTION__), 0 : 0));
        ...
        if (exp->lwr && exp->upr)
        {
            exp->lwr = exp->lwr->optimize(0);
            exp->upr = exp->upr->optimize(0);
            ...
            else if (t1b->ty == Tpointer)
            {
                ...
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 4667, __FUNCTION__), 0 : 0));
    ...
    {
        ((void)(!(!exp->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 4766, __FUNCTION__), 0 : 0));
    ...
    void visit(IndexExp *exp)
    {
        ...
        if (!exp->e1->type)
            exp->e1 = semantic(exp->e1, sc);
        ((void)(!(exp->e1->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 4854, __FUNCTION__), 0 : 0));
        if (exp->e1->op == TOKtype && exp->e1->type->ty != Ttuple)
        {
            exp->e2 = semantic(exp->e2, sc);
        ...
        if (exp->e2->op == TOKtuple)
        {
            ...
            if (te->exps && te->exps->length == 1)
                exp->e2 = Expression::combine(te->e0, (*te->exps)[0]);
        }
        if (sc != scx)
            sc = sc->pop();
            ...
            case Taarray:
                {
                    ...
                    {
                        exp->e2 = exp->e2->implicitCastTo(sc, taa->index);
                        if (exp->e2->type == Type::terror)
                            return setError();
                    }
            ...
            case Ttuple:
                {
                    ...
                    else if (exp->e1->op == TOKtype)
                    {
                        ...
                        ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 5000, __FUNCTION__), 0 : 0));
    ...
    void visit(PostExp *exp)
    {
        ...
        if (t1->ty == Tclass || t1->ty == Tstruct || exp->e1->op == TOKarraylength)
        {
            ...
            if (exp->e1->op != TOKvar && exp->e1->op != TOKarraylength)
            {
                ...
                VarDeclaration *v = copyToTemp(0x200000LL, "__postref", exp->e1);
    ...
    void visit(AssignExp *exp)
    {
        ...
        if (exp->e1->op == TOKarray)
        {
            ...
            {
                ((void)(!((*ae->arguments)[0]->op == TOKinterval) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 5204, __FUNCTION__), 0 : 0));
...

        {
            ...
            if (e1x->checkRightThis(sc))
                return setError();
            exp->e1 = e1x;
            ((void)(!(exp->e1->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 5385, __FUNCTION__), 0 : 0));
        }
        Type *t1 = exp->e1->type->toBasetype();
        ...
        Ltupleassign:
            ...
            if (exp->e1->op == TOKtuple)
            {
                ...
                ((void)(!(exp->e1->type->ty == Ttuple) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 5458, __FUNCTION__), 0 : 0));
        ...
        if (exp->op == TOKassign && exp->e1->checkModifiable(sc) == 2)
        {
            ...
            if (exp->e1->op == TOKindex)
            {
                ...
                if (e1x->op == TOKerror)
                {
                 ...
                 ((VarExp *)exp->e1)->var->storage_class & (0x1000LL | 0x200000LL))
        {
        ...
        else if (t1->ty == Tstruct)
        {
            ...
            if (exp->op == TOKconstruct)
            {
                ...
                if (t2->ty == Tstruct && sd == ((TypeStruct *)t2)->sym)
                {
                    ...
                    CallExp *ce = (e2y->op == TOKcall) ? (CallExp *)e2y : nullptr;
                    DotVarExp *dve = (ce && ce->e1->op == TOKdotvar)
                        ? (DotVarExp *)ce->e1 : nullptr;
                    if (sd->ctor && ce && dve && dve->var->isCtorDeclaration() &&
                        e2y->type->implicitConvTo(t1))
                    {
# 5572 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c"
                        AssignExp *ae = exp;
            ...
            else if (exp->op == TOKassign)
            {
                ...
                {
# 5731 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c"
                    ...
                    ae->e1 = semantic(ae->e1, sc);
                    ae->e1 = ae->e1->optimize(0);
                    ae->e2 = ev;
                    Expression *e = ae->op_overload(sc);
                    if (e)
                    {
                        Expression *ey = nullptr;
                        ...
                        else if (!ev->implicitConvTo(ie->type) && sd->ctor)
                        {
                            ...
                            ey = new StructLiteralExp(exp->loc, sd, nullptr);
                ...
                ((void)(!(exp->op == TOKblit) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 5805, __FUNCTION__), 0 : 0));
        ...
        else if (t1->ty == Tsarray)
        {
            ...
            ((void)(!(exp->e1->op != TOKslice) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 5826, __FUNCTION__), 0 : 0));
            ...
            if (e2x->implicitConvTo(e1x->type))
            {
                ...
                if (isUnaArrayOp(e2x->op) || isBinArrayOp(e2x->op))
                {
                    ...
                    SliceExp *sle = new SliceExp(e1x->loc, e1x, nullptr, nullptr);
                    sle->arrayop = true;
                    e1x = semantic(sle, sc);
                }
                else
                 ...
                 t2->nextOf()->implicitConvTo(t1->nextOf()))
        {
            ...
            {
# 6067 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c"
        ...
        if (exp->e1->op == TOKvar && exp->op == TOKassign)
        {
            ...
            {
                ((void)(!(t1->ty == Tclass) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 6159, __FUNCTION__), 0 : 0));
        ...
        exp->type = exp->e1->type;
        ((void)(!(exp->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 6169, __FUNCTION__), 0 : 0));
    ...
    void visit(PowAssignExp *exp)
    {
        ...
        ((void)(!(exp->e1->type && exp->e2->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 6285, __FUNCTION__), 0 : 0));
        if (exp->e1->op == TOKslice || exp->e1->type->ty == Tarray || exp->e1->type->ty == Tsarray)
        {
            if (checkNonAssignmentArrayOp(exp->e1))
                return setError();
            ...
            (exp->e2->type->isintegral() || exp->e2->type->isfloating()))
        {
            ...
            ((void)(!(e == exp) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 6328, __FUNCTION__), 0 : 0));
            ...
            else
            {
                ...
                VarDeclaration *v = copyToTemp(0x200000LL, "__powtmp", exp->e1);
    ...
    void visit(AddExp *exp)
    {
            ...
            (tb1->isimaginary() && exp->e2->type->isreal()))
        {
            switch (exp->type->toBasetype()->ty)
            {
                ...
                default:
                    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 6449, __FUNCTION__), 0 : 0));
            }
        }
        result = exp;
    }
    ...
    void visit(MinExp *exp)
    {
            ...
            (t1->isimaginary() && t2->isreal()))
        {
            switch (exp->type->ty)
            {
                ...
                default:
                    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 6582, __FUNCTION__), 0 : 0));
            }
        }
        result = exp;
    }
    ...
    void visit(CatExp *exp)
    {
        ...
        {
# 6648 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c"
            goto Lpeer;
        }
            ...
            else if (t1->isimaginary())
            {
                if (t2->isimaginary())
                {
                    ...
                    switch (t1->toBasetype()->ty)
                    {
                        ...
                        default:
                            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 6858, __FUNCTION__), 0 : 0));
                    }
            ...
            else if (t1->isimaginary())
            {
                if (t2->isimaginary())
                {
                    switch (t1->toBasetype()->ty)
                    {
                        ...
                        default:
                            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 6967, __FUNCTION__), 0 : 0));
                    }
                }
                else
                    exp->type = t2;
    ...
    Module *loadStdMath()
    {
        static Import *impStdMath = nullptr;
        if (!impStdMath)
        {
            Identifiers *a = new Identifiers();
            a->push(Id::std);
            Import *s = new Import(Loc(), a, Id::math, nullptr, false);
            s->load(nullptr);
            if (s->mod)
            {
                s->mod->importAll(nullptr);
                s->mod->semantic(nullptr);
            }
            impStdMath = s;
        }
...
# 8019 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c"
        exp->hookDtors(sc);
...
Expression *semanticX(DotIdExp *exp, Scope *sc)
{
    ...
    if (exp->ident == Id::_mangleof)
    {
        ...
        switch (exp->e1->op)
        {
            ...
            L1:
                {
                    ((void)(!(ds) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 8177, __FUNCTION__), 0 : 0));
    ...
    if (exp->e1->op == TOKtuple && exp->ident == Id::offsetof)
    {
        ...
        Expression *e = new TupleExp(exp->loc, nullptr, exps);
        e = semantic(e, sc);
        return e;
    }
...
Expression *semanticY(DotIdExp *exp, Scope *sc, int flag)
{
# 8263 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c"
    ...
    if (eright->op == TOKscope)
    {
        ...
        if (s && !(sc->flags & 0x0200) && !symbolIsVisible(sc->_module, s))
        {
            if (s->isDeclaration())
        ...
        if (s)
        {
            ...
            if (v)
            {
                ...
                if ((v->storage_class & 0x800000LL) && v->_init && !exp->wantsym)
                {
            ...
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 8480, __FUNCTION__), 0 : 0));
        }
...
Expression *semanticY(DotTemplateInstanceExp *exp, Scope *sc, int flag)
{
    ...
    ((void)(!(e) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expressionsem.c", 8573, __FUNCTION__), 0 : 0));
