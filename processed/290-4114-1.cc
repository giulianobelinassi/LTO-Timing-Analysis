# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/init.h" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c" 2
# 1 "d/id.h" 1
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c" 2
...
void initTypeMangle()
{
    ...
    for (size_t i = 0; i < TMAX; i++)
    {
        if (!mangleChar[i])
            fprintf(
# 90 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c" 3 4
                   stderr
# 90 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c"
                         , "ty = %llu\n", (ulonglong)i);
        ((void)(!(mangleChar[i]) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c", 91, __FUNCTION__), 0 : 0));
    }
}
...
void MODtoDecoBuffer(OutBuffer *buf, MOD mod)
{
    switch (mod)
    {
        ...
        case MODshared | MODwildconst:
            ...
            break;
        default:
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c", 129, __FUNCTION__), 0 : 0));
    }
}
...
# 150 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c"
    ...
    void mangleFuncType(TypeFunction *t, TypeFunction *ta, unsigned char modMask, Type *tret)
    {
        ...
        switch (t->linkage)
        {
            ...
            default:
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c", 230, __FUNCTION__), 0 : 0));
        }
        buf->writeByte(mc);
        ...
        buf->writeByte('Z' - t->parameterList.varargs);
        if (tret != nullptr)
    ...
    void mangleDecl(Declaration *sthis)
    {
        ...
        ((void)(!(sthis->ident) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c", 326, __FUNCTION__), 0 : 0));
        ...
        else if (sthis->type->deco)
        {
            ...
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c", 339, __FUNCTION__), 0 : 0));
    }
    ...
    void mangleFunc(FuncDeclaration *fd, bool inParent)
    {
        ...
        else
        {
            ...
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c", 386, __FUNCTION__), 0 : 0));
        }
    }
    ...
    void visit(Declaration *d)
    {
        ...
        if (!d->parent || d->parent->isModule() || d->linkage == LINKcpp)
        {
            switch (d->linkage)
            {
                ...
                default:
                    fprintf(
# 433 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c" 3 4
                           stderr
# 433 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c"
                                 , "'%s', linkage = %d\n", d->toChars(), d->linkage);
                    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c", 434, __FUNCTION__), 0 : 0));
                    return;
            }
        }
...
# 466 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c"
    ...
    {
        ((void)(!(!fd->isFuncAliasDeclaration()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c", 521, __FUNCTION__), 0 : 0));
    ...
    {
# 642 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c"
        ...
        else
        {
            ...
            ((void)(!(n < BUFFER_LEN) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c", 651, __FUNCTION__), 0 : 0));
    ...
    void visit(StringExp *e)
    {
        ...
        switch (e->sz)
        {
            ...
            default:
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c", 738, __FUNCTION__), 0 : 0));
        }
        buf->reserve(1 + 11 + 2 * qlen);
        buf->writeByte(m);
        buf->printf("%d_", (int)qlen);
    ...
    {
        if (p->storageClass & 0x80000LL && !(p->storageClass & 0x2000000000000LL))
            buf->writeByte('M');

        if ((p->storageClass & (0x100000000000LL | 0x80000000LL)) == 0x100000000000LL)
            buf->writestring("Nk");
        switch (p->storageClass & (0x800LL | 0x1000LL | 0x200000LL | 0x2000LL))
        {
            case 0:
            case 0x800LL:
                break;
            ...
            case 0x2000LL:
                ...
                break;
            default:
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmangle.c", 826, __FUNCTION__), 0 : 0));
        }
