# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 2
...
extern Mem mem;
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/speller.h" 1
# 9 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/speller.h"
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 2
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 2
...
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 2
...
# 30 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 2
...
# 31 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 2
...
# 32 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 2
...
# 33 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 2
...
# 34 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 2
...
Dsymbol *Dsymbol::syntaxCopy(Dsymbol *)
{
    print();
    printf("%s %s\n", kind(), toChars());
    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c", 105, __FUNCTION__), 0 : 0));
    return nullptr;
}
# 117 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
    ...
    if (members)
    {
        for (size_t i = 0; i < members->length; i++)
        {
            ...
            if (!x)
            {
                ...
                ((void)(!(*ps == nullptr) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c", 143, __FUNCTION__), 0 : 0));
                return false;
            }
            if (*ps)
            {
                ((void)(!(ident) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c", 148, __FUNCTION__), 0 : 0));
                ...
                else if (s->isOverloadable() && (*ps)->isOverloadable())
                {
                    ...
                    if (f1 && f2)
                    {
                        ((void)(!(!f1->isFuncAliasDeclaration()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c", 160, __FUNCTION__), 0 : 0));
                        ((void)(!(!f2->isFuncAliasDeclaration()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c", 161, __FUNCTION__), 0 : 0));
                        for (; f1 != f2; f1 = f1->overnext0)
                        {
                            if (f1->overnext0 == nullptr)
                            {
                                f1->overnext0 = f2;
                                break;
                            }
...
# 322 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
...
# 378 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
Dsymbol *Dsymbol::toParent()
{
    return parent ? parent->pastMixinAndNspace() : nullptr;
}
...
{
    return parent ? parent->pastMixin() : nullptr;
}
...
# 502 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
...
Dsymbol *Dsymbol::searchX(Loc loc, Scope *sc, RootObject *id)
{
    ...
    switch (id->dyncast())
    {
        ...
        default:
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c", 600, __FUNCTION__), 0 : 0));
    }
    return sm;
}
...
AggregateDeclaration *Dsymbol::isMember()
{
    ...
    return parent ? parent->isAggregateDeclaration() : nullptr;
}
...
ClassDeclaration *Dsymbol::isClassMember()
{
    ...
    return ad ? ad->isClassDeclaration() : nullptr;
}
...
# 698 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
...
# 734 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 3 4
   __builtin_va_start(
# 734 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
   ap
# 734 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 3 4
   ,
# 734 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
...
# 736 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 3 4
   __builtin_va_end(
# 736 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
   ap
# 736 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 3 4
   )
# 736 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
...
# 742 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 3 4
   __builtin_va_start(
# 742 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
   ap
# 742 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 3 4
   ,
# 742 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
...
# 744 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 3 4
   __builtin_va_end(
# 744 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
   ap
# 744 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 3 4
   )
# 744 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
...
# 750 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 3 4
   __builtin_va_start(
# 750 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
   ap
# 750 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 3 4
   ,
# 750 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
...
# 752 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 3 4
   __builtin_va_end(
# 752 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
   ap
# 752 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 3 4
   )
# 752 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
...
# 758 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 3 4
   __builtin_va_start(
# 758 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
   ap
# 758 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 3 4
   ,
# 758 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
...
# 760 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 3 4
   __builtin_va_end(
# 760 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
   ap
# 760 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c" 3 4
   )
# 760 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
...
void Dsymbol::checkDeprecated(Loc loc, Scope *sc)
{
    if (global.params.useDeprecated != DIAGNOSTICoff && isDeprecated())
    {
        ...
        for (Dsymbol *p = this; p; p = p->parent)
        {
            message = p->depdecl ? p->depdecl->getMessage() : nullptr;
            if (message)
                break;
        }
  ...
  L1:
    ...
    if (d && d->storage_class & 0x2000000000LL)
    {
        if (!(sc->func && sc->func->storage_class & 0x2000000000LL))
        {
...
{
    ((void)(!(forward) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c", 967, __FUNCTION__), 0 : 0));
    if (Declaration *d = s->isDeclaration())
    {
...
{
    ((void)(!(forward) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c", 998, __FUNCTION__), 0 : 0));
...
Dsymbol *ScopeDsymbol::search(const Loc &loc, Identifier *ident, int flags)
{
    ...
    if (importedScopes)
    {
        ...
        for (size_t i = 0; i < importedScopes->length; i++)
        {
            ...
            int sflags = flags & (IgnoreErrors | IgnoreAmbiguous | IgnoreSymbolVisibility);
        ...
        if (s)
        {
                ...
                !s->isOverloadable() && !s->parent->isTemplateMixin() && !s->parent->isNspace())
            {
                ...
                if (s->isImport() || ((ad = s->isAliasDeclaration()) != nullptr && ad->_import != nullptr))
                {}
                else
...
OverloadSet *ScopeDsymbol::mergeOverloadSet(Identifier *ident, OverloadSet *os, Dsymbol *s)
{
    ...
    {
        ((void)(!(s->isOverloadable()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c", 1249, __FUNCTION__), 0 : 0));
...
{
    array->ptr[idx / (sizeof(size_t) * 8)] |= 1ULL << (idx % (sizeof(size_t) * 8));
}

static bool bitArrayGet(BitArray *array, size_t idx)
{
    const size_t boffset = idx % (sizeof(size_t) * 8);
    return (array->ptr[idx / (sizeof(size_t) * 8)] & (1ULL << boffset)) >> boffset;
}
...
static void bitArrayLength(BitArray *array, size_t len)
{
    if (array->len < len)
    {
        const size_t obytes = (array->len + (sizeof(size_t) * 8) - 1) / (sizeof(size_t) * 8);
        const size_t nbytes = (len + (sizeof(size_t) * 8) - 1) / (sizeof(size_t) * 8);
        ...
        array->len = nbytes * (sizeof(size_t) * 8);
    }
}
...
{
    size_t n = 0;
    ScopeDsymbol_foreach(nullptr, members, &dimDg, &n);
    return n;
}
# 1447 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
...
{
    GetNthSymbolCtx ctx = { nth, nullptr };
    int res = ScopeDsymbol_foreach(nullptr, members, &getNthSymbolDg, &ctx);
    return res ? ctx.sym : nullptr;
}
# 1479 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
int ScopeDsymbol_foreach(Scope *sc, Dsymbols *members, ForeachDg dg, void *ctx, size_t *pn)
{
    ((void)(!(dg) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c", 1481, __FUNCTION__), 0 : 0));
    if (!members)
        return 0;
...
FuncDeclaration *ScopeDsymbol::findGetMembers()
{
    ...
    FuncDeclaration *fdx = s ? s->isFuncDeclaration() : nullptr;
...
Dsymbol *WithScopeSymbol::search(const Loc &loc, Identifier *ident, int flags)
{
    ...
    for (Expression *e = withstate->exp; e != eold; e = resolveAliasThis(_scope, e))
    {
        ...
        {
            s = e->type->toDsymbol(nullptr);
        }
        else
        {
            Type *t = e->type->toBasetype();
            s = t->toDsymbol(nullptr);
        }
        if (s)
        {
...
ArrayScopeSymbol::ArrayScopeSymbol(Scope *sc, Expression *e)
    : ScopeDsymbol()
{
    ((void)(!(e->op == TOKindex || e->op == TOKslice || e->op == TOKarray) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c", 1576, __FUNCTION__), 0 : 0));
    exp = e;
    type = nullptr;
    td = nullptr;
    this->sc = sc;
...
Dsymbol *ArrayScopeSymbol::search(const Loc &loc, Identifier *ident, int)
{
    ...
    L1:
        if (td)
        {
            ...
            VarDeclaration *v = new VarDeclaration(loc, Type::tsize_t, Id::dollar, nullptr);
            Expression *e = new IntegerExp(Loc(), td->objects->length, Type::tsize_t);
            v->_init = new ExpInitializer(Loc(), e);
            v->storage_class |= 0x10000000000LL | 1LL | 4LL;
            v->semantic(sc);
            return v;
        }
        ...
        if (!*pvar)
        {
            ...
            else if (ce->type && (t = ce->type->toBasetype()) != nullptr &&
                     (t->ty == Tstruct || t->ty == Tclass))
            {

                ((void)(!(exp->op == TOKarray || exp->op == TOKslice) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c", 1705, __FUNCTION__), 0 : 0));
                AggregateDeclaration *ad = isAggregate(t);
                ((void)(!(ad) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c", 1707, __FUNCTION__), 0 : 0));
                ...
                if (TemplateDeclaration *td = s->isTemplateDeclaration())
                {
                    ...
                    {
                        ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c", 1729, __FUNCTION__), 0 : 0));
                    }
                ...
                else
                {
                    ...
                    ((void)(!(d) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c", 1751, __FUNCTION__), 0 : 0));
                ...
                v = new VarDeclaration(loc, nullptr, Id::dollar, new ExpInitializer(Loc(), e));
                v->storage_class |= 0x10000000000LL | 0x1000000000LL | 0x20000000000LL;
            }
            else
            {
                ...
                v->storage_class |= 0x10000000000LL | 0x1000000000LL;
            }
            *pvar = v;
        }
        (*pvar)->semantic(sc);
...
# 1873 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.c"
