# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c"
# 10 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c"
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.h" 1
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.h"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/checkedint.h" 2
...
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c" 2
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c" 2
# 1 "d/id.h" 1
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c" 2
    ...
    void visit(StructInitializer *i)
    {
        ...
        if (t->ty == Tstruct)
        {
            ...
            for (size_t fieldi = 0, j = 0; j < i->field.length; j++)
            {
                ...
                ((void)(!(sc) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c", 149, __FUNCTION__), 0 : 0));
    ...
    void visit(ArrayInitializer *init)
    {
        ...
        if (init->isAssociativeArray())
        {
            ...
            for (size_t i = 0; i < init->value.length; i++)
            {
                ...
                ((void)(!(iz->isExpInitializer()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c", 580, __FUNCTION__), 0 : 0));
                (*values)[i] = ((ExpInitializer *)iz)->exp;
                ((void)(!((*values)[i]->op != TOKerror) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c", 582, __FUNCTION__), 0 : 0));
            }
        ...
        else
        {
            ...
            for (size_t i = 0; i < init->value.length; i++)
            {
                ((void)(!(!init->index[i]) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c", 598, __FUNCTION__), 0 : 0));
                ...
                ((void)(!(iz->isExpInitializer()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c", 609, __FUNCTION__), 0 : 0));
                (*elements)[i] = ((ExpInitializer *)iz)->exp;
                ((void)(!((*elements)[i]->op != TOKerror) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c", 611, __FUNCTION__), 0 : 0));
            }
    ...
    void visit(ArrayInitializer *init)
    {
        ...
        if (init->type)
        {
            ...
            switch (t->ty)
            {
                ...
                default:
                    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c", 780, __FUNCTION__), 0 : 0));
            }
        }
        else
        {
        ...
        for (size_t i = 0, j = 0; i < init->value.length; i++, j++)
        {
            ...
            ((void)(!(j < edim) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/initsem.c", 812, __FUNCTION__), 0 : 0));
            Initializer *iz = init->value[i];
            if (!iz)
                goto Lno;
            Expression *ex = initializerToExpression(iz);
