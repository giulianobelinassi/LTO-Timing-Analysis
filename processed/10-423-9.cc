# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/sparseset.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/sparseset.c"
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/sparseset.c"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/sparseset.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/sparseset.c" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/sparseset.h" 1
# 89 "/home/giulianob/gcc_git_gnu/gcc/gcc/sparseset.h"
...
extern sparseset sparseset_alloc (unsigned long n_elms);
extern void sparseset_clear_bit (sparseset, unsigned long);
...
static inline bool
sparseset_bit_p (sparseset s, unsigned long e)
{
  unsigned long idx;

  ((void)(!(e < s->size) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/sparseset.h", 143, __FUNCTION__), 0 : 0));
...
static inline void
sparseset_insert_bit (sparseset s, unsigned long e, unsigned long idx)
{
  s->sparse[e] = idx;
  s->dense[idx] = e;
}
...
static inline void
sparseset_set_bit (sparseset s, unsigned long e)
{
...
{
  unsigned long mem = s->members;

  ((void)(!(mem != 0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/sparseset.h", 177, __FUNCTION__), 0 : 0));
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/sparseset.c" 2



sparseset
sparseset_alloc (unsigned long n_elms)
{
  unsigned int n_bytes = sizeof (struct sparseset_def)
    + ((n_elms - 1) * 2 * sizeof (unsigned long));

  sparseset set = ((struct sparseset_def *) xmalloc ((n_bytes)));
...
static inline void
sparseset_swap (sparseset s, unsigned long idx1, unsigned long idx2)
{
  unsigned long tmp = s->dense[idx2];
...
void
sparseset_clear_bit (sparseset s, unsigned long e)
{
  if (sparseset_bit_p (s, e))
    {
      unsigned long idx = s->sparse[e];
      unsigned long iter = s->iter;
      unsigned long mem = s->members - 1;
...
sparseset_and (sparseset d, sparseset a, sparseset b)
{
  ...
  if (d == a || d == b)
    {
      ...
      for (sparseset_iter_init (d); sparseset_iter_p (d) && (((e) = sparseset_iter_elm (d)) || 1); sparseset_iter_next (d))
 if (!sparseset_bit_p (s, e))
      ...
      else
 {
   ...
   lrg = a;
      ...
      sparseset_clear (d);
      for (sparseset_iter_init (sml); sparseset_iter_p (sml) && (((e) = sparseset_iter_elm (sml)) || 1); sparseset_iter_next (sml))
...
sparseset_and_compl (sparseset d, sparseset a, sparseset b)
{
  ...
  ((void)(!(d != b) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/sparseset.c", 170, __FUNCTION__), 0 : 0));
 ...
 {
   for (sparseset_iter_init (b); sparseset_iter_p (b) && (((e) = sparseset_iter_elm (b)) || 1); sparseset_iter_next (b))
     sparseset_clear_bit (d, e);
 }
    }
  else
    {
      sparseset_clear (d);
      for (sparseset_iter_init (a); sparseset_iter_p (a) && (((e) = sparseset_iter_elm (a)) || 1); sparseset_iter_next (a))
 if (!sparseset_bit_p (b, e))
   sparseset_set_bit (d, e);
    }
}
