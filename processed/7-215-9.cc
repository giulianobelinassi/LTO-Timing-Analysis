# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c"
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c" 2
...
find_a_file (struct path_prefix *pprefix, const char *name, int mode)
{
  ...
  if (debug)
    fprintf (
# 41 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c" 3 4
            stderr
# 41 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c"
                  , "Looking for '%s'\n", name);
  ...
  temp = ((char *) xmalloc (sizeof (char) * (len)));
      ...
      if (access (name, mode) == 0)
 {
   ...
   if (debug)
     fprintf (
# 58 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c" 3 4
             stderr
# 58 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c"
                   , "  - found: absolute path\n");

   return temp;
 }
# 73 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c"
      if (debug)
 fprintf (
# 74 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c" 3 4
         stderr
# 74 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c"
 ...
 if (stat (temp, &st) >= 0
     && ! 
# 85 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c" 3 4
         ((((
# 85 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c"
         st.st_mode
# 85 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c" 3 4
         )) & 0170000) == (0040000))
     
# 86 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c"
    && access (temp, mode) == 0)
   return temp;
# 99 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c"
      }

  if (debug && pprefix->plist == nullptr)
    fprintf (
# 102 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c" 3 4
            stderr
# 102 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c"
...
prefix_from_string (const char *p, struct path_prefix *pprefix)
{
  ...
  char *nstore = ((char *) xmalloc (sizeof (char) * (strlen (p) + 3)));

  if (debug)
    fprintf (
# 178 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c" 3 4
            stderr
# 178 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c"
      ...
      if (*endp == ':' || *endp == 0)
 {
   ...
   if (debug)
     fprintf (
# 199 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c" 3 4
             stderr
# 199 "/home/giulianob/gcc_git_gnu/gcc/gcc/file-find.c"
                   , "  - add prefix: %s\n", nstore);
