# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc"
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.h" 1
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.h"
class tristate {
 public:
  enum value {
    TS_UNKNOWN,
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc" 2
...
tristate::as_string () const
{
  switch (m_value)
    {
    default:
      (fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 33, __FUNCTION__));
    case TS_UNKNOWN:
      return "UNKNOWN";
    case TS_TRUE:
      return "TRUE";
...
tristate::not_ () const
{
  switch (m_value)
    {
    default:
      (fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 49, __FUNCTION__));
    case TS_UNKNOWN:
...
tristate::or_ (tristate other) const
{
  switch (m_value)
    {
    default:
      (fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 65, __FUNCTION__));
    case TS_UNKNOWN:
      if (other.is_true ())
 return tristate (TS_TRUE);
      else
...
tristate::and_ (tristate other) const
{
  switch (m_value)
    {
    default:
      (fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 84, __FUNCTION__));
    case TS_UNKNOWN:
      if (other.is_false ())
 return tristate (TS_FALSE);
      else
...
namespace selftest {
# 119 "/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc"
static void
test_ctors ()
{
  tristate u (tristate::TS_UNKNOWN);
  do { const char *desc_ = "ASSERT_FALSE (" "(u.is_known ())" ")"; bool actual_ = ((u.is_known ())); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 123, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 123, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_FALSE (" "(u.is_true ())" ")"; bool actual_ = ((u.is_true ())); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 124, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 124, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_FALSE (" "(u.is_false ())" ")"; bool actual_ = ((u.is_false ())); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 125, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 125, __FUNCTION__))), desc_); } while (0);
  do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 126, __FUNCTION__)), "u.as_string ()", "\"UNKNOWN\"", (u.as_string ()), ("UNKNOWN")); } while (0);

  tristate t (tristate::TS_TRUE);
  do { const char *desc_ = "ASSERT_TRUE (" "(t.is_known ())" ")"; bool actual_ = ((t.is_known ())); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 129, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 129, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_TRUE (" "(t.is_true ())" ")"; bool actual_ = ((t.is_true ())); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 130, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 130, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_FALSE (" "(t.is_false ())" ")"; bool actual_ = ((t.is_false ())); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 131, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 131, __FUNCTION__))), desc_); } while (0);
  do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 132, __FUNCTION__)), "t.as_string ()", "\"TRUE\"", (t.as_string ()), ("TRUE")); } while (0);

  tristate f (tristate::TS_FALSE);
  do { const char *desc_ = "ASSERT_TRUE (" "(f.is_known ())" ")"; bool actual_ = ((f.is_known ())); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 135, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 135, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_FALSE (" "(f.is_true ())" ")"; bool actual_ = ((f.is_true ())); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 136, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 136, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_TRUE (" "(f.is_false ())" ")"; bool actual_ = ((f.is_false ())); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 137, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 137, __FUNCTION__))), desc_); } while (0);
  do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 138, __FUNCTION__)), "f.as_string ()", "\"FALSE\"", (f.as_string ()), ("FALSE")); } while (0);

  do { const char *desc_ = "ASSERT_EQ (" "(u)" ", " "(u)" ")"; if (((u)) == ((u))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 140, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 140, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(t)" ", " "(t)" ")"; if (((t)) == ((t))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 141, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 141, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(f)" ", " "(f)" ")"; if (((f)) == ((f))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 142, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 142, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_NE (" "u" ", " "t" ")"; if ((u) != (t)) ::selftest::pass ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 143, __FUNCTION__)), desc_); else ::selftest::fail ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 143, __FUNCTION__)), desc_); } while (0);
  do { const char *desc_ = "ASSERT_NE (" "u" ", " "f" ")"; if ((u) != (f)) ::selftest::pass ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 144, __FUNCTION__)), desc_); else ::selftest::fail ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 144, __FUNCTION__)), desc_); } while (0);
  do { const char *desc_ = "ASSERT_NE (" "t" ", " "f" ")"; if ((t) != (f)) ::selftest::pass ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 145, __FUNCTION__)), desc_); else ::selftest::fail ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 145, __FUNCTION__)), desc_); } while (0);

  tristate t2 (true);
  do { const char *desc_ = "ASSERT_TRUE (" "(t2.is_true ())" ")"; bool actual_ = ((t2.is_true ())); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 148, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 148, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(t)" ", " "(t2)" ")"; if (((t)) == ((t2))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 149, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 149, __FUNCTION__)))), desc_); } while (0);

  tristate f2 (false);
  do { const char *desc_ = "ASSERT_TRUE (" "(f2.is_false ())" ")"; bool actual_ = ((f2.is_false ())); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 152, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 152, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(f)" ", " "(f2)" ")"; if (((f)) == ((f2))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 153, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 153, __FUNCTION__)))), desc_); } while (0);

  tristate u2 (tristate::unknown ());
  do { const char *desc_ = "ASSERT_TRUE (" "(!u2.is_known ())" ")"; bool actual_ = ((!u2.is_known ())); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 156, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 156, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(u)" ", " "(u2)" ")"; if (((u)) == ((u2))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 157, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 157, __FUNCTION__)))), desc_); } while (0);
}
...
test_and ()
{
  do { do { const char *desc_ = "ASSERT_EQ (" "(tristate::unknown () && tristate::unknown ())" ", " "(tristate (tristate::TS_UNKNOWN))" ")"; if (((tristate::unknown () && tristate::unknown ())) == ((tristate (tristate::TS_UNKNOWN)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 165, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 165, __FUNCTION__)))), desc_); } while (0); } while (0);

  do { do { const char *desc_ = "ASSERT_EQ (" "(tristate (false) && tristate (false))" ", " "(tristate (tristate::TS_FALSE))" ")"; if (((tristate (false) && tristate (false))) == ((tristate (tristate::TS_FALSE)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 167, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 167, __FUNCTION__)))), desc_); } while (0); } while (0);
  do { do { const char *desc_ = "ASSERT_EQ (" "(tristate (false) && tristate (true))" ", " "(tristate (tristate::TS_FALSE))" ")"; if (((tristate (false) && tristate (true))) == ((tristate (tristate::TS_FALSE)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 168, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 168, __FUNCTION__)))), desc_); } while (0); } while (0);
  do { do { const char *desc_ = "ASSERT_EQ (" "(tristate (true) && tristate (false))" ", " "(tristate (tristate::TS_FALSE))" ")"; if (((tristate (true) && tristate (false))) == ((tristate (tristate::TS_FALSE)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 169, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 169, __FUNCTION__)))), desc_); } while (0); } while (0);
  do { do { const char *desc_ = "ASSERT_EQ (" "(tristate (true) && tristate (true))" ", " "(tristate (tristate::TS_TRUE))" ")"; if (((tristate (true) && tristate (true))) == ((tristate (tristate::TS_TRUE)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 170, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 170, __FUNCTION__)))), desc_); } while (0); } while (0);

  do { do { const char *desc_ = "ASSERT_EQ (" "(tristate::unknown () && tristate (true))" ", " "(tristate (tristate::TS_UNKNOWN))" ")"; if (((tristate::unknown () && tristate (true))) == ((tristate (tristate::TS_UNKNOWN)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 172, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 172, __FUNCTION__)))), desc_); } while (0); } while (0);
  do { do { const char *desc_ = "ASSERT_EQ (" "(tristate (true) && tristate::unknown ())" ", " "(tristate (tristate::TS_UNKNOWN))" ")"; if (((tristate (true) && tristate::unknown ())) == ((tristate (tristate::TS_UNKNOWN)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 173, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 173, __FUNCTION__)))), desc_); } while (0); } while (0);

  do { do { const char *desc_ = "ASSERT_EQ (" "(tristate::unknown () && tristate (false))" ", " "(tristate (tristate::TS_FALSE))" ")"; if (((tristate::unknown () && tristate (false))) == ((tristate (tristate::TS_FALSE)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 175, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 175, __FUNCTION__)))), desc_); } while (0); } while (0);
  do { do { const char *desc_ = "ASSERT_EQ (" "(tristate (false) && tristate::unknown ())" ", " "(tristate (tristate::TS_FALSE))" ")"; if (((tristate (false) && tristate::unknown ())) == ((tristate (tristate::TS_FALSE)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 176, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 176, __FUNCTION__)))), desc_); } while (0); } while (0);
}
...
test_or ()
{
  do { do { const char *desc_ = "ASSERT_EQ (" "(tristate::unknown () || tristate::unknown ())" ", " "(tristate (tristate::TS_UNKNOWN))" ")"; if (((tristate::unknown () || tristate::unknown ())) == ((tristate (tristate::TS_UNKNOWN)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 184, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 184, __FUNCTION__)))), desc_); } while (0); } while (0);

  do { do { const char *desc_ = "ASSERT_EQ (" "(tristate (false) || tristate (false))" ", " "(tristate (tristate::TS_FALSE))" ")"; if (((tristate (false) || tristate (false))) == ((tristate (tristate::TS_FALSE)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 186, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 186, __FUNCTION__)))), desc_); } while (0); } while (0);
  do { do { const char *desc_ = "ASSERT_EQ (" "(tristate (false) || tristate (true))" ", " "(tristate (tristate::TS_TRUE))" ")"; if (((tristate (false) || tristate (true))) == ((tristate (tristate::TS_TRUE)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 187, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 187, __FUNCTION__)))), desc_); } while (0); } while (0);
  do { do { const char *desc_ = "ASSERT_EQ (" "(tristate (true) || tristate (false))" ", " "(tristate (tristate::TS_TRUE))" ")"; if (((tristate (true) || tristate (false))) == ((tristate (tristate::TS_TRUE)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 188, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 188, __FUNCTION__)))), desc_); } while (0); } while (0);
  do { do { const char *desc_ = "ASSERT_EQ (" "(tristate (true) || tristate (true))" ", " "(tristate (tristate::TS_TRUE))" ")"; if (((tristate (true) || tristate (true))) == ((tristate (tristate::TS_TRUE)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 189, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 189, __FUNCTION__)))), desc_); } while (0); } while (0);

  do { do { const char *desc_ = "ASSERT_EQ (" "(tristate::unknown () || tristate (true))" ", " "(tristate (tristate::TS_TRUE))" ")"; if (((tristate::unknown () || tristate (true))) == ((tristate (tristate::TS_TRUE)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 191, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 191, __FUNCTION__)))), desc_); } while (0); } while (0);
  do { do { const char *desc_ = "ASSERT_EQ (" "(tristate (true) || tristate::unknown ())" ", " "(tristate (tristate::TS_TRUE))" ")"; if (((tristate (true) || tristate::unknown ())) == ((tristate (tristate::TS_TRUE)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 192, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 192, __FUNCTION__)))), desc_); } while (0); } while (0);

  do { do { const char *desc_ = "ASSERT_EQ (" "(tristate::unknown () || tristate (false))" ", " "(tristate (tristate::TS_UNKNOWN))" ")"; if (((tristate::unknown () || tristate (false))) == ((tristate (tristate::TS_UNKNOWN)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 194, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 194, __FUNCTION__)))), desc_); } while (0); } while (0);
  do { do { const char *desc_ = "ASSERT_EQ (" "(tristate (false) || tristate::unknown ())" ", " "(tristate (tristate::TS_UNKNOWN))" ")"; if (((tristate (false) || tristate::unknown ())) == ((tristate (tristate::TS_UNKNOWN)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 195, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 195, __FUNCTION__)))), desc_); } while (0); } while (0);
}
...
test_not ()
{
  do { do { const char *desc_ = "ASSERT_EQ (" "(!tristate::unknown ())" ", " "(tristate (tristate::TS_UNKNOWN))" ")"; if (((!tristate::unknown ())) == ((tristate (tristate::TS_UNKNOWN)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 203, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 203, __FUNCTION__)))), desc_); } while (0); } while (0);
  do { do { const char *desc_ = "ASSERT_EQ (" "(!tristate (true))" ", " "(tristate (tristate::TS_FALSE))" ")"; if (((!tristate (true))) == ((tristate (tristate::TS_FALSE)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 204, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 204, __FUNCTION__)))), desc_); } while (0); } while (0);
  do { do { const char *desc_ = "ASSERT_EQ (" "(!tristate (false))" ", " "(tristate (tristate::TS_TRUE))" ")"; if (((!tristate (false))) == ((tristate (tristate::TS_TRUE)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 205, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/tristate.cc", 205, __FUNCTION__)))), desc_); } while (0); } while (0);
}
