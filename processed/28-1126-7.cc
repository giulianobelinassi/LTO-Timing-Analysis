# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c" 2
# 1 "d/id.h" 1
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c" 2
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c" 2
...
Scope *Scope::alloc()
{
    if (freelist)
    {
        ...
        ((void)(!(s->flags & 0x8000) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c", 52, __FUNCTION__), 0 : 0));
        s->flags &= ~0x8000;
        return s;
    }
...
Scope *Scope::push()
{
    ...
    ((void)(!(!(flags & 0x8000)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c", 151, __FUNCTION__), 0 : 0));
    s->scopesym = nullptr;
    s->enclosing = this;
    s->slabel = nullptr;
    s->nofree = 0;
    s->fieldinit = saveFieldInit();
    s->flags = (flags & (0x0060 | 0x0008 | 0x0080 | 0x0100 | 0x0010 |
                         0x0002 | 0x0200));
    s->lastdc = nullptr;

    ((void)(!(this != s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c", 161, __FUNCTION__), 0 : 0));
    return s;
}
...
Scope *Scope::pop()
{
    ...
    if (enclosing)
    {
        ...
        if (fieldinit)
        {
            ...
            {
                ((void)(!(fieldinit != enclosing->fieldinit) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c", 185, __FUNCTION__), 0 : 0));
...
{
    Scope *sc = this->push();
    sc->flags = this->flags | 0x0080;
    return sc;
}

Scope *Scope::endCTFE()
{
    ((void)(!(flags & 0x0080) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c", 213, __FUNCTION__), 0 : 0));
    return pop();
}
...
void Scope::mergeCallSuper(Loc loc, unsigned cs)
{
    ...
    if (cs != callSuper)
    {
        ...
        int aAll = (cs & (1 | 2)) != 0;
        int bAll = (callSuper & (1 | 2)) != 0;


        bool aAny = (cs & 0x40) != 0;
        bool bAny = (callSuper & 0x40) != 0;


        bool aRet = (cs & 0x20) != 0;
        bool bRet = (callSuper & 0x20) != 0;


        bool aHalt = (cs & 0x80) != 0;
        bool bHalt = (callSuper & 0x80) != 0;
        ...
        else if (aHalt || (aRet && aAll))
        {
            ...
            callSuper |= cs & (0x40 | 0x10);
        }
        else if (bHalt || (bRet && bAll))
        {
            callSuper = cs | (callSuper & (0x40 | 0x10));
        }
        else
        {
...
# 302 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c"
...
void Scope::mergeFieldInit(Loc loc, unsigned *fies)
{
    if (fieldinit && fies)
    {
        ...
        ((void)(!(ad) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c", 361, __FUNCTION__), 0 : 0));
...
static Dsymbol *searchScopes(Scope *scope, Loc loc, Identifier *ident, Dsymbol **pscopesym, int flags)
{
    ...
    {
        ((void)(!(sc != sc->enclosing) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c", 387, __FUNCTION__), 0 : 0));
        if (!sc->scopesym)
            continue;
...
# 427 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c"
Dsymbol *Scope::search(Loc loc, Identifier *ident, Dsymbol **pscopesym, int flags)
{

    ((void)(!(!(flags & (SearchLocalsOnly | SearchImportsOnly))) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c", 430, __FUNCTION__), 0 : 0));
    ...
    if (ident == Id::empty)
    {
        ...
        {
            ((void)(!(sc != sc->enclosing) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c", 439, __FUNCTION__), 0 : 0));
            if (!sc->scopesym)
                continue;
...
Dsymbol *Scope::insert(Dsymbol *s)
{
    ...
    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c", 530, __FUNCTION__), 0 : 0));
    return nullptr;
}
...
void Scope::setNoFree()
{
    ...
    for (Scope *sc = this; sc; sc = sc->enclosing)
    {
        ...
        ((void)(!(!(flags & 0x8000)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c", 589, __FUNCTION__), 0 : 0));
...
void Scope::deprecation10378(Loc loc, Dsymbol *sold, Dsymbol *snew)
{
    ...
    OverloadSet *osold = nullptr;
    OverloadSet *osnew = nullptr;
    if (sold && (osold = sold->isOverloadSet()) != nullptr &&
        snew && (osnew = snew->isOverloadSet()) != nullptr &&
...
# 693 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dscope.c"
