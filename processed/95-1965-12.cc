# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c" 2
# 1 "d/id.h" 1
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c" 2
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c", 48, __FUNCTION__), 0 : 0));
...
void EnumDeclaration::semantic(Scope *sc)
{
    ...
    {
        ((void)(!(memtype) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c", 97, __FUNCTION__), 0 : 0));
    ...
    if (!symtab)
        symtab = new DsymbolTable();
# 144 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c"
    if (memtype)
    {
    ...
    if (!added)
    {
        ...
        if (isAnonymous())
        {
            ...
            {
                ((void)(!(sct) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c", 233, __FUNCTION__), 0 : 0));
                if (sct->scopesym)
                {
...
Expression *EnumDeclaration::getMaxMinValue(Loc loc, Identifier *id)
{
    ...
    for (size_t i = 0; i < members->length; i++)
    {
        ...
        {
# 343 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c"
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c", 514, __FUNCTION__), 0 : 0));
...
void EnumMember::semantic(Scope *sc)
{
    ...
    ((void)(!(ed) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c", 538, __FUNCTION__), 0 : 0));
    ed->semantic(sc);
    if (ed->errors)
        goto Lerrors;
    ...
    linkage = LINKd;
    storage_class = 0x800000LL;
    userAttribDecl = ed->isAnonymous() ? ed->userAttribDecl : nullptr;
    ...
    if (origType)
    {
        ...
        type = origType;
        ((void)(!(value()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c", 565, __FUNCTION__), 0 : 0));
    }

    if (value())
    {
        Expression *e = value();
        ((void)(!(e->dyncast() == DYNCAST_EXPRESSION) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c", 571, __FUNCTION__), 0 : 0));
        e = ::semantic(e, sc);
        ...
        else if (origType)
        {
            ...
            e = e->ctfeInterpret();
            ((void)(!(ed->isAnonymous()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c", 632, __FUNCTION__), 0 : 0));
    ...
    else
    {
        ...
        ((void)(!(emprev) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c", 680, __FUNCTION__), 0 : 0));
        if (emprev->semanticRun < PASSsemanticdone)
        ...
        ((void)(!(eprev) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c", 695, __FUNCTION__), 0 : 0));
        ...
        if (e->op != TOKerror)
        {
            ((void)(!(emprev->origValue) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c", 714, __FUNCTION__), 0 : 0));
    ...
    ((void)(!(origValue) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/denum.c", 739, __FUNCTION__), 0 : 0));
    semanticRun = PASSsemanticdone;
}
