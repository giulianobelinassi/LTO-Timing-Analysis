# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc"
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc" 2
...
extern void diagnostic_set_info (diagnostic_info *, const char *, va_list *,
     rich_location *, diagnostic_t) __attribute__ ((__format__ (__gcc_tdiag__, 2, 0))) __attribute__ ((__nonnull__ (2)));
...
extern json::value *json_from_expanded_location (diagnostic_context *context,
       location_t loc);
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/graphviz.h" 1
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/graphviz.h"
class graphviz_out {
 public:
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.h" 1
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.h"
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/tree-diagnostic.h" 1
# 51 "/home/giulianob/gcc_git_gnu/gcc/gcc/tree-diagnostic.h"
...
extern void maybe_unwind_expanded_macro_loc (diagnostic_context *context,
          location_t where);
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.h" 2
# 41 "/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.h"
...
# 125 "/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.h"
template <typename GraphTraits>
class cluster
{
 public:
     ...
     const dump_args_t &args) const
{
  ...
  (&pp)->format_decoder = default_tree_printer;
  pp.buffer->stream = fp;
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/shortest-paths.h" 1
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/shortest-paths.h"
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/shortest-paths.h" 2
  ...
  m_prev (graph.m_nodes.length ())
{
  ...
  for (unsigned i = 0; i < graph.m_nodes.length (); i++)
    {
      m_dist.quick_push (0x7fffffff);
      m_prev.quick_push (nullptr);
      queue.quick_push (i);
    }
   ...
   if (m_dist[queue[i]] < min_dist)
     {
      ...
      ((void)(!(idx_with_min_dist != -1) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/shortest-paths.h", 99, __FUNCTION__), 0 : 0));
      ((void)(!(idx_in_queue_with_min_dist != -1) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/shortest-paths.h", 100, __FUNCTION__), 0 : 0));
 ...
 = static_cast <node_t *> (m_graph.m_nodes[idx_with_min_dist]);
      ...
      int i;
      edge_t *succ;
      for (i = 0; (n->m_succs).iterate ((i), &(succ)); ++(i))
 {
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc" 2
...
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc" 2
...
test_dump_to_dot ()
{
  ...
  pretty_printer pp;
  pp.buffer->stream = nullptr;
  test_dump_args_t dump_args;
  g.dump_dot_to_pp (&pp, nullptr, dump_args);

  do { ::selftest::assert_str_contains ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 115, __FUNCTION__)), "pp_formatted_text (&pp)", "\"a -> b;\\n\"", (pp_formatted_text (&pp)), ("a -> b;\n")); } while (0)
                     ;
}
# 130 "/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc"
static void
test_shortest_paths ()
{
  test_graph g;
  ...
  do { const char *desc_ = "ASSERT_EQ (" "(path_to_a.m_edges.length ())" ", " "(0)" ")"; if (((path_to_a.m_edges.length ())) == ((0))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 151, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 151, __FUNCTION__)))), desc_); } while (0);

  test_path path_to_b = sp.get_shortest_path (b);
  do { const char *desc_ = "ASSERT_EQ (" "(path_to_b.m_edges.length ())" ", " "(1)" ")"; if (((path_to_b.m_edges.length ())) == ((1))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 154, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 154, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(path_to_b.m_edges[0])" ", " "(ab)" ")"; if (((path_to_b.m_edges[0])) == ((ab))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 155, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 155, __FUNCTION__)))), desc_); } while (0);

  test_path path_to_c = sp.get_shortest_path (c);
  do { const char *desc_ = "ASSERT_EQ (" "(path_to_c.m_edges.length ())" ", " "(1)" ")"; if (((path_to_c.m_edges.length ())) == ((1))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 158, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 158, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(path_to_c.m_edges[0])" ", " "(ac)" ")"; if (((path_to_c.m_edges[0])) == ((ac))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 159, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 159, __FUNCTION__)))), desc_); } while (0);

  test_path path_to_d = sp.get_shortest_path (d);
  do { const char *desc_ = "ASSERT_EQ (" "(path_to_d.m_edges.length ())" ", " "(2)" ")"; if (((path_to_d.m_edges.length ())) == ((2))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 162, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 162, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(path_to_d.m_edges[0])" ", " "(ac)" ")"; if (((path_to_d.m_edges[0])) == ((ac))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 163, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 163, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(path_to_d.m_edges[1])" ", " "(cd)" ")"; if (((path_to_d.m_edges[1])) == ((cd))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 164, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 164, __FUNCTION__)))), desc_); } while (0);

  test_path path_to_e = sp.get_shortest_path (e);
  do { const char *desc_ = "ASSERT_EQ (" "(path_to_e.m_edges.length ())" ", " "(2)" ")"; if (((path_to_e.m_edges.length ())) == ((2))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 167, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 167, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(path_to_e.m_edges[0])" ", " "(ab)" ")"; if (((path_to_e.m_edges[0])) == ((ab))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 168, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 168, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(path_to_e.m_edges[1])" ", " "(be)" ")"; if (((path_to_e.m_edges[1])) == ((be))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 169, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 169, __FUNCTION__)))), desc_); } while (0);

  test_path path_to_f = sp.get_shortest_path (f);
  do { const char *desc_ = "ASSERT_EQ (" "(path_to_f.m_edges.length ())" ", " "(2)" ")"; if (((path_to_f.m_edges.length ())) == ((2))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 172, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 172, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(path_to_f.m_edges[0])" ", " "(ac)" ")"; if (((path_to_f.m_edges[0])) == ((ac))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 173, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 173, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(path_to_f.m_edges[1])" ", " "(cf)" ")"; if (((path_to_f.m_edges[1])) == ((cf))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 174, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/digraph.cc", 174, __FUNCTION__)))), desc_); } while (0);
}
