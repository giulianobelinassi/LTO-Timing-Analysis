# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 2
...
extern Mem mem;
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.h" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 2
# 1 "d/id.h" 1
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 2

extern int HtmlNamedEntity(const utf8_t *p, size_t length);
# 31 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
...
# 126 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 3 4
   __builtin_va_start(
# 126 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
   ap
# 126 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 3 4
   ,
# 126 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
...
# 128 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 3 4
   __builtin_va_end(
# 128 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
   ap
# 128 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 3 4
   )
# 128 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
...
# 135 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 3 4
   __builtin_va_start(
# 135 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
   ap
# 135 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 3 4
   ,
# 135 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
...
# 137 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 3 4
   __builtin_va_end(
# 137 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
   ap
# 137 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 3 4
   )
# 137 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
...
# 144 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 3 4
   __builtin_va_start(
# 144 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
   ap
# 144 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 3 4
   ,
# 144 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
...
# 146 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 3 4
   __builtin_va_end(
# 146 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
   ap
# 146 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 3 4
   )
# 146 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
    ...
    while (1)
    {
        ...
        switch (*p)
        {
            ...
            { utf8_t c;
                ...
                if (*t->ptr == '_')
                {
                    ...
                    if (!initdone)
                    {
                        ...
                        ::time(&ct);
                        char *p = ctime(&ct);
                        ((void)(!(p) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c", 386, __FUNCTION__), 0 : 0));
                    ...
                    { unsigned major = 0;
                        ...
                        {
                            c = *p;
                            if ((_sch_istable[((utf8_t)c) & 0xff] & (unsigned short)(_sch_isdigit)))
                                minor = minor * 10 + c - '0';
                            else if (c == '.')
                            {
                                if (point)
            ...
            { unsigned c = *p;
                ...
                if (c < 0x80 && (_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isprint)))
                    ...
                    switch (*p)
                    {
                        ...
                        default:
                            if ((_sch_istable[(*p) & 0xff] & (unsigned short)(_sch_isalpha)) ||
                                (p != idstart && (_sch_istable[(*p) & 0xff] & (unsigned short)(_sch_isdigit))))
                                continue;
...
# 1236 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
    ...
    while (1)
    {
        ...
        { delimleft = c;
            ...
            if (c == '(')
                ...
                delimright = '>';
            else if ((_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isalpha)) || c == '_' || (c >= 0x80 && isUniAlpha(c)))
            {
                Token tok;
                p--;
                scan(&tok);
        ...
        else
        {
            ...
            if (nest == 1)
            {
                ...
                goto Ldone;
            if (startline && (_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isalpha)) && hereid)
            { Token tok;
...
# 1391 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
...
# 1614 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
    ...
    if (c == '0')
    {
        ...
        switch (c)
        {
            ...
            case '.':
                if (p[1] == '.')
                    goto Ldone;
                if ((_sch_istable[(p[1]) & 0xff] & (unsigned short)(_sch_isalpha)) || p[1] == '_' || p[1] & 0x80)
                    goto Ldone;
                goto Lreal;
    ...
    while (1)
    {
        ...
        switch (c)
        {
            ...
            case '.':
                if (p[1] == '.')
                    goto Ldone;
                if (base == 10 && ((_sch_istable[(p[1]) & 0xff] & (unsigned short)(_sch_isalpha)) || p[1] == '_' || p[1] & 0x80))
                    goto Ldone;
                goto Lreal;
...
Ldone:
    ...
    switch (flags)
    {
        ...
        default:
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c", 1897, __FUNCTION__), 0 : 0));
    }
    t->uns64value = n;
    return result;
}
# 1910 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
TOK Lexer::inreal(Token *t)
{
    ...
    while (1)
    {
        ...
        if ((_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isdigit)) || (hex && (_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isxdigit))) || c == '_')
        {
            c = *p++;
            continue;
        }
...
# 2004 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c" 3 4
   (*__errno_location ()) 
# 2004 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
         = 0;
    switch (*p)
    {
        case 'F':
...
# 2180 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
unsigned Lexer::decodeUTF()
{
    ...
    c = *s;
    ((void)(!(c & 0x80) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c", 2190, __FUNCTION__), 0 : 0));
...
# 2224 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.c"
