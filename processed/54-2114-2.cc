# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c" 2
# 1 "d/id.h" 1
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c" 2
...
{
    ((void)(!(!!aggrfe ^ !!rangefe) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c", 60, __FUNCTION__), 0 : 0));
    this->loc = loc;
    this->aggrfe = aggrfe;
...
# 84 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c"
static void lowerArrayAggregate(StaticForeach *sfe, Scope *sc)
{
    ...
    if (el->op == TOKint64)
    {
        ...
        sfe->aggrfe->aggr = sfe->aggrfe->aggr->optimize(0);
    }
    else
    {
...
# 133 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c"
...
# 157 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c"
static Statement *createForeach(StaticForeach *sfe, Loc loc, Parameters *parameters, Statement *s)
{
    ...
    {
        ((void)(!(sfe->rangefe && parameters->length == 1) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c", 165, __FUNCTION__), 0 : 0));
...
# 192 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c"
...
# 217 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c"
static Expression *createTuple(Loc loc, TypeStruct *type, Expressions *e)
{
    return new CallExp(loc, new TypeExp(loc, type), e);
}
# 247 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c"
static void lowerNonArrayAggregate(StaticForeach *sfe, Scope *sc)
{
    ...
    for (size_t i = 0; i < nvars; i++)
    {
        for (size_t j = 0; j < 3; j++)
        {
            ...
            params->push(new Parameter(p->storageClass, p->type, p->ident, nullptr));
        }
    }
    Expression *res[2];
    ...
    if (sfe->rangefe)
    {
        ...
        sc = sc->endCTFE();
        sfe->rangefe->lwr = sfe->rangefe->lwr->optimize(0);
        sfe->rangefe->lwr = sfe->rangefe->lwr->ctfeInterpret();
        sfe->rangefe->upr = sfe->rangefe->upr->optimize(0);
    ...
    ((void)(!(!!sfe->aggrfe ^ !!sfe->rangefe) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c", 365, __FUNCTION__), 0 : 0));
...
void staticForeachPrepare(StaticForeach *sfe, Scope *sc)
{
    ((void)(!(sc) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/cond.c", 381, __FUNCTION__), 0 : 0));
    if (sfe->aggrfe)
    {
        sc = sc->startCTFE();
        sfe->aggrfe->aggr = semantic(sfe->aggrfe->aggr, sc);
