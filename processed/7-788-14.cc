# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c"
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c"
# 1 "./bconfig.h" 1
...
# 6 "./bconfig.h" 2
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c" 2
# 1 "./tm.h" 1
# 22 "./tm.h"
# 1 "./options.h" 1
...
# 49 "./tm.h" 2
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c" 2
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c" 2
# 36 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c"
struct link
{
  struct link *next;
  int pos;
...
{
  rtx peep = info->def;
  int ninsns = (((((peep)->u.fld[0]).rt_rtvec))->num_elem);
  int i;
      ...
      if (i > 0)
 {
   ...
   printf ("  if (LABEL_P (insn)\n      || BARRIER_P (insn))\n    goto L%d;\n",
      ...
      match_rtx ((((((peep)->u.fld[0]).rt_rtvec))->elem[i]), nullptr, info->index);
    }




  if ((((peep)->u.fld[1]).rt_str) && (((peep)->u.fld[1]).rt_str)[0])
    printf ("  if (! (%s)) goto L%d;\n",
     (((peep)->u.fld[1]).rt_str), info->index);
...
match_rtx (rtx x, struct link *path, int fail_label)
{
  ...
  switch (code)
    {
    case MATCH_OPERAND:
      if ((((x)->u.fld[0]).rt_int) > max_opno)
 max_opno = (((x)->u.fld[0]).rt_int);
      if ((((x)->u.fld[0]).rt_int) >= n_operands)
 n_operands = 1 + (((x)->u.fld[0]).rt_int);
      ...
      printf ("  operands[%d] = x;\n", (((x)->u.fld[0]).rt_int));
      if ((((x)->u.fld[1]).rt_str) && (((x)->u.fld[1]).rt_str)[0])
 printf ("  if (! %s (x, %smode)) goto L%d;\n",
  (((x)->u.fld[1]).rt_str), mode_name[((machine_mode) (x)->mode)], fail_label);
      return;
    ...
    case MATCH_OP_DUP:
      ...
      link.next = path;
      link.vecelt = -1;
      for (i = 0; i < (((((x)->u.fld[1]).rt_rtvec))->num_elem); i++)
 {
   link.pos = i;
   match_rtx ((((((x)->u.fld[1]).rt_rtvec))->elem[i]), &link, fail_label);
 }
      return;
 ...
 printf ("  if (! %s (x, %smode)) goto L%d;\n",
  (((x)->u.fld[1]).rt_str), mode_name[((machine_mode) (x)->mode)], fail_label);
      link.next = path;
      link.vecelt = -1;
      for (i = 0; i < (((((x)->u.fld[2]).rt_rtvec))->num_elem); i++)
 {
   link.pos = i;
   match_rtx ((((((x)->u.fld[2]).rt_rtvec))->elem[i]), &link, fail_label);
 }
      return;
      ...
      for (i = 0; i < (((((x)->u.fld[2]).rt_rtvec))->num_elem); i++)
 {
  ...
  if (((machine_mode) (x)->mode) != ((void) 0, E_VOIDmode))
    {
      printf ("  if (GET_MODE (x) != %smode) goto L%d;\n",
       mode_name[((machine_mode) (x)->mode)], fail_label);
    }
  ...
  for (i = 0; i < len; i++)
    {
      link.pos = i;
      if (fmt[i] == 'e' || fmt[i] == 'u')
 match_rtx ((((x)->u.fld[i]).rt_rtx), &link, fail_label);
      else if (fmt[i] == 'E')
 {
   int j;
   printf ("  if (XVECLEN (x, %d) != %d) goto L%d;\n",
    i, (((((x)->u.fld[i]).rt_rtvec))->num_elem), fail_label);
   for (j = 0; j < (((((x)->u.fld[i]).rt_rtvec))->num_elem); j++)
     {
       link.vecelt = j;
       match_rtx ((((((x)->u.fld[i]).rt_rtvec))->elem[j]), &link, fail_label);
     }
 }
      else if (fmt[i] == 'i')
 {
   ...
   printf ("  if (XINT (x, %d) != %d) goto L%d;\n",
    i, (((x)->u.fld[i]).rt_int), fail_label);
 }
      else if (fmt[i] == 'r')
 {
   ((void)(!(i == 0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c", 278, __FUNCTION__), 0 : 0));
   printf ("  if (REGNO (x) != %d) goto L%d;\n",
    (rhs_regno(x)), fail_label);
 }
      else if (fmt[i] == 'w')
 {
   ...
   printf ("%" 
# 293 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c" 3 4
          "l" "d"
# 293 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c"
                                 , ((x)->u.hwint[i]));
   printf (") goto L%d;\n", fail_label);
 }
      else if (fmt[i] == 's')
 {
   ...
   printf ("  if (strcmp (XSTR (x, %d), \"%s\")) goto L%d;\n",
    i, (((x)->u.fld[i]).rt_str), fail_label);
 }
      else if (fmt[i] == 'p')

 (fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c", 311, __FUNCTION__));
    }
}
...
print_code (enum rtx_code code)
{
  ...
  for (p1 = (rtx_name[(int) (code)]); *p1; p1++)
    putchar_unlocked (_sch_toupper[(*p1) & 0xff]);
}
...
main (int argc, const char **argv)
{
  ...
  if (!init_rtx_reader_args (argc, argv))
    return (
# 356 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c" 3 4
           1
# 356 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c"
                          );
 ...
 break;
  ...
  fflush_unlocked (
# 416 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c" 3 4
 stdout
# 416 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c"
 );
  return (ferror_unlocked (
# 417 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c" 3 4
         stdout
# 417 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c"
         ) != 0 ? 
# 417 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c" 3 4
                                1 
# 417 "/home/giulianob/gcc_git_gnu/gcc/gcc/genpeep.c"
