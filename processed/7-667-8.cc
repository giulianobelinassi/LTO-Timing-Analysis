# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmacro.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmacro.c"
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmacro.c"
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmacro.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmacro.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmacro.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/macro.h" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmacro.c" 2
...
# 92 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmacro.c"
size_t extractArgN(const utf8_t *p, size_t end, const utf8_t **pmarg, size_t *pmarglen, int n)
{
  ...
  Largstart:
    ...
    if (n != 1 && v < end && (_sch_istable[(p[v]) & 0xff] & (unsigned short)(_sch_isspace)))
        v++;
    *pmarg = p + v;
            ...
            case '<':
                if (!inexp && !instring && !incomment)
                {
                        ...
                        p[v + 3] == '-')
                    {
                        ...
                        (_sch_istable[(p[v + 1]) & 0xff] & (unsigned short)(_sch_isalpha)))
                        intag = 1;
                }
                continue;
        ...
        const utf8_t *arg, size_t arglen)
{
    ...
    size_t end = *pend;
    ((void)(!(start <= end) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmacro.c", 239, __FUNCTION__), 0 : 0));
    ((void)(!(end <= buf->length()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmacro.c", 240, __FUNCTION__), 0 : 0));
    ...
    {
        utf8_t *p = (utf8_t *)buf->slice().ptr;



        if (p[u] == '$' && ((_sch_istable[(p[u + 1]) & 0xff] & (unsigned short)(_sch_isdigit)) || p[u + 1] == '+'))
        {
            if (u > start && p[u - 1] == '$')
            {
                buf->remove(u - 1, 1);
    ...
    for (size_t u = start; u + 4 < end; )
    {
        ...
        if (p[u] == '$' && p[u + 1] == '(' && isIdStart(p+u+2))
        {
            ...
            ((void)(!(v <= end) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmacro.c", 350, __FUNCTION__), 0 : 0));
                ...
                if (!m)
                {
                    ...
                    if (m)
                    {
                        ...
                        if (marglen)
                        {
                            ...
                            ((void)(!(q) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dmacro.c", 376, __FUNCTION__), 0 : 0));
