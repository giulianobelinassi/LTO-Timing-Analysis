# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/imphint.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/imphint.c"
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/imphint.c"
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/imphint.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/imphint.c" 2
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/imphint.c"
const char *importHint(const char *s)
{
    ...
    for (int n = 0; modules[m]; n++)
    {
        ...
        ((void)(!(modules[m]) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/imphint.c", 47, __FUNCTION__), 0 : 0));
        if (strcmp(s, p) == 0)
            return modules[m];
    }
    return nullptr;
