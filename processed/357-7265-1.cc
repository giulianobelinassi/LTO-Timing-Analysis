# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c"
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c"
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
...
extern Mem mem;
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/dsymbol.h" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2

# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/macro.h" 1
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/macro.h"
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
...
#pragma GCC diagnostic pop
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.h" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
...
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
...
# 30 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
# 1 "d/id.h" 1
...
# 31 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
...
# 32 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
...
# 33 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
...
# 34 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
...
# 35 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
...
# 37 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c" 2
...
struct DocComment
{
    ...
    DocComment() :
       summary(nullptr), copyright(nullptr), macros(nullptr), pmacrotable(nullptr), pescapetable(nullptr)
    { }
...
static Dsymbol *getEponymousMember(TemplateDeclaration *td)
{
    ...
    if (VarDeclaration *vd = td->onemember->isVarDeclaration())
        return td->constraint ? nullptr : vd;
...
void gendocfile(Module *m)
{
    ...
    m->macrotable->expand(&buf2, 0, &end, nullptr, 0);
    ...
    ((void)(!(m->docfile) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c", 469, __FUNCTION__), 0 : 0));
    m->docfile->setbuffer(buf.slice().ptr, buf.length());
    m->docfile->ref = 1;
    ensurePathToNameExists(Loc(), m->docfile->toChars());
    writeFile(m->loc, m->docfile);
}
# 483 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c"
void escapeDdocString(OutBuffer *buf, size_t start)
{
    for (size_t u = start; u < buf->length(); u++)
    {
        ...
        switch(c)
        {
            ...
            case '(':
                buf->remove(u, 1);
                buf->insert(u, (const char *)"$(LPAREN)", 9);
                u += 8;
                break;

            case ')':
                buf->remove(u, 1);
                buf->insert(u, (const char *)"$(RPAREN)", 9);
                u += 8;
                break;
        }
    }
...
static bool emitAnchorName(OutBuffer *buf, Dsymbol *s, Scope *sc)
{
    ...
    TemplateDeclaration *td;
    if (s->isCtorDeclaration() || ((td = s->isTemplateDeclaration()) != nullptr &&
...
static void expandTemplateMixinComments(TemplateMixin *tm, OutBuffer *buf, Scope *sc)
{
    ...
    TemplateDeclaration *td = (tm && tm->tempdecl) ?
        tm->tempdecl->isTemplateDeclaration() : nullptr;
    if (td && td->members)
    {
...
void emitComment(Dsymbol *s, OutBuffer *buf, Scope *sc)
{
    ...
    public:
        ...
        {
# 929 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c"
...
void toDocBuffer(Dsymbol *s, OutBuffer *buf, Scope *sc)
{
    ...
    public:
        ...
        void visit(AliasDeclaration *ad)
        {
            ...
            if (Dsymbol *s = ad->aliassym)
            {
                prettyPrintDsymbol(s, ad->parent);
            }
            else if (Type *type = ad->getType())
            {
                if (type->ty == Tclass || type->ty == Tstruct || type->ty == Tenum)
                {
                    if (Dsymbol *s = type->toDsymbol(nullptr))
                        prettyPrintDsymbol(s, ad->parent);
                    else
        ...
        void visit(ClassDeclaration *cd)
        {
            ...
            for (size_t i = 0; i < cd->baseclasses->length; i++)
            {
                ...
                {
                    HdrGenState hgs;
                    ::toCBuffer(bc->type, buf, nullptr, &hgs);
                }
            }
            buf->writestring(";\n");
        }
        ...
        void visit(EnumDeclaration *ed)
        {
            ...
            if (ed->memtype)
            {
                ...
                HdrGenState hgs;
                ::toCBuffer(ed->memtype, buf, nullptr, &hgs);
                buf->writestring(")");
            }
            buf->writestring(";\n");
        }
...
# 1316 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c"
void DocComment::parseSections(const utf8_t *comment)
{
    const utf8_t *p;
    const utf8_t *pstart;
    const utf8_t *pend;
    const utf8_t *idstart = nullptr;
    size_t idlen;
    ...
    while (*p)
    {
        ...
        while (1)
        {
            ...
            if (!inCode && isIdStart(p))
            {
                ...
                if (*q == ':' && (_sch_istable[(*p) & 0xff] & (unsigned short)(_sch_isupper))
                        && ((_sch_istable[(q[1]) & 0xff] & (unsigned short)(_sch_isspace)) || q[1] == 0))
                {
                    idlen = q - p;
                    idstart = p;
...
{
    ((void)(!(a->length) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c", 1447, __FUNCTION__), 0 : 0));
...
{
    ((void)(!(a->length) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c", 1531, __FUNCTION__), 0 : 0));
...
{
    ((void)(!(a->length) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c", 1582, __FUNCTION__), 0 : 0));
    Dsymbol *s = (*a)[0];
    ...
    const utf8_t *tempstart = nullptr;
    size_t templen = 0;

    const utf8_t *namestart = nullptr;
    size_t namelen = 0;

    const utf8_t *textstart = nullptr;
    size_t textlen = 0;
    ...
    TypeFunction *tf = a->length == 1 ? isTypeFunction(s) : nullptr;
    if (tf)
    {
...
# 1762 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c"
...
# 1886 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c"
...
# 2000 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c"
size_t skiptoident(OutBuffer *buf, size_t i)
{
    while (i < buf->length())
    {
        ...
        else if (!((_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isalpha)) || c == '_' || c == '\n'))
            continue;
        i = oi;
        break;
    }
...
size_t skippastident(OutBuffer *buf, size_t i)
{
    while (i < buf->length())
    {
        ...
        else if ((_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isalnum)) || c == '_')
            continue;
        i = oi;
        break;
    }
...
# 2065 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c"
size_t skippastURL(OutBuffer *buf, size_t i)
{
    ...
    {
        utf8_t c = p[j];
        if ((_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isalnum)))
            continue;
        if (c == '-' || c == '_' || c == '?' ||
            c == '=' || c == '%' || c == '&' ||
            c == '/' || c == '+' || c == '#' ||
...
{
    static const char *table[] = { "true", "false", "null", nullptr };
...
bool isReservedName(utf8_t *str, size_t len)
{
    static const char *table[] = {
        ...
        "__EOF__", "__LOCAL_SIZE", "___tls_get_addr", "__entrypoint", nullptr };
...
void highlightText(Scope *sc, Dsymbols *a, OutBuffer *buf, size_t offset)
{
    Dsymbol *s = a->length ? (*a)[0] : nullptr;
        ...
        switch (c)
        {
            ...
            case '\n':
                ...
                if (!sc->_module->isDocFile &&
                    !inCode && i == iLineStart && i + 1 < buf->length())
                {
            ...
            case '<':
            {
                ...
                if (se && strcmp(se, "&lt;") == 0)
                {
                    ...
                    if ((_sch_istable[(p[1]) & 0xff] & (unsigned short)(_sch_isalpha)) || (p[1] == '/' && (_sch_istable[(p[2]) & 0xff] & (unsigned short)(_sch_isalpha))))
                    {
                        size_t j = i + 2;
                        p += 2;
                        while (1)
            ...
            case '&':
            {
                ...
                if (inCode)
                    break;
                utf8_t *p = (utf8_t *)&buf->slice().ptr[i];
                if (p[1] == '#' || (_sch_istable[(p[1]) & 0xff] & (unsigned short)(_sch_isalpha)))
                    break;
                    ...
                    if (inCode)
                    {
                        ...
                        for (utf8_t *p = (utf8_t *)codebuf.slice().ptr; p < endp; )
                        {
                            if (lineStart)
                            {
                                ...
                                ((void)(!((utf8_t *)codebuf.slice().ptr <= p) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c", 2488, __FUNCTION__), 0 : 0));
                                ((void)(!(p < (utf8_t *)codebuf.slice().ptr + codebuf.length()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c", 2489, __FUNCTION__), 0 : 0));
                                lineStart = false;
                                endp = (utf8_t *)codebuf.slice().ptr + codebuf.length();
                                continue;
                            }
                            if (*p == '\n')
                                lineStart = true;
            ...
            default:
                ...
                if (isIdStart(start))
                {
                    ...
                    if (c == '_' &&
                        (i == 0 || !(_sch_istable[(*(start - 1)) & 0xff] & (unsigned short)(_sch_isdigit))) &&
...
void highlightCode2(Scope *sc, Dsymbols *a, OutBuffer *buf, size_t offset)
{
    ...
    Lexer lex(nullptr, (utf8_t *)buf->slice().ptr, 0, buf->length() - 1, 0, 1);
    OutBuffer res;
...
{
    ((void)(!(c < 256) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/doc.c", 2731, __FUNCTION__), 0 : 0));
...
{
    unsigned c = *p;
    if ((_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isalpha)) || c == '_')
        return true;
    if (c >= 0x80)
    {
        size_t i = 0;
...
{
    unsigned c = *p;
    if ((_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isalnum)) || c == '_')
        return true;
    if (c >= 0x80)
    {
        size_t i = 0;
