# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nogc.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nogc.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nogc.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nogc.c" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nogc.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nogc.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nogc.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nogc.c" 2
# 1 "d/id.h" 1
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nogc.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nogc.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nogc.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nogc.c" 2
...
public:
    ...
    void visit(DeclarationExp *e)
    {
        ...
        if (v && !(v->storage_class & 0x800000LL) && !v->isDataseg() && v->_init)
        {
...
Expression *checkGC(Scope *sc, Expression *e)
{
    ...
    if (e && e->op != TOKerror &&
        f && sc->intypeof != 1 && !(sc->flags & 0x0080) &&
