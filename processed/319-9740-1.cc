# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c"
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c"
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
extern Mem mem;
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
# 1 "d/id.h" 1
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/attrib.h" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
void initPrecedence();
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
# 30 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
# 31 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
# 32 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
# 33 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/version.h" 1
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/version.h"
...
# 34 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
# 37 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
# 39 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
# 40 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/aliasthis.h" 1
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/aliasthis.h"
...
# 41 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
# 42 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
# 43 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c" 2
...
public:
    ...
    void visit(Statement *)
    {
        ...
        buf->writenl();
        ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c", 98, __FUNCTION__), 0 : 0));
    }
    ...
    void visit(CompoundDeclarationStatement *s)
    {
        ...
        for (size_t i = 0; i < s->statements->length; i++)
        {
            ...
            if (ds && ds->exp->op == TOKdeclaration)
            {
                ...
                ((void)(!(d->isDeclaration()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c", 151, __FUNCTION__), 0 : 0));
    ...
    void visit(StaticForeachStatement *s)
    {
        ...
        {
            ((void)(!(s->sfe->rangefe) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c", 327, __FUNCTION__), 0 : 0));
            visit(s->sfe->rangefe);
        }
    }
    ...
    {
        printf("t = %p, ty = %d\n", t, t->ty);
        ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c", 780, __FUNCTION__), 0 : 0));
    }
    ...
    void visit(LinkDeclaration *d)
    {
        ...
        switch (d->linkage)
        {
            ...
            default:
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c", 1277, __FUNCTION__), 0 : 0));
                break;
        }
    ...
    void visit(CPPMangleDeclaration *d)
    {
        ...
        switch (d->cppmangle)
        {
            ...
            default:
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c", 1295, __FUNCTION__), 0 : 0));
                break;
        }
    ...
    void visit(StaticForeachDeclaration *s)
    {
        ...
        {
            ((void)(!(s->sfe->rangefe) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c", 1407, __FUNCTION__), 0 : 0));
    ...
    bool visitEponymousMember(TemplateDeclaration *d)
    {
        ...
        {
            ((void)(!(fd->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c", 1481, __FUNCTION__), 0 : 0));
    ...
    void objectToBuffer(RootObject *oarg)
    {
        ...
        {
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c", 1712, __FUNCTION__), 0 : 0));
        }
    }
    ...
    {
        if (d->storage_class & 0x8000000000000LL)
            return;
        buf->writestring("alias ");
        if (d->aliassym)
        {
    ...
    void visit(FuncDeclaration *f)
    {
        ...
        if (hgs->hdrgen)
        {
            ...
            if (!tf->next || f->storage_class & 0x100LL)
            {
                hgs->autoMember++;
                bodyToBuffer(f);
                hgs->autoMember--;
    ...
    {
        if (d->storage_class & 0x400000000LL)
            buf->writestring("@trusted ");
        if (d->storage_class & 0x200000000LL)
            buf->writestring("@safe ");
        if (d->storage_class & 0x40000000000LL)
            buf->writestring("@nogc ");
        if (d->storage_class & 0x2000000000LL)
    ...
    {
        if (stcToBuffer(buf, d->storage_class & ~1LL))
            buf->writeByte(' ');
        ...
        if (e->type == Type::tsize_t)
        {
            ...
            if ((sinteger_t)uval >= 0)
            {
                ...
                if (target.ptrsize == 8)
                    ...
                    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c", 2222, __FUNCTION__), 0 : 0));
    ...
    {
        ((void)(!(precedence[e->op] != PREC_zero) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c", 2239, __FUNCTION__), 0 : 0));
        ((void)(!(pr != PREC_zero) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c", 2240, __FUNCTION__), 0 : 0));
        ...
        L1:
            switch (t->ty)
            {
                ...
                case Tchar:
                {
                    ...
                    if (v == '\'')
                        buf->writestring("'\\''");
                    else if ((_sch_istable[((int)v) & 0xff] & (unsigned short)(_sch_isprint)) && v != '\\')
                        buf->printf("'%c'", (int)v);
                    else
                ...
                default:
                    ...
                    if (!global.errors)
                    {
                        ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c", 2372, __FUNCTION__), 0 : 0));
                    }
                    break;
            }
        }
    ...
    void floatToBuffer(Type *type, real_t value)
    {
        ...
        ((void)(!(strlen(buffer) < BUFFER_LEN) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c", 2398, __FUNCTION__), 0 : 0));
        ...
        for (size_t i = 0; i < e->len; i++)
        {
            ...
            switch (c)
            {
                ...
                default:
                    if (c <= 0xFF)
                    {
                        if (c <= 0x7F && (_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isprint)))
                            buf->writeByte(c);
                        else
                            buf->printf("\\x%02x", c);
                    }
    ...
    {
        if (p->storageClass & 0x100LL)
            buf->writestring("auto ");

        if (p->storageClass & 0x100000000000LL)
        ...
        if (p->storageClass & 0x1000LL)
            ...
            buf->writestring("ref ");
        else if (p->storageClass & 0x800LL)
            buf->writestring("in ");
        else if (p->storageClass & 0x2000LL)
            buf->writestring("lazy ");
        else if (p->storageClass & 0x10000000LL)
            buf->writestring("alias ");
        ...
        if (stcToBuffer(buf, stc & (4LL | 0x100000LL | 0x80000000LL | 0x20000000LL | 0x80000LL | 0x2000000000000LL)))
            buf->writeByte(' ');
...
{
    bool result = false;
    if ((stc & (0x100000000000LL | 0x80000LL)) == (0x100000000000LL | 0x80000LL))
        stc &= ~0x80000LL;
    if (stc & 0x2000000000000LL)
        stc &= ~(0x80000LL | 0x2000000000000LL);
    while (stc)
    {
...
const char *stcToChars(StorageClass& stc)
{
    ...
    {
        { 0x100LL, TOKauto, nullptr },
        { 0x80000LL, TOKscope, nullptr },
        { 1LL, TOKstatic, nullptr },
        { 2LL, TOKextern, nullptr },
        { 4LL, TOKconst, nullptr },
        { 8LL, TOKfinal, nullptr },
        { 0x10LL, TOKabstract, nullptr },
        { 0x200LL, TOKsynchronized, nullptr },
        { 0x400LL, TOKdeprecated, nullptr },
        { 0x80LL, TOKoverride, nullptr },
        { 0x2000LL, TOKlazy, nullptr },
        { 0x10000000LL, TOKalias, nullptr },
        { 0x1000LL, TOKout, nullptr },
        { 0x800LL, TOKin, nullptr },
        { 0x800000LL, TOKenum, nullptr },
        { 0x100000LL, TOKimmutable, nullptr },
        { 0x20000000LL, TOKshared, nullptr },
        { 0x2000000LL, TOKnothrow, nullptr },
        { 0x80000000LL, TOKinout, nullptr },
        { 0x4000000LL, TOKpure, nullptr },
        { 0x200000LL, TOKref, nullptr },
        { 0x8000000LL, TOKreserved, nullptr },
        { 0x40000000LL, TOKgshared, nullptr },
        { 0x40000000000LL, TOKat, "@nogc" },
        { 0x100000000LL, TOKat, "@property" },
        { 0x200000000LL, TOKat, "@safe" },
        { 0x400000000LL, TOKat, "@trusted" },
        { 0x800000000LL, TOKat, "@system" },
        { 0x2000000000LL, TOKat, "@disable" },
        { 0x4000000000000LL, TOKat, "@__future" },
        { 0x8000000000000LL, TOKat, "__local" },
    ...
    for (int i = 0; table[i].stc; i++)
    {
        ...
        ((void)(!(tbl & STCStorageClass) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c", 3312, __FUNCTION__), 0 : 0));
        if (stc & tbl)
        {
            stc &= ~tbl;
            if (tbl == 0x8000000LL)
...
const char *trustToChars(TRUST trust)
{
    switch (trust)
    {
        ...
        default: ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c", 3345, __FUNCTION__), 0 : 0));
    }
    return nullptr;
}
...
const char *linkageToChars(LINK linkage)
{
    switch (linkage)
    {
        ...
        default: ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c", 3373, __FUNCTION__), 0 : 0));
    }
    return nullptr;
}
...
const char *protectionToChars(Prot::Kind kind)
{
    switch (kind)
    {
        case Prot::undefined: return nullptr;
        ...
        default: ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/hdrgen.c", 3403, __FUNCTION__), 0 : 0));
    }
    return nullptr;
}
