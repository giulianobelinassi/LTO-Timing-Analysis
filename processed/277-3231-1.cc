# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/canthrow.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/canthrow.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/canthrow.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/canthrow.c" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/canthrow.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/canthrow.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/canthrow.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/canthrow.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/canthrow.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/canthrow.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/canthrow.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/canthrow.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/canthrow.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/canthrow.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/canthrow.c" 2
...
bool canThrow(Expression *e, FuncDeclaration *func, bool mustNotThrow)
{
    ...
    public:
        ...
        {
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/canthrow.c", 229, __FUNCTION__), 0 : 0));
        }
    };
...
bool Dsymbol_canThrow(Dsymbol *s, FuncDeclaration *func, bool mustNotThrow)
{
    ...
    else if ((vd = s->isVarDeclaration()) != nullptr)
    {
        ...
        if (vd->storage_class & 0x800000LL)
            ;
        else if (vd->isStatic() || vd->storage_class & (2LL | 0x8000000LL | 0x40000000LL))
            ;
        else
        {
            if (vd->_init)
