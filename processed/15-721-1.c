# 1 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
...
# 7 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 2
...
# 41 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
                                (*__errno_location ())
# 41 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
                                ));
        return -1;
    }
    if (ret == 0)
...
# 56 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
...
# 91 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
    ...
    gz_statep state;
{
    ...
    if (state->size == 0) {
        ...
        if (state->in == 
# 101 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
                        ((void *)0) 
# 101 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
                             || state->out == 
# 101 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
                                              ((void *)0)
# 101 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
...
# 139 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
    if (strm->avail_in > 1 &&
    ...
    gz_statep state;
{
    ...
    do {
        ...
        if (ret == (-3)) {
            gz_error(state, (-3),
                     strm->msg == 
# 206 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
                                 ((void *)0) 
# 206 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
    ...
    off_t len;
{
    ...
    while (len)
        ...
        if (state->x.have) {
            n = (sizeof(int) == sizeof(off_t) && (state->x.have) > 0x7fffffff) || (off_t)state->x.have > len ?
    ...
    unsigned len;
{
    ...
    if (file == 
# 383 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
               ((void *)0)
# 383 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
                   )
        return -1;
    ...
    gzFile file;
{
    ...
    if (file == 
# 421 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
               ((void *)0)
# 421 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
                   )
        return 0;
    state = (gz_statep)file;
    ...
    gzFile file;
{
    ...
    if (file == 
# 455 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
               ((void *)0)
# 455 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
                   )
        return -1;
    state = (gz_statep)file;
    ...
    gzFile file;
{
    ...
    if (file == 
# 490 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
               ((void *)0)
# 490 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
                   )
        return -1;
    state = (gz_statep)file;
    ...
    int len;
{
    ...
    if (file == 
# 554 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
               ((void *)0) 
# 554 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
                    || buf == 
# 554 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
                              ((void *)0) 
# 554 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
                                   || len < 1)
        return 
# 555 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
              ((void *)0)
# 555 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
                  ;
    state = (gz_statep)file;
    ...
    if (state->mode != 7247 ||
        (state->err != 0 && state->err != (-5)))
        return 
# 561 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
              ((void *)0)
# 561 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
                  ;
    ...
    if (state->seek) {
        ...
        if (gz_skip(state, state->skip) == -1)
            return 
# 567 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
                  ((void *)0)
# 567 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
                      ;
    }
    ...
    if (left) do {
        ...
        if (state->x.have == 0 && gz_fetch(state) == -1)
            return 
# 578 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
                  ((void *)0)
# 578 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
                      ;
        if (state->x.have == 0) {
            state->past = 1;
            break;
        ...
        if (eol != 
# 587 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
                  ((void *)0)
# 587 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
                      )
...
# 597 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
                           ((void *)0)
# 597 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
                               );


    if (buf == str)
        return 
# 601 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
              ((void *)0)
# 601 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
                  ;
    buf[0] = 0;
    return str;
}
    ...
    gzFile file;
{
    ...
    if (file == 
# 613 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
               ((void *)0)
# 613 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
                   )
        return 0;
    state = (gz_statep)file;
    ...
    gzFile file;
{
    ...
    if (file == 
# 634 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
               ((void *)0)
# 634 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
                   )
        return (-2);
    state = (gz_statep)file;
    ...
    err = state->err == (-5) ? (-5) : 0;
    gz_error(state, 0, 
# 649 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c" 3 4
                         ((void *)0)
# 649 "/home/giulianob/gcc_git_gnu/gcc/zlib/gzread.c"
                             );
    free(state->path);
    ret = close(state->fd);
    free(state);
