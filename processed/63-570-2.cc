# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nspace.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nspace.c"
# 9 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nspace.c"
...
# 10 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nspace.c" 2
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nspace.c" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nspace.c" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nspace.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nspace.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nspace.c" 2
...
void Nspace::addMember(Scope *sc, ScopeDsymbol *sds)
{
    ...
    if (members)
    {
        ...
        ((void)(!(sc) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nspace.c", 57, __FUNCTION__), 0 : 0));
        sc = sc->push(this);
        sc->linkage = LINKcpp;
        sc->parent = this;
...
void Nspace::setScope(Scope *sc)
{
    ...
    if (members)
    {
        ((void)(!(sc) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nspace.c", 76, __FUNCTION__), 0 : 0));
        sc = sc->push(this);
        sc->linkage = LINKcpp;
        sc->parent = this;
        for (size_t i = 0; i < members->length; i++)
...
void Nspace::semantic(Scope *sc)
{
    ...
    if (members)
    {
        ((void)(!(sc) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nspace.c", 105, __FUNCTION__), 0 : 0));
        sc = sc->push(this);
        sc->linkage = LINKcpp;
        sc->parent = this;
...
void Nspace::semantic2(Scope *sc)
{
    ...
    if (members)
    {
        ((void)(!(sc) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/nspace.c", 133, __FUNCTION__), 0 : 0));
        sc = sc->push(this);
        sc->linkage = LINKcpp;
        for (size_t i = 0; i < members->length; i++)
        {
