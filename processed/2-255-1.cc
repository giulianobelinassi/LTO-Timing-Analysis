...
setup_prefixes (const char *exec_path)
{
  ...
  if (!self)
    ...
    self = concat (self, "gcc-" "ranlib", nullptr);
...
main (int ac, char **av)
{
  ...
  const char *err_msg;
  const char **nargv;
  bool is_ar = !strcmp ("ranlib", "ar");
  int exit_code = 
# 136 "gcc-ranlib.c" 3 4
                 1
# 136 "gcc-ranlib.c"
                                ;
  int i;
      ...
      if (!strncmp (av[i], "-B", 2))
 {
  ...
  {
    fprintf (
# 156 "gcc-ranlib.c" 3 4
            stderr
# 156 "gcc-ranlib.c"
                  , "Usage: gcc-ar [-B prefix] ar arguments ...\n");
    exit (
# 157 "gcc-ranlib.c" 3 4
         1
# 157 "gcc-ranlib.c"
                     );
  }
...
# 187 "gcc-ranlib.c"
  ...
  exe_name = find_a_file (&target_path, "ranlib", 
# 193 "gcc-ranlib.c" 3 4
                                                    1
# 193 "gcc-ranlib.c"
                                                        );
  if (!exe_name)
    {
      const char *real_exe_name = "ranlib";



      exe_name = find_a_file (&path, real_exe_name, 
# 200 "gcc-ranlib.c" 3 4
                                                   1
# 200 "gcc-ranlib.c"
                                                       );
      if (!exe_name)
