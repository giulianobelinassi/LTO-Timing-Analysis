# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/memory-block.cc"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/memory-block.cc"
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/memory-block.cc"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/memory-block.cc" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/memory-block.cc" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/memory-block.cc" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/memory-block.cc" 2


memory_block_pool memory_block_pool::instance;

memory_block_pool::memory_block_pool () : m_blocks (nullptr) {}
...
mempool_obstack_chunk_alloc (size_t size)
{
  if (size == memory_block_pool::block_size)
    ...
    return ((char *) xmalloc (sizeof (char) * (size)));
}
