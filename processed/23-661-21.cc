# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/iasmgcc.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/iasmgcc.c"
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/iasmgcc.c"
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/port.h" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/iasmgcc.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/iasmgcc.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/iasmgcc.c" 2
...
void initPrecedence();
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/iasmgcc.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/iasmgcc.c" 2

Expression *semantic(Expression *e, Scope *sc);
Statement *semantic(Statement *s, Scope *sc);
# 38 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/iasmgcc.c"
...
# 138 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/iasmgcc.c"
...
# 189 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/iasmgcc.c"
...
# 248 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/iasmgcc.c"
static GccAsmStatement *parseGccAsm(Parser *p, GccAsmStatement *s)
{
    ...
    for (int section = 0; section < 4; ++section)
    {
        ...
        switch (section)
        {
            ...
            default:
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/iasmgcc.c", 278, __FUNCTION__), 0 : 0));
        }
...
# 298 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/iasmgcc.c"
Statement *gccAsmSemantic(GccAsmStatement *s, Scope *sc)
{
    ...
    if (s->args)
    {
        for (size_t i = 0; i < s->args->length; i++)
        {
            ...
            e = (*s->constraints)[i];
            e = semantic(e, sc);
            ((void)(!(e->op == TOKstring && ((StringExp *) e)->sz == 1) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/iasmgcc.c", 349, __FUNCTION__), 0 : 0));
            (*s->constraints)[i] = e;
        }
    }
    ...
    if (s->clobbers)
    {
        for (size_t i = 0; i < s->clobbers->length; i++)
        {
            ...
            e = semantic(e, sc);
            ((void)(!(e->op == TOKstring && ((StringExp *) e)->sz == 1) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/iasmgcc.c", 361, __FUNCTION__), 0 : 0));
            (*s->clobbers)[i] = e;
        }
    }
