# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c"
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c" 2




# 30 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c"
...
# 36 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c" 3 4
                             __null
# 36 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c"
                                 ;


bool locale_utf8 = false;
# 48 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c"
void
gcc_init_libintl (void)
{

  setlocale (
# 52 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c" 3 4
            0
# 52 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c"
                    , "");
  setlocale (
# 53 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c" 3 4
            5
# 53 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c"
                       , "");




  (void) bindtextdomain ("gcc", "/usr/local/share/locale");
  (void) textdomain ("gcc");
  ...
  locale_encoding = nl_langinfo (
# 68 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c" 3 4
                                CODESET
# 68 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c"
                                       );
  if (locale_encoding != 
# 69 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c" 3 4
                        __null
      
# 70 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c"
...
gcc_gettext_width (const char *msgstr)
{
  ...
  wchar_t *wmsgstr = ((wchar_t *) __builtin_alloca(sizeof (wchar_t) * (nwcs + 1)));

  mbstowcs (wmsgstr, msgstr, nwcs + 1);
  return wcswidth (wmsgstr, nwcs);
}
# 139 "/home/giulianob/gcc_git_gnu/gcc/gcc/intl.c"
char *
get_spaces (const char *str)
{
   size_t len = gcc_gettext_width (str);
   char *spaces = ((char *) xmalloc (sizeof (char) * (len + 1)));
   memset (spaces, ' ', len);
   spaces[len] = '\0';
   return spaces;
}
