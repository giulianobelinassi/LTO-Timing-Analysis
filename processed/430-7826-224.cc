# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c" 2
# 1 "d/id.h" 1
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c" 2
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c" 2
...
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c" 2
...
# 30 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c" 2
...
{
    ((void)(!(type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 95, __FUNCTION__), 0 : 0));
    return type->size();
}
...
int Declaration::checkModify(Loc loc, Scope *sc, Type *, Expression *e1, int flag)
{
    ...
    if (isParameter() || isResult())
    {
        ...
        {
            if (scx->func == parent && (scx->flags & 0x0060))
            {
    ...
    if (v && (isCtorinit() || isField()))
    {
        ...
        if ((storage_class & (0x4000LL | 0x200000LL)) == (0x4000LL | 0x200000LL))
            return 2;
    ...
    : Declaration(id)
{
    ...
    this->isexp = false;
    this->tupletype = nullptr;
}

Dsymbol *TupleDeclaration::syntaxCopy(Dsymbol *)
{
    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 185, __FUNCTION__), 0 : 0));
    return nullptr;
}
...
Type *TupleDeclaration::getType()
{
    ...
    if (!tupletype)
    {
        ...
        for (size_t i = 0; i < types->length; i++)
        {
            ...
            Parameter *arg = new Parameter(0, t, nullptr, nullptr);
            (*args)[i] = arg;
            if (!t->deco)
                hasdeco = 0;
        }
        ...
        if (hasdeco)
            return tupletype->semantic(Loc(), nullptr);
    }
    ...
    : Declaration(id)
{
    ...
    this->loc = loc;
    this->type = type;
    this->aliassym = nullptr;
    this->_import = nullptr;
    this->overnext = nullptr;
    ((void)(!(type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 292, __FUNCTION__), 0 : 0));
}
    ...
    : Declaration(id)
{
    ...
    ((void)(!(s != this) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 299, __FUNCTION__), 0 : 0));
    this->loc = loc;
    this->type = nullptr;
    this->aliassym = s;
    this->_import = nullptr;
    this->overnext = nullptr;
    ((void)(!(s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 305, __FUNCTION__), 0 : 0));
}
...
Dsymbol *AliasDeclaration::syntaxCopy(Dsymbol *s)
{
    ...
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 316, __FUNCTION__), 0 : 0));
    AliasDeclaration *sa =
        type ? new AliasDeclaration(loc, ident, type->syntaxCopy())
             : new AliasDeclaration(loc, ident, aliassym->syntaxCopy(nullptr));
...
void AliasDeclaration::semantic(Scope *sc)
{
    if (semanticRun >= PASSsemanticdone)
        return;
    ((void)(!(semanticRun <= PASSsemantic) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 328, __FUNCTION__), 0 : 0));

    storage_class |= sc->stc & 0x400LL;
...
void AliasDeclaration::aliasSemantic(Scope *sc)
{
    ...
    inuse = 1;
# 390 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c"
    ...
    if (!s || !s->isEnumMember())
    {
        ...
        Expression *e;
        Scope *sc2 = sc;
        if (storage_class & (0x200000LL | 0x2000000LL | 0x40000000000LL | 0x4000000LL | 0x2000000000LL))
        {


            sc2 = sc->push();
            sc2->stc |= storage_class & (0x200000LL | 0x2000000LL | 0x40000000000LL | 0x4000000LL | 0x20000000LL | 0x2000000000LL);
        }
    ...
    if (s == this)
    {
        ((void)(!(global.errors) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 450, __FUNCTION__), 0 : 0));
        type = Type::terror;
        s = nullptr;
    }
    if (!s)
...
{
# 505 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c"
    if (semanticRun >= PASSsemanticdone)
    {
...
# 565 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c"
                os->parent = parent;
                aliassym = os;
            }
            os->push(s);
...
Dsymbol *AliasDeclaration::toAlias()
{
    ...
    ((void)(!(this != aliassym) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 601, __FUNCTION__), 0 : 0));
    ...
    : Declaration(ident)
{
    ...
    else
    {
        ...
        ((void)(!(!aliassym->isOverDeclaration()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 711, __FUNCTION__), 0 : 0));
    }
}
...
bool OverDeclaration::equals(RootObject *o)
{
    ...
    if (aliassym == s)
    {
        ...
        {
            return fd->isUnique() != nullptr;
        }
        if (TemplateDeclaration *td = s->isTemplateDeclaration())
        {
            return td->overnext == nullptr;
        }
    }
    return false;
}
    ...
    : Declaration(id)
{
    ...
    ((void)(!(id) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 815, __FUNCTION__), 0 : 0));
    ((void)(!(type || init) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 816, __FUNCTION__), 0 : 0));
    this->type = type;
    this->_init = init;
    this->loc = loc;
    offset = 0;
...
Dsymbol *VarDeclaration::syntaxCopy(Dsymbol *s)
{
    ...
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 850, __FUNCTION__), 0 : 0));
...
void VarDeclaration::semantic(Scope *sc)
{
    ...
    storage_class |= (sc->stc & ~(0x200LL | 0x80LL | 0x10LL | 8LL));
    if (storage_class & 2LL && _init)
    ...
    if (ad)
        storage_class |= ad->storage_class & (4LL | 0x100000LL | 0x20000000LL | 0x80000000LL);
    ...
    if (!type)
    {
        ...
        bool needctfe = (storage_class & (0x800000LL | 1LL)) != 0;
    ...
    else
    {
        ...
        Scope *sc2 = sc->push();
        sc2->stc |= (storage_class & (0x200000LL | 0x2000000LL | 0x40000000000LL | 0x4000000LL | 0x100000000LL | 0x200000000LL | 0x400000000LL | 0x800000000LL));
        inuse++;
    ...
    {
        if ((storage_class & 0x40000000LL) && !isMember())
        {
    ...
    if (tb->ty == Tvoid && !(storage_class & 0x2000LL))
    {
        if (inferred)
        {
    ...
    if ((storage_class & 0x100LL) && !inferred)
    ...
    if (tb->ty == Ttuple)
    {
        ...
        Expression *ie = (_init && !_init->isVoidInitializer()) ? initializerToExpression(_init) : nullptr;
        if (ie)
            ie = ::semantic(ie, sc);
...
Lnomatch:
        ...
        for (size_t i = 0; i < nelems; i++)
        {
            ...
            if (ie)
            {
                ...
                ti = _init ? _init->syntaxCopy() : nullptr;

            VarDeclaration *v = new VarDeclaration(loc, arg->type, id, ti);
            v->storage_class |= 0x10000000000LL | storage_class;
            if (arg->storageClass & 0x20LL)
    ...
    if (type->isConst())
    {
        storage_class |= 4LL;
        if (type->isShared())
            storage_class |= 0x20000000LL;
    }
    else if (type->isImmutable())
        storage_class |= 0x100000LL;
    else if (type->isShared())
        storage_class |= 0x20000000LL;
    else if (type->isWild())
        storage_class |= 0x80000000LL;

    if (StorageClass stc = storage_class & (0x200LL | 0x80LL | 0x10LL | 8LL))
    {
        if (stc == 8LL)
    ...
    if (storage_class & 0x80000LL)
    {
        StorageClass stc = storage_class & (1LL | 2LL | 0x800000LL | 0x8000000LL | 0x40000000LL);
        if (stc)
        {
            OutBuffer buf;
            stcToBuffer(&buf, stc);
        ...
        {
            storage_class &= ~0x80000LL;
        }
    }

    if (storage_class & (1LL | 2LL | 0x800000LL | 0x40000LL | 0x8000000LL | 0x40000000LL | 0x1000000000LL))
    {
    }
    else
    {
        ...
        if (aad)
        {
            if (global.params.vfield &&
                storage_class & (4LL | 0x100000LL) && _init && !_init->isVoidInitializer())
            {
                const char *s = (storage_class & 0x100000LL) ? "immutable" : "const";
                message(loc, "`%s.%s` is `%s` field", ad->toPrettyChars(), toChars(), s);
            }
            storage_class |= 0x40LL;
    ...
    if ((storage_class & (0x200000LL | 0x20LL | 0x4000LL | 0x10000000000LL | 0x4000000000LL)) == 0x200000LL && ident != Id::This)
    {
    ...
    if (type->hasWild())
    {
        if (storage_class & (1LL | 2LL | 0x8000000LL | 0x40000000LL | 0x800000LL | 0x40LL) ||
            isDataseg()
            )
        {
    ...
    if (!(storage_class & (0x1000000000LL | 0x200000LL | 0x4000000000LL)) && tbn->ty == Tstruct &&
        ((TypeStruct *)tbn)->sym->noDefaultCtor)
    {
        if (!_init)
        {
            if (isField())
            {
                ...
                storage_class |= 0x8000000000LL;
            }
            else if (storage_class & 0x20LL)
                ;
            else
    ...
    if (type->isscope() && !(storage_class & 0x1000000LL))
    {
        if (storage_class & (0x40LL | 0x1000LL | 0x200000LL | 1LL | 0x800000LL | 0x8000000LL | 0x40000000LL) || !fd)
        {
        ...
        if (!(storage_class & 0x80000LL))
        {
            if (!(storage_class & 0x20LL) && ident != Id::withSym)
    ...
    if (sc->func && !sc->intypeof)
    {
        if (_init && _init->isVoidInitializer() && type->hasPointers())
        {
            if (sc->func->setUnsafe())
                error("void initializers for pointers not allowed in safe functions");
        }
        else if (!_init &&
                 !(storage_class & (1LL | 2LL | 0x8000000LL | 0x40000000LL | 0x800000LL | 0x40LL | 0x20LL)) &&
    ...
    if (!_init && !fd)
    {
        ...
        storage_class |= 0x20000LL;
    }

    if (_init)
        storage_class |= 0x400000LL;
    else if (storage_class & 0x800000LL)
        error("manifest constants must have initializers");

    bool isBlit = false;
    d_uns64 sz = 0;
    if (!_init && !sc->inunion && !(storage_class & (1LL | 0x40000000LL | 2LL)) && fd &&
        (!(storage_class & (0x40LL | 0x800LL | 0x4000LL | 0x20LL | 0x4000000000LL))
         || (storage_class & 0x1000LL)) &&
        (sz = type->size()) != 0)
    {


        if (sz == (~(d_uns64)0) && type->ty != Terror)
        ...
        if (tv->needsNested())
        {
            ...
            ((void)(!(tv->toBasetype()->ty == Tstruct) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 1387, __FUNCTION__), 0 : 0));
    ...
    {
        sc = sc->push();
        sc->stc &= ~((4LL | 0x100000LL | 0x20000000LL | 0x80000000LL) | 0x4000000LL | 0x2000000LL | 0x40000000000LL | 0x200000LL | 0x2000000000LL);
        ...
        if (sc->func || sc->intypeof == 1)
        {
            ...
            if (fd &&
                !(storage_class & (0x800000LL | 1LL | 0x8000000LL | 0x40000000LL | 2LL)) &&
        ...
        else if (storage_class & (4LL | 0x100000LL | 0x800000LL) ||
                 type->isConst() || type->isImmutable())
        {
            ...
            if (!inferred)
            {
                ...
                if (ei)
                {
                    ...
                    bool needctfe = isDataseg() || (storage_class & 0x800000LL);
                    if (needctfe) sc = sc->startCTFE();
                    exp = ::semantic(exp, sc);
...
# 1563 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c"
                    if (ti->ty == Tstruct)
                    {
...
Ldtor:
    ...
    if (edtor)
    {
        if (sc->func && storage_class & (1LL | 0x40000000LL))
...
void VarDeclaration::semantic2(Scope *sc)
{
    ...
    if (_init && storage_class & 0x800000LL)
    {
...
void VarDeclaration::setFieldOffset(AggregateDeclaration *ad, unsigned *poffset, bool isunion)
{
    ...
    if (aliassym)
    {
        ...
        ((void)(!(v2) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 1713, __FUNCTION__), 0 : 0));
        for (size_t i = 0; i < v2->objects->length; i++)
        {
            RootObject *o = (*v2->objects)[i];
            ((void)(!(o->dyncast() == DYNCAST_EXPRESSION) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 1717, __FUNCTION__), 0 : 0));
            Expression *e = (Expression *)o;
            ((void)(!(e->op == TOKdsymbol) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 1719, __FUNCTION__), 0 : 0));
    ...
    if (!isField())
        return;
    ((void)(!(!(storage_class & (1LL | 2LL | 0x20LL | 0x8000000LL))) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 1728, __FUNCTION__), 0 : 0));
    ...
    if (tv->ty == Tstruct)
    {
        ...
        ((void)(!(ts->sym != ad) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 1762, __FUNCTION__), 0 : 0));
    ...
    ((void)(!(sz != (~(d_uns64)0) && sz < 
# 1779 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c" 3 4
   (4294967295U)
# 1779 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c"
   ) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 1779, __FUNCTION__), 0 : 0));
    unsigned memsize = (unsigned)sz;
    unsigned memalignsize = target.fieldalign(t);
...
Dsymbol *VarDeclaration::toAlias()
{
    ...
    ((void)(!(this != aliassym) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 1802, __FUNCTION__), 0 : 0));
    Dsymbol *s = aliassym ? aliassym->toAlias() : this;
    return s;
}
...
AggregateDeclaration *VarDeclaration::isThis()
{
    ...
    if (!(storage_class & (1LL | 2LL | 0x800000LL | 0x40000LL |
                           0x8000000LL | 0x40000000LL | 0x1000000000LL)))
    {
...
bool VarDeclaration::isImportedSymbol() const
{
    if (protection.kind == Prot::export_ && !_init &&
        (storage_class & 1LL || parent->isModule()))
        return true;
    return false;
}
...
{
    ((void)(!((storage_class & 0x800000LL) && _init) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 1849, __FUNCTION__), 0 : 0));
...
bool VarDeclaration::checkNestedReference(Scope *sc, Loc loc)
{
    ...
    if (sc->intypeof == 1 || (sc->flags & 0x0080))
        return false;
    if (!parent || parent == sc->parent)
        return false;
    if (isDataseg() || (storage_class & 0x800000LL))
        return false;
    ...
    if (ident == Id::withSym)
    {
        ...
        ((void)(!(ez) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 1941, __FUNCTION__), 0 : 0));
        Expression *e = ez->exp;
...
{
    ((void)(!(type && _init) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 1958, __FUNCTION__), 0 : 0));
    ...
    Expression *e = initializerToExpression(_init, needFullType ? type : nullptr);
...
{
    return !(storage_class & 0x800000LL);
}
...
bool VarDeclaration::isDataseg()
{
    if (isdataseg == 0)
    {
        ...
        Dsymbol *parent = toParent();
        if (!parent && !(storage_class & 1LL))
        {
            error("forward referenced");
            type = Type::terror;
        }
        else if (storage_class & (1LL | 2LL | 0x8000000LL | 0x40000000LL) ||
                 parent->isModule() || parent->isTemplateInstance() || parent->isNspace())
        {
            ((void)(!(!isParameter() && !isResult()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 2017, __FUNCTION__), 0 : 0));
            isdataseg = 1;
        }
    }
...
bool VarDeclaration::isThreadlocal()
{
    ...
    bool i = isDataseg() &&
        !(storage_class & (0x100000LL | 4LL | 0x20000000LL | 0x40000000LL));
...
{
    return (storage_class & 0x1000000000LL) != 0;
}
...
bool VarDeclaration::isOverlappedWith(VarDeclaration *v)
{
    ...
    ((void)(!(vsz != (~(d_uns64)0) && tsz != (~(d_uns64)0)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 2054, __FUNCTION__), 0 : 0));
...
bool VarDeclaration::needsScopeDtor()
{
    ...
    return edtor && !(storage_class & 0x1000000LL);
}
...
Expression *VarDeclaration::callScopeDtor(Scope *)
{
    ...
    if (storage_class & (0x1000000LL | 0x200000LL | 0x1000LL | 0x40LL))
    {
        return nullptr;
    }
    ...
    if (tv->ty == Tstruct)
    {
        ...
        ((void)(!(sz != (~(d_uns64)0)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 2102, __FUNCTION__), 0 : 0));
        if (!sz)
            return nullptr;
        ...
        else
        {
            ...
            ((void)(!(sdsz != (~(d_uns64)0) && sdsz != 0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 2131, __FUNCTION__), 0 : 0));
    ...
    if (storage_class & (0x100LL | 0x80000LL) && !(storage_class & 0x20LL))
    {
        for (ClassDeclaration *cd = type->isClassHandle();
             cd;
             cd = cd->baseClass)
        {
# 2163 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c"
            if (cd->isCPPclass())
            {
                break;
            }
...
# 2190 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c"
...
TypeInfoDeclaration::TypeInfoDeclaration(Type *tinfo)
    : VarDeclaration(Loc(), Type::dtypeinfo->type, tinfo->getTypeInfoIdent(), nullptr)
{
    this->tinfo = tinfo;
    storage_class = 1LL | 0x40000000LL;
...
{
    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 2233, __FUNCTION__), 0 : 0));
    return nullptr;
}

void TypeInfoDeclaration::semantic(Scope *)
{
    ((void)(!(linkage == LINKc) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 2239, __FUNCTION__), 0 : 0));
}
...
ThisDeclaration::ThisDeclaration(Loc loc, Type *t)
   : VarDeclaration(loc, t, Id::This, nullptr)
{
    storage_class |= 0x1000000LL;
}

Dsymbol *ThisDeclaration::syntaxCopy(Dsymbol *)
{
    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.c", 2536, __FUNCTION__), 0 : 0));
    return nullptr;
}
