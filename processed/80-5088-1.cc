# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c" 2
...
extern Mem mem;
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expression.h" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/identifier.h" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/identifier.h" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/expression.h" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c" 2
...
{
    ((void)(!(lit && lit->sd && lit->sd->isClassDeclaration()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 31, __FUNCTION__), 0 : 0));
    this->value = lit;
    this->type = type;
}
...
const char *CTFEExp::toChars()
{
    switch (op)
    {
        ...
        default: ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 169, __FUNCTION__), 0 : 0)); return nullptr;
    }
}
...
Expression *UnionExp::copy()
{
    ...
    ((void)(!(e->size <= sizeof(u)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 177, __FUNCTION__), 0 : 0));
...
UnionExp copyLiteral(Expression *e)
{
    ...
    if (e->op == TOKslice)
    {
        ...
        if (se->type->toBasetype()->ty == Tsarray)
        {
            ...
            ((void)(!(ue.exp()->op == TOKarrayliteral) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 358, __FUNCTION__), 0 : 0));
            ArrayLiteralExp *r = (ArrayLiteralExp *)ue.exp();
    ...
    if (isPointer(e->type))
    {
        ...
        else if (e->op == TOKdotvar)
        {
            ...
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 386, __FUNCTION__), 0 : 0));
        Expression *r = ue.exp();
        r->type = e->type;
        return ue;
    }
    ...
    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 402, __FUNCTION__), 0 : 0));
    return ue;
}
...
# 496 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c"
...
uinteger_t resolveArrayLength(Expression *e)
{
    ...
    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 544, __FUNCTION__), 0 : 0));
    return 0;
}
# 560 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c"
ArrayLiteralExp *createBlockDuplicatedArrayLiteral(UnionExp *pue, Loc loc, Type *type,
        Expression *elem, size_t dim)
{
        ...
        unsigned value, size_t dim, unsigned char sz)
{
    ...
    for (size_t elemi = 0; elemi < dim; ++elemi)
    {
        switch (sz)
        {
            ...
            default: ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 605, __FUNCTION__), 0 : 0));
        }
    }
...
TypeAArray *toBuiltinAAType(Type *t)
{
    ...
    if (t->ty == Taarray)
        return (TypeAArray *)t;
    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 632, __FUNCTION__), 0 : 0));
    return nullptr;
}
...
Expression *getAggregateFromPointer(Expression *e, dinteger_t *ofs)
{
    *ofs = 0;
    ...
    if (e->op == TOKdotvar)
    {
        ...
        ((void)(!(v) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 717, __FUNCTION__), 0 : 0));
    ...
    Expression *eptr, Expression *e2)
{
    ...
    else
    {
        ...
        ((void)(!(!CTFEExp::isCantExp(dollar)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 872, __FUNCTION__), 0 : 0));
        indx = ofs1;
...
int comparePointers(TOK op, Expression *agg1, dinteger_t ofs1, Expression *agg2, dinteger_t ofs2)
{
    if (pointToSameMemoryBlock(agg1, agg2))
    {
        ...
        default:
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 947, __FUNCTION__), 0 : 0));
        }
        return n;
    }
    ...
    if (null1 || null2)
    {
        ...
        case TOKnotequal:
            ...
            break;
        default:
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 970, __FUNCTION__), 0 : 0));
        }
    }
    else
    {
...
Expression *paintFloatInt(UnionExp *pue, Expression *fromVal, Type *to)
{
    ...
    ((void)(!(to->size() == 4 || to->size() == 8) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1007, __FUNCTION__), 0 : 0));
...
static bool numCmp(TOK op, N n1, N n2)
{
    switch (op)
    {
        ...
        default:
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1058, __FUNCTION__), 0 : 0));
    }
    return false;
}
...
int realCmp(TOK op, real_t r1, real_t r2)
{
    ...
    if (CTFloat::isNaN(r1) || CTFloat::isNaN(r2))
    {
        switch (op)
        {
            ...
            default:
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1096, __FUNCTION__), 0 : 0));
        }
        return 0;
    }
    else
...
int ctfeCmpArrays(Loc loc, Expression *e1, Expression *e2, uinteger_t len)
{
    ...
    ((void)(!(ae1 && ae2) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1145, __FUNCTION__), 0 : 0));
...
{
    ((void)(!(e->type->ty == Tdelegate) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1176, __FUNCTION__), 0 : 0));

    if (e->op == TOKdelegate)
        return ((DelegateExp *)e)->func;
    if (e->op == TOKfunction)
        return ((FuncExp *)e)->fd;
    ((void)(!(e->op == TOKnull) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1182, __FUNCTION__), 0 : 0));
    return nullptr;
}
...
int ctfeRawCmp(Loc loc, Expression *e1, Expression *e2)
{
    ...
    if (e1->op == TOKtypeid && e2->op == TOKtypeid)
    {
        ...
        ((void)(!(t1) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1210, __FUNCTION__), 0 : 0));
        ((void)(!(t2) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1211, __FUNCTION__), 0 : 0));
        return t1 != t2;
    }
    ...
    if (e1->type->ty == Tdelegate && e2->type->ty == Tdelegate)
    {
        ...
        if (e1->op == TOKfunction && e2->op == TOKfunction)
            return 0;
        ((void)(!(e1->op == TOKdelegate && e2->op == TOKdelegate) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1246, __FUNCTION__), 0 : 0));
    ...
    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1383, __FUNCTION__), 0 : 0));
    return 0;
}
...
Expression *ctfeIndex(Loc loc, Type *type, Expression *e1, uinteger_t indx)
{
    ...
    ((void)(!(e1->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1582, __FUNCTION__), 0 : 0));
    if (e1->op == TOKstring)
    {
        StringExp *es1 = (StringExp *)e1;
        if (indx >= es1->len)
    ...
    ((void)(!(e1->op == TOKarrayliteral) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1593, __FUNCTION__), 0 : 0));
    {
...
# 1673 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c"
void assignInPlace(Expression *dest, Expression *src)
{
    ((void)(!(dest->op == TOKstructliteral || dest->op == TOKarrayliteral || dest->op == TOKstring) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1675, __FUNCTION__), 0 : 0))
    ...
    {
        ((void)(!(dest->op == src->op) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1682, __FUNCTION__), 0 : 0));
    ...
    else if (src->op == TOKarrayliteral && dest->op == TOKstring)
    {
        ...
        ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1709, __FUNCTION__), 0 : 0));

    ((void)(!(oldelems->length == newelems->length) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1711, __FUNCTION__), 0 : 0));
    ...
    for (size_t i= 0; i < oldelems->length; ++i)
    {
        ...
        if (e->op == TOKstructliteral)
        {
            ((void)(!(o->op == e->op) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1719, __FUNCTION__), 0 : 0));
            assignInPlace(o, e);
        }
    ...
    Expression *oldval, size_t oldlen, size_t newlen)
{
    ...
    ((void)(!(elemType) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1787, __FUNCTION__), 0 : 0));
    ...
    if (oldval->op == TOKstring)
    {
        ...
        for (size_t elemi = copylen; elemi < newlen; ++elemi)
        {
            switch (oldse->sz)
            {
                ...
                default: ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1813, __FUNCTION__), 0 : 0));
            }
        }
    ...
    else
    {
        if (oldlen != 0)
        {
            ((void)(!(oldval->op == TOKarrayliteral) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1827, __FUNCTION__), 0 : 0));
...
bool isCtfeValueValid(Expression *newval)
{
    ...
    if (newval->op == TOKslice)
    {
        ...
        ((void)(!(se->lwr && se->lwr->op == TOKint64) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1926, __FUNCTION__), 0 : 0));
        ((void)(!(se->upr && se->upr->op == TOKint64) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1927, __FUNCTION__), 0 : 0));
        return (tb->ty == Tarray ||
                tb->ty == Tsarray) &&
               (se->e1->op == TOKstring ||
                se->e1->op == TOKarrayliteral);
...
bool isCtfeReferenceValid(Expression *newval)
{
    ...
    if (newval->op == TOKvar)
    {
        ...
        ((void)(!(v) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 1948, __FUNCTION__), 0 : 0));
    ...
    if (elements)
    {
        ...
        for (size_t i = 0; i < elements->length; i++)
        {
            ...
            else if (cd)
            {
                ...
                ((void)(!((elements->length + i) >= (fieldsSoFar + cd->fields.length)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 2056, __FUNCTION__), 0 : 0));
                size_t indx = (elements->length - fieldsSoFar)- cd->fields.length + i;
                ((void)(!(indx < elements->length) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/ctfeexpr.c", 2058, __FUNCTION__), 0 : 0));
                z = (*elements)[indx];
            }
            if (!z)
            {
