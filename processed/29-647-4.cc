# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c"
# 9 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c"
...
# 10 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c" 2
...
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c" 2
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c" 2





# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c"
...
# 58 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c"
...
Strings *FileName::splitPath(const char *path)
{
    ...
    if (path)
    {
        ...
        { char instring = 0;
            ...
            while ((_sch_istable[((utf8_t)*p) & 0xff] & (unsigned short)(_sch_isspace)))
                p++;
            buf.reserve(strlen(p) + 1);
            for (; ; p++)
            {
                c = *p;
                switch (c)
                {
                    case '"':
                        instring ^= 1;
                        continue;
# 96 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c"
                    case ':':
...
const char *FileName::name(const char *str)
{
    ...
    for (;;)
    {
        switch (*e)
        {
            ...
            case '/':
               return e + 1;
# 267 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c"
            default:
                if (e == str)
                    break;
                e--;
...
# 345 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c"
    memcpy(f + pathlen, name, namelen + 1);
    return f;
}
...
# 454 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c"
const char *FileName::safeSearchPath(Strings *path, const char *name)
{
# 481 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c"
...
int FileName::exists(const char *name)
{
    ...
    if (stat(name, &st) < 0)
        return 0;
    if (
# 539 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c" 3 4
       ((((
# 539 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c"
       st.st_mode
# 539 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c" 3 4
       )) & 0170000) == (0040000))
# 539 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c"
        ...
        return 2;
    return 1;
# 557 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c"
}
...
bool FileName::ensurePathExists(const char *path)
{
    ...
    if (path && *path)
    {
        if (!exists(path))
        {
            ...
            if (*p)
            {
# 577 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c"
            ...
            if (path[strlen(path) - 1] != sep)
            {
                ...
                if (r)
                {
                    ...
                    if (
# 601 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c" 3 4
                       (*__errno_location ()) 
# 601 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c"
                             != 
# 601 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c" 3 4
                                17
# 601 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c"
...
# 640 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c"
}
...
{
    if (str)
    { ((void)(!(str[0] != (char)0xAB) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/filename.c", 648, __FUNCTION__), 0 : 0));
        memset(const_cast<char *>(str), 0xAB, strlen(str) + 1);
    }
