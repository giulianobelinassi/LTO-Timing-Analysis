# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 2
...
# 38 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
 __gmpz_clear 
# 38 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
           (c->offset);
  
# 39 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
 __gmpz_clear 
# 39 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
           (c->repeat);
...
node_copy (splay_tree_node node, void *base)
{
  ...
  c = ((gfc_constructor *) xcalloc (1, sizeof (gfc_constructor)));
...
# 57 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
 __gmpz_init_set 
# 57 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
              (c->offset, src->offset);
  
# 58 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
 __gmpz_init_set 
# 58 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
              (c->repeat, src->repeat);
...
{
  int n = 
# 67 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
         __gmpz_get_si 
# 67 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
                    (((gfc_constructor*)node->value)->offset);
...
{
  gfc_constructor *c = ((gfc_constructor *) xcalloc (1, sizeof (gfc_constructor)));
  c->base = 
# 78 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
           __null
# 78 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
               ;
  c->expr = 
# 79 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
           __null
# 79 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
               ;
  c->iterator = 
# 80 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
               __null
# 80 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
                   ;

  
# 82 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
 __gmpz_init_set_si 
# 82 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
                 (c->offset, 0);
  
# 83 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
 __gmpz_init_set_si 
# 83 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
                 (c->repeat, 1);
...
gfc_constructor_base gfc_constructor_get_base (void)
{
  return splay_tree_new (splay_tree_compare_ints, 
# 90 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
                                                 __null
# 90 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
                                                     , node_free);
}
...
gfc_constructor_copy (gfc_constructor_base base)
{
  ...
  if (!base)
    return 
# 100 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
          __null
# 100 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
              ;
...
gfc_constructor_insert (gfc_constructor_base *base, gfc_constructor *c, int n)
{
  ...
  if (*base == 
# 146 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
              __null
# 146 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
                  )
    *base = splay_tree_new (splay_tree_compare_ints, 
# 147 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
                                                    __null
# 147 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
                                                        , node_free);

  c->base = *base;
  
# 150 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
 __gmpz_set_si 
# 150 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
            (c->offset, n);

  node = splay_tree_insert (*base, (splay_tree_key) n, (splay_tree_value) c);
  ((void)(!(node) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c", 153, __FUNCTION__), 0 : 0));
...
gfc_constructor_lookup (gfc_constructor_base base, int offset)
{
  ...
  if (!base)
    return 
# 179 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
          __null
# 179 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
              ;
  ...
  if (!node)
    return 
# 189 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
          __null
# 189 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
              ;

  c = (gfc_constructor *) node->value;
  if (
# 192 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
     (__builtin_constant_p ((
# 192 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
     1
# 192 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
     ) >= 0) && (
# 192 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
...
# 192 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
    ...
    {
      if (
# 194 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
         __gmpz_get_si 
# 194 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
                    (c->offset) + 
# 194 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
                                  __gmpz_get_si 
# 194 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
                                             (c->repeat) <= offset)
 c = 
# 195 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
    __null
# 195 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
        ;
    }
  else
    c = 
# 198 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
       __null
# 198 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
           ;
...
gfc_constructor_lookup_expr (gfc_constructor_base base, int offset)
{
  ...
  return c ? c->expr : 
# 208 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
                      __null
# 208 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
                          ;
}


int
gfc_constructor_expr_foreach (gfc_constructor *ctor __attribute__ ((__unused__)),
         int(*f)(gfc_expr *) __attribute__ ((__unused__)))
{
  ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c", 216, __FUNCTION__), 0 : 0));
  return 0;
}

void
gfc_constructor_swap (gfc_constructor *ctor __attribute__ ((__unused__)),
                      int n __attribute__ ((__unused__)), int m __attribute__ ((__unused__)))
{
  ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c", 224, __FUNCTION__), 0 : 0));
}
  ...
  if (base)
    {
      ...
      return node ? (gfc_constructor*) node->value : 
# 235 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
                                                    __null
# 235 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
                                                        ;
    }
  else
    return 
# 238 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
          __null
# 238 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
              ;
}
...
# 248 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
        __gmpz_get_si 
# 248 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
                   (ctor->offset));
      return node ? (gfc_constructor*) node->value : 
# 249 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
                                                    __null
# 249 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
                                                        ;
    }
  else
    return 
# 252 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
          __null
# 252 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
              ;
}
...
{
  if (ctor)
    splay_tree_remove (ctor->base, 
# 260 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
                                  __gmpz_get_si 
# 260 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
                                             (ctor->offset));
}
...
gfc_constructor_lookup_next (gfc_constructor_base base, int offset)
{
  ...
  if (!base)
    return 
# 270 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
          __null
# 270 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
              ;

  node = splay_tree_successor (base, (splay_tree_key) offset);
  if (!node)
    return 
# 274 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c" 3 4
          __null
# 274 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/constructor.c"
              ;
