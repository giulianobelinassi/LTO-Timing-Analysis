# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c"
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c" 2

# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.h" 1
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.h"
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/typed-splay-tree.h" 1
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/typed-splay-tree.h"
...
{
  splay_tree_node pending = nullptr;
  splay_tree_node active = nullptr;
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.h" 2

class edit_context;
class edited_file;
# 42 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.h"
class edit_context
{
 public:
  edit_context ();
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c" 2
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c" 2
# 44 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c"
class edit_context;
class edited_file;
class edited_line;
class line_event;
...
# 137 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c"
class edited_line
{
 public:
...
# 182 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c"
class line_event
{
 public:
...
: m_valid (true),
  m_files (strcmp, nullptr, edited_file::delete_cb)
{}
...
{
  ((void)(!(filename) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 321, __FUNCTION__), 0 : 0));
...
{
  ((void)(!(filename) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 330, __FUNCTION__), 0 : 0));
...
: m_filename (filename),
  m_edited_lines (line_comparator, nullptr, edited_line::delete_cb),
  m_num_lines (-1)
{
}
...
edited_file::print_diff (pretty_printer *pp, bool show_filenames)
{
  if (show_filenames)
    {
      pp_string (pp, colorize_start ((pp)->show_color, "diff-filename"));
      pp_printf (pp, "--- %s\n", m_filename);
      pp_printf (pp, "+++ %s\n", m_filename);
         ...
         int old_end_of_hunk, int new_start_of_hunk)
{
  ...
  pp_string (pp, colorize_start ((pp)->show_color, "diff-hunk"));
      ...
      int end_of_run)
{
  ...
  for (int line_num = start_of_run;
       ...
       line_num++)
    {
      ...
      ((void)(!(el_in_run) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 570, __FUNCTION__), 0 : 0));
      if (el_in_run->actually_edited_p ())
 {
  ...
  for (int line_num = start_of_run;
    ...
    {
      edited_line *el_in_run = get_line (line_num);
      ((void)(!(el_in_run) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 588, __FUNCTION__), 0 : 0));
...
{
  ((void)(!(missing_trailing_newline) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 663, __FUNCTION__), 0 : 0));
  if (m_num_lines == -1)
    {
      m_num_lines = 0;
      while (true)
...
: m_line_num (line_num),
  m_content (nullptr), m_len (0), m_alloc_sz (0),
  m_line_events (),
  m_predecessors ()
{
...
edited_line::~edited_line ()
{
  ...
  free (m_content);
  for (i = 0; (m_predecessors).iterate ((i), &(pred)); ++(i))
    delete pred;
}
...
edited_line::get_effective_column (int orig_column) const
{
  int i;
  line_event *event;
  for (i = 0; (m_line_events).iterate ((i), &(event)); ++(i))
     ...
     int replacement_len)
{
 ...
 return true;
  ...
  ((void)(!(start_offset >= 0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 763, __FUNCTION__), 0 : 0));
  ((void)(!(next_offset >= 0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 764, __FUNCTION__), 0 : 0));
  ...
  ((void)(!(suffix <= m_content + m_len) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 780, __FUNCTION__), 0 : 0));
...
# 840 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c"
void
...
edited_line::ensure_terminated ()
{
  ...
  ((void)(!(m_len < m_alloc_sz) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 876, __FUNCTION__), 0 : 0));
  m_content[m_len] = '\0';
}
...
test_get_content ()
{
  ...
  {
    const char *content = ("");
    temp_source_file tmp ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 909, __FUNCTION__)), ".c", content);
    edit_context edit;
    auto_free <char *> result = edit.get_content (tmp.get_filename ());
    do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 912, __FUNCTION__)), "\"\"", "result", (""), (result)); } while (0);
  }
...

  {
    const char *content = ("/* before */\n"
      "foo = bar.field;\n"
      "/* after */\n");
    temp_source_file tmp ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 920, __FUNCTION__)), ".c", content);
    edit_context edit;
    auto_free <char *> result = edit.get_content (tmp.get_filename ());
    do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 923, __FUNCTION__)), "\"/* before */\\n\" \"foo = bar.field;\\n\" \"/* after */\\n\"", "result", ("/* before */\n" "foo = bar.field;\n" "/* after */\n"), (result)); } while (0)
...

  {
    const char *content = ("/* before */\n"
      "foo = bar.field;\n"
      "/* after */");
    temp_source_file tmp ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 933, __FUNCTION__)), ".c", content);
    edit_context edit;
    auto_free <char *> result = edit.get_content (tmp.get_filename ());

    do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 937, __FUNCTION__)), "\"/* before */\\n\" \"foo = bar.field;\\n\" \"/* after */\"", "result", ("/* before */\n" "foo = bar.field;\n" "/* after */"), (result)); } while (0)
...
test_applying_fixits_insert_before (const line_table_case &case_)
{
  ...
  const char *old_content = ("/* before */\n"
        "foo = bar.field;\n"
        "/* after */\n");
  temp_source_file tmp ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 954, __FUNCTION__)), ".c", old_content);
  ...
  if (start <= LINE_MAP_MAX_LOCATION_WITH_COLS)
    do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 971, __FUNCTION__)), "\"/* before */\\n\" \"foo = /* inserted */bar.field;\\n\" \"/* after */\\n\"", "new_content", ("/* before */\n" "foo = /* inserted */bar.field;\n" "/* after */\n"), (new_content)); } while (0)

                                 ;


  do { const char *desc_ = "ASSERT_EQ (" "(100)" ", " "(edit.get_effective_column (filename, 1, 100))" ")"; if (((100)) == ((edit.get_effective_column (filename, 1, 100)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 976, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 976, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(100)" ", " "(edit.get_effective_column (filename, 3, 100))" ")"; if (((100)) == ((edit.get_effective_column (filename, 3, 100)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 977, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 977, __FUNCTION__)))), desc_); } while (0);


  do { const char *desc_ = "ASSERT_EQ (" "(1)" ", " "(edit.get_effective_column (filename, 2, 1))" ")"; if (((1)) == ((edit.get_effective_column (filename, 2, 1)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 980, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 980, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(6)" ", " "(edit.get_effective_column (filename, 2, 6))" ")"; if (((6)) == ((edit.get_effective_column (filename, 2, 6)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 981, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 981, __FUNCTION__)))), desc_); } while (0);


  do { const char *desc_ = "ASSERT_EQ (" "(21)" ", " "(edit.get_effective_column (filename, 2, 7))" ")"; if (((21)) == ((edit.get_effective_column (filename, 2, 7)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 984, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 984, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(22)" ", " "(edit.get_effective_column (filename, 2, 8))" ")"; if (((22)) == ((edit.get_effective_column (filename, 2, 8)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 985, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 985, __FUNCTION__)))), desc_); } while (0);


  auto_free <char *> diff = edit.generate_diff (false);
  do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 989, __FUNCTION__)), "\"@@ -1,3 +1,3 @@\\n\" \" /* before */\\n\" \"-foo = bar.field;\\n\" \"+foo = /* inserted */bar.field;\\n\" \" /* after */\\n\"", "diff", ("@@ -1,3 +1,3 @@\n" " /* before */\n" "-foo = bar.field;\n" "+foo = /* inserted */bar.field;\n" " /* after */\n"), (diff)); } while (0)
...
test_applying_fixits_insert_after (const line_table_case &case_)
{
  ...
  const char *old_content = ("/* before */\n"
        "foo = bar.field;\n"
        "/* after */\n");
  temp_source_file tmp ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1009, __FUNCTION__)), ".c", old_content);
  const char *filename = tmp.get_filename ();
  line_table_test ltt (case_);
  linemap_add (line_table, LC_ENTER, false, tmp.get_filename (), 2);
  ...
  edit.add_fixits (&richloc);
  auto_free <char *> new_content = edit.get_content (filename);
  do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1028, __FUNCTION__)), "\"/* before */\\n\" \"foo = bar.field/* inserted */;\\n\" \"/* after */\\n\"", "new_content", ("/* before */\n" "foo = bar.field/* inserted */;\n" "/* after */\n"), (new_content)); } while (0)

                               ;


  auto_free <char *> diff = edit.generate_diff (false);
  do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1034, __FUNCTION__)), "\"@@ -1,3 +1,3 @@\\n\" \" /* before */\\n\" \"-foo = bar.field;\\n\" \"+foo = bar.field/* inserted */;\\n\" \" /* after */\\n\"", "diff", ("@@ -1,3 +1,3 @@\n" " /* before */\n" "-foo = bar.field;\n" "+foo = bar.field/* inserted */;\n" " /* after */\n"), (diff)); } while (0)
...
test_applying_fixits_insert_after_at_line_end (const line_table_case &case_)
{
  ...
  const char *old_content = ("/* before */\n"
        "foo = bar.field;\n"
        "/* after */\n");
  temp_source_file tmp ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1054, __FUNCTION__)), ".c", old_content);
  const char *filename = tmp.get_filename ();
  line_table_test ltt (case_);
  linemap_add (line_table, LC_ENTER, false, tmp.get_filename (), 2);
  ...
  edit.add_fixits (&richloc);
  auto_free <char *> new_content = edit.get_content (filename);
  do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1070, __FUNCTION__)), "\"/* before */\\n\" \"foo = bar.field;/* inserted */\\n\" \"/* after */\\n\"", "new_content", ("/* before */\n" "foo = bar.field;/* inserted */\n" "/* after */\n"), (new_content)); } while (0)

                               ;


  auto_free <char *> diff = edit.generate_diff (false);
  do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1076, __FUNCTION__)), "\"@@ -1,3 +1,3 @@\\n\" \" /* before */\\n\" \"-foo = bar.field;\\n\" \"+foo = bar.field;/* inserted */\\n\" \" /* after */\\n\"", "diff", ("@@ -1,3 +1,3 @@\n" " /* before */\n" "-foo = bar.field;\n" "+foo = bar.field;/* inserted */\n" " /* after */\n"), (diff)); } while (0)
...
test_applying_fixits_insert_after_failure (const line_table_case &case_)
{
  ...
  const char *old_content = ("/* before */\n"
        "foo = bar.field;\n"
        "/* after */\n");
  temp_source_file tmp ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1096, __FUNCTION__)), ".c", old_content);
  const char *filename = tmp.get_filename ();
  line_table_test ltt (case_);
  linemap_add (line_table, LC_ENTER, false, tmp.get_filename (), 2);
  ...
  do { const char *desc_ = "ASSERT_EQ (" "(loc)" ", " "(linemap_position_for_loc_and_offset (line_table, loc, 1))" ")"; if (((loc)) == ((linemap_position_for_loc_and_offset (line_table, loc, 1)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1118, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1118, __FUNCTION__)))), desc_); } while (0);



  richloc.add_fixit_insert_after ("/* inserted */");
  do { const char *desc_ = "ASSERT_TRUE (" "(richloc.seen_impossible_fixit_p ())" ")"; bool actual_ = ((richloc.seen_impossible_fixit_p ())); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1123, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1123, __FUNCTION__))), desc_); } while (0);

  edit_context edit;
  edit.add_fixits (&richloc);
  do { const char *desc_ = "ASSERT_FALSE (" "(edit.valid_p ())" ")"; bool actual_ = ((edit.valid_p ())); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1127, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1127, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(nullptr)" ", " "(edit.get_content (filename))" ")"; if (((nullptr)) == ((edit.get_content (filename)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1128, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1128, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(nullptr)" ", " "(edit.generate_diff (false))" ")"; if (((nullptr)) == ((edit.generate_diff (false)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1129, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1129, __FUNCTION__)))), desc_); } while (0);
}
...
test_applying_fixits_insert_containing_newline (const line_table_case &case_)
{
  ...
  temp_source_file tmp ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1145, __FUNCTION__)), ".c", old_content);
  const char *filename = tmp.get_filename ();
  line_table_test ltt (case_);
  linemap_add (line_table, LC_ENTER, false, tmp.get_filename (), 3);
  ...
  edit.add_fixits (&richloc);
  auto_free <char *> new_content = edit.get_content (filename);
  do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1165, __FUNCTION__)), "(\"    case 'a':\\n\" \"      x = a;\\n\" \"      break;\\n\" \"    case 'b':\\n\" \"      x = b;\\n\")", "new_content", (("    case 'a':\n" "      x = a;\n" "      break;\n" "    case 'b':\n" "      x = b;\n")), (new_content)); } while (0)
  ...
  auto_free <char *> diff = edit.generate_diff (false);
  do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1174, __FUNCTION__)), "(\"@@ -1,4 +1,5 @@\\n\" \"     case 'a':\\n\" \"       x = a;\\n\" \"+      break;\\n\" \"     case 'b':\\n\" \"       x = b;\\n\")", "diff", (("@@ -1,4 +1,5 @@\n" "     case 'a':\n" "       x = a;\n" "+      break;\n" "     case 'b':\n" "       x = b;\n")), (diff)); } while (0)
...
test_applying_fixits_growing_replace (const line_table_case &case_)
{
  ...
  const char *old_content = ("/* before */\n"
        "foo = bar.field;\n"
        "/* after */\n");
  temp_source_file tmp ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1194, __FUNCTION__)), ".c", old_content);
  const char *filename = tmp.get_filename ();
  line_table_test ltt (case_);
  ...
  if (finish <= LINE_MAP_MAX_LOCATION_WITH_COLS)
    {
      do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1211, __FUNCTION__)), "\"/* before */\\n\" \"foo = bar.m_field;\\n\" \"/* after */\\n\"", "new_content", ("/* before */\n" "foo = bar.m_field;\n" "/* after */\n"), (new_content)); } while (0)

                                   ;


      do { const char *desc_ = "ASSERT_EQ (" "(18)" ", " "(edit.get_effective_column (filename, 2, 16))" ")"; if (((18)) == ((edit.get_effective_column (filename, 2, 16)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1216, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1216, __FUNCTION__)))), desc_); } while (0);


      auto_free <char *> diff = edit.generate_diff (false);
      do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1220, __FUNCTION__)), "\"@@ -1,3 +1,3 @@\\n\" \" /* before */\\n\" \"-foo = bar.field;\\n\" \"+foo = bar.m_field;\\n\" \" /* after */\\n\"", "diff", ("@@ -1,3 +1,3 @@\n" " /* before */\n" "-foo = bar.field;\n" "+foo = bar.m_field;\n" " /* after */\n"), (diff)); } while (0)
...
test_applying_fixits_shrinking_replace (const line_table_case &case_)
{
  ...
  const char *old_content = ("/* before */\n"
        "foo = bar.m_field;\n"
        "/* after */\n");
  temp_source_file tmp ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1239, __FUNCTION__)), ".c", old_content);
  const char *filename = tmp.get_filename ();
  line_table_test ltt (case_);
  linemap_add (line_table, LC_ENTER, false, filename, 2);
  ...
  if (finish <= LINE_MAP_MAX_LOCATION_WITH_COLS)
    {
      do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1256, __FUNCTION__)), "\"/* before */\\n\" \"foo = bar.field;\\n\" \"/* after */\\n\"", "new_content", ("/* before */\n" "foo = bar.field;\n" "/* after */\n"), (new_content)); } while (0)

                                   ;


      do { const char *desc_ = "ASSERT_EQ (" "(16)" ", " "(edit.get_effective_column (filename, 2, 18))" ")"; if (((16)) == ((edit.get_effective_column (filename, 2, 18)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1261, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1261, __FUNCTION__)))), desc_); } while (0);


      auto_free <char *> diff = edit.generate_diff (false);
      do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1265, __FUNCTION__)), "\"@@ -1,3 +1,3 @@\\n\" \" /* before */\\n\" \"-foo = bar.m_field;\\n\" \"+foo = bar.field;\\n\" \" /* after */\\n\"", "diff", ("@@ -1,3 +1,3 @@\n" " /* before */\n" "-foo = bar.m_field;\n" "+foo = bar.field;\n" " /* after */\n"), (diff)); } while (0)
...
test_applying_fixits_replace_containing_newline (const line_table_case &case_)
{
  ...
  temp_source_file tmp ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1283, __FUNCTION__)), ".c", old_content);
  const char *filename = tmp.get_filename ();
  line_table_test ltt (case_);
  ...
  do { const char *desc_ = "ASSERT_TRUE (" "(richloc.seen_impossible_fixit_p ())" ")"; bool actual_ = ((richloc.seen_impossible_fixit_p ())); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1300, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1300, __FUNCTION__))), desc_); } while (0);
...
test_applying_fixits_remove (const line_table_case &case_)
{
  ...
  const char *old_content = ("/* before */\n"
        "foo = bar.m_field;\n"
        "/* after */\n");
  temp_source_file tmp ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1322, __FUNCTION__)), ".c", old_content);
  const char *filename = tmp.get_filename ();
  line_table_test ltt (case_);
  linemap_add (line_table, LC_ENTER, false, filename, 2);
  ...
  if (finish <= LINE_MAP_MAX_LOCATION_WITH_COLS)
    {
      do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1341, __FUNCTION__)), "\"/* before */\\n\" \"foo = bar;\\n\" \"/* after */\\n\"", "new_content", ("/* before */\n" "foo = bar;\n" "/* after */\n"), (new_content)); } while (0)

                                   ;


      do { const char *desc_ = "ASSERT_EQ (" "(10)" ", " "(edit.get_effective_column (filename, 2, 18))" ")"; if (((10)) == ((edit.get_effective_column (filename, 2, 18)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1346, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1346, __FUNCTION__)))), desc_); } while (0);


      auto_free <char *> diff = edit.generate_diff (false);
      do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1350, __FUNCTION__)), "\"@@ -1,3 +1,3 @@\\n\" \" /* before */\\n\" \"-foo = bar.m_field;\\n\" \"+foo = bar;\\n\" \" /* after */\\n\"", "diff", ("@@ -1,3 +1,3 @@\n" " /* before */\n" "-foo = bar.m_field;\n" "+foo = bar;\n" " /* after */\n"), (diff)); } while (0)
...
test_applying_fixits_multiple (const line_table_case &case_)
{
  ...
  const char *old_content = ("/* before */\n"
        "foo = bar.field;\n"
        "/* after */\n");
  temp_source_file tmp ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1369, __FUNCTION__)), ".c", old_content);
  const char *filename = tmp.get_filename ();
  line_table_test ltt (case_);
  linemap_add (line_table, LC_ENTER, false, filename, 2);
  ...
  do { const char *desc_ = "ASSERT_EQ (" "(100)" ", " "(edit.get_effective_column (filename, 1, 100))" ")"; if (((100)) == ((edit.get_effective_column (filename, 1, 100)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1403, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1403, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(1)" ", " "(edit.get_effective_column (filename, 2, 1))" ")"; if (((1)) == ((edit.get_effective_column (filename, 2, 1)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1404, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1404, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(6)" ", " "(edit.get_effective_column (filename, 2, 6))" ")"; if (((6)) == ((edit.get_effective_column (filename, 2, 6)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1405, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1405, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(18)" ", " "(edit.get_effective_column (filename, 2, 7))" ")"; if (((18)) == ((edit.get_effective_column (filename, 2, 7)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1406, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1406, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(27)" ", " "(edit.get_effective_column (filename, 2, 16))" ")"; if (((27)) == ((edit.get_effective_column (filename, 2, 16)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1407, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1407, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(100)" ", " "(edit.get_effective_column (filename, 3, 100))" ")"; if (((100)) == ((edit.get_effective_column (filename, 3, 100)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1408, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1408, __FUNCTION__)))), desc_); } while (0);
  ...
  if (c17 <= LINE_MAP_MAX_LOCATION_WITH_COLS)
    {
      ...
      do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1417, __FUNCTION__)), "\"/* before */\\n\" \"foo = /* alpha */pub.meadow;/* beta */\\n\" \"/* after */\\n\"", "new_content", ("/* before */\n" "foo = /* alpha */pub.meadow;/* beta */\n" "/* after */\n"), (new_content)); } while (0)
      ...
      auto_free <char *> diff = edit.generate_diff (false);
      do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1424, __FUNCTION__)), "\"@@ -1,3 +1,3 @@\\n\" \" /* before */\\n\" \"-foo = bar.field;\\n\" \"+foo = /* alpha */pub.meadow;/* beta */\\n\" \" /* after */\\n\"", "diff", ("@@ -1,3 +1,3 @@\n" " /* before */\n" "-foo = bar.field;\n" "+foo = /* alpha */pub.meadow;/* beta */\n" " /* after */\n"), (diff)); } while (0)
...
change_line (edit_context &edit, int line_num)
{
  ...
  if (loc <= LINE_MAP_MAX_LOCATION_WITH_COLS)
    {
      do { const char *desc_ = "ASSERT_EQ (" "(line_num)" ", " "(exploc.line)" ")"; if (((line_num)) == ((exploc.line))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1448, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1448, __FUNCTION__)))), desc_); } while (0);
      do { const char *desc_ = "ASSERT_EQ (" "(column)" ", " "(exploc.column)" ")"; if (((column)) == ((exploc.column))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1449, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1449, __FUNCTION__)))), desc_); } while (0);
    }
...
insert_line (edit_context &edit, int line_num)
{
  ...
  if (loc <= LINE_MAP_MAX_LOCATION_WITH_COLS)
    {
      do { const char *desc_ = "ASSERT_EQ (" "(line_num)" ", " "(exploc.line)" ")"; if (((line_num)) == ((exploc.line))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1474, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1474, __FUNCTION__)))), desc_); } while (0);
      do { const char *desc_ = "ASSERT_EQ (" "(column)" ", " "(exploc.column)" ")"; if (((column)) == ((exploc.column))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1475, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1475, __FUNCTION__)))), desc_); } while (0);
    }
...
test_applying_fixits_multiple_lines (const line_table_case &case_)
{
  ...
  do { const char *desc_ = "ASSERT_NE (" "f" ", " "NULL" ")"; if ((f) != (nullptr)) ::selftest::pass ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1494, __FUNCTION__)), desc_); else ::selftest::fail ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1494, __FUNCTION__)), desc_); } while (0);
  ...
  auto_free <char *> diff = edit.generate_diff (false);
  do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1521, __FUNCTION__)), "\"@@ -1,7 +1,8 @@\\n\" \" line 1\\n\" \"-line 2\\n\" \"-line 3\\n\" \"-line 4\\n\" \"+CHANGED: line 2\\n\" \"+CHANGED: line 3\\n\" \"+CHANGED: line 4\\n\" \"+INSERTED\\n\" \" line 5\\n\" \" line 6\\n\" \" line 7\\n\" \"@@ -147,10 +148,10 @@\\n\" \" line 147\\n\" \" line 148\\n\" \" line 149\\n\" \"-line 150\\n\" \"-line 151\\n\" \"+CHANGED: line 150\\n\" \"+CHANGED: line 151\\n\" \" line 152\\n\" \"-line 153\\n\" \"+CHANGED: line 153\\n\" \" line 154\\n\" \" line 155\\n\" \" line 156\\n\"", "diff", ("@@ -1,7 +1,8 @@\n" " line 1\n" "-line 2\n" "-line 3\n" "-line 4\n" "+CHANGED: line 2\n" "+CHANGED: line 3\n" "+CHANGED: line 4\n" "+INSERTED\n" " line 5\n" " line 6\n" " line 7\n" "@@ -147,10 +148,10 @@\n" " line 147\n" " line 148\n" " line 149\n" "-line 150\n" "-line 151\n" "+CHANGED: line 150\n" "+CHANGED: line 151\n" " line 152\n" "-line 153\n" "+CHANGED: line 153\n" " line 154\n" " line 155\n" " line 156\n"), (diff)); } while (0)
# 1546 "/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c"
                      ;
...
test_applying_fixits_modernize_named_init (const line_table_case &case_)
{
  ...
  const char *old_content = ("/* before */\n"
        "bar    : 1,\n"
        "/* after */\n");
  temp_source_file tmp ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1567, __FUNCTION__)), ".c", old_content);
  const char *filename = tmp.get_filename ();
  line_table_test ltt (case_);
  linemap_add (line_table, LC_ENTER, false, filename, 2);
...

  {
...

    {
      ...
      do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1600, __FUNCTION__)), "\"/* before */\\n\" \".    : 1,\\n\" \"/* after */\\n\"", "new_content", ("/* before */\n" ".    : 1,\n" "/* after */\n"), (new_content)); } while (0)


                  ;

      do { const char *desc_ = "ASSERT_EQ (" "(6)" ", " "(edit.get_effective_column (filename, 2, 8))" ")"; if (((6)) == ((edit.get_effective_column (filename, 2, 8)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1605, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1605, __FUNCTION__)))), desc_); } while (0);

      do { const char *desc_ = "ASSERT_EQ (" "(9)" ", " "(edit.get_effective_column (filename, 2, 11))" ")"; if (((9)) == ((edit.get_effective_column (filename, 2, 11)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1607, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1607, __FUNCTION__)))), desc_); } while (0);
    }
    ...
    do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1616, __FUNCTION__)), "\"/* before */\\n\" \".    bar = 1,\\n\" \"/* after */\\n\"", "new_content", ("/* before */\n" ".    bar = 1,\n" "/* after */\n"), (new_content)); } while (0)
...

  {
    ...
    do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1630, __FUNCTION__)), "\"/* before */\\n\" \".    bar = 1,\\n\" \"/* after */\\n\"", "new_content", ("/* before */\n" ".    bar = 1,\n" "/* after */\n"), (new_content)); } while (0)
...
test_applying_fixits_unreadable_file ()
{
  ...
  do { const char *desc_ = "ASSERT_TRUE (" "(edit.valid_p ())" ")"; bool actual_ = ((edit.valid_p ())); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1655, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1655, __FUNCTION__))), desc_); } while (0);
  edit.add_fixits (&insert);
  do { const char *desc_ = "ASSERT_FALSE (" "(edit.valid_p ())" ")"; bool actual_ = ((edit.valid_p ())); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1657, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1657, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(nullptr)" ", " "(edit.get_content (filename))" ")"; if (((nullptr)) == ((edit.get_content (filename)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1658, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1658, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(nullptr)" ", " "(edit.generate_diff (false))" ")"; if (((nullptr)) == ((edit.generate_diff (false)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1659, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1659, __FUNCTION__)))), desc_); } while (0);
}
...
test_applying_fixits_line_out_of_range ()
{
  ...
  temp_source_file tmp ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1672, __FUNCTION__)), ".txt", old_content);
  const char *filename = tmp.get_filename ();
  line_table_test ltt;
  linemap_add (line_table, LC_ENTER, false, filename, 2);
  ...
  edit_context edit;
  do { const char *desc_ = "ASSERT_TRUE (" "(edit.valid_p ())" ")"; bool actual_ = ((edit.valid_p ())); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1686, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1686, __FUNCTION__))), desc_); } while (0);
  edit.add_fixits (&insert);
  do { const char *desc_ = "ASSERT_FALSE (" "(edit.valid_p ())" ")"; bool actual_ = ((edit.valid_p ())); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1688, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1688, __FUNCTION__))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(nullptr)" ", " "(edit.get_content (filename))" ")"; if (((nullptr)) == ((edit.get_content (filename)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1689, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1689, __FUNCTION__)))), desc_); } while (0);
  do { const char *desc_ = "ASSERT_EQ (" "(nullptr)" ", " "(edit.generate_diff (false))" ")"; if (((nullptr)) == ((edit.generate_diff (false)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1690, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1690, __FUNCTION__)))), desc_); } while (0);
}
...
test_applying_fixits_column_validation (const line_table_case &case_)
{
  ...
  const char *old_content = "One-liner file\n";
  temp_source_file tmp ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1703, __FUNCTION__)), ".txt", old_content);
  const char *filename = tmp.get_filename ();
  line_table_test ltt (case_);
  linemap_add (line_table, LC_ENTER, false, filename, 1);
...

  {
    ...
    if (c15 <= LINE_MAP_MAX_LOCATION_WITH_COLS)
      do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1726, __FUNCTION__)), "\"One-liner file change\\n\"", "new_content", ("One-liner file change\n"), (new_content)); } while (0);
    else
      do { const char *desc_ = "ASSERT_EQ (" "(nullptr)" ", " "(new_content)" ")"; if (((nullptr)) == ((new_content))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1728, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1728, __FUNCTION__)))), desc_); } while (0);
  }
...

  {
    ...
    edit_context edit;
    do { const char *desc_ = "ASSERT_TRUE (" "(edit.valid_p ())" ")"; bool actual_ = ((edit.valid_p ())); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1739, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1739, __FUNCTION__))), desc_); } while (0);
    edit.add_fixits (&richloc);
    do { const char *desc_ = "ASSERT_FALSE (" "(edit.valid_p ())" ")"; bool actual_ = ((edit.valid_p ())); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1741, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1741, __FUNCTION__))), desc_); } while (0);
    do { const char *desc_ = "ASSERT_EQ (" "(nullptr)" ", " "(edit.get_content (filename))" ")"; if (((nullptr)) == ((edit.get_content (filename)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1742, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1742, __FUNCTION__)))), desc_); } while (0);
    do { const char *desc_ = "ASSERT_EQ (" "(nullptr)" ", " "(edit.generate_diff (false))" ")"; if (((nullptr)) == ((edit.generate_diff (false)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1743, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1743, __FUNCTION__)))), desc_); } while (0);
  }
...

  {
    ...
    if (c14 <= LINE_MAP_MAX_LOCATION_WITH_COLS)
      do { ::selftest::assert_streq ((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1760, __FUNCTION__)), "\"One-liner change\\n\"", "new_content", ("One-liner change\n"), (new_content)); } while (0);
    else
      do { const char *desc_ = "ASSERT_EQ (" "(nullptr)" ", " "(new_content)" ")"; if (((nullptr)) == ((new_content))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1762, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1762, __FUNCTION__)))), desc_); } while (0);
  }
...

  {
    ...
    edit_context edit;
    do { const char *desc_ = "ASSERT_TRUE (" "(edit.valid_p ())" ")"; bool actual_ = ((edit.valid_p ())); if (actual_) ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1774, __FUNCTION__))), desc_); else ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1774, __FUNCTION__))), desc_); } while (0);
    edit.add_fixits (&richloc);
    do { const char *desc_ = "ASSERT_FALSE (" "(edit.valid_p ())" ")"; bool actual_ = ((edit.valid_p ())); if (actual_) ::selftest::fail (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1776, __FUNCTION__))), desc_); else ::selftest::pass (((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1776, __FUNCTION__))), desc_); } while (0);
    do { const char *desc_ = "ASSERT_EQ (" "(nullptr)" ", " "(edit.get_content (filename))" ")"; if (((nullptr)) == ((edit.get_content (filename)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1777, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1777, __FUNCTION__)))), desc_); } while (0);
    do { const char *desc_ = "ASSERT_EQ (" "(nullptr)" ", " "(edit.generate_diff (false))" ")"; if (((nullptr)) == ((edit.generate_diff (false)))) ::selftest::pass ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1778, __FUNCTION__)))), desc_); else ::selftest::fail ((((::selftest::location ("/home/giulianob/gcc_git_gnu/gcc/gcc/edit-context.c", 1778, __FUNCTION__)))), desc_); } while (0);
  }
}
