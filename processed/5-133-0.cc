# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/bbt.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/bbt.c"
# 38 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/bbt.c"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 39 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/bbt.c" 2
...
# 40 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/bbt.c" 2
...
# 41 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/bbt.c" 2
...
# 42 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/bbt.c" 2

typedef struct gfc_treap
{
  int priority; struct gfc_treap *left, *right;
}
gfc_bbt;
...
insert (gfc_bbt *new_bbt, gfc_bbt *t, compare_fn compare)
{
  ...
  if (t == 
# 101 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/bbt.c" 3 4
          __null
# 101 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/bbt.c"
              )
    return new_bbt;
...
delete_root (gfc_bbt *t)
{
  ...
  if (t->left == 
# 145 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/bbt.c" 3 4
                __null
# 145 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/bbt.c"
                    )
    return t->right;
  if (t->right == 
# 147 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/bbt.c" 3 4
                 __null
# 147 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/bbt.c"
                     )
    return t->left;
...
delete_treap (gfc_bbt *old, gfc_bbt *t, compare_fn compare)
{
  ...
  if (t == 
# 175 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/bbt.c" 3 4
          __null
# 175 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/bbt.c"
              )
    return 
# 176 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/bbt.c" 3 4
          __null
# 176 "/home/giulianob/gcc_git_gnu/gcc/gcc/fortran/bbt.c"
              ;
