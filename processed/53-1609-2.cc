# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.h" 2
class Type;
class Expression;
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c" 2
...
# 54 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c" 3 4
                             (18446744073709551615UL)
# 54 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c"
                                       , false);
}
...
{
    if (value != 
# 59 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c" 3 4
                (18446744073709551615UL)
# 59 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c"
                          )
        ++value;
    else if (negative)
    {
...
SignExtendedNumber SignExtendedNumber::operator+(const SignExtendedNumber& rhs) const
{
    ...
    if (negative != rhs.negative)
        ...
        return SignExtendedNumber(carry ? 
# 109 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c" 3 4
                                         (18446744073709551615UL) 
# 109 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c"
                                                    : sum, false);
}
...
SignExtendedNumber SignExtendedNumber::operator*(const SignExtendedNumber& rhs) const
{
# 131 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c"
    if (value == 0)
    {
        if (!negative)
            return *this;
    ...
    if (
# 148 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c" 3 4
       (18446744073709551615UL) 
# 148 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c"
                  / tAbs < aAbs)
...
SignExtendedNumber SignExtendedNumber::operator/(const SignExtendedNumber& rhs) const
{
    ...
    if (!isMinimum())
        ...
        rvVal = 
# 179 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c" 3 4
               (18446744073709551615UL) 
# 179 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c"
                          / aAbs;
...
SignExtendedNumber SignExtendedNumber::operator%(const SignExtendedNumber& rhs) const
{
    ...
    if (!isMinimum())
        ...
        rvVal = 
# 214 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c" 3 4
               (18446744073709551615UL) 
# 214 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c"
                          % aAbs + 1;
...
IntRange& IntRange::castSigned(uinteger_t mask)
{
    ...
    int minHalfChunkNegativity = imin.negative;
...
IntRange& IntRange::castUnsigned(Type *type)
{
    if (!type->isintegral() || type->toBasetype()->ty == Tvector)
        return castUnsigned(
# 420 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c" 3 4
                           (18446744073709551615UL)
# 420 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c"
                                     );
    else if (type->toBasetype()->ty == Tdchar)
        return castDchar();
    else
...
# 655 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/intrange.c"
