# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/rmem.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/rmem.c"
# 9 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/rmem.c"
...
# 10 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/rmem.c" 2
...
extern Mem mem;
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/rmem.c" 2
...
void Mem::error()
{
    ...
    exit(
# 135 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/rmem.c" 3 4
        1
# 135 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/rmem.c"
                    );
}
# 147 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/rmem.c"
...
extern "C" void *allocmemory(size_t m_size)
{
    ...
    if (m_size > (256 * 4096 - 64))
    {
        ...
        printf("Error: out of memory\n");
        exit(
# 175 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/rmem.c" 3 4
            1
# 175 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/rmem.c"
                        );
        return p;
    }

    heapleft = (256 * 4096 - 64);

    heapp = xmalloc((256 * 4096 - 64));
    ...
    if (!heapp)
    {
        printf("Error: out of memory\n");
        exit(
# 188 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/rmem.c" 3 4
            1
# 188 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/rmem.c"
                        );
    }
    goto L1;
}
