# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/arrayop.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/arrayop.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/arrayop.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/arrayop.c" 2
...
extern Mem mem;
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/arrayop.c" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/arrayop.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/arrayop.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/arrayop.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/arrayop.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/arrayop.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/arrayop.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/arrayop.c" 2
# 1 "d/id.h" 1
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/arrayop.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/arrayop.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/arrayop.c" 2
...
FuncDeclaration *buildArrayOp(Identifier *ident, BinExp *exp, Scope *sc)
{
    ...
    Statement *s1 = new ForeachRangeStatement(Loc(), TOKforeach,
        new Parameter(0, nullptr, Id::p, nullptr),
    ...
    StorageClass stc = 0x400000000LL | 0x4000000LL | 0x2000000LL | 0x40000000000LL;



    TypeFunction *ftype = new TypeFunction(ParameterList(fparams), exp->e1->type, LINKc, stc);

    FuncDeclaration *fd = new FuncDeclaration(Loc(), Loc(), ident, 0LL, ftype);
    fd->fbody = fbody;
...
Expression *arrayOp(BinExp *e, Scope *sc)
{
    ...
    Type *tb = e->type->toBasetype();
    ((void)(!(tb->ty == Tarray || tb->ty == Tsarray) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/arrayop.c", 178, __FUNCTION__), 0 : 0));
...
void buildArrayIdent(Expression *e, OutBuffer *buf, Expressions *arguments)
{
    ...
    public:
        ...
        void visit(BinAssignExp *e)
        {
            ...
            default: ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/arrayop.c", 331, __FUNCTION__), 0 : 0));
            }
            buf->writestring(s);
        }
...
Expression *buildArrayLoop(Expression *e, Parameters *fparams)
{
    ...
    public:
        ...
        void visit(Expression *e)
        {
            ...
            Parameter *param = new Parameter(0, e->type, id, nullptr);
            fparams->shift(param);
        ...
        void visit(ArrayLiteralExp *e)
        {
            ...
            Parameter *param = new Parameter(4LL, e->type, id, nullptr);
            fparams->shift(param);
        ...
        void visit(BinAssignExp *e)
        {
            ...
            default:
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/arrayop.c", 498, __FUNCTION__), 0 : 0));
            }
        }
