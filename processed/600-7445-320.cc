# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/lexer.h" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c" 2
...
Expression *expandVar(int result, VarDeclaration *v)
{
    ...
    if (v->isConst() || v->isImmutable() || v->storage_class & 0x800000LL)
    {
        ...
        if (v->storage_class & 0x800000LL ||
            ...
            ((result & 1) && (tb->ty != Tsarray && tb->ty != Tstruct))
           )
        {
            if (v->_init)
            {
                ...
                if (ei->op == TOKconstruct || ei->op == TOKblit)
                {
                    ...
                    else if (ei->op == TOKstring)
                    {
                        ...
                        if (!(result & 1) && ei->type->toBasetype()->ty == Tpointer)
                            goto L1;
                    }
                    else
                        goto L1;
                    ...
                    else if (ei->implicitConvTo(v->type) >= MATCHconst)
                    {
                        ...
                        ei = semantic(ei, nullptr);
                    }
                    else
                        goto L1;
                }
                else if (!(v->storage_class & 0x800000LL) &&
...
Expression *Expression_optimize(Expression *e, int result, bool keepLvalue)
{
    ...
    public:
        ...
        void visit(ArrayLiteralExp *e)
        {
            if (e->elements)
            {
                expOptimize(e->basis, result & 1);
                for (size_t i = 0; i < e->elements->length; i++)
                {
                    expOptimize((*e->elements)[i], result & 1);
                }
            }
        }
        ...
        {
            ((void)(!(e->keys->length == e->values->length) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c", 265, __FUNCTION__), 0 : 0));
            for (size_t i = 0; i < e->keys->length; i++)
            {
                expOptimize((*e->keys)[i], result & 1);
                expOptimize((*e->values)[i], result & 1);
            }
        }

        void visit(StructLiteralExp *e)
        {
            if (e->stageflags & 0x4) return;
        ...
        {
            ((void)(!(e->var) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c", 330, __FUNCTION__), 0 : 0));
        }
        ...
        void visit(CallExp *e)
        {
            ...
            if (e->arguments)
            {
                ...
                ((void)(!(t1->ty == Tfunction) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c", 530, __FUNCTION__), 0 : 0));
                TypeFunction *tf = (TypeFunction *)t1;
                for (size_t i = 0; i < e->arguments->length; i++)
                {
                    Parameter *p = tf->parameterList[i];
                    bool keep = p && (p->storageClass & (0x200000LL | 0x1000LL)) != 0;
                    expOptimize((*e->arguments)[i], 0, keep);
                }
            }
        }
        ...
        void visit(CastExp *e)
        {
            ...
            ((void)(!(e->type) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c", 548, __FUNCTION__), 0 : 0));
            TOK op1 = e->e1->op;
                ...
                (e->type->ty == Tpointer || e->type->ty == Tarray))
            {
                ...
                if (esz == (~(d_uns64)0) || e1sz == (~(d_uns64)0))
                    return error();
            ...
            if (e->type->ty == Tclass && e->e1->type->ty == Tclass)
            {
                ...
                cdfrom->size(e->loc);
                ((void)(!(cdfrom->sizeok == SIZEOKdone) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c", 621, __FUNCTION__), 0 : 0));
                ((void)(!(cdto->sizeok == SIZEOKdone || !cdto->isBaseOf(cdfrom, nullptr)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c", 622, __FUNCTION__), 0 : 0));
                int offset;
        ...
        void visit(BinExp *e)
        {
            ...
            if (e->op == TOKshlass || e->op == TOKshrass || e->op == TOKushrass)
            {
                if (e->e2->isConst() == 1)
                {
                    ...
                    ((void)(!(sz != (~(d_uns64)0)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c", 680, __FUNCTION__), 0 : 0));
                    sz *= 8;
        ...
        void shift_optimize(BinExp *e, UnionExp (*shift)(Loc, Type *, Expression *, Expression *))
        {
            ...
            if (e->e2->isConst() == 1)
            {
                ...
                ((void)(!(sz != (~(d_uns64)0)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/optimize.c", 765, __FUNCTION__), 0 : 0));
                sz *= 8;
                if (i2 < 0 || (d_uns64)i2 >= sz)
                {
        ...
        void visit(ArrayLengthExp *e)
        {
            ...
            if (e->e1->op == TOKvar)
            {
                ...
                if (v && (v->storage_class & 1LL) && (v->storage_class & 0x100000LL) && v->_init)
                {
        ...
        static void setLengthVarIfKnown(VarDeclaration *lengthVar, Expression *arr)
        {
            ...
            lengthVar->storage_class |= 1LL | 4LL;
        }

        void visit(IndexExp *e)
        {

            if (expOptimize(e->e1, result & 1))
                return;
