# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/identifier.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/identifier.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/identifier.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/identifier.c" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/identifier.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/identifier.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/identifier.c" 2
# 1 "d/id.h" 1
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/identifier.c" 2
...
#pragma GCC diagnostic pop
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/identifier.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/identifier.c" 2
...
{
    fprintf(
# 90 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/identifier.c" 3 4
           stderr
# 90 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/identifier.c"
                 , "%s",string);
}
...
Identifier *Identifier::idPool(const char *s, size_t len, int value)
{
    ...
    ((void)(!(sv) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/identifier.c", 136, __FUNCTION__), 0 : 0));
...
bool Identifier::isValidIdentifier(const char *p)
{
    ...
    while (p[idx])
    {
        ...
        if (!((dc >= 0x80 && isUniAlpha(dc)) || (_sch_istable[(dc) & 0xff] & (unsigned short)(_sch_isalnum)) || dc == '_'))
            goto Linvalid;
    }
    return true;
