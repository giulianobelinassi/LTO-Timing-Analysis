# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/graphds.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/graphds.c"
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/graphds.c"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/graphds.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/graphds.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/graphds.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/graphds.c" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/graphds.h" 1
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/graphds.h"
struct graph_edge
{
  int src, dest;
...
int graphds_dfs (struct graph *, int *, int,
   vec<int> *, bool, bitmap, skip_edge_callback = nullptr);
int graphds_scc (struct graph *, bitmap, skip_edge_callback = nullptr);
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/graphds.c" 2
...
{
  struct graph_edge *e = ((struct graph_edge *) __extension__ ({ struct obstack *__h = ((&g->ob)); __extension__ ({ struct obstack *__o = (__h); size_t __len = ((sizeof (struct graph_edge))); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < __len) _obstack_newchunk (__o, __len); ((void) ((__o)->next_free += (__len))); }); __extension__ ({ struct obstack *__o1 = (__h); void *__value = (void *) __o1->object_base; if (__o1->next_free == __value) __o1->maybe_empty_object = 1; __o1->next_free = ((sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (((__o1->next_free) - (sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (__o1->alignment_mask)) & ~(__o1->alignment_mask))); if ((size_t) (__o1->next_free - (char *) __o1->chunk) > (size_t) (__o1->chunk_limit - (char *) __o1->chunk)) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; __value; }); }));
...
# 203 "/home/giulianob/gcc_git_gnu/gcc/gcc/graphds.c"
int
      ...
      skip_edge_callback skip_edge_p)
{
  ...
  struct graph_edge *e;
  struct graph_edge **stack = ((struct graph_edge * *) xmalloc (sizeof (struct graph_edge *) * (g->n_vertices)));
  bitmap_iterator bi;
  unsigned av;

  if (subgraph)
    {
      for (bmp_iter_set_init (&(bi), (subgraph), (0), &(av)); bmp_iter_set (&(bi), &(av)); bmp_iter_next (&(bi), &(av)))
 {
...
# 290 "/home/giulianob/gcc_git_gnu/gcc/gcc/graphds.c"
int
graphds_scc (struct graph *g, bitmap subgraph,
      skip_edge_callback skip_edge_p)
{
  int *queue = ((int *) xmalloc (sizeof (int) * (g->n_vertices)));
  ...
  if (subgraph)
    {
      nq = 0;
      for (bmp_iter_set_init (&(bi), (subgraph), (0), &(v)); bmp_iter_set (&(bi), &(v)); bmp_iter_next (&(bi), &(v)))
 {
   queue[nq++] = v;
 }
    }
 ...
 queue[i] = i;
  ...
  ((void)(!(postorder.length () == (unsigned) nq) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/graphds.c", 316, __FUNCTION__), 0 : 0));

  for (i = 0; i < nq; i++)
    queue[i] = postorder[nq - i - 1];
  comp = graphds_dfs (g, queue, nq, nullptr, true, subgraph, skip_edge_p);
...
{
  __extension__ ({ struct obstack *__o = (&g->ob); void *__obj = (void *) (nullptr); if (__obj > (void *) __o->chunk && __obj < (void *) __o->chunk_limit) __o->next_free = __o->object_base = (char *) __obj; else _obstack_free (__o, __obj); });
  free (g);
}
...
{
  vec<int> postorder = vNULL;
  int *marks = ((int *) xcalloc ((g->n_vertices), sizeof (int)));
  int mark = 1, i, v, idom;
  bool changed = true;
  struct graph_edge *e;
# 432 "/home/giulianob/gcc_git_gnu/gcc/gcc/graphds.c"
  for (i = 0; i < g->n_vertices; i++)
    {
      parent[i] = -1;
      son[i] = -1;
  ...
  graphds_dfs (g, &entry, 1, &postorder, true, nullptr);
  ((void)(!(postorder.length () == (unsigned) g->n_vertices) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/graphds.c", 439, __FUNCTION__), 0 : 0));
  ((void)(!(postorder[g->n_vertices - 1] == entry) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/graphds.c", 440, __FUNCTION__), 0 : 0));
