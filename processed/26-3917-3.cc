# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c" 2
# 1 "d/id.h" 1
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c" 2
...
StorageClass mergeFuncAttrs(StorageClass s1, FuncDeclaration *f)
{
    ...
    StorageClass s2 = (f->storage_class & 0x2000000000LL);
    ...
    if (so & 0x800000000LL)
        stc |= 0x800000000LL;
    else if (sa & 0x400000000LL)
        stc |= 0x400000000LL;
    else if ((so & (0x400000000LL | 0x200000000LL)) == (0x400000000LL | 0x200000000LL))
        stc |= 0x400000000LL;
    else if (sa & 0x200000000LL)
        stc |= 0x200000000LL;
    ...
    if (sa & 0x40000000000LL)
        stc |= 0x40000000000LL;

    if (so & 0x2000000000LL)
        stc |= 0x2000000000LL;

    return stc;
}
# 87 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c"
FuncDeclaration *hasIdentityOpAssign(AggregateDeclaration *ad, Scope *sc)
{
    ...
    if (assign)
    {
        ...
        UnionExp er; new(&er) NullExp(ad->loc, ad->type);
        UnionExp el; new(&el) IdentifierExp(ad->loc, Id::p);
        el.exp()->type = ad->type;
        Expressions a;
        a.setDim(1);
...
# 200 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c"
FuncDeclaration *buildOpAssign(StructDeclaration *sd, Scope *sc)
{
    ...
    StorageClass stc = 0x200000000LL | 0x2000000LL | 0x4000000LL | 0x40000000000LL;
    Loc declLoc = sd->loc;
    Loc loc = Loc();
    ...
    if (sd->dtor || sd->postblit)
    {
        ...
        if (stc & 0x200000000LL)
            stc = (stc & ~0x200000000LL) | 0x400000000LL;
    }

    Parameters *fparams = new Parameters;
    fparams->push(new Parameter(0x1000000LL, sd->type, Id::p, nullptr));
    TypeFunction *tf = new TypeFunction(ParameterList(fparams), sd->handleType(), LINKd, stc | 0x200000LL);

    FuncDeclaration *fop = new FuncDeclaration(declLoc, Loc(), Id::assign, stc, tf);
    fop->storage_class |= 0x400000000000LL;
    fop->generated = true;
    Expression *e = nullptr;
    if (stc & 0x2000000000LL)
    {
    }
    else if (sd->dtor || sd->postblit)
    {
        ...
        if (sd->dtor)
        {
            ...
            tmp->storage_class |= 0x1000000LL | 0x10000000000LL | 0x1000000000LL;
    ...
    {
# 296 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c"
        for (size_t i = 0; i < sd->fields.length; i++)
        {
            VarDeclaration *v = sd->fields[i];
    ...
    if (global.endGagging(errors))
    {
        ...
        fop->storage_class |= 0x2000000000LL;
        fop->fbody = nullptr;
    }
...
FuncDeclaration *hasIdentityOpEquals(AggregateDeclaration *ad, Scope *sc)
{
    ...
    if (eq)
    {
        ...
        UnionExp er; new(&er) NullExp(ad->loc, nullptr);
        UnionExp el; new(&el) IdentifierExp(ad->loc, Id::p);
        Expressions a;
        a.setDim(1);
        for (size_t i = 0; i < 5; i++)
        {
            ...
            switch (i)
            {
                ...
                default: ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c", 429, __FUNCTION__), 0 : 0));
            }
...
# 470 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c"
FuncDeclaration *buildOpEquals(StructDeclaration *sd, Scope *sc)
{
...
# 489 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c"
FuncDeclaration *buildXopEquals(StructDeclaration *sd, Scope *sc)
{
    if (!needOpEquals(sd))
        return nullptr;
    ...
    if (Dsymbol *eq = search_function(sd, Id::eq))
    {
        if (FuncDeclaration *fd = eq->isFuncDeclaration())
        {
            TypeFunction *tfeqptr;
            {
                ...
                parameters->push(new Parameter(0x200000LL | 4LL, sd->type, nullptr, nullptr));
    ...
    if (!sd->xerreq)
    {
        ...
        ((void)(!(s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c", 526, __FUNCTION__), 0 : 0));
    ...
    Parameters *parameters = new Parameters;
    parameters->push(new Parameter(0x200000LL | 4LL, sd->type, Id::p, nullptr));
    parameters->push(new Parameter(0x200000LL | 4LL, sd->type, Id::q, nullptr));
    TypeFunction *tf = new TypeFunction(ParameterList(parameters), Type::tbool, LINKd);

    Identifier *id = Id::xopEquals;
    FuncDeclaration *fop = new FuncDeclaration(declLoc, Loc(), id, 1LL, tf);
    fop->generated = true;
...
# 572 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c"
FuncDeclaration *buildXopCmp(StructDeclaration *sd, Scope *sc)
{
    ...
    if (!sd->xerrcmp)
    {
        ...
        e = semantic(e, sc);
        Dsymbol *s = getDsymbol(e);
        ((void)(!(s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c", 611, __FUNCTION__), 0 : 0));
...
FuncDeclaration *buildXtoHash(StructDeclaration *sd, Scope *sc)
{
    ...
    TypeFunction *tf = new TypeFunction(ParameterList(parameters), Type::thash_t,
                                        LINKd, 0x2000000LL | 0x400000000LL);
...
# 781 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c"
FuncDeclaration *buildPostBlit(StructDeclaration *sd, Scope *sc)
{
    ...
    {
        stc |= sd->postblits[i]->storage_class & 0x2000000000LL;
    }

    Statements *a = new Statements();
    for (size_t i = 0; i < sd->fields.length && !(stc & 0x2000000000LL); i++)
    {
        VarDeclaration *v = sd->fields[i];
        if (v->storage_class & 0x200000LL)
            continue;
        ...
        if (!sdv->postblit)
            continue;
        ((void)(!(!sdv->isUnionDeclaration()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c", 810, __FUNCTION__), 0 : 0));
        ...
        a->push(new ExpStatement(loc, ex));
    ...
    if (a->length || (stc & 0x2000000000LL))
    {

        PostBlitDeclaration *dd = new PostBlitDeclaration(declLoc, Loc(), stc, Id::__fieldPostblit);
        dd->generated = true;
        dd->storage_class |= 0x400000000000LL;
        dd->fbody = (stc & 0x2000000000LL) ? nullptr : new CompoundStatement(loc, a);
    ...
    switch (sd->postblits.length)
    {
        ...
        default:
            Expression *e = nullptr;
            stc = 0x200000000LL | 0x2000000LL | 0x4000000LL | 0x40000000000LL;
            for (size_t i = 0; i < sd->postblits.length; i++)
            {
    ...
    if (xpostblit)
    {
        ...
        alias->addMember(sc, sd);
    }
    return xpostblit;
}
# 986 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c"
FuncDeclaration *buildDtor(AggregateDeclaration *ad, Scope *sc)
{
    ...
    if (xdtor)
    {
        ...
        alias->addMember(sc, ad);
    }
    return xdtor;
}
# 1135 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/clone.c"
FuncDeclaration *buildInv(AggregateDeclaration *ad, Scope *sc)
{
    StorageClass stc = 0x200000000LL | 0x2000000LL | 0x4000000LL | 0x40000000000LL;
    Loc declLoc = ad->loc;
    ...
    switch (ad->invs.length)
    {
        ...
        default:
            ...
            for (size_t i = 0; i < ad->invs.length; i++)
            {
                ...
                StorageClass stcy = (ad->invs[i]->storage_class & 0x200LL) |
                                    (ad->invs[i]->type->mod & MODshared ? 0x20000000LL : 0);
                if (i == 0)
                    stcx = stcy;
                else if (stcx ^ stcy)
                {
