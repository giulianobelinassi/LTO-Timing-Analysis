# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
...
# 12 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/globals.h" 2
...
extern Mem mem;
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/outbuffer.h" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/init.h" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/init.h" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/init.h" 2
...
# 18 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/init.h" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.h" 2
...
# 15 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/declaration.h" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c" 2
...
# 17 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c" 2
...
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c" 2
...
# 25 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c" 2
...
# 26 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c" 2
...
# 27 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c" 2
...
# 28 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c" 2
...
# 16 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/parse.h" 2
...
void initPrecedence();
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c" 2
...
# 270 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
    ...
    : Declaration(id)
{
    ...
    if (type)
    {
        ...
        this->storage_class &= ~((4LL | 0x100000LL | 0x20000000LL | 0x80000000LL) | (0x200000LL | 0x2000000LL | 0x40000000000LL | 0x4000000LL | 0x100000000LL | 0x200000000LL | 0x400000000LL | 0x800000000LL));
    }
    this->loc = loc;
    this->endloc = endloc;
    fthrows = nullptr;
...
Dsymbol *FuncDeclaration::syntaxCopy(Dsymbol *s)
{
    ...
    f->outId = outId;
    f->frequire = frequire ? frequire->syntaxCopy() : nullptr;
    f->fensure = fensure ? fensure->syntaxCopy() : nullptr;
    f->fbody = fbody ? fbody->syntaxCopy() : nullptr;
    ((void)(!(!fthrows) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 380, __FUNCTION__), 0 : 0));
    return f;
}
...
static bool canInferAttributes(FuncDeclaration *fd, Scope *sc)
{
    ...
    if (fd->isFuncLiteralDeclaration() ||
        (fd->storage_class & 0x400000000000LL) ||
...
void FuncDeclaration::semantic(Scope *sc)
{
    ...
    if (semanticRun >= PASSsemanticdone)
        return;
    ((void)(!(semanticRun <= PASSsemantic) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 465, __FUNCTION__), 0 : 0));
    ...
    storage_class |= sc->stc & ~0x200000LL;
    ad = isThis();


    if (ad && !generated)
    {
        storage_class |= ad->storage_class & ((4LL | 0x100000LL | 0x20000000LL | 0x80000000LL) | 0x200LL);
        ad->makeNested();
    }
    if (sc->func)
        storage_class |= sc->func->storage_class & 0x2000000000LL;

    if ((storage_class & (4LL | 0x100000LL | 0x20000000LL | 0x80000000LL)) && !(ad || isNested()))
        storage_class &= ~(4LL | 0x100000LL | 0x20000000LL | 0x80000000LL);
    ...
    {
        Type *treq = fld->treq;
        ((void)(!(treq->nextOf()->ty == Tfunction) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 503, __FUNCTION__), 0 : 0));
        if (treq->ty == Tdelegate)
            fld->tok = TOKdelegate;
        else if (treq->ty == Tpointer && treq->nextOf()->ty == Tfunction)
            fld->tok = TOKfunction;
        else
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 509, __FUNCTION__), 0 : 0));
    ...
    {
        sc = sc->push();
        sc->stc |= storage_class & (0x2000000000LL | 0x400LL);
        TypeFunction *tf = type->toTypeFunction();

        if (sc->func)
        {
# 552 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
        ...
        if (tf->isref) sc->stc |= 0x200000LL;
        if (tf->isscope) sc->stc |= 0x80000LL;
        if (tf->isnothrow) sc->stc |= 0x2000000LL;
        if (tf->isnogc) sc->stc |= 0x40000000000LL;
        if (tf->isproperty) sc->stc |= 0x100000000LL;
        if (tf->purity == PUREfwdref) sc->stc |= 0x4000000LL;
        if (tf->trust != TRUSTdefault)
            sc->stc &= ~(0x200000000LL | 0x800000000LL | 0x400000000LL);
        if (tf->trust == TRUSTsafe) sc->stc |= 0x200000000LL;
        if (tf->trust == TRUSTsystem) sc->stc |= 0x800000000LL;
        if (tf->trust == TRUSTtrusted) sc->stc |= 0x400000000LL;
        ...
        if (isCtorDeclaration())
        {
            ...
            ((void)(!(tret) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 595, __FUNCTION__), 0 : 0));
        ...
        if (ad && ad->isClassDeclaration() && (tf->isreturn || sc->stc & 0x100000000000LL) && !(sc->stc & 1LL))
            sc->stc |= 0x80000LL;


        if (sc->stc & 0x80000LL && ad && ad->isStructDeclaration() && !ad->type->hasPointers())
        {
            sc->stc &= ~0x80000LL;
            tf->isscope = false;
        }
        ...
        if (type->isConst())
            stc |= 4LL;
        if (type->isShared() || storage_class & 0x200LL)
            stc |= 0x20000000LL;
        if (type->isWild())
            stc |= 0x80000000LL;
        switch (stc & (4LL | 0x100000LL | 0x20000000LL | 0x80000000LL))
        {
            case 0x100000LL:
            case 0x100000LL | 4LL:
            case 0x100000LL | 0x80000000LL:
            case 0x100000LL | 0x80000000LL | 4LL:
            case 0x100000LL | 0x20000000LL:
            case 0x100000LL | 0x20000000LL | 4LL:
            case 0x100000LL | 0x20000000LL | 0x80000000LL:
            case 0x100000LL | 0x20000000LL | 0x80000000LL | 4LL:
            ...
            case 0x20000000LL | 4LL:
                type = type->makeSharedConst();
                break;

            case 0x20000000LL | 0x80000000LL:
                type = type->makeSharedWild();
                break;

            case 0x20000000LL | 0x80000000LL | 4LL:
            ...
            default:
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 683, __FUNCTION__), 0 : 0));
        }
    ...
    else
    {
        ...
        storage_class &= ~((4LL | 0x100000LL | 0x20000000LL | 0x80000000LL) | (0x200000LL | 0x2000000LL | 0x40000000000LL | 0x4000000LL | 0x100000000LL | 0x200000000LL | 0x400000000LL | 0x800000000LL));
    }

    f = (TypeFunction *)type;

    if ((storage_class & 0x100LL) && !f->isref && !inferRetType)
    ...
    if (ClassDeclaration *cd = parent->isClassDeclaration())
    {
        ...
        if (may_override && type->nextOf() == nullptr)
        {
        ...
        Lintro:
                ...
                else
                {
                    ...
                    if (cd->isCPPclass() && target.cpp.reverseOverloads)
                    {
                        ...
                        for (int i = (int)cd->vtbl.length; i > vtblIndex; i--)
                        {
                            ...
                            ((void)(!(fd) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 921, __FUNCTION__), 0 : 0));
                            fd->vtblIndex++;
                        }
            ...
            default:
            {
                ...
                if (fdc->toParent() == parent)
                {
                    ...
                    bool thismixin = this->parent->isClassDeclaration() != nullptr;
                ...
                foverrides.push(fdv);
# 1023 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
                if (fdv->tintro)
                    tintro = fdv->tintro;
                    ...
                    if (ti)
                    {
                        if (tintro)
                        {
                            if (!tintro->nextOf()->equals(ti->nextOf()) &&
                                !tintro->nextOf()->isBaseOf(ti->nextOf(), nullptr) &&
                                !ti->nextOf()->isBaseOf(tintro->nextOf(), nullptr))
                            {
    ...
    L2: ;
        ...
        if (isOverride())
        {
            if (storage_class & 0x2000000000LL)
...
Ldone:
    ...
    static bool printedMain = false;
    if (global.params.verbose && !printedMain)
    {
        const char *type = isMain() ? "main" : isWinMain() ? "winmain" : isDllMain() ? "dllmain" : (const char *)nullptr;
    ...
    ((void)(!(type->ty != Terror || errors) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 1223, __FUNCTION__), 0 : 0));
}
...
void FuncDeclaration::semantic2(Scope *sc)
{
    if (semanticRun >= PASSsemantic2done)
        return;
    ((void)(!(semanticRun <= PASSsemantic2) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 1230, __FUNCTION__), 0 : 0));
...
# 1251 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
...
static void buildEnsureRequire(FuncDeclaration *fdx)
{
    ...
    if (fdx->fensure)
    {
        ...
        if (fdx->outId)
        {
            p = new Parameter(0x200000LL | 4LL, f->nextOf(), fdx->outId, nullptr);
            fparams->push(p);
        }
...
void FuncDeclaration::semantic3(Scope *sc)
{
    ...
    if (!parent)
    {
        ...
        ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 1363, __FUNCTION__), 0 : 0));
    }
    ...
    {
        if (storage_class & 0x400000000000LL)
        {
    ...
    if (fbody || frequire || needEnsure)
    {
        ...
        sc2->fes = fes;
        sc2->linkage = LINKd;
        sc2->stc &= ~(0x100LL | 0x80000LL | 1LL | 2LL | 0x10LL |
                        0x400LL | 0x80LL |
                        (4LL | 0x100000LL | 0x20000000LL | 0x80000000LL) | 8LL | 0x8000000LL | 0x40000000LL | 0x200000LL | 0x100000000000LL |
                        0x100000000LL | 0x2000000LL | 0x4000000LL | 0x200000000LL | 0x400000000LL | 0x800000000LL);
        sc2->protection = Prot(Prot::public_);
        sc2->explicitProtection = 0;
        sc2->aligndecl = nullptr;
        if (this->ident != Id::require && this->ident != Id::ensure)
            sc2->flags = sc->flags & ~0x0060;
        sc2->flags &= ~0x0100;
        sc2->tf = nullptr;
        sc2->os = nullptr;
        sc2->noctor = 0;
        ...
        sc2->fieldinit_dim = 0;
# 1496 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
        ...
        if (f->parameterList.varargs == VARARGvariadic)
        {
            if (f->linkage == LINKd)
            {
                ...
                v_arguments = new VarDeclaration(Loc(), Type::typeinfotypelist->type, Id::_arguments_typeinfo, nullptr);
                v_arguments->storage_class |= 0x10000000000LL | 0x20LL;
                ...
                _arguments->storage_class |= 0x10000000000LL;
            ...
            if (f->linkage == LINKd || f->parameterList.length())
            {
                ...
                v_argptr = new VarDeclaration(Loc(), t, Id::_argptr, nullptr);
                v_argptr->storage_class |= 0x10000000000LL;
        ...
        if (nparams)
        {
            ...
            for (size_t i = 0; i < nparams; i++)
            {
                ...
                VarDeclaration *v = new VarDeclaration(loc, vtype, id, nullptr);

                stc |= 0x20LL;
                if (f->parameterList.varargs == VARARGtypesafe && i + 1 == nparams)
                    stc |= 0x10000LL;
                if (flags & 0x40 && !(fparam->storageClass & 0x80000LL))
                    stc |= 0x1000000000000LL;
                stc |= fparam->storageClass & (0x800LL | 0x1000LL | 0x200000LL | 0x100000000000LL | 0x80000LL | 0x2000LL | 8LL | (4LL | 0x100000LL | 0x20000000LL | 0x80000000LL) | 0x1000000LL);
                v->storage_class = stc;
                v->semantic(sc2);
                if (!sc2->insert(v))
            ...
            for (size_t i = 0; i < f->parameterList.parameters->length; i++)
            {
                ...
                if (fparam->type->ty == Ttuple)
                {
                    ...
                    for (size_t j = 0; j < dim; j++)
                    {
                        ...
                        ((void)(!(narg->ident) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 1628, __FUNCTION__), 0 : 0));
                        VarDeclaration *v = sc2->search(Loc(), narg->ident, nullptr)->isVarDeclaration();
                        ((void)(!(v) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 1630, __FUNCTION__), 0 : 0));
                        Expression *e = new VarExp(v->loc, v);
                        (*exps)[j] = e;
                    }
                    ((void)(!(fparam->ident) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 1634, __FUNCTION__), 0 : 0));
        ...
        if (addPreInvariant())
        {
            Expression *e = addInvariant(loc, sc, ad, vthis, isDtorDeclaration() != nullptr);
            if (e)
        ...
        if (addPostInvariant())
        {
            Expression *e = addInvariant(loc, sc, ad, vthis, isCtorDeclaration() != nullptr);
            if (e)
        ...
        if (fbody)
        {
            ...
            bool inferRef = (f->isref && (storage_class & 0x100LL));
            ...
            ((void)(!(type == f || (type->ty == Tfunction && f->purity == PUREimpure && ((TypeFunction *)type)->purity >= PUREfwdref)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 1721, __FUNCTION__), 0 : 0))
            ...
            if (returns && !fbody->isErrorStatement())
            {
                for (size_t i = 0; i < returns->length; )
                {
                    ...
                    if (inferRef && f->isref && !exp->type->constConv(f->next))
                        f->isref = false;
                    i++;
                }
            }
            if (f->isref)
            {
                if (storage_class & 0x100LL)
                    storage_class &= ~0x100LL;
            }
            ...
            else if (ad2 && isCtorDeclaration())
            {
                ...
                if (!(sc2->callSuper & 1))
                {
                    for (size_t i = 0; i < ad2->fields.length; i++)
                    {
                        ...
                        if (v->ctorinit == 0)
                        {
                            ...
                            else if (v->storage_class & 0x8000000000LL)
                        ...
                        {
                            bool mustInit = (v->storage_class & 0x8000000000LL ||
                                             v->type->needsNested());
                            if (mustInit && !(sc2->fieldinit[i] & 1))
                            {
                    ...
                    cd->baseClass && cd->baseClass->ctor)
                {
                    ...
                    FuncDeclaration *fd = resolveFuncCall(Loc(), sc2, cd->baseClass->ctor, nullptr, vthis->type, nullptr, 1);
                    if (!fd)
                    {
                        error("no match for implicit super() call in constructor");
                    }
                    else if (fd->storage_class & 0x2000000000LL)
                    {
...
# 1863 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
            buildEnsureRequire(this);
            ...
            else if (ad2 && isCtorDeclaration())
            {
                ...
                {
                    Statement *s = new ReturnStatement(loc, nullptr);
                    s = ::semantic(s, sc2);
            ...
            else if (fes)
            {
                ...
                ((void)(!(!returnLabel) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 1906, __FUNCTION__), 0 : 0));
            }
            else
            {
            ...
            if (returns)
            {
                ...
                ((void)(!(tret->ty != Tvoid) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 1943, __FUNCTION__), 0 : 0));
        ...
        if (freq)
        {
            ...
            sym->endlinnum = endloc.linnum;
            sc2 = sc2->push(sym);
            sc2->flags = (sc2->flags & ~0x0060) | 0x0040;
        ...
        if (fens)
        {
            ...
            sc2 = scout;
            sc2->flags = (sc2->flags & ~0x0060) | 0x0060;
        ...
        else
        {
            ...
            if (parameters)
            {
                for (size_t i = 0; i < parameters->length; i++)
                {
                    ...
                    {
                        ((void)(!(v->_init) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 2093, __FUNCTION__), 0 : 0));
                        ExpInitializer *ie = v->_init->isExpInitializer();
                        ((void)(!(ie) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 2095, __FUNCTION__), 0 : 0));
            ...
            if (parameters)
            {
                for (size_t i = 0; i < parameters->length; i++)
                {
                    ...
                    if (v->storage_class & (0x200000LL | 0x1000LL | 0x2000LL))
                        continue;
                    ...
                    if (v->needsScopeDtor())
                    {
                        ...
                        v->storage_class |= 0x1000000LL;

                        s = ::semantic(s, sc2);

                        bool isnothrow = f->isnothrow & !(flags & 4);
                        int blockexit = blockExit(s, this, isnothrow);
                        if (f->isnothrow && isnothrow && blockexit & BEthrow)
                            ::error(loc, "nothrow %s '%s' may throw", kind(), toPrettyChars());
                        if (flags & 4 && blockexit & BEthrow)
                            f->isnothrow = false;
    ...
    {
        flags &= ~0x10;
        if (storage_class & 0x100000000000LL)
        {
            if (type == f)
                f = (TypeFunction *)f->copy();
            f->isreturn = true;
    ...
    if (parameters)
    {
        ...
        ((void)(!(nfparams == parameters->length) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 2317, __FUNCTION__), 0 : 0));
        for (size_t u = 0; u < parameters->length; u++)
        {
            VarDeclaration *v = (*parameters)[u];
            if (v->storage_class & 0x1000000000000LL)
            {

                Parameter *p = f->parameterList[u];
                v->storage_class &= ~0x1000000000000LL;
                v->storage_class |= 0x80000LL | 0x2000000000000LL;
                p->storageClass |= 0x80000LL | 0x2000000000000LL;
                ((void)(!(!(p->storageClass & 0x1000000000000LL)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 2328, __FUNCTION__), 0 : 0));
            }
        }
    }

    if (vthis && vthis->storage_class & 0x1000000000000LL)
    {
        vthis->storage_class &= ~0x1000000000000LL;
        vthis->storage_class |= 0x80000LL | 0x2000000000000LL;
        f->isscope = true;
...
VarDeclaration *FuncDeclaration::declareThis(Scope *sc, AggregateDeclaration *ad)
{
    if (ad)
    {
        VarDeclaration *v;
        {
            ...
            ((void)(!(thandle) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 2486, __FUNCTION__), 0 : 0));
            thandle = thandle->addMod(type->mod);
            thandle = thandle->addStorageClass(storage_class);
            v = new ThisDeclaration(loc, thandle);
            v->storage_class |= 0x20LL;
            if (thandle->ty == Tstruct)
            {
                v->storage_class |= 0x200000LL;


                if (type->ty == Tfunction && ((TypeFunction *)type)->iswild & 2)
                    v->storage_class |= 0x100000000000LL;
            }
            if (type->ty == Tfunction)
            {
                ...
                if (tf->isreturn)
                    v->storage_class |= 0x100000000000LL;
                if (tf->isscope)
                    v->storage_class |= 0x80000LL;
            }
            if (flags & 0x40 && !(v->storage_class & 0x80000LL))
                v->storage_class |= 0x1000000000000LL;

            v->semantic(sc);
            if (!sc->insert(v))
                ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 2512, __FUNCTION__), 0 : 0));
            v->parent = this;
            return v;
        }
    }
    else if (isNested())
    {
        ...
        v->semantic(sc);
        if (!sc->insert(v))
            ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 2538, __FUNCTION__), 0 : 0));
        v->parent = this;
        return v;
    }
...
void FuncDeclaration::buildResultVar(Scope *sc, Type *tret)
{
    if (!vresult)
    {
        ...
        vresult = new VarDeclaration(loc, tret, outId ? outId : Id::result, nullptr);
        vresult->storage_class |= 0x1000000LL;

        if (outId == Id::result)
            vresult->storage_class |= 0x10000000000LL;
        if (!isVirtual())
            vresult->storage_class |= 4LL;
        vresult->storage_class |= 0x4000000000LL;
    ...
    if (sc && vresult->semanticRun == PASSinit)
    {
        TypeFunction *tf = type->toTypeFunction();
        if (tf->isref)
            vresult->storage_class |= 0x200000LL;
        vresult->type = tret;
        ...
        ((void)(!(vresult->parent == this) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 2618, __FUNCTION__), 0 : 0));
    }
}
...
{
# 2661 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
    for (size_t i = 0; i < foverrides.length; i++)
    {
        FuncDeclaration *fdv = foverrides[i];
        ...
        {
            ((void)(!(fdv->_scope) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 2671, __FUNCTION__), 0 : 0));
...
{
# 2718 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
    for (size_t i = 0; i < foverrides.length; i++)
    {
        FuncDeclaration *fdv = foverrides[i];
        ...
        {
            ((void)(!(fdv->_scope) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 2729, __FUNCTION__), 0 : 0));
            Scope *sc = fdv->_scope->push();
            sc->stc &= ~0x80LL;
            fdv->semantic3(sc);
            sc->pop();
        ...
        if (fdv->fdensure)
        {
            ...
            if (outId)
            {
                ...
                if (t1->isBaseOf(t2, nullptr))
                {
                    ...
                    v->storage_class |= 0x10000000000LL;
...
# 2809 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
    ...
    for (int vi = 0; vi < dim; vi++)
    {
        ...
        if (fdv && fdv->ident == ident)
        {
            ...
            switch (cov)
            {
                ...
                default:
                    ((void)(!(0) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 2867, __FUNCTION__), 0 : 0));
            }
        }
    }
...
# 2894 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
...
bool FuncDeclaration::overloadInsert(Dsymbol *s)
{
    ...
    ((void)(!(s != this) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 2915, __FUNCTION__), 0 : 0));
...
# 2967 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
int overloadApply(Dsymbol *fstart, void *param, int (*fp)(void *, Dsymbol *))
{
    Dsymbol *d;
    Dsymbol *next;
...
# 3159 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
FuncDeclaration *FuncDeclaration::overloadModMatch(Loc loc, Type *tthis, bool &hasOverloads)
{
  ...
  struct ParamMod
  {
    ...
    else
    {
        ...
        ((void)(!(tthis) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 3254, __FUNCTION__), 0 : 0));
        ((void)(!(!MODimplicitConv(tthis->mod, tf->mod)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 3255, __FUNCTION__), 0 : 0));
        {
...
# 3311 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
...
# 3484 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
FuncDeclaration *resolveFuncCall(Loc loc, Scope *sc, Dsymbol *s,
        Objects *tiargs, Type *tthis, Expressions *fargs, int flags)
{
    ...
    const int numOverloadsDisplay = 5;
    ...
    if (!m.lastf && !(flags & 1))
    {
        ...
        {
            ((void)(!(fd) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 3569, __FUNCTION__), 0 : 0));

            bool hasOverloads = fd->overnext != nullptr;
            TypeFunction *tf = fd->type->toTypeFunction();
            if (tthis && !MODimplicitConv(tthis->mod, tf->mod))
            {
                OutBuffer thisBuf, funcBuf;
                MODMatchToBuffer(&thisBuf, tthis->mod, tf->mod);
                MODMatchToBuffer(&funcBuf, tf->mod, tthis->mod);
...
# 3653 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
int FuncDeclaration::getLevel(Loc loc, Scope *sc, FuncDeclaration *fd)
{
    ...
    while (fd != s && fdparent != s->toParent2())
    {
        ...
        else
        {
            ...
            if (thiscd)
            {
# 3689 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
        ...
        s = s->toParent2();
        ((void)(!(s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 3697, __FUNCTION__), 0 : 0));
        level++;
    }
    return level;
...
bool FuncDeclaration::isFinalFunc()
{
    ...
    return isMember() &&
        (Declaration::isFinal() ||
         ((cd = toParent()->isClassDeclaration()) != nullptr && cd->storage_class & 8LL));
}
...
Type *getIndirection(Type *t)
{
    ...
    if (t->ty == Taarray || t->ty == Tclass)
        return t;
    if (t->ty == Tstruct)
        return t->hasPointers() ? t : nullptr;


    return nullptr;
}
# 3972 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
...
{
    TypeFunction *tf = type->toTypeFunction();
    ((void)(!(tf->next) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 4045, __FUNCTION__), 0 : 0));
...
{
    ((void)(!(t) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 4061, __FUNCTION__), 0 : 0));
    ...
    for (size_t i = 0; i < dim; i++)
    {
        ...
        if (!fparam->type)
            continue;
        Type *tprmi = (fparam->storageClass & (0x2000LL | 0x1000LL | 0x200000LL))
...
# 4102 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
bool FuncDeclaration::isNested()
{
    FuncDeclaration *f = toAliasFunc();

    return ((f->storage_class & 1LL) == 0) &&
           (f->linkage == LINKd) &&
           (f->toParent2()->isFuncDeclaration() != nullptr);
}
# 4119 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
AggregateDeclaration *FuncDeclaration::isThis()
{

    AggregateDeclaration *ad = (storage_class & 1LL) ? nullptr : isMember2();
...
# 4163 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
Expression *addInvariant(Loc loc, Scope *sc, AggregateDeclaration *ad, VarDeclaration *vthis, bool direct)
{
...
# 4195 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
            e = new ThisExp(Loc());
            e->type = vthis->type;
...
FuncDeclaration *FuncDeclaration::genCfunc(Parameters *fparams, Type *treturn, Identifier *id, StorageClass stc)
{
    ...
    if (s)
    {
        ...
        ((void)(!(fd) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 4250, __FUNCTION__), 0 : 0));
        ((void)(!(fd->type->nextOf()->equals(treturn)) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 4251, __FUNCTION__), 0 : 0));
    }
    else
    {
        tf = new TypeFunction(ParameterList(fparams), treturn, LINKc, stc);
        fd = new FuncDeclaration(Loc(), Loc(), id, 1LL, tf);
...
void FuncDeclaration::checkDmain()
{
    ...
    if (nparams == 1)
    {
        ...
        if (t->ty != Tarray ||
            ...
            fparam0->storageClass & (0x1000LL | 0x200000LL | 0x2000LL))
        {
            argerr = true;
        }
    }
...
# 4309 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
    ...
    if (isNested())
    {
        ...
        if (fdthis != this)
        {
            ...
            if (!found)
            {
                ...
                if (!sc->intypeof && !(sc->flags & 0x0100))
...
# 4408 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
...
# 4455 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
bool FuncDeclaration::needsClosure()
{
# 4479 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
    if (requiresClosure)
        goto Lyes;
    ...
    for (size_t i = 0; i < closureVars.length; i++)
    {
        ...
        for (size_t j = 0; j < v->nestedrefs.length; j++)
        {
            ...
            ((void)(!(f != this) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 4490, __FUNCTION__), 0 : 0));
# 4499 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
...
# 4546 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
bool FuncDeclaration::checkClosure()
{
    ...
    for (size_t i = 0; i < closureVars.length; i++)
    {
        ...
        {
            FuncDeclaration *f = v->nestedrefs[j];
            ((void)(!(f != this) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 4571, __FUNCTION__), 0 : 0));
...
bool FuncDeclaration::hasNestedFrameRefs()
{
    if (closureVars.length)
        return true;
# 4622 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
...
{
    ((void)(!(funcalias != this) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 4663, __FUNCTION__), 0 : 0));
    ...
    {
        ((void)(!(!funcalias->isFuncAliasDeclaration()) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 4674, __FUNCTION__), 0 : 0));
...
FuncLiteralDeclaration::FuncLiteralDeclaration(Loc loc, Loc endloc, Type *type,
    ...
    : FuncDeclaration(loc, endloc, nullptr, 0LL, type)
{
...
Dsymbol *FuncLiteralDeclaration::syntaxCopy(Dsymbol *s)
{
    ...
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 4708, __FUNCTION__), 0 : 0));
...
# 4753 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 4817, __FUNCTION__), 0 : 0));
...
void CtorDeclaration::semantic(Scope *sc)
{
    ...
    if (ad && (!parent->isTemplateInstance() || parent->isTemplateMixin()))
    {
        ...
        {
            if (dim == 0 && tf->parameterList.varargs == VARARGnone)
            {
                if (fbody || !(storage_class & 0x2000000000LL) || dim)
                {
            ...
            else if (dim == 0 && tf->parameterList.varargs)
            {
            }
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 4938, __FUNCTION__), 0 : 0));
...
DtorDeclaration::DtorDeclaration(Loc loc, Loc endloc)
    : FuncDeclaration(loc, endloc, Id::dtor, 0LL, nullptr)
{
}
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 5015, __FUNCTION__), 0 : 0));
...
StaticCtorDeclaration::StaticCtorDeclaration(Loc loc, Loc endloc, StorageClass stc)
    : FuncDeclaration(loc, endloc,
      Identifier::generateId("_staticCtor"), 1LL | stc, nullptr)
{
}

StaticCtorDeclaration::StaticCtorDeclaration(Loc loc, Loc endloc, const char *name, StorageClass stc)
    : FuncDeclaration(loc, endloc,
      Identifier::generateId(name), 1LL | stc, nullptr)
{
}

Dsymbol *StaticCtorDeclaration::syntaxCopy(Dsymbol *s)
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 5105, __FUNCTION__), 0 : 0));
...
void StaticCtorDeclaration::semantic(Scope *sc)
{
    ...
    if (isInstantiated() && semanticRun < PASSsemantic)
    {
        ...
        v->storage_class = 0x10000000000LL | (isSharedStaticCtorDeclaration() ? 1LL : 0x8000000LL);
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 5209, __FUNCTION__), 0 : 0));
...
StaticDtorDeclaration::StaticDtorDeclaration(Loc loc, Loc endloc, StorageClass stc)
    : FuncDeclaration(loc, endloc,
      Identifier::generateId("_staticDtor"), 1LL | stc, nullptr)
{
    vgate = nullptr;
}
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 5232, __FUNCTION__), 0 : 0));
...
void StaticDtorDeclaration::semantic(Scope *sc)
{
    ...
    if (isInstantiated() && semanticRun < PASSsemantic)
    {
        ...
        VarDeclaration *v = new VarDeclaration(Loc(), Type::tint32, Id::gate, nullptr);
        v->storage_class = 0x10000000000LL | (isSharedStaticDtorDeclaration() ? 1LL : 0x8000000LL);
        Statements *sa = new Statements();
        Statement *s = new ExpStatement(Loc(), v);
        sa->push(s);
        Expression *e = new IdentifierExp(Loc(), v->ident);
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 5337, __FUNCTION__), 0 : 0));
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 5353, __FUNCTION__), 0 : 0));
...
void InvariantDeclaration::semantic(Scope *sc)
{
    ...
    sc->stc &= ~1LL;
    sc->stc |= 4LL;
    sc->flags = (sc->flags & ~0x0060) | 0x0020;
    sc->linkage = LINKd;
...
# 5420 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c"
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 5435, __FUNCTION__), 0 : 0));
...
NewDeclaration::NewDeclaration(Loc loc, Loc endloc, StorageClass stc, Parameters *fparams, VarArg varargs)
    : FuncDeclaration(loc, endloc, Id::classNew, 1LL | stc, nullptr)
{
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 5505, __FUNCTION__), 0 : 0));
...
DeleteDeclaration::DeleteDeclaration(Loc loc, Loc endloc, StorageClass stc, Parameters *fparams)
    : FuncDeclaration(loc, endloc, Id::classDelete, 1LL | stc, nullptr)
{
    this->parameters = fparams;
}
...
{
    ((void)(!(!s) ? fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/func.c", 5584, __FUNCTION__), 0 : 0));
