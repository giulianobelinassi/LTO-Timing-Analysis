# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/diagnostic-color.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/diagnostic-color.c"
# 19 "/home/giulianob/gcc_git_gnu/gcc/gcc/diagnostic-color.c"
# 1 "./config.h" 1
...
# 9 "./config.h" 2
# 20 "/home/giulianob/gcc_git_gnu/gcc/gcc/diagnostic-color.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/gcc/diagnostic-color.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/gcc/diagnostic-color.c" 2
...
# 23 "/home/giulianob/gcc_git_gnu/gcc/gcc/diagnostic-color.c" 2





# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/color-macros.h" 1
# 29 "/home/giulianob/gcc_git_gnu/gcc/gcc/diagnostic-color.c" 2
# 74 "/home/giulianob/gcc_git_gnu/gcc/gcc/diagnostic-color.c"
struct color_cap
{
  const char *name;
  const char *val;
...
{
  { "error", "\33[" "01" ";" "31" "m\33[K", 5, false },
  { "warning", "\33[" "01" ";" "35" "m\33[K",
        7, false },
  { "note", "\33[" "01" ";" "36" "m\33[K", 4, false },
  { "range1", "\33[" "32" "m\33[K", 6, false },
  { "range2", "\33[" "34" "m\33[K", 6, false },
  { "locus", "\33[" "01" "m\33[K", 5, false },
  { "quote", "\33[" "01" "m\33[K", 5, false },
  { "path", "\33[" "01" ";" "36" "m\33[K", 4, false },
  { "fixit-insert", "\33[" "32" "m\33[K", 12, false },
  { "fixit-delete", "\33[" "31" "m\33[K", 12, false },
  { "diff-filename", "\33[" "01" "m\33[K", 13, false },
  { "diff-hunk", "\33[" "36" "m\33[K", 9, false },
  { "diff-delete", "\33[" "31" "m\33[K", 11, false },
  { "diff-insert", "\33[" "32" "m\33[K", 11, false },
  { "type-diff", "\33[" "01" ";" "32" "m\33[K", 9, false },
...
{
  return show_color ? "\33[" "" "m\33[K" : "";
}
# 135 "/home/giulianob/gcc_git_gnu/gcc/gcc/diagnostic-color.c"
static bool
 ...
 if (cap->val && val)
   {
     ...
     b = ((char *) xmalloc (sizeof (char) * (val_len + sizeof ("\33[" "" "m\33[K"))));
     memcpy (b, "\33[", strlen ("\33["));
     memcpy (b + strlen ("\33["), val, val_len);
     memcpy (b + strlen ("\33[") + val_len, "m\33[K",
      sizeof ("m\33[K"));
...
{
# 218 "/home/giulianob/gcc_git_gnu/gcc/gcc/diagnostic-color.c"
  char const *t = getenv ("TERM");

  return t && strcmp (t, "dumb") != 0 && isatty (
# 220 "/home/giulianob/gcc_git_gnu/gcc/gcc/diagnostic-color.c" 3 4
                                                2
# 220 "/home/giulianob/gcc_git_gnu/gcc/gcc/diagnostic-color.c"
                                                             );
...
colorize_init (diagnostic_color_rule_t rule)
{
 ...
 return false;
    default:
      (fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/diagnostic-color.c", 239, __FUNCTION__));
    }
}
...
determine_url_format (diagnostic_url_rule_t rule)
{
 ...
 return URL_FORMAT_NONE;
    default:
      (fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/gcc/diagnostic-color.c", 346, __FUNCTION__));
    }
}
