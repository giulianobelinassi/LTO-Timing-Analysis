# 1 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
# 18 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
# 1 "./config.h" 1
# 19 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 2
...
# 20 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 2
...
# 21 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 2
...
# 22 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/libcpp/../include/hashtab.h" 1
# 23 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 2
...
# 24 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 2
...
write_macdef (cpp_reader *pfile, cpp_hashnode *hn, void *file_p)
{
 ...
 poisoned:
   ...
   if (fwrite_unlocked (&s, sizeof (s), 1, f) != 1
    ...
    default:
      fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c", 97, __FUNCTION__);
    }
}
...
static int
save_idents (cpp_reader *pfile __attribute__ ((__unused__)), cpp_hashnode *hn, void *ss_p)
{
  ...
  if (hn->type != NT_VOID)
    {
      ...
      if (*slot == 
# 137 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 3 4
                  __null
# 137 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
                      )
 {
   struct cpp_string *sp;
   unsigned char *text;

   sp = ((struct cpp_string *) xmalloc (sizeof (struct cpp_string)));
   *slot = sp;

   sp->len = (((&(hn)->ident))->len);
   sp->text = text = ((unsigned char *) xmalloc (sizeof (unsigned char) * ((((&(hn)->ident))->len))));
...
cpp_save_state (cpp_reader *r, FILE *f)
{
  ...
  r->savedstate = ((struct cpp_savedstate *) xmalloc (sizeof (struct cpp_savedstate)));
...
static int
count_defs (cpp_reader *pfile __attribute__ ((__unused__)), cpp_hashnode *hn, void *ss_p)
{
  struct cpp_savedstate *const ss = (struct cpp_savedstate *)ss_p;
 ...
 if (slot == 
# 245 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 3 4
            __null
# 245 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
                )
   {
    ...
    default:
      fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c", 254, __FUNCTION__);
    }
}


static int
write_defs (cpp_reader *pfile __attribute__ ((__unused__)), cpp_hashnode *hn, void *ss_p)
{
  struct cpp_savedstate *const ss = (struct cpp_savedstate *)ss_p;
 ...
 slot = (void **) htab_find (ss->definedhash, &news);
 if (slot == 
# 283 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 3 4
            __null
# 283 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
                )
   {
    ...
    default:
      fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c", 292, __FUNCTION__);
    }
}
...
cpp_write_pch_deps (cpp_reader *r, FILE *f)
{
  ...
  ss->defs = ((cpp_hashnode * *) xmalloc (sizeof (cpp_hashnode *) * (ss->n_defs)));
  ss->n_defs = 0;
  cpp_forall_identifiers (r, write_defs, ss);


  qsort (ss->defs, ss->n_defs, sizeof (cpp_hashnode *), &comp_hashnodes);
  definedstrs = ss->definedstrs = ((unsigned char *) xmalloc (sizeof (unsigned char) * (ss->hashsize)));
  ...
  free (ss);
  r->savedstate = 
# 351 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 3 4
                 __null
# 351 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
                     ;


  if (fwrite_unlocked (&r->counter, sizeof (r->counter), 1, f) != 1)
    {
      cpp_errno (r, CPP_DL_ERROR, "while writing precompiled header");
      return -1;
    }
...
_cpp_restore_pushed_macros (cpp_reader *r, FILE *f)
{
  ...
  if (fread_unlocked (&count_saved, sizeof (count_saved), 1, f) != 1)
    return 0;
  if (! count_saved)
    return 1;
  for (i = 0; i < count_saved; i++)
    {
      if (fread_unlocked (&nlen, sizeof (nlen), 1, f) != 1)
 return 0;
      p = ((struct def_pragma_macro *) xmalloc (sizeof (struct def_pragma_macro)));
      memset (p, 0, sizeof (struct def_pragma_macro));
      p->name = ((char *) xmalloc ((nlen + 1)));
      p->name[nlen] = 0;
      if (fread_unlocked (p->name, nlen, 1, f) != 1)
 return 0;
      if (fread_unlocked (&defnlen, sizeof (defnlen), 1, f) != 1)
 return 0;
      if (defnlen == 0)
        p->is_undef = 1;
      else
        {
   defn = ((uchar *) xmalloc (sizeof (uchar) * (defnlen + 1)));
   defn[defnlen] = 0;

   if (fread_unlocked (defn, defnlen, 1, f) != 1)
     return 0;

   p->definition = defn;
   if (fread_unlocked (&(p->line), sizeof (location_t), 1, f) != 1)
     return 0;
   defnlen = 0;
   if (fread_unlocked (&defnlen, sizeof (defnlen), 1, f) != 1)
     return 0;
...
_cpp_save_pushed_macros (cpp_reader *r, FILE *f)
{
  ...
  p = r->pushed_macros;
  while (p != 
# 465 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 3 4
             __null
# 465 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
                 )
    {
      count_saved++;
      p = p->next;
    }
  if (fwrite_unlocked (&count_saved, sizeof (count_saved), 1, f) != 1)
    return 0;
  if (!count_saved)
    return 1;

  pp = (struct def_pragma_macro **) __builtin_alloca(sizeof (struct def_pragma_macro *) * count_saved)
                       ;

  p = r->pushed_macros;
  i = count_saved;
  while (p != 
# 480 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 3 4
             __null
# 480 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
                 )
    {
      --i;
      pp[i] = p;
  ...
  for (i = 0; i < count_saved; i++)
    {
      ...
      if (fwrite_unlocked (&defnlen, sizeof (size_t), 1, f) != 1
   || fwrite_unlocked (pp[i]->name, defnlen, 1, f) != 1)
 return 0;
      if (pp[i]->is_undef)
 {
   defnlen = 0;
   ...
   if (fwrite_unlocked (&defnlen, sizeof (size_t), 1, f) != 1
       || fwrite_unlocked (pp[i]->definition, defnlen, 1, f) != 1)
     return 0;
   if (fwrite_unlocked (&(pp[i]->line), sizeof (location_t), 1, f) != 1)
     return 0;
   defnlen = 0;
   defnlen |= (pp[i]->syshdr != 0 ? 1 : 0);
   defnlen |= (pp[i]->used != 0 ? 2 : 0);
   if (fwrite_unlocked (&defnlen, sizeof (defnlen), 1, f) != 1)
     return 0;
 }
    }
  return 1;
...
static int
collect_ht_nodes (cpp_reader *pfile __attribute__ ((__unused__)), cpp_hashnode *hn,
    void *nl_p)
{
  ...
  if (hn->type != NT_VOID || hn->flags & (1 << 1))
    {
      if (nl->n_defs == nl->asize)
        {
          nl->asize *= 2;
          nl->defs = ((cpp_hashnode * *) xrealloc ((void *) (nl->defs), sizeof (cpp_hashnode *) * (nl->asize)));
        }
...
# 565 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
int
cpp_valid_state (cpp_reader *r, const char *name, int fd)
{
  struct macrodef_struct m;
  size_t namebufsz = 256;
  unsigned char *namebuf = ((unsigned char *) xmalloc (sizeof (unsigned char) * (namebufsz)));
  unsigned char *undeftab = 
# 571 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 3 4
                           __null
# 571 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
                               ;
 ...
 {
   if (lseek (fd, m.definition_length, 
# 594 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 3 4
                                      1
# 594 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
                                              ) == -1)
     goto error;
   continue;
 }
      ...
      if (m.definition_length > namebufsz)
 {
   ...
   namebuf = ((unsigned char *) xmalloc (sizeof (unsigned char) * (namebufsz)));
 }
   ...
   || h->flags & (1 << 1))
 {
   ...
   goto fail;
      ...
      if (h->type == NT_VOID)
 {
# 631 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
   if (!(h->flags & (1 << 5))
   ...
   || memcmp (namebuf, newdefn, m.definition_length) != 0)
 {
  ...
  free (namebuf);
  namebuf = 
# 658 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 3 4
           __null
# 658 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
               ;



  undeftab = ((unsigned char *) xmalloc (sizeof (unsigned char) * (m.definition_length)));
  ...
  nl.n_defs = 0;
  nl.asize = 10;
  nl.defs = ((cpp_hashnode * *) xmalloc (sizeof (cpp_hashnode *) * (nl.asize)));
      ...
      else
 {
  ...
  free(nl.defs);
  nl.defs = 
# 698 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 3 4
           __null
# 698 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
               ;
  free (undeftab);
  undeftab = 
# 700 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 3 4
            __null
# 700 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
                ;
...
# 753 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
static int
save_macros (cpp_reader *r, cpp_hashnode *h, void *data_p)
{
 ...
 {
   data->array_size *= 2;
   data->defns = ((uchar * *) xrealloc ((void *) (data->defns), sizeof (uchar *) * ((data->array_size))));
 }
...
{
  struct save_macro_data *d = ((struct save_macro_data *) xmalloc (sizeof (struct save_macro_data)));

  d->array_size = 512;
  d->defns = ((uchar * *) xmalloc (sizeof (uchar *) * (d->array_size)));
  d->count = 0;
  ...
  struct save_macro_data *data)
{
...

  {
    ...
    s->n_defined = cpp_lookup (r, (const unsigned char *)"defined", sizeof "defined" - 1);
    s->n_true = cpp_lookup (r, (const unsigned char *)"true", sizeof "true" - 1);
    s->n_false = cpp_lookup (r, (const unsigned char *)"false", sizeof "false" - 1);
    s->n__VA_ARGS__ = cpp_lookup (r, (const unsigned char *)"__VA_ARGS__", sizeof "__VA_ARGS__" - 1);
    s->n__VA_OPT__ = cpp_lookup (r, (const unsigned char *)"__VA_OPT__", sizeof "__VA_OPT__" - 1);
  }
      ...
      if (h->type == NT_VOID)
 {
   if (cpp_push_buffer (r, defn, ustrchr (defn, '\n') - defn, true)
       != 
# 838 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 3 4
         __null
# 838 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
             )
     {
       _cpp_clean_line (r);
       if (!_cpp_create_definition (r, h))
  fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c", 842, __FUNCTION__);
       _cpp_pop_buffer (r);
     }
   else
     fancy_abort ("/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c", 846, __FUNCTION__);
 }
  ...
  if (deps_restore (r->deps, f, ((r)->opts.restore_pch_deps) ? name : 
# 857 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c" 3 4
                                                                         __null
# 857 "/home/giulianob/gcc_git_gnu/gcc/libcpp/pch.c"
                                                                             )
      != 0)
    goto error;
  ...
  if (fread_unlocked (&counter, sizeof (counter), 1, f) != 1)
    goto error;
