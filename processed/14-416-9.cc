# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/stringtable.c"
...
# 1 "<command-line>" 2
# 1 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/stringtable.c"
# 9 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/stringtable.c"
...
# 10 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/stringtable.c" 2
...
# 11 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/stringtable.c" 2
...
# 13 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/stringtable.c" 2
...
# 14 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/stringtable.c" 2
...
uint32_t StringTable::allocValue(const char *s, size_t length, void *ptrvalue)
{
    ...
    if (!npools || nfill + nbytes > (1U << 12))
    {
        pools = (uint8_t **)mem.xrealloc(pools, ++npools * sizeof(pools[0]));
        pools[npools - 1] = (uint8_t *)mem.xmalloc(nbytes > (1U << 12) ? nbytes : (1U << 12));
        nfill = 0;
    }
    ...
    const uint32_t vptr = (uint32_t)(npools << 12 | nfill);
    nfill += nbytes + (-nbytes & 7);
    return vptr;
}
...
StringValue *StringTable::getValue(uint32_t vptr)
{
    ...
    const size_t idx = (vptr >> 12) - 1;
    const size_t off = vptr & ((1U << 12) - 1);
...
# 183 "/home/giulianob/gcc_git_gnu/gcc/gcc/d/dmd/root/stringtable.c"
